...
uses
  ...
  StdCtrls, Mask, ToolEdit, RxGrdCpt,
...
function EditGradientCaption(Component: TRxGradientCaption;
  Designer: IDesigner): Boolean;
var Grad: TGradCaptionsEditor;
begin
  Grad := TGradCaptionsEditor.Create(Application);
  try
    Grad.SetGradientCaption(Component, Designer);
    Result := Grad.ShowModal = mrOk;
  finally
    Grad.Free;
  end;
end;
