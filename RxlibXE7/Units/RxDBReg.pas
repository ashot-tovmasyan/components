...
uses
  ...
  DB, TypInfo, RXLConst, RXDBCtrl, RXLookup, RxLogin, RXDBComb, VCLUtils,
...
begin
  ...
  if Result then                             // Added by CFZ 2005/12/20
    TRxMemoryData(Dest).CopyStructure(Source,TRxMemoryData(Dest).AutoIncAsInteger);
end;
