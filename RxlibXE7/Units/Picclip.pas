...
uses Messages, Classes, Controls, {$IFDEF WIN32} Windows, {$ELSE}
  WinTypes, WinProcs, {$ENDIF} Graphics;
...
uses SysUtils, VCLUtils, Consts, {$IFDEF RX_D6} RTLConsts, {$ENDIF} RXConst;
