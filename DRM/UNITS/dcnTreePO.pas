...
begin
  ...
  gbxOptions.Caption := SOptionsCaption; //я добавил
  chkHeader.Caption:=SHeaderPage;
  chkFooter.Caption:=SFooterPage;
  chkShowPrintProgress.Caption:=SShowPrintProgress;

  OkBut.Caption := SOkButton; //я добавил
  CancelBut.Caption := SCancelButton; //я добавил
  HelpBut.Caption := SHelpButton; //я добавил
  //Buttons
