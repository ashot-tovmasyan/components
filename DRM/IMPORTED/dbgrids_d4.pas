...
_T46 = function (p0 : Integer): Boolean of object;

{_T47 = procedure (p0 : TCustomDBGrid;
p1 : TColumnClass) of object;}

_T48 = function : TColumn of object;

_T49 = _T22;

_T50 = procedure (p0 : TStream) of object;
...
_T57 = function (const p0 : string): Boolean of object;
...
RegRegisterMethod(TColumn,'RestoreDefaults',TypeInfo(_T21),NoParams, pointer(56));

RegRegisterMethod(TColumnTitle,'SetCaption',TypeInfo(_T22),[
...
TypeInfo(TColumn)], pointer(MinVMTOffset - 92));

RegRegisterMethod(TCustomDBGrid,'ColEnter',TypeInfo(_T30),NoParams, pointer(MinVMTOffset - 93));

RegRegisterMethod(TCustomDBGrid,'ColExit',TypeInfo(_T31),NoParams, pointer(MinVMTOffset - 94));

RegRegisterMethod(TCustomDBGrid,'CreateColumns',TypeInfo(_T32),[TypeInfo(TDBGridColumns)], pointer(MinVMTOffset - 95));

RegRegisterMethod(TCustomDBGrid,'DefineFieldMap',TypeInfo(_T33),NoParams, pointer(216));

RegRegisterMethod(TCustomDBGrid,'DrawDataCell',TypeInfo(_T34),[
TypeInfo(IDispatch),
TypeInfo(TField),
TypeInfo(TGridDrawState)], pointer(MinVMTOffset - 96));

RegRegisterMethod(TCustomDBGrid,'DrawColumnCell',TypeInfo(_T35),[
TypeInfo(IDispatch),
TypeInfo(Integer),
TypeInfo(TColumn),
TypeInfo(TGridDrawState)], pointer(MinVMTOffset - 97));

RegRegisterMethod(TCustomDBGrid,'EditButtonClick',TypeInfo(_T36),NoParams, pointer(MinVMTOffset - 98));

RegRegisterMethod(TCustomDBGrid,'HighlightCell',TypeInfo(_T37),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(string),
TypeInfo(TGridDrawState),TypeInfo(Boolean)], pointer(220));

RegRegisterMethod(TCustomDBGrid,'LayoutChanged',TypeInfo(_T38),NoParams, pointer(224));

RegRegisterMethod(TCustomDBGrid,'LinkActive',TypeInfo(_T39),[
TypeInfo(Boolean)], pointer(228));

RegRegisterMethod(TCustomDBGrid,'Scroll',TypeInfo(_T40),[
TypeInfo(Integer)], pointer(232));

RegRegisterMethod(TCustomDBGrid,'SetColumnAttributes',TypeInfo(_T41),NoParams, pointer(236));

RegRegisterMethod(TCustomDBGrid,'TitleClick',TypeInfo(_T42),[
TypeInfo(TColumn)], pointer(MinVMTOffset - 99));

RegRegisterMethod(TCustomDBGrid,'DefaultDrawDataCell',TypeInfo(_T43),[
TypeInfo(IDispatch),
TypeInfo(TField),
TypeInfo(TGridDrawState)],Addr(__TCustomDBGrid__DefaultDrawDataCell__Wrapper));

RegRegisterMethod(TCustomDBGrid,'DefaultDrawColumnCell',TypeInfo(_T44),[
TypeInfo(IDispatch),
TypeInfo(Integer),
TypeInfo(TColumn),
TypeInfo(TGridDrawState)],Addr(__TCustomDBGrid__DefaultDrawColumnCell__Wrapper));

RegisterProc(TCustomDBGrid,'ShowPopupEditor',mtScriptMethod,TypeInfo(_T45),[
TypeInfo(TColumn),
TypeInfo(Integer)],Addr(__TCustomDBGrid__ShowPopupEditor__Wrapper),cRegister);

RegRegisterMethod(TCustomDBGrid,'ValidFieldIndex',TypeInfo(_T46),[
TypeInfo(Integer),TypeInfo(Boolean)],Addr(TCustomDBGrid.ValidFieldIndex));

RegRegisterMethod(TDBGridColumns,'Add',TypeInfo(_T48),[TypeInfo(TColumn)],Addr(TDBGridColumns.Add));

RegRegisterMethod(TDBGridColumns,'LoadFromFile',TypeInfo(_T49),[
TypeInfo(string)],Addr(TDBGridColumns.LoadFromFile));

RegRegisterMethod(TDBGridColumns,'LoadFromStream',TypeInfo(_T50),[
TypeInfo(TStream)],Addr(TDBGridColumns.LoadFromStream));

RegRegisterMethod(TDBGridColumns,'RestoreDefaults',TypeInfo(_T51),NoParams,Addr(TDBGridColumns.RestoreDefaults));

RegRegisterMethod(TDBGridColumns,'RebuildColumns',TypeInfo(_T52),NoParams,Addr(TDBGridColumns.RebuildColumns));

RegRegisterMethod(TDBGridColumns,'SaveToFile',TypeInfo(_T53),[
TypeInfo(string)],Addr(TDBGridColumns.SaveToFile));

RegRegisterMethod(TDBGridColumns,'SaveToStream',TypeInfo(_T54),[
TypeInfo(TStream)],Addr(TDBGridColumns.SaveToStream));

RegRegisterMethod(TGridDataLink,'IsAggRow',TypeInfo(_T55),[
TypeInfo(Integer),TypeInfo(Boolean)], pointer(84));

RegisterProc(TGridDataLink,'Create',mtConstructor,TypeInfo(_T56),[
TypeInfo(TCustomDBGrid)],Addr(TGridDataLink.Create),cRegister);

RegRegisterMethod(TGridDataLink,'AddMapping',TypeInfo(_T57),[
TypeInfo(string),TypeInfo(Boolean)],Addr(TGridDataLink.AddMapping));

RegRegisterMethod(TGridDataLink,'ClearMapping',TypeInfo(_T58),NoParams,Addr(TGridDataLink.ClearMapping));

RegRegisterMethod(TGridDataLink,'Modified',TypeInfo(_T59),NoParams,Addr(TGridDataLink.Modified));

RegRegisterMethod(TGridDataLink,'Reset',TypeInfo(_T60),NoParams,Addr(TGridDataLink.Reset));

end;
initialization
_mreg_0;
{RegisterProc(TDBGridColumns,'Create',mtConstructor,TypeInfo(_T47),[
