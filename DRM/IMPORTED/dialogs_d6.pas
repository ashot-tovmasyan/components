...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[59] ,frDown));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[60] ,frFindNext));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[61] ,frHideMatchCase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[62] ,frHideWholeWord));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[63] ,frHideUpDown));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[64] ,frMatchCase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[65] ,frDisableMatchCase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[66] ,frDisableUpDown));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[67] ,frDisableWholeWord));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[68] ,frReplace));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[69] ,frReplaceAll));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[70] ,frWholeWord));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[71] ,frShowHelp));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[72] ,mtWarning));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[73] ,mtError));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[74] ,mtInformation));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[75] ,mtConfirmation));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[76] ,mtCustom));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[77] ,mbYes));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[78] ,mbNo));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[79] ,mbOK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[80] ,mbCancel));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[81] ,mbAbort));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[82] ,mbRetry));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[83] ,mbIgnore));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[84] ,mbAll));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[85] ,mbNoToAll));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[86] ,mbYesToAll));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[87] ,mbHelp));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[88] ,VarFromSet(mbYesNoCancel, sizeof(mbYesNoCancel))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[89] ,VarFromSet(mbYesAllNoAllCancel, sizeof(mbYesAllNoAllCancel))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[90] ,VarFromSet(mbOKCancel, sizeof(mbOKCancel))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[91] ,VarFromSet(mbAbortRetryIgnore, sizeof(mbAbortRetryIgnore))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[92] ,VarFromSet(mbAbortIgnore, sizeof(mbAbortIgnore))));
end;
...
RegRegisterMethod(TCommonDialog,'WndProc',TypeInfo(_T12),[
TypeInfo(IDispatch)], pointer(48));

RegRegisterMethod(TCommonDialog,'MessageHook',TypeInfo(_T13),[
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(52));

RegRegisterMethod(TCommonDialog,'TaskModalDialog',TypeInfo(_T14),[
TypeInfoPointer,
...
RegRegisterMethod(TOpenDialog,'GetStaticRect',TypeInfo(_T25),[TypeInfo(IDispatch)], pointer(64));
