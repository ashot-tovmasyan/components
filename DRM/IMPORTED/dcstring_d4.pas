...
TypeInfo(TObject),
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(64));
...
TypeInfo(TSelectionType)], pointer(72));
...
TypeInfo(string),TypeInfo(string)], pointer(80));
...
TypeInfo(string),TypeInfo(Boolean)], pointer(160));
