...
RegRegisterMethod(TCustomDCParser,'GetErrorDesc',TypeInfo(_T10),[TypeInfo(string)], pointer(68));

RegRegisterMethod(TCustomDCParser,'DoGetColorData',TypeInfo(_T11),[
TypeInfo(Integer),
TypeInfo(string),
TypeInfo(string)], pointer(72));

RegRegisterMethod(TCustomDCParser,'SetLinePos',TypeInfo(_T12),[
TypeInfo(Integer)], pointer(76));

RegRegisterMethod(TCustomDCParser,'InitCommon',TypeInfo(_T13),NoParams, pointer(80));

RegRegisterMethod(TCustomDCParser,'UpdateLinePtr',TypeInfo(_T14),NoParams, pointer(84));

RegRegisterMethod(TCustomDCParser,'TokenDataToState',TypeInfo(_T15),[
TypeInfo(TTokenData)], pointer(88));

RegRegisterMethod(TCustomDCParser,'StateToTokenData',TypeInfo(_T16),[
TypeInfo(TTokenData)], pointer(92));

RegRegisterMethod(TCustomDCParser,'UpdateSettings',TypeInfo(_T18),NoParams, pointer(100));

RegRegisterMethod(TCustomDCParser,'ParseComment',TypeInfo(_T19),[TypeInfo(Integer)], pointer(104));

RegRegisterMethod(TCustomDCParser,'GetErrorPoint',TypeInfo(_T20),[TypeInfo(IDispatch)], pointer(108));
...
RegRegisterMethod(TCustomDCParser,'TokenString',TypeInfo(_T42),[TypeInfo(string)], pointer(112));
...
RegRegisterMethod(TCustomDCParser,'NextToken',TypeInfo(_T53),[TypeInfo(Integer)], pointer(116));
...
RegRegisterMethod(TDCIncludeParser,'GetParsedFileName',TypeInfo(_T62),[TypeInfo(string)], pointer(128));

RegRegisterMethod(TDCIncludeParser,'DoFileConfirm',TypeInfo(_T63),[
TypeInfo(string),
...
RegRegisterMethod(TModuleParser,'DefineIsDefined',TypeInfo(_T69),[
TypeInfo(string),TypeInfo(Boolean)], pointer(120));

RegRegisterMethod(TModuleParser,'ParseIncludeFile',TypeInfo(_T70),[
TypeInfo(string),
...
RegRegisterMethod(TTokenData,'ProcessSinglePop',TypeInfo(_T80),[
TypeInfo(TCustomDCParser)], pointer(28));
...
{RegRegisterMethod(TCustomDCParser,'GetTokenDataClass',TypeInfo(_T17),[TypeInfo(TCollectionItemClass)], pointer(96))}
