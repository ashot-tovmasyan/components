...
_T1 = function (p0 : Pointer): Pointer of object;
...
_T6 = function (p0 : Integer): Pointer of object;

_T7 = function (p0 : Pointer): Integer of object;

_T8 = function (p0 : Pointer;
...
_T17 = function (p0 : Char): Char of object;

_T18 = procedure (p0 : Word) of object;

{_T19 = function (p0 : PWideChar): string of object;}

{_T20 = function (p0 : PWideChar;
p1 : Integer): string of object;}

{_T21 = procedure (p0 : PWideChar;
...
{_T24 = function (p0 : PWideChar): string of object;}

{_T25 = procedure (p0 : PWideChar;
var p1 : string) of object;}

_T26 = function (const p0 : string): PWideChar of object;

_T27 = procedure (var p0 : Variant;
const p1 : Variant) of object;

_T28 = function (const p0 : Variant): Integer of object;

_T29 = function (const p0 : Variant;
p1 : Integer): Variant of object;

_T30 = function (const p0 : Variant): Boolean of object;

_T31 = _T30;

_T32 = function (const p0 : Variant): string of object;

_T33 = function (p0 : TDateTime): Variant of object;

_T34 = function (const p0 : Variant): TDateTime of object;

_T35 = function (const p0 : Array of Integer;
p1 : Integer): Variant of object;

_T36 = function (const p0 : Array of Variant): Variant of object;

_T37 = _T28;

_T38 = function (const p0 : Variant;
p1 : Integer): Integer of object;

_T39 = _T38;

_T40 = function (const p0 : Variant): Pointer of object;

_T41 = procedure (const p0 : Variant) of object;

_T42 = _T30;

{_T43 = procedure (p0 : PLibModule) of object;}

{_T44 = procedure (p0 : PLibModule) of object;}

_T45 = function (p0 : Pointer): Longint of object;

{_T46 = function (p0 : TClass): Longint of object;}

_T47 = function (p0 : LongWord): Longint of object;

{_T48 = function (p0 : PChar): Longint of object;}

{_T49 = procedure (p0 : TEnumModuleFunc;
p1 : Pointer) of object;}

{_T50 = procedure (p0 : TEnumModuleFunc;
p1 : Pointer) of object;}

{_T51 = procedure (p0 : TModuleUnloadProc) of object;}

{_T52 = procedure (p0 : TModuleUnloadProc) of object;}

{_T53 = function (p0 : PResStringRec): string of object;}

_T54 = procedure (var p0 : string) of object;

_T55 = procedure (var p0 : Variant;
const p1 : Pointer;
p2 : Pointer) of object;

_T56 = procedure (var p0 : Pointer;
const p1 : Variant;
p2 : Pointer) of object;
...
_T59 = function (p0 : Comp): Double of object;

_T60 = procedure (p0 : Double;
var p1 : Comp) of object;

_T61 = function (p0 : Comp): Currency of object;

_T62 = procedure (p0 : Currency;
var p1 : Comp) of object;
...
_T68 = function (p0 : Pointer): TObject of object;

_T69 = _T16;

{_T70 = function : TClass of object;}

_T71 = function : ShortString of object;

_T72 = function (const p0 : string): Boolean of object;

{_T73 = function : TClass of object;}

_T74 = _T0;

_T75 = function : Longint of object;

{_T76 = function (p0 : TClass): Boolean of object;}

_T77 = function (const p0 : ShortString): Pointer of object;

_T78 = function (p0 : Pointer): ShortString of object;

_T79 = _T77;

_T80 = function (const p0 : IDispatch;
out p1): Boolean of object;

{_T82 = function : PInterfaceTable of object;}

_T83 = function (p0 : TObject;
...
_T86 = procedure (var p0) of object;

_T87 = _T86;

_T88 = function : TObject of object;
...
function __DC__GetSystem__ClearAnyProc(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := PointerToVariant(System.ClearAnyProc);
end;

procedure __DC__SetSystem__ClearAnyProc(Instance : TObject; Params : PVariantArgList);
begin
System.ClearAnyProc:=VarToPointer(OleVariant(Params^[0]));
end;

function __DC__GetSystem__ChangeAnyProc(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := PointerToVariant(System.ChangeAnyProc);
end;

procedure __DC__SetSystem__ChangeAnyProc(Instance : TObject; Params : PVariantArgList);
begin
System.ChangeAnyProc:=VarToPointer(OleVariant(Params^[0]));
end;

function __DC__GetSystem__RefAnyProc(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := PointerToVariant(System.RefAnyProc);
end;

procedure __DC__SetSystem__RefAnyProc(Instance : TObject; Params : PVariantArgList);
begin
System.RefAnyProc:=VarToPointer(OleVariant(Params^[0]));
end;
...
function __DC__GetSystem__EmptyParam(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := System.EmptyParam;
end;

procedure __DC__SetSystem__EmptyParam(Instance : TObject; Params : PVariantArgList);
begin
System.EmptyParam:=OleVariant(Params^[0]);
end;
...
__RegisteredVars.Add(RegisterVar('ClearAnyProc',__DC__GetSystem__ClearAnyProc,__DC__SetSystem__ClearAnyProc));
__RegisteredVars.Add(RegisterVar('ChangeAnyProc',__DC__GetSystem__ChangeAnyProc,__DC__SetSystem__ChangeAnyProc));
__RegisteredVars.Add(RegisterVar('RefAnyProc',__DC__GetSystem__RefAnyProc,__DC__SetSystem__RefAnyProc));
...
__RegisteredVars.Add(RegisterVar('EmptyParam',__DC__GetSystem__EmptyParam,__DC__SetSystem__EmptyParam));
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[15] ,varStrArg));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[16] ,varString));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[17] ,varAny));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[18] ,varTypeMask));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[19] ,varArray));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[20] ,varByRef));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[21] ,vtInteger));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[22] ,vtBoolean));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[23] ,vtChar));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[24] ,vtExtended));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[25] ,vtString));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[26] ,vtPointer));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[27] ,vtPChar));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[28] ,vtObject));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[29] ,vtClass));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[30] ,vtWideChar));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[31] ,vtPWideChar));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[32] ,vtAnsiString));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[33] ,vtCurrency));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[34] ,vtVariant));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[35] ,vtInterface));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[36] ,vtWideString));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[37] ,vtInt64));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[38] ,vmtSelfPtr));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[39] ,vmtIntfTable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[40] ,vmtAutoTable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[41] ,vmtInitTable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[42] ,vmtTypeInfo));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[43] ,vmtFieldTable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[44] ,vmtMethodTable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[45] ,vmtDynamicTable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[46] ,vmtClassName));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[47] ,vmtInstanceSize));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[48] ,vmtParent));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[49] ,vmtSafeCallException));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[50] ,vmtAfterConstruction));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[51] ,vmtBeforeDestruction));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[52] ,vmtDispatch));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[53] ,vmtDefaultHandler));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[54] ,vmtNewInstance));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[55] ,vmtFreeInstance));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[56] ,vmtDestroy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[57] ,vmtQueryInterface));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[58] ,vmtAddRef));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[59] ,vmtRelease));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[60] ,vmtCreateObject));
end;
...
RegisterProc(nil,MethodNames[12],mtProc,TypeInfo(_T0),[TypeInfoPointer],Addr(RaiseList),cRegister);

RegisterProc(nil,MethodNames[13],mtProc,TypeInfo(_T1),[
TypeInfoPointer,TypeInfoPointer],Addr(SetRaiseList),cRegister);

RegisterProc(nil,MethodNames[14],mtProc,TypeInfo(_T2),[
...
RegisterProc(nil,MethodNames[17],mtProc,TypeInfo(_T5),[TypeInfo(Boolean)],Addr(IsMemoryManagerSet),cRegister);

RegisterProc(nil,MethodNames[18],mtProc,TypeInfo(_T6),[
TypeInfo(Integer),TypeInfoPointer],Addr(SysGetMem),cRegister);

RegisterProc(nil,MethodNames[19],mtProc,TypeInfo(_T7),[
TypeInfoPointer,TypeInfo(Integer)],Addr(SysFreeMem),cRegister);

RegisterProc(nil,MethodNames[20],mtProc,TypeInfo(_T8),[
TypeInfoPointer,
TypeInfo(Integer),TypeInfoPointer],Addr(SysReallocMem),cRegister);

RegisterProc(nil,MethodNames[21],mtProc,TypeInfo(_T9),[TypeInfo(IDispatch)],Addr(____GetHeapStatus__Wrapper),cRegister);

RegisterProc(nil,MethodNames[22],mtProc,TypeInfo(_T11),[
TypeInfo(Integer)],Addr(EndThread),cRegister);

RegisterProc(nil,MethodNames[23],mtProc,TypeInfo(_T12),[TypeInfo(Integer)],Addr(IOResult),cRegister);

RegisterProc(nil,MethodNames[24],mtProc,TypeInfo(_T13),[
TypeInfoUntyped,
TypeInfoUntyped,
TypeInfo(Integer)],Addr(Move),cRegister);

RegisterProc(nil,MethodNames[25],mtProc,TypeInfo(_T14),[TypeInfo(Integer)],Addr(ParamCount),cRegister);

RegisterProc(nil,MethodNames[26],mtProc,TypeInfo(_T15),[
TypeInfo(Integer),TypeInfo(string)],Addr(ParamStr),cRegister);

RegisterProc(nil,MethodNames[27],mtProc,TypeInfo(_T16),NoParams,Addr(Randomize),cRegister);

RegisterProc(nil,MethodNames[28],mtProc,TypeInfo(_T17),[
TypeInfo(Char),TypeInfo(Char)],Addr(UpCase),cRegister);

RegisterProc(nil,MethodNames[29],mtProc,TypeInfo(_T18),[
...
RegisterProc(nil,MethodNames[44],mtProc,TypeInfo(_T40),[
TypeInfo(Variant),TypeInfoPointer],Addr(VarArrayLock),cRegister);

RegisterProc(nil,MethodNames[45],mtProc,TypeInfo(_T41),[
TypeInfo(Variant)],Addr(VarArrayUnlock),cRegister);

RegisterProc(nil,MethodNames[46],mtProc,TypeInfo(_T42),[
TypeInfo(Variant),TypeInfo(Boolean)],Addr(VarIsArray),cRegister);

RegisterProc(nil,MethodNames[47],mtProc,TypeInfo(_T45),[
TypeInfoPointer,TypeInfo(Longint)],Addr(FindHInstance),cRegister);

RegisterProc(nil,MethodNames[48],mtProc,TypeInfo(_T47),[
TypeInfo(LongWord),TypeInfo(Longint)],Addr(FindResourceHInstance),cRegister);
...
RegisterProc(nil,MethodNames[52],mtProc,TypeInfo(_T57),NoParams,Addr(FPower10),cRegister);

RegisterProc(nil,MethodNames[53],mtProc,TypeInfo(_T58),NoParams,Addr(TextStart),cRegister);
...
RegisterProc(nil,MethodNames[56],mtProc,TypeInfo(_T61),[
TypeInfo(Comp),TypeInfo(Currency)],Addr(CompToCurrency),cCdecl);

RegisterProc(nil,MethodNames[57],mtProc,TypeInfo(_T62),[
TypeInfo(Currency),
TypeInfo(Comp)],Addr(CurrencyToComp),cCdecl);

RegisterProc(nil,MethodNames[58],mtProc,TypeInfo(_T63),[
TypeInfo(Integer),TypeInfoPointer],Addr(GetMemory),cCdecl);

RegisterProc(nil,MethodNames[59],mtProc,TypeInfo(_T64),[
TypeInfoPointer,TypeInfo(Integer)],Addr(FreeMemory),cCdecl);

RegisterProc(nil,MethodNames[60],mtProc,TypeInfo(_T65),[
TypeInfoPointer,
TypeInfo(Integer),TypeInfoPointer],Addr(ReallocMemory),cCdecl);

RegisterProc(TObject,'Create',mtConstructor,TypeInfo(_T66),NoParams,Addr(TObject.Create),cRegister);

RegRegisterMethod(TObject,'Free',TypeInfo(_T67),NoParams,Addr(TObject.Free));

RegisterProc(TObject,'InitInstance',mtClassMethod,TypeInfo(_T68),[
TypeInfoPointer,TypeInfo(TObject)],Addr(TObject.InitInstance),cRegister);

RegRegisterMethod(TObject,'CleanupInstance',TypeInfo(_T69),NoParams,Addr(TObject.CleanupInstance));

RegisterProc(TObject,'ClassName',mtClassMethod,TypeInfo(_T71),[TypeInfo(ShortString)],Addr(TObject.ClassName),cRegister);

RegisterProc(TObject,'ClassNameIs',mtClassMethod,TypeInfo(_T72),[
TypeInfo(string),TypeInfo(Boolean)],Addr(TObject.ClassNameIs),cRegister);

RegisterProc(TObject,'ClassInfo',mtClassMethod,TypeInfo(_T74),[TypeInfoPointer],Addr(TObject.ClassInfo),cRegister);

RegisterProc(TObject,'InstanceSize',mtClassMethod,TypeInfo(_T75),[TypeInfo(Longint)],Addr(TObject.InstanceSize),cRegister);

RegisterProc(TObject,'MethodAddress',mtClassMethod,TypeInfo(_T77),[
TypeInfo(ShortString),TypeInfoPointer],Addr(TObject.MethodAddress),cRegister);

RegisterProc(TObject,'MethodName',mtClassMethod,TypeInfo(_T78),[
TypeInfoPointer,TypeInfo(ShortString)],Addr(TObject.MethodName),cRegister);

RegRegisterMethod(TObject,'FieldAddress',TypeInfo(_T79),[
TypeInfo(ShortString),TypeInfoPointer],Addr(TObject.FieldAddress));

RegRegisterMethod(TObject,'GetInterface',TypeInfo(_T80),[
TypeInfo(IDispatch),
TypeInfoUntyped,TypeInfo(Boolean)],Addr(__TObject__GetInterface__Wrapper));

RegRegisterMethod(TObject,'SafeCallException',TypeInfo(_T83),[
TypeInfo(TObject),
TypeInfoPointer,TypeInfo(HRESULT)], pointer(-28));

RegRegisterMethod(TObject,'AfterConstruction',TypeInfo(_T84),NoParams, pointer(-24));

RegRegisterMethod(TObject,'BeforeDestruction',TypeInfo(_T85),NoParams, pointer(-20));

RegRegisterMethod(TObject,'Dispatch',TypeInfo(_T86),[
TypeInfoUntyped], pointer(-16));

RegRegisterMethod(TObject,'DefaultHandler',TypeInfo(_T87),[
TypeInfoUntyped], pointer(-12));

RegisterProc(TObject,'NewInstance',mtClassMethod,TypeInfo(_T88),[TypeInfo(TObject)], pointer(-8),cRegister);

RegRegisterMethod(TObject,'FreeInstance',TypeInfo(_T89),NoParams, pointer(-4));

RegisterProc(TObject,'Destroy',mtDestructor,TypeInfo(_T90),NoParams, pointer(0),cRegister);

end;
initialization
__RegisteredMethods := TList.Create;
_mreg_0;
{RegisterProc(nil,'BeginThread',mtProc,TypeInfo(_T10),[
TypeInfoPointer,
TypeInfo(LongWord),
...
{RegisterProc(nil,'WideCharToString',mtProc,TypeInfo(_T19),[
TypeInfoPWideChar,TypeInfo(string)],Addr(WideCharToString),cRegister)}

{RegisterProc(nil,'WideCharLenToString',mtProc,TypeInfo(_T20),[
TypeInfoPWideChar,
TypeInfo(Integer),TypeInfo(string)],Addr(WideCharLenToString),cRegister)}

{RegisterProc(nil,'WideCharToStrVar',mtProc,TypeInfo(_T21),[
TypeInfoPWideChar,
TypeInfo(string)],Addr(WideCharToStrVar),cRegister)}

{RegisterProc(nil,'WideCharLenToStrVar',mtProc,TypeInfo(_T22),[
TypeInfoPWideChar,
TypeInfo(Integer),
TypeInfo(string)],Addr(WideCharLenToStrVar),cRegister)}

{RegisterProc(nil,'StringToWideChar',mtProc,TypeInfo(_T23),[
TypeInfo(string),
TypeInfoPWideChar,
TypeInfo(Integer),TypeInfoPWideChar],Addr(StringToWideChar),cRegister)}

{RegisterProc(nil,'OleStrToString',mtProc,TypeInfo(_T24),[
TypeInfoPWideChar,TypeInfo(string)],Addr(OleStrToString),cRegister)}

{RegisterProc(nil,'OleStrToStrVar',mtProc,TypeInfo(_T25),[
TypeInfoPWideChar,
TypeInfo(string)],Addr(OleStrToStrVar),cRegister)}

{RegisterProc(nil,'RegisterModule',mtProc,TypeInfo(_T43),[
TypeInfoPointer],Addr(RegisterModule),cRegister)}

{RegisterProc(nil,'UnregisterModule',mtProc,TypeInfo(_T44),[
TypeInfoPointer],Addr(UnregisterModule),cRegister)}

{RegisterProc(nil,'FindClassHInstance',mtProc,TypeInfo(_T46),[
TypeInfo(TClass),TypeInfo(Longint)],Addr(FindClassHInstance),cRegister)}

{RegisterProc(nil,'LoadResourceModule',mtProc,TypeInfo(_T48),[
TypeInfoPChar,TypeInfo(Longint)],Addr(LoadResourceModule),cRegister)}

{RegisterProc(nil,'EnumModules',mtProc,TypeInfo(_T49),[
TypeInfo(TEnumModuleFunc),
TypeInfoPointer],Addr(EnumModules),cRegister)}

{RegisterProc(nil,'EnumResourceModules',mtProc,TypeInfo(_T50),[
TypeInfo(TEnumModuleFunc),
TypeInfoPointer],Addr(EnumResourceModules),cRegister)}

{RegisterProc(nil,'AddModuleUnloadProc',mtProc,TypeInfo(_T51),[
TypeInfo(TModuleUnloadProc)],Addr(AddModuleUnloadProc),cRegister)}

{RegisterProc(nil,'RemoveModuleUnloadProc',mtProc,TypeInfo(_T52),[
TypeInfo(TModuleUnloadProc)],Addr(RemoveModuleUnloadProc),cRegister)}

{RegisterProc(nil,'LoadResString',mtProc,TypeInfo(_T53),[
TypeInfoPointer,TypeInfo(string)],Addr(LoadResString),cRegister)}

{RegRegisterMethod(TObject,'ClassType',TypeInfo(_T70),[TypeInfo(TClass)],Addr(TObject.ClassType))}

{RegisterProc(TObject,'ClassParent',mtClassMethod,TypeInfo(_T73),[TypeInfo(TClass)],Addr(TObject.ClassParent),cRegister)}

{RegisterProc(TObject,'InheritsFrom',mtClassMethod,TypeInfo(_T76),[
TypeInfo(TClass),TypeInfo(Boolean)],Addr(TObject.InheritsFrom),cRegister)}

{RegisterProc(TObject,'GetInterfaceTable',mtClassMethod,TypeInfo(_T82),[TypeInfoPointer],Addr(TObject.GetInterfaceTable),cRegister)}
