...
_T24 = procedure (p0 : TChangeRange) of object;
...
_T28 = function : Integer of object;

_T29 = function : Longint of object;

_T30 = _T29;

_T31 = function (p0 : Longint): Longint of object;

_T32 = _T31;

_T33 = procedure (p0 : Longint;
...
TypeInfo(Longint)], pointer(MinVMTOffset - 52));
...
RegRegisterMethod(TOutlineNode,'ChangeLevelBy',TypeInfo(_T24),[
TypeInfo(TChangeRange)],Addr(TOutlineNode.ChangeLevelBy));

RegRegisterMethod(TOutlineNode,'Collapse',TypeInfo(_T25),NoParams,Addr(TOutlineNode.Collapse));

RegRegisterMethod(TOutlineNode,'Expand',TypeInfo(_T26),NoParams,Addr(TOutlineNode.Expand));

RegRegisterMethod(TOutlineNode,'FullExpand',TypeInfo(_T27),NoParams,Addr(TOutlineNode.FullExpand));

RegRegisterMethod(TOutlineNode,'GetDisplayWidth',TypeInfo(_T28),[TypeInfo(Integer)],Addr(TOutlineNode.GetDisplayWidth));

RegRegisterMethod(TOutlineNode,'GetFirstChild',TypeInfo(_T29),[TypeInfo(Longint)],Addr(TOutlineNode.GetFirstChild));

RegRegisterMethod(TOutlineNode,'GetLastChild',TypeInfo(_T30),[TypeInfo(Longint)],Addr(TOutlineNode.GetLastChild));

RegRegisterMethod(TOutlineNode,'GetNextChild',TypeInfo(_T31),[
TypeInfo(Longint),TypeInfo(Longint)],Addr(TOutlineNode.GetNextChild));

RegRegisterMethod(TOutlineNode,'GetPrevChild',TypeInfo(_T32),[
TypeInfo(Longint),TypeInfo(Longint)],Addr(TOutlineNode.GetPrevChild));

RegRegisterMethod(TOutlineNode,'MoveTo',TypeInfo(_T33),[
TypeInfo(Longint),
