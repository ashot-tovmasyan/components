...
RegRegisterMethod(TDirectoryListBox,'Change',TypeInfo(_T6),NoParams, pointer(256));

RegRegisterMethod(TDirectoryListBox,'ReadBitmaps',TypeInfo(_T7),NoParams, pointer(260));

RegRegisterMethod(TDirectoryListBox,'BuildList',TypeInfo(_T8),NoParams, pointer(264));
...
RegRegisterMethod(TDriveComboBox,'BuildList',TypeInfo(_T14),NoParams, pointer(280));

RegRegisterMethod(TFileListBox,'ReadBitmaps',TypeInfo(_T15),NoParams, pointer(252));

RegRegisterMethod(TFileListBox,'Change',TypeInfo(_T16),NoParams, pointer(256));

RegRegisterMethod(TFileListBox,'ReadFileNames',TypeInfo(_T17),NoParams, pointer(260));

RegRegisterMethod(TFileListBox,'GetFilePath',TypeInfo(_T18),[TypeInfo(string)], pointer(264));
