...
TypeInfo(TComponent)], pointer(96));
...
TypeInfo(String),TypeInfo(Boolean)], pointer(104));

RegRegisterMethod(TCodeDesigner,'GetMethodState',TypeInfo(_T297),[
TypeInfo(String),TypeInfo(TMethodState)], pointer(108));
...
TypeInfo(Integer),TypeInfo(String)], pointer(132));
...
RegRegisterMethod(TEditSource,'StartEdit',TypeInfo(_T321),NoParams, pointer(MinVMTOffset - 15));
...
TypeInfo(TFileName),
TypeInfo(Integer),TypeInfo(TStream)], pointer(64));

RegRegisterMethod(TFileSystem,'FileAge',TypeInfo(_T327),[
TypeInfo(TFileName),TypeInfo(Integer)], pointer(68));
...
TypeInfo(TFileName),TypeInfo(Boolean)], pointer(84));
...
TypeInfo(TFileName),TypeInfo(TFileName)], pointer(92));
...
TypeInfo(Integer),TypeInfo(TFont)], pointer(52));

RegRegisterMethod(TSimpleParser,'GetBackColor',TypeInfo(_T378),[
TypeInfo(Integer),
TypeInfo(TColor),TypeInfo(Boolean)], pointer(56));
