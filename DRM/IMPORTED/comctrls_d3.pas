...
_T6 = procedure (p0 : Word;
p1 : Word;
p2 : Integer) of object;

_T7 = _T2;

_T8 = procedure (p0 : SmallInt) of object;

_T9 = _T2;

{_T10 = function (p0 : TStream;
p1 : PChar;
p2 : Integer): Integer of object;}

{_T11 = function (p0 : TStream;
p1 : PChar;
p2 : Integer): Integer of object;}
...
_T14 = procedure (p0 : TCoolBar) of object;

_T15 = function : TCoolBand of object;

_T16 = _T2;

_T17 = _T2;

_T18 = function (p0 : TListItem;
p1 : Integer): Boolean of object;

_T19 = function (p0 : TListItem): Boolean of object;

_T20 = procedure (p0 : TListItem;
p1 : Integer) of object;

_T21 = procedure (p0 : TListColumn) of object;

_T22 = function : TListItem of object;

_T23 = procedure (p0 : TListItem) of object;
...
_T27 = procedure (p0 : TListArrangement) of object;
...
_T31 = function (const p0 : IDispatch;
p1 : TSearchDirection): TListItem of object;

_T32 = function (p0 : TListItem;
p1 : TSearchDirection;
...
{_T36 = function (p0 : TLVCompare;
p1 : Longint): Boolean of object;}

_T37 = function (p0 : string): Integer of object;
...
_T42 = procedure (const p0 : string) of object;
...
_T46 = function (p0 : TTreeNode): Boolean of object;
...
_T50 = procedure (p0 : TTreeNode) of object;

_T51 = _T50;

_T52 = function : TTreeNode of object;
...
_T63 = procedure (p0 : TStream) of object;

_T64 = _T42;

_T65 = _T63;

_T66 = procedure (p0 : TUDBtnType) of object;

_T67 = procedure (p0 : TDateTimePicker) of object;

_T68 = procedure (p0 : THeaderSection;
const p1 : IDispatch;
p2 : Boolean) of object;

_T69 = _T2;

_T70 = procedure (p0 : THeaderSection) of object;

_T71 = _T70;

_T72 = procedure (p0 : THeaderSection;
p1 : Integer;
p2 : TSectionTrackState) of object;

_T73 = procedure (p0 : THeaderControl) of object;

_T74 = function : THeaderSection of object;

_T75 = procedure (p0 : TCustomListView) of object;

_T76 = _T75;

_T77 = function : TListColumn of object;

_T78 = procedure (p0 : TListItems) of object;

_T79 = _T2;

_T80 = _T2;

_T81 = function (p0 : TDisplayCode): IDispatch of object;

_T82 = _T26;

_T83 = function : IDispatch of object;
...
_T93 = function (p0 : TListItem): Integer of object;

_T94 = function (p0 : Integer): TListItem of object;

_T95 = function (p0 : TTabSheet;
p1 : Boolean;
p2 : Boolean): TTabSheet of object;

_T96 = _T84;

_T97 = procedure (p0 : TCustomRichEdit) of object;

_T98 = _T2;

_T99 = _T1;

_T100 = procedure (p0 : TStatusPanel;
const p1 : IDispatch) of object;

_T101 = _T2;

_T102 = procedure (p0 : TStatusBar) of object;

_T103 = function : TStatusPanel of object;

_T104 = procedure (p0 : TCustomRichEdit;
...
_T110 = procedure (p0 : TTreeNodes) of object;

_T111 = _T26;

_T112 = _T84;

{_T113 = function (p0 : TTVCompare;
p1 : Longint): Boolean of object;}
...
_T116 = function (p0 : Boolean): IDispatch of object;
...
_T121 = function : HWND of object;

_T122 = _T52;

_T123 = _T52;

_T124 = function (p0 : TTreeNode): TTreeNode of object;
...
_T132 = function (p0 : TTreeNode): Integer of object;

_T133 = _T2;

_T134 = procedure (p0 : TTreeNode;
p1 : TNodeAttachMode) of object;

_T135 = procedure (p0 : TCustomTreeView) of object;

_T136 = function (p0 : TTreeNode;
const p1 : string): TTreeNode of object;

_T137 = _T136;

_T138 = function (p0 : TTreeNode;
const p1 : string;
...
{_T149 = function (p0 : HTreeItem): TTreeNode of object;}
...
const __ConstNames0 : array[0..141] of string = (
'tpTop'
,'tpBottom'
,'psText'
,'psOwnerDraw'
...
__RegisteredMethods.Add(RegisterRWProc(MethodNames[1],Addr(_TNodeInfo_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[2],Addr(_TRichEditStreamInfo_)));
...
RegRegisterMethod(TAnimate,'DoOpen',TypeInfo(_T2),NoParams, pointer(124));

RegRegisterMethod(TAnimate,'DoClose',TypeInfo(_T3),NoParams, pointer(128));

RegRegisterMethod(TAnimate,'DoStart',TypeInfo(_T4),NoParams, pointer(132));

RegRegisterMethod(TAnimate,'DoStop',TypeInfo(_T5),NoParams, pointer(136));

RegRegisterMethod(TAnimate,'Play',TypeInfo(_T6),[
TypeInfo(Word),
TypeInfo(Word),
TypeInfo(Integer)],Addr(TAnimate.Play));

RegRegisterMethod(TAnimate,'Reset',TypeInfo(_T7),NoParams,Addr(TAnimate.Reset));

RegRegisterMethod(TAnimate,'Seek',TypeInfo(_T8),[
TypeInfo(SmallInt)],Addr(TAnimate.Seek));

RegRegisterMethod(TAnimate,'Stop',TypeInfo(_T9),NoParams,Addr(TAnimate.Stop));

RegRegisterMethod(TCoolBand,'ParentColorChanged',TypeInfo(_T12),NoParams, pointer(MinVMTOffset - 2));

RegRegisterMethod(TCoolBand,'ParentBitmapChanged',TypeInfo(_T13),NoParams, pointer(MinVMTOffset - 3));

RegisterProc(TCoolBands,'Create',mtConstructor,TypeInfo(_T14),[
TypeInfo(TCoolBar)],Addr(TCoolBands.Create),cRegister);

RegRegisterMethod(TCoolBands,'Add',TypeInfo(_T15),[TypeInfo(TCoolBand)],Addr(TCoolBands.Add));

RegRegisterMethod(TCoolBar,'Change',TypeInfo(_T16),NoParams, pointer(MinVMTOffset - 36));

RegRegisterMethod(TCoolBar,'Resize',TypeInfo(_T17),NoParams, pointer(MinVMTOffset - 37));

RegRegisterMethod(TCustomListView,'CanChange',TypeInfo(_T18),[
TypeInfo(TListItem),
TypeInfo(Integer),TypeInfo(Boolean)], pointer(MinVMTOffset - 36));

RegRegisterMethod(TCustomListView,'CanEdit',TypeInfo(_T19),[
TypeInfo(TListItem),TypeInfo(Boolean)], pointer(MinVMTOffset - 37));

RegRegisterMethod(TCustomListView,'Change',TypeInfo(_T20),[
TypeInfo(TListItem),
TypeInfo(Integer)], pointer(MinVMTOffset - 38));

RegRegisterMethod(TCustomListView,'ColClick',TypeInfo(_T21),[
TypeInfo(TListColumn)], pointer(MinVMTOffset - 39));

RegRegisterMethod(TCustomListView,'CreateListItem',TypeInfo(_T22),[TypeInfo(TListItem)], pointer(124));

RegRegisterMethod(TCustomListView,'Delete',TypeInfo(_T23),[
TypeInfo(TListItem)], pointer(MinVMTOffset - 40));

RegRegisterMethod(TCustomListView,'Edit',TypeInfo(_T24),[
TypeInfo(IDispatch)], pointer(MinVMTOffset - 41));

RegRegisterMethod(TCustomListView,'InsertItem',TypeInfo(_T25),[
TypeInfo(TListItem)], pointer(MinVMTOffset - 42));

RegRegisterMethod(TCustomListView,'AlphaSort',TypeInfo(_T26),[TypeInfo(Boolean)],Addr(TCustomListView.AlphaSort));

RegRegisterMethod(TCustomListView,'Arrange',TypeInfo(_T27),[
TypeInfo(TListArrangement)],Addr(TCustomListView.Arrange));

RegRegisterMethod(TCustomListView,'FindCaption',TypeInfo(_T28),[
TypeInfo(Integer),
TypeInfo(string),
TypeInfo(Boolean),
TypeInfo(Boolean),
...
RegRegisterMethod(TCustomListView,'FindData',TypeInfo(_T29),[
TypeInfo(Integer),
TypeInfoPointer,
TypeInfo(Boolean),
TypeInfo(Boolean),TypeInfo(TListItem)],Addr(TCustomListView.FindData));

RegRegisterMethod(TCustomListView,'GetItemAt',TypeInfo(_T30),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(TListItem)],Addr(TCustomListView.GetItemAt));

RegRegisterMethod(TCustomListView,'GetNearestItem',TypeInfo(_T31),[
TypeInfo(IDispatch),
TypeInfo(TSearchDirection),TypeInfo(TListItem)],Addr(__TCustomListView__GetNearestItem__Wrapper));

RegRegisterMethod(TCustomListView,'GetNextItem',TypeInfo(_T32),[
TypeInfo(TListItem),
TypeInfo(TSearchDirection),
TypeInfo(TItemStates),TypeInfo(TListItem)],Addr(TCustomListView.GetNextItem));

RegRegisterMethod(TCustomListView,'GetSearchString',TypeInfo(_T33),[TypeInfo(string)],Addr(TCustomListView.GetSearchString));

RegRegisterMethod(TCustomListView,'IsEditing',TypeInfo(_T34),[TypeInfo(Boolean)],Addr(TCustomListView.IsEditing));

RegRegisterMethod(TCustomListView,'Scroll',TypeInfo(_T35),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TCustomListView.Scroll));

RegRegisterMethod(TCustomListView,'StringWidth',TypeInfo(_T37),[
TypeInfo(string),TypeInfo(Integer)],Addr(TCustomListView.StringWidth));

RegRegisterMethod(TCustomListView,'UpdateItems',TypeInfo(_T38),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TCustomListView.UpdateItems));

RegRegisterMethod(TCustomRichEdit,'RequestSize',TypeInfo(_T39),[
TypeInfo(IDispatch)], pointer(156));

RegRegisterMethod(TCustomRichEdit,'SelectionChange',TypeInfo(_T40),NoParams, pointer(MinVMTOffset - 37));

RegRegisterMethod(TCustomRichEdit,'FindText',TypeInfo(_T41),[
TypeInfo(string),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(TSearchTypes),TypeInfo(Integer)],Addr(TCustomRichEdit.FindText));

RegRegisterMethod(TCustomRichEdit,'Print',TypeInfo(_T42),[
TypeInfo(string)],Addr(TCustomRichEdit.Print));

RegRegisterMethod(TCustomTabControl,'CanChange',TypeInfo(_T44),[TypeInfo(Boolean)], pointer(MinVMTOffset - 36));

RegRegisterMethod(TCustomTabControl,'Change',TypeInfo(_T45),NoParams, pointer(MinVMTOffset - 37));

RegRegisterMethod(TCustomTreeView,'CanEdit',TypeInfo(_T46),[
TypeInfo(TTreeNode),TypeInfo(Boolean)], pointer(MinVMTOffset - 36));

RegRegisterMethod(TCustomTreeView,'CanChange',TypeInfo(_T47),[
TypeInfo(TTreeNode),TypeInfo(Boolean)], pointer(MinVMTOffset - 37));

RegRegisterMethod(TCustomTreeView,'CanCollapse',TypeInfo(_T48),[
TypeInfo(TTreeNode),TypeInfo(Boolean)], pointer(MinVMTOffset - 38));

RegRegisterMethod(TCustomTreeView,'CanExpand',TypeInfo(_T49),[
TypeInfo(TTreeNode),TypeInfo(Boolean)], pointer(MinVMTOffset - 39));

RegRegisterMethod(TCustomTreeView,'Change',TypeInfo(_T50),[
TypeInfo(TTreeNode)], pointer(MinVMTOffset - 40));

RegRegisterMethod(TCustomTreeView,'Collapse',TypeInfo(_T51),[
TypeInfo(TTreeNode)], pointer(MinVMTOffset - 41));

RegRegisterMethod(TCustomTreeView,'CreateNode',TypeInfo(_T52),[TypeInfo(TTreeNode)], pointer(124));

RegRegisterMethod(TCustomTreeView,'Edit',TypeInfo(_T53),[
TypeInfo(IDispatch)], pointer(MinVMTOffset - 42));

RegRegisterMethod(TCustomTreeView,'Expand',TypeInfo(_T54),[
TypeInfo(TTreeNode)], pointer(MinVMTOffset - 43));

RegRegisterMethod(TCustomTreeView,'AlphaSort',TypeInfo(_T55),[TypeInfo(Boolean)],Addr(TCustomTreeView.AlphaSort));

RegRegisterMethod(TCustomTreeView,'FullCollapse',TypeInfo(_T57),NoParams,Addr(TCustomTreeView.FullCollapse));

RegRegisterMethod(TCustomTreeView,'FullExpand',TypeInfo(_T58),NoParams,Addr(TCustomTreeView.FullExpand));

RegRegisterMethod(TCustomTreeView,'GetHitTestInfoAt',TypeInfo(_T59),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(THitTests)],Addr(TCustomTreeView.GetHitTestInfoAt));

RegRegisterMethod(TCustomTreeView,'GetNodeAt',TypeInfo(_T60),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(TTreeNode)],Addr(TCustomTreeView.GetNodeAt));

RegRegisterMethod(TCustomTreeView,'IsEditing',TypeInfo(_T61),[TypeInfo(Boolean)],Addr(TCustomTreeView.IsEditing));

RegRegisterMethod(TCustomTreeView,'LoadFromFile',TypeInfo(_T62),[
TypeInfo(string)],Addr(TCustomTreeView.LoadFromFile));

RegRegisterMethod(TCustomTreeView,'LoadFromStream',TypeInfo(_T63),[
TypeInfo(TStream)],Addr(TCustomTreeView.LoadFromStream));

RegRegisterMethod(TCustomTreeView,'SaveToFile',TypeInfo(_T64),[
TypeInfo(string)],Addr(TCustomTreeView.SaveToFile));

RegRegisterMethod(TCustomTreeView,'SaveToStream',TypeInfo(_T65),[
TypeInfo(TStream)],Addr(TCustomTreeView.SaveToStream));

RegRegisterMethod(TCustomUpDown,'Click',TypeInfo(_T66),[
TypeInfo(TUDBtnType)], pointer(MinVMTOffset - 36));

RegisterProc(TDateTimeColors,'Create',mtConstructor,TypeInfo(_T67),[
TypeInfo(TDateTimePicker)],Addr(TDateTimeColors.Create),cRegister);

RegRegisterMethod(THeaderControl,'DrawSection',TypeInfo(_T68),[
TypeInfo(THeaderSection),
TypeInfo(IDispatch),
TypeInfo(Boolean)], pointer(MinVMTOffset - 36));

RegRegisterMethod(THeaderControl,'Resize',TypeInfo(_T69),NoParams, pointer(MinVMTOffset - 37));

RegRegisterMethod(THeaderControl,'SectionClick',TypeInfo(_T70),[
TypeInfo(THeaderSection)], pointer(MinVMTOffset - 38));

RegRegisterMethod(THeaderControl,'SectionResize',TypeInfo(_T71),[
TypeInfo(THeaderSection)], pointer(MinVMTOffset - 39));

RegRegisterMethod(THeaderControl,'SectionTrack',TypeInfo(_T72),[
TypeInfo(THeaderSection),
TypeInfo(Integer),
TypeInfo(TSectionTrackState)], pointer(MinVMTOffset - 40));

RegisterProc(THeaderSections,'Create',mtConstructor,TypeInfo(_T73),[
TypeInfo(THeaderControl)],Addr(THeaderSections.Create),cRegister);

RegRegisterMethod(THeaderSections,'Add',TypeInfo(_T74),[TypeInfo(THeaderSection)],Addr(THeaderSections.Add));

RegisterProc(TIconOptions,'Create',mtConstructor,TypeInfo(_T75),[
TypeInfo(TCustomListView)],Addr(TIconOptions.Create),cRegister);

RegisterProc(TListColumns,'Create',mtConstructor,TypeInfo(_T76),[
TypeInfo(TCustomListView)],Addr(TListColumns.Create),cRegister);

RegRegisterMethod(TListColumns,'Add',TypeInfo(_T77),[TypeInfo(TListColumn)],Addr(TListColumns.Add));

RegisterProc(TListItem,'Create',mtConstructor,TypeInfo(_T78),[
TypeInfo(TListItems)],Addr(TListItem.Create),cRegister);

RegRegisterMethod(TListItem,'CancelEdit',TypeInfo(_T79),NoParams,Addr(TListItem.CancelEdit));

RegRegisterMethod(TListItem,'Delete',TypeInfo(_T80),NoParams,Addr(TListItem.Delete));

RegRegisterMethod(TListItem,'DisplayRect',TypeInfo(_T81),[
TypeInfo(TDisplayCode),TypeInfo(IDispatch)],Addr(__TListItem__DisplayRect__Wrapper));

RegRegisterMethod(TListItem,'EditCaption',TypeInfo(_T82),[TypeInfo(Boolean)],Addr(TListItem.EditCaption));

RegRegisterMethod(TListItem,'GetPosition',TypeInfo(_T83),[TypeInfo(IDispatch)],Addr(__TListItem__GetPosition__Wrapper));

RegRegisterMethod(TListItem,'MakeVisible',TypeInfo(_T84),[
TypeInfo(Boolean)],Addr(TListItem.MakeVisible));

RegRegisterMethod(TListItem,'Update',TypeInfo(_T85),NoParams,Addr(TListItem.Update));

RegRegisterMethod(TListItem,'SetPosition',TypeInfo(_T86),[
TypeInfo(IDispatch)],Addr(__TListItem__SetPosition__Wrapper));

RegisterProc(TListItems,'Create',mtConstructor,TypeInfo(_T87),[
TypeInfo(TCustomListView)],Addr(TListItems.Create),cRegister);

RegRegisterMethod(TListItems,'Add',TypeInfo(_T88),[TypeInfo(TListItem)],Addr(TListItems.Add));

RegRegisterMethod(TListItems,'BeginUpdate',TypeInfo(_T89),NoParams,Addr(TListItems.BeginUpdate));

RegRegisterMethod(TListItems,'Clear',TypeInfo(_T90),NoParams,Addr(TListItems.Clear));

RegRegisterMethod(TListItems,'Delete',TypeInfo(_T91),[
TypeInfo(Integer)],Addr(TListItems.Delete));

RegRegisterMethod(TListItems,'EndUpdate',TypeInfo(_T92),NoParams,Addr(TListItems.EndUpdate));

RegRegisterMethod(TListItems,'IndexOf',TypeInfo(_T93),[
TypeInfo(TListItem),TypeInfo(Integer)],Addr(TListItems.IndexOf));

RegRegisterMethod(TListItems,'Insert',TypeInfo(_T94),[
TypeInfo(Integer),TypeInfo(TListItem)],Addr(TListItems.Insert));

RegRegisterMethod(TPageControl,'FindNextPage',TypeInfo(_T95),[
TypeInfo(TTabSheet),
TypeInfo(Boolean),
TypeInfo(Boolean),TypeInfo(TTabSheet)],Addr(TPageControl.FindNextPage));

RegRegisterMethod(TPageControl,'SelectNextPage',TypeInfo(_T96),[
TypeInfo(Boolean)],Addr(TPageControl.SelectNextPage));

RegisterProc(TParaAttributes,'Create',mtConstructor,TypeInfo(_T97),[
TypeInfo(TCustomRichEdit)],Addr(TParaAttributes.Create),cRegister);

RegRegisterMethod(TProgressBar,'StepIt',TypeInfo(_T98),NoParams,Addr(TProgressBar.StepIt));

RegRegisterMethod(TProgressBar,'StepBy',TypeInfo(_T99),[
TypeInfo(Integer)],Addr(TProgressBar.StepBy));

RegRegisterMethod(TStatusBar,'DrawPanel',TypeInfo(_T100),[
TypeInfo(TStatusPanel),
TypeInfo(IDispatch)], pointer(MinVMTOffset - 36));

RegRegisterMethod(TStatusBar,'Resize',TypeInfo(_T101),NoParams, pointer(MinVMTOffset - 37));

RegisterProc(TStatusPanels,'Create',mtConstructor,TypeInfo(_T102),[
TypeInfo(TStatusBar)],Addr(TStatusPanels.Create),cRegister);

RegRegisterMethod(TStatusPanels,'Add',TypeInfo(_T103),[TypeInfo(TStatusPanel)],Addr(TStatusPanels.Add));

RegisterProc(TTextAttributes,'Create',mtConstructor,TypeInfo(_T104),[
TypeInfo(TCustomRichEdit),
TypeInfo(TAttributeType)],Addr(TTextAttributes.Create),cRegister);

RegRegisterMethod(TToolBar,'Resize',TypeInfo(_T105),NoParams, pointer(MinVMTOffset - 36));

RegRegisterMethod(TToolButton,'BeginUpdate',TypeInfo(_T106),NoParams, pointer(88));

RegRegisterMethod(TToolButton,'EndUpdate',TypeInfo(_T107),NoParams, pointer(92));

RegRegisterMethod(TToolButton,'UpdateControl',TypeInfo(_T108),NoParams, pointer(96));

RegRegisterMethod(TTrackBar,'SetTick',TypeInfo(_T109),[
TypeInfo(Integer)],Addr(TTrackBar.SetTick));

RegisterProc(TTreeNode,'Create',mtConstructor,TypeInfo(_T110),[
TypeInfo(TTreeNodes)],Addr(TTreeNode.Create),cRegister);

RegRegisterMethod(TTreeNode,'AlphaSort',TypeInfo(_T111),[TypeInfo(Boolean)],Addr(TTreeNode.AlphaSort));

RegRegisterMethod(TTreeNode,'Collapse',TypeInfo(_T112),[
TypeInfo(Boolean)],Addr(TTreeNode.Collapse));

RegRegisterMethod(TTreeNode,'Delete',TypeInfo(_T114),NoParams,Addr(TTreeNode.Delete));

RegRegisterMethod(TTreeNode,'DeleteChildren',TypeInfo(_T115),NoParams,Addr(TTreeNode.DeleteChildren));

RegRegisterMethod(TTreeNode,'DisplayRect',TypeInfo(_T116),[
TypeInfo(Boolean),TypeInfo(IDispatch)],Addr(__TTreeNode__DisplayRect__Wrapper));

RegRegisterMethod(TTreeNode,'EditText',TypeInfo(_T117),[TypeInfo(Boolean)],Addr(TTreeNode.EditText));

RegRegisterMethod(TTreeNode,'EndEdit',TypeInfo(_T118),[
TypeInfo(Boolean)],Addr(TTreeNode.EndEdit));

RegRegisterMethod(TTreeNode,'Expand',TypeInfo(_T119),[
TypeInfo(Boolean)],Addr(TTreeNode.Expand));

RegRegisterMethod(TTreeNode,'GetFirstChild',TypeInfo(_T120),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetFirstChild));

RegRegisterMethod(TTreeNode,'GetHandle',TypeInfo(_T121),[TypeInfo(HWND)],Addr(TTreeNode.GetHandle));

RegRegisterMethod(TTreeNode,'GetLastChild',TypeInfo(_T122),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetLastChild));

RegRegisterMethod(TTreeNode,'GetNext',TypeInfo(_T123),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetNext));

RegRegisterMethod(TTreeNode,'GetNextChild',TypeInfo(_T124),[
TypeInfo(TTreeNode),TypeInfo(TTreeNode)],Addr(TTreeNode.GetNextChild));

RegRegisterMethod(TTreeNode,'GetNextSibling',TypeInfo(_T125),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetNextSibling));

RegRegisterMethod(TTreeNode,'GetNextVisible',TypeInfo(_T126),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetNextVisible));

RegRegisterMethod(TTreeNode,'GetPrev',TypeInfo(_T127),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetPrev));

RegRegisterMethod(TTreeNode,'GetPrevChild',TypeInfo(_T128),[
TypeInfo(TTreeNode),TypeInfo(TTreeNode)],Addr(TTreeNode.GetPrevChild));

RegRegisterMethod(TTreeNode,'GetPrevSibling',TypeInfo(_T129),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetPrevSibling));

RegRegisterMethod(TTreeNode,'GetPrevVisible',TypeInfo(_T130),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetPrevVisible));

RegRegisterMethod(TTreeNode,'HasAsParent',TypeInfo(_T131),[
TypeInfo(TTreeNode),TypeInfo(Boolean)],Addr(TTreeNode.HasAsParent));

RegRegisterMethod(TTreeNode,'IndexOf',TypeInfo(_T132),[
TypeInfo(TTreeNode),TypeInfo(Integer)],Addr(TTreeNode.IndexOf));

RegRegisterMethod(TTreeNode,'MakeVisible',TypeInfo(_T133),NoParams,Addr(TTreeNode.MakeVisible));

RegRegisterMethod(TTreeNode,'MoveTo',TypeInfo(_T134),[
TypeInfo(TTreeNode),
TypeInfo(TNodeAttachMode)], pointer(12));

RegisterProc(TTreeNodes,'Create',mtConstructor,TypeInfo(_T135),[
TypeInfo(TCustomTreeView)],Addr(TTreeNodes.Create),cRegister);

RegRegisterMethod(TTreeNodes,'AddChildFirst',TypeInfo(_T136),[
TypeInfo(TTreeNode),
TypeInfo(string),TypeInfo(TTreeNode)],Addr(TTreeNodes.AddChildFirst));

RegRegisterMethod(TTreeNodes,'AddChild',TypeInfo(_T137),[
TypeInfo(TTreeNode),
TypeInfo(string),TypeInfo(TTreeNode)],Addr(TTreeNodes.AddChild));

RegRegisterMethod(TTreeNodes,'AddChildObjectFirst',TypeInfo(_T138),[
TypeInfo(TTreeNode),
TypeInfo(string),
TypeInfoPointer,TypeInfo(TTreeNode)],Addr(TTreeNodes.AddChildObjectFirst));

RegRegisterMethod(TTreeNodes,'AddChildObject',TypeInfo(_T139),[
TypeInfo(TTreeNode),
TypeInfo(string),
TypeInfoPointer,TypeInfo(TTreeNode)],Addr(TTreeNodes.AddChildObject));

RegRegisterMethod(TTreeNodes,'AddFirst',TypeInfo(_T140),[
TypeInfo(TTreeNode),
TypeInfo(string),TypeInfo(TTreeNode)],Addr(TTreeNodes.AddFirst));

RegRegisterMethod(TTreeNodes,'Add',TypeInfo(_T141),[
TypeInfo(TTreeNode),
TypeInfo(string),TypeInfo(TTreeNode)],Addr(TTreeNodes.Add));

RegRegisterMethod(TTreeNodes,'AddObjectFirst',TypeInfo(_T142),[
TypeInfo(TTreeNode),
TypeInfo(string),
TypeInfoPointer,TypeInfo(TTreeNode)],Addr(TTreeNodes.AddObjectFirst));

RegRegisterMethod(TTreeNodes,'AddObject',TypeInfo(_T143),[
TypeInfo(TTreeNode),
TypeInfo(string),
TypeInfoPointer,TypeInfo(TTreeNode)],Addr(TTreeNodes.AddObject));

RegRegisterMethod(TTreeNodes,'BeginUpdate',TypeInfo(_T144),NoParams,Addr(TTreeNodes.BeginUpdate));

RegRegisterMethod(TTreeNodes,'Clear',TypeInfo(_T145),NoParams,Addr(TTreeNodes.Clear));

RegRegisterMethod(TTreeNodes,'Delete',TypeInfo(_T146),[
TypeInfo(TTreeNode)],Addr(TTreeNodes.Delete));

RegRegisterMethod(TTreeNodes,'EndUpdate',TypeInfo(_T147),NoParams,Addr(TTreeNodes.EndUpdate));

RegRegisterMethod(TTreeNodes,'GetFirstNode',TypeInfo(_T148),[TypeInfo(TTreeNode)],Addr(TTreeNodes.GetFirstNode));

RegRegisterMethod(TTreeNodes,'Insert',TypeInfo(_T150),[
TypeInfo(TTreeNode),
TypeInfo(string),TypeInfo(TTreeNode)],Addr(TTreeNodes.Insert));

RegRegisterMethod(TTreeNodes,'InsertObject',TypeInfo(_T151),[
TypeInfo(TTreeNode),
TypeInfo(string),
...
_mreg_0;
{RegRegisterMethod(TConversion,'ConvertReadStream',TypeInfo(_T10),[
TypeInfo(TStream),
TypeInfoPChar,
TypeInfo(Integer),TypeInfo(Integer)], pointer(0))}

{RegRegisterMethod(TConversion,'ConvertWriteStream',TypeInfo(_T11),[
TypeInfo(TStream),
TypeInfoPChar,
TypeInfo(Integer),TypeInfo(Integer)], pointer(4))}

{RegRegisterMethod(TCustomListView,'CustomSort',TypeInfo(_T36),[
TypeInfo(TLVCompare),
TypeInfo(Longint),TypeInfo(Boolean)],Addr(TCustomListView.CustomSort))}

{RegisterProc(TCustomRichEdit,'RegisterConversionFormat',mtClassMethod,TypeInfo(_T43),[
TypeInfo(string),
TypeInfo(TConversionClass)],Addr(TCustomRichEdit.RegisterConversionFormat),cRegister)}

{RegRegisterMethod(TCustomTreeView,'CustomSort',TypeInfo(_T56),[
TypeInfo(TTVCompare),
TypeInfo(Longint),TypeInfo(Boolean)],Addr(TCustomTreeView.CustomSort))}

{RegRegisterMethod(TTreeNode,'CustomSort',TypeInfo(_T113),[
TypeInfo(TTVCompare),
TypeInfo(Longint),TypeInfo(Boolean)],Addr(TTreeNode.CustomSort))}

{RegRegisterMethod(TTreeNodes,'GetNode',TypeInfo(_T149),[
