...
RegisterProc(nil,MethodNames[36],mtProc,TypeInfo(_T68),[TypeInfo(TStringList)],Addr(GetRegisteredClassesList),cRegister);

RegisterProc(nil,MethodNames[37],mtProc,TypeInfo(_T70),[
TypeInfo(TDCScripter),
TypeInfo(TStrings)],Addr(GetRoutineNames),cRegister);

RegisterProc(nil,MethodNames[38],mtProc,TypeInfo(_T71),[
TypeInfo(string),
TypeInfo(TStrings),
TypeInfo(TComponent),
TypeInfo(string),
...
RegisterProc(nil,MethodNames[39],mtProc,TypeInfo(_T72),[
TypeInfo(string)],Addr(ExecuteJavaClass),cRegister);

RegisterProc(nil,MethodNames[40],mtProc,TypeInfo(_T73),[
TypeInfo(string),TypeInfo(Boolean)],Addr(IsIdentRegistered),cRegister);

RegisterProc(nil,MethodNames[41],mtProc,TypeInfo(_T74),[
TypeInfo(string),TypeInfo(Boolean)],Addr(IsConstRegistered),cRegister);

RegisterProc(nil,MethodNames[42],mtProc,TypeInfo(_T75),[
TypeInfo(string),TypeInfo(Boolean)],Addr(IsClassRegistered),cRegister);

RegisterProc(nil,MethodNames[43],mtProc,TypeInfo(_T76),[
TypeInfo(string),TypeInfo(Boolean)],Addr(IsPropRegistered),cRegister);

RegisterProc(nil,MethodNames[44],mtProc,TypeInfo(_T77),[
TypeInfo(string),
TypeInfo(Variant)],Addr(GetRegisteredConst),cRegister);

RegisterProc(nil,MethodNames[45],mtProc,TypeInfo(_T78),NoParams,Addr(BreakRunningScript),cRegister);

RegisterProc(nil,MethodNames[46],mtProc,TypeInfo(_T79),[
TypeInfo(string),TypeInfo(Boolean)],Addr(IsMethodRegistered),cRegister);

RegisterProc(nil,MethodNames[47],mtProc,TypeInfo(_T80),[
TypeInfo(string),TypeInfo(Boolean)],Addr(IsVarRegistered),cRegister);

RegisterProc(nil,MethodNames[48],mtProc,TypeInfo(_T81),[TypeInfo(TStringList)],Addr(GetRegisteredConstList),cRegister);

RegisterProc(nil,MethodNames[49],mtProc,TypeInfo(_T82),[TypeInfo(TStringList)],Addr(GetRegisteredVarList),cRegister);

RegisterProc(nil,MethodNames[50],mtProc,TypeInfo(_T83),[TypeInfo(TStringList)],Addr(GetRegisteredPropNames),cRegister);

RegisterProc(nil,MethodNames[51],mtProc,TypeInfo(_T84),[TypeInfo(TStringList)],Addr(GetRegisteredProcList),cRegister);

RegisterProc(nil,MethodNames[52],mtProc,TypeInfo(_T85),[
TypeInfo(Integer),TypeInfo(TRegisteredClassInfo)],Addr(GetRegisteredClassInfo),cRegister);

RegisterProc(nil,MethodNames[53],mtProc,TypeInfo(_T86),[
TypeInfo(TDCScripter)],Addr(RunRunner),cRegister);

RegisterProc(nil,MethodNames[54],mtProc,TypeInfo(_T87),[
TypeInfo(Integer),TypeInfo(Integer)],Addr(GetDWordSize),cRegister);

RegisterProc(nil,MethodNames[55],mtProc,TypeInfo(_T91),NoParams,Addr(DCUnitFinalization),cRegister);
