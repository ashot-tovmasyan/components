...
procedure _mreg_0;
begin
RegRegisterMethod(TQRCustomLabel,'GetCaptionBased',TypeInfo(_T0),[TypeInfo(Boolean)], pointer(164));

RegRegisterMethod(TQRCustomLabel,'FormatLines',TypeInfo(_T1),NoParams, pointer(168));

RegRegisterMethod(TQRCustomLabel,'ReadFontSize',TypeInfo(_T2),[
TypeInfo(TReader)], pointer(172));

RegRegisterMethod(TQRCustomLabel,'WriteFontSize',TypeInfo(_T3),[
TypeInfo(TWriter)], pointer(176));
