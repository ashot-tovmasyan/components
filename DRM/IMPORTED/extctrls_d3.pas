...
RegRegisterMethod(TCustomRadioGroup,'CanModify',TypeInfo(_T2),[TypeInfo(Boolean)], pointer(128));
...
RegRegisterMethod(TTimer,'Timer',TypeInfo(_T7),NoParams, pointer(MinVMTOffset - 14));
