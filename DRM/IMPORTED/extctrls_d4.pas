...
_T12 = function (var p0 : Integer): Boolean of object;
...
RegRegisterMethod(TCustomControlBar,'DoBandMove',TypeInfo(_T1),[
TypeInfo(TControl),
TypeInfo(IDispatch)], pointer(188));

RegRegisterMethod(TCustomControlBar,'DoBandPaint',TypeInfo(_T2),[
TypeInfo(TControl),
TypeInfo(TCanvas),
TypeInfo(IDispatch),
TypeInfo(TBandPaintOptions)], pointer(192));

RegisterProc(TCustomControlBar,'DragControl',mtScriptMethod,TypeInfo(_T3),[
TypeInfo(TControl),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Boolean),TypeInfo(Boolean)],Addr(__TCustomControlBar__DragControl__Wrapper),cRegister);

RegRegisterMethod(TCustomControlBar,'GetControlInfo',TypeInfo(_T4),[
TypeInfo(TControl),
TypeInfo(IDispatch),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(200));

RegRegisterMethod(TCustomControlBar,'PaintControlFrame',TypeInfo(_T5),[
TypeInfo(TCanvas),
TypeInfo(TControl),
TypeInfo(IDispatch)], pointer(204));

RegRegisterMethod(TCustomControlBar,'StickControls',TypeInfo(_T6),NoParams, pointer(208));

RegRegisterMethod(TCustomRadioGroup,'CanModify',TypeInfo(_T7),[TypeInfo(Boolean)], pointer(188));

RegRegisterMethod(THeader,'Sizing',TypeInfo(_T8),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(MinVMTOffset - 71));

RegRegisterMethod(THeader,'Sized',TypeInfo(_T9),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(MinVMTOffset - 72));

RegRegisterMethod(TImage,'Progress',TypeInfo(_T10),[
TypeInfo(TObject),
TypeInfo(TProgressStage),
TypeInfo(Byte),
TypeInfo(Boolean),
TypeInfo(IDispatch),
TypeInfo(string)], pointer(MinVMTOffset - 49));

RegRegisterMethod(TShape,'StyleChanged',TypeInfo(_T11),[
TypeInfo(TObject)],Addr(TShape.StyleChanged));

RegRegisterMethod(TSplitter,'CanResize',TypeInfo(_T12),[
TypeInfo(Integer),TypeInfo(Boolean)], pointer(140));

RegRegisterMethod(TSplitter,'DoCanResize',TypeInfo(_T13),[
TypeInfo(Integer),TypeInfo(Boolean)], pointer(144));

RegRegisterMethod(TSplitter,'StopSizing',TypeInfo(_T14),NoParams, pointer(MinVMTOffset - 49));

RegRegisterMethod(TTimer,'Timer',TypeInfo(_T15),NoParams, pointer(MinVMTOffset - 15));
