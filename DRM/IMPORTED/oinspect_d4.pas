...
TypeInfo(TDCDsgnProp),
TypeInfo(TDCDsgnProp),TypeInfo(Integer)], pointer(276));

RegRegisterMethod(TCustomAxInspector,'IsOCX',TypeInfo(_T7),[
TypeInfo(TObject),TypeInfo(Boolean)], pointer(280));

RegRegisterMethod(TCustomObjectInspector,'ShowAxHelp',TypeInfo(_T8),NoParams, pointer(216));
...
TypeInfo(TDCDsgnProp)], pointer(228));

RegRegisterMethod(TCustomObjectInspector,'GetRealName',TypeInfo(_T14),[
TypeInfo(TDCDsgnProp),TypeInfo(string)], pointer(240));

RegRegisterMethod(TCustomObjectInspector,'ComponentChanged',TypeInfo(_T15),NoParams, pointer(244));

RegRegisterMethod(TCustomObjectInspector,'IsEmpty',TypeInfo(_T17),[TypeInfo(Boolean)], pointer(252));

RegRegisterMethod(TCustomObjectInspector,'CanHaveSubNodes',TypeInfo(_T18),[TypeInfo(Boolean)], pointer(256));

RegRegisterMethod(TCustomObjectInspector,'IsInspectorKey',TypeInfo(_T19),[
TypeInfo(Word),
TypeInfo(TShiftState),TypeInfo(Boolean)], pointer(260));

RegRegisterMethod(TCustomObjectInspector,'GetActivePropDesc',TypeInfo(_T20),[TypeInfo(string)], pointer(264));

RegRegisterMethod(TCustomObjectInspector,'UpdateEditorValue',TypeInfo(_T21),NoParams, pointer(268));
...
{RegRegisterMethod(TCustomObjectInspector,'GetInplaceEditClass',TypeInfo(_T9),[TypeInfo(TInplaceEditClass)], pointer(220))}

{RegRegisterMethod(TCustomObjectInspector,'GetEditorClass',TypeInfo(_T12),[
TypeInfo(TDCDsgnProp),TypeInfo(TControlClass)], pointer(232))}

{RegRegisterMethod(TCustomObjectInspector,'GetPopupClass',TypeInfo(_T13),[
TypeInfo(TDCDsgnProp),TypeInfo(TWinControlClass)], pointer(236))}
...
TypeInfo(TGetPropEditProc)], pointer(248))}
