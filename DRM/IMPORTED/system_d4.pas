...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[16] ,varAny));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[17] ,varTypeMask));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[18] ,varArray));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[19] ,varByRef));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[20] ,vtInteger));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[21] ,vtBoolean));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[22] ,vtChar));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[23] ,vtExtended));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[24] ,vtString));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[25] ,vtPointer));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[26] ,vtPChar));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[27] ,vtObject));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[28] ,vtClass));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[29] ,vtWideChar));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[30] ,vtPWideChar));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[31] ,vtAnsiString));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[32] ,vtCurrency));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[33] ,vtVariant));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[34] ,vtInterface));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[35] ,vtWideString));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[36] ,vtInt64));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[37] ,vmtSelfPtr));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[38] ,vmtIntfTable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[39] ,vmtAutoTable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[40] ,vmtInitTable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[41] ,vmtTypeInfo));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[42] ,vmtFieldTable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[43] ,vmtMethodTable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[44] ,vmtDynamicTable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[45] ,vmtClassName));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[46] ,vmtInstanceSize));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[47] ,vmtParent));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[48] ,vmtSafeCallException));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[49] ,vmtAfterConstruction));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[50] ,vmtBeforeDestruction));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[51] ,vmtDispatch));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[52] ,vmtDefaultHandler));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[53] ,vmtNewInstance));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[54] ,vmtFreeInstance));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[55] ,vmtDestroy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[56] ,vmtQueryInterface));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[57] ,vmtAddRef));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[58] ,vmtRelease));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[59] ,vmtCreateObject));
end;
