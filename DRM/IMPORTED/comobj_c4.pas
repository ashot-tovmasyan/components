...
{_T18 = procedure (const p0 : IUnknown;
const p1 : TIID;
const p2 : IUnknown;
var p3 : Longint) of object;}

{_T19 = procedure (const p0 : IUnknown;
const p1 : TIID;
var p2 : Longint) of object;}

_T20 = function : TComClassManager of object;
...
{_T23 = procedure (p0 : IUnknown) of object;}
...
_T27 = function (out p0 : Integer): HResult of object;
...
{_T29 = procedure (const p0 : IUnknown) of object;}

_T32 = procedure  of object;

{_T33 = procedure (p0 : TComServerObject;
p1 : TFactoryProc) of object;}

{_T34 = function (p0 : TClass): TComObjectFactory of object;}

_T35 = function (const p0 : IDispatch): TComObjectFactory of object;

_T36 = _T32;

{_T37 = procedure (const p0 : IUnknown) of object;}

{_T38 = procedure (p0 : TComObjectFactory;
...
_T41 = function (const p0 : IDispatch;
...
_T44 = function : WideString of object;

_T45 = function : Boolean of object;

_T46 = function (const p0 : WideString): Boolean of object;

{_T48 = function (const p0 : IUnknown): TComObject of object;}

_T49 = _T32;

_T50 = procedure (p0 : Boolean) of object;

_T51 = function (p0 : Boolean): Integer of object;
...
{_T58 = function : ITypeLib of object;}

_T59 = _T14;

_T60 = _T41;

{_T62 = function (p0 : Integer): ITypeInfo of object;}
...
RegisterProc(nil,MethodNames[13],mtProc,TypeInfo(_T17),[TypeInfo(string)],Addr(CreateClassID),cRegister);

RegisterProc(nil,MethodNames[14],mtProc,TypeInfo(_T20),[TypeInfo(TComClassManager)],Addr(ComClassManager),cRegister);

RegisterProc(EOleException,'Create',mtConstructor,TypeInfo(_T21),[
TypeInfo(string),
TypeInfo(Integer),
TypeInfo(string),
TypeInfo(string),
...
RegisterProc(EOleSysError,'Create',mtConstructor,TypeInfo(_T22),[
TypeInfo(string),
TypeInfo(Integer),
TypeInfo(Integer)],Addr(EOleSysError.Create),cRegister);

RegisterProc(TAutoObject,'GetIDsOfNames',mtMethod,TypeInfo(_T25),[
TypeInfo(IDispatch),
TypeInfoPointer,
TypeInfo(Integer),
TypeInfo(Integer),
...
RegisterProc(TAutoObject,'GetTypeInfo',mtMethod,TypeInfo(_T26),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfoUntyped,TypeInfo(HResult)], pointer(20),cStdCall);

RegisterProc(TAutoObject,'GetTypeInfoCount',mtMethod,TypeInfo(_T27),[
TypeInfo(Integer),TypeInfo(HResult)], pointer(24),cStdCall);

RegisterProc(TAutoObject,'Invoke',mtMethod,TypeInfo(_T28),[
TypeInfo(Integer),
TypeInfo(IDispatch),
TypeInfo(Integer),
TypeInfo(Word),
...
RegisterProc(TComClassManager,'Create',mtConstructor,TypeInfo(_T32),NoParams,Addr(TComClassManager.Create),cRegister);

RegRegisterMethod(TComClassManager,'GetFactoryFromClassID',TypeInfo(_T35),[
TypeInfo(IDispatch),TypeInfo(TComObjectFactory)],Addr(__TComClassManager__GetFactoryFromClassID__Wrapper));

RegisterProc(TComObject,'Create',mtConstructor,TypeInfo(_T36),NoParams,Addr(TComObject.Create),cRegister);

RegRegisterMethod(TComObject,'Initialize',TypeInfo(_T39),NoParams, pointer(0));

RegisterProc(TComObject,'ObjAddRef',mtMethod,TypeInfo(_T40),[TypeInfo(Integer)], pointer(4),cStdCall);

RegisterProc(TComObject,'ObjQueryInterface',mtMethod,TypeInfo(_T41),[
TypeInfo(IDispatch),
TypeInfoUntyped,TypeInfo(HResult)], pointer(8),cRegister);

RegisterProc(TComObject,'ObjRelease',mtMethod,TypeInfo(_T42),[TypeInfo(Integer)], pointer(12),cStdCall);

RegRegisterMethod(TComObjectFactory,'GetProgID',TypeInfo(_T43),[TypeInfo(string)], pointer(0));

RegRegisterMethod(TComObjectFactory,'GetLicenseString',TypeInfo(_T44),[TypeInfo(WideString)], pointer(4));

RegRegisterMethod(TComObjectFactory,'HasMachineLicense',TypeInfo(_T45),[TypeInfo(Boolean)], pointer(8));

RegRegisterMethod(TComObjectFactory,'ValidateUserLicense',TypeInfo(_T46),[
TypeInfo(WideString),TypeInfo(Boolean)], pointer(12));

RegRegisterMethod(TComObjectFactory,'RegisterClassObject',TypeInfo(_T49),NoParams,Addr(TComObjectFactory.RegisterClassObject));

RegRegisterMethod(TComObjectFactory,'UpdateRegistry',TypeInfo(_T50),[
TypeInfo(Boolean)], pointer(20));

RegRegisterMethod(TComServerObject,'CountObject',TypeInfo(_T51),[
TypeInfo(Boolean),TypeInfo(Integer)], pointer(0));

RegRegisterMethod(TComServerObject,'CountFactory',TypeInfo(_T52),[
TypeInfo(Boolean),TypeInfo(Integer)], pointer(4));

RegRegisterMethod(TComServerObject,'GetHelpFileName',TypeInfo(_T53),[TypeInfo(string)], pointer(8));

RegRegisterMethod(TComServerObject,'GetServerFileName',TypeInfo(_T54),[TypeInfo(string)], pointer(12));

RegRegisterMethod(TComServerObject,'GetServerKey',TypeInfo(_T55),[TypeInfo(string)], pointer(16));

RegRegisterMethod(TComServerObject,'GetServerName',TypeInfo(_T56),[TypeInfo(string)], pointer(20));

RegRegisterMethod(TComServerObject,'GetStartSuspended',TypeInfo(_T57),[TypeInfo(Boolean)], pointer(24));

RegRegisterMethod(TComServerObject,'SetHelpFileName',TypeInfo(_T59),[
TypeInfo(string)], pointer(32));

RegisterProc(TContainedObject,'QueryInterface',mtMethod,TypeInfo(_T60),[
TypeInfo(IDispatch),
...
{RegisterProc(nil,'InterfaceConnect',mtProc,TypeInfo(_T18),[
TypeInfo(IUnknown),
TypeInfo(TIID),
TypeInfo(IUnknown),
TypeInfo(Longint)],Addr(InterfaceConnect),cRegister)}

{RegisterProc(nil,'InterfaceDisconnect',mtProc,TypeInfo(_T19),[
TypeInfo(IUnknown),
TypeInfo(TIID),
TypeInfo(Longint)],Addr(InterfaceDisconnect),cRegister)}

{RegisterProc(TAggregatedObject,'Create',mtConstructor,TypeInfo(_T23),[
TypeInfo(IUnknown)],Addr(TAggregatedObject.Create),cRegister)}

{RegRegisterMethod(TAutoObject,'EventSinkChanged',TypeInfo(_T29),[
TypeInfo(IUnknown)], pointer(32))}

{RegRegisterMethod(TComClassManager,'ForEachFactory',TypeInfo(_T33),[
TypeInfo(TComServerObject),
TypeInfo(TFactoryProc)],Addr(TComClassManager.ForEachFactory))}

{RegRegisterMethod(TComClassManager,'GetFactoryFromClass',TypeInfo(_T34),[
TypeInfo(TClass),TypeInfo(TComObjectFactory)],Addr(TComClassManager.GetFactoryFromClass))}

{RegisterProc(TComObject,'CreateAggregated',mtConstructor,TypeInfo(_T37),[
TypeInfo(IUnknown)],Addr(TComObject.CreateAggregated),cRegister)}

{RegisterProc(TComObject,'CreateFromFactory',mtConstructor,TypeInfo(_T38),[
TypeInfo(TComObjectFactory),
TypeInfo(IUnknown)],Addr(TComObject.CreateFromFactory),cRegister)}

{RegRegisterMethod(TComObjectFactory,'CreateComObject',TypeInfo(_T48),[
TypeInfo(IUnknown),TypeInfo(TComObject)], pointer(16))}

{RegRegisterMethod(TComServerObject,'GetTypeLib',TypeInfo(_T58),[TypeInfo(ITypeLib)], pointer(28))}

{RegRegisterMethod(TTypedComObjectFactory,'GetInterfaceTypeInfo',TypeInfo(_T62),[
