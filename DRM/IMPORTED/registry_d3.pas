...
_T28 = function (const p0 : string): Currency of object;
...
_T31 = function (const p0 : string): TDateTime of object;

_T32 = _T31;

_T33 = function (const p0 : string): Double of object;

_T34 = _T18;

_T35 = function (const p0 : string): string of object;
...
_T44 = procedure (const p0 : string;
...
RegRegisterMethod(TRegIniFile,'WriteString',TypeInfo(_T2),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(string)],Addr(TRegIniFile.WriteString));

RegRegisterMethod(TRegIniFile,'ReadInteger',TypeInfo(_T3),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(Longint),TypeInfo(Longint)],Addr(TRegIniFile.ReadInteger));

RegRegisterMethod(TRegIniFile,'WriteInteger',TypeInfo(_T4),[
TypeInfo(string),
TypeInfo(string),
...
RegRegisterMethod(TRegistry,'ReadCurrency',TypeInfo(_T28),[
TypeInfo(string),TypeInfo(Currency)],Addr(TRegistry.ReadCurrency));

RegRegisterMethod(TRegistry,'ReadBinaryData',TypeInfo(_T29),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(Integer),TypeInfo(Integer)],Addr(TRegistry.ReadBinaryData));

RegRegisterMethod(TRegistry,'ReadBool',TypeInfo(_T30),[
TypeInfo(string),TypeInfo(Boolean)],Addr(TRegistry.ReadBool));

RegRegisterMethod(TRegistry,'ReadDate',TypeInfo(_T31),[
TypeInfo(string),TypeInfo(TDateTime)],Addr(TRegistry.ReadDate));

RegRegisterMethod(TRegistry,'ReadDateTime',TypeInfo(_T32),[
TypeInfo(string),TypeInfo(TDateTime)],Addr(TRegistry.ReadDateTime));

RegRegisterMethod(TRegistry,'ReadFloat',TypeInfo(_T33),[
TypeInfo(string),TypeInfo(Double)],Addr(TRegistry.ReadFloat));

RegRegisterMethod(TRegistry,'ReadInteger',TypeInfo(_T34),[
TypeInfo(string),TypeInfo(Integer)],Addr(TRegistry.ReadInteger));

RegRegisterMethod(TRegistry,'ReadString',TypeInfo(_T35),[
TypeInfo(string),TypeInfo(string)],Addr(TRegistry.ReadString));

RegRegisterMethod(TRegistry,'ReadTime',TypeInfo(_T36),[
TypeInfo(string),TypeInfo(TDateTime)],Addr(TRegistry.ReadTime));

RegRegisterMethod(TRegistry,'RegistryConnect',TypeInfo(_T37),[
TypeInfo(string),TypeInfo(Boolean)],Addr(TRegistry.RegistryConnect));

RegRegisterMethod(TRegistry,'RenameValue',TypeInfo(_T38),[
TypeInfo(string),
TypeInfo(string)],Addr(TRegistry.RenameValue));

RegRegisterMethod(TRegistry,'ReplaceKey',TypeInfo(_T39),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(string),TypeInfo(Boolean)],Addr(TRegistry.ReplaceKey));

RegRegisterMethod(TRegistry,'RestoreKey',TypeInfo(_T40),[
TypeInfo(string),
TypeInfo(string),TypeInfo(Boolean)],Addr(TRegistry.RestoreKey));

RegRegisterMethod(TRegistry,'SaveKey',TypeInfo(_T41),[
TypeInfo(string),
TypeInfo(string),TypeInfo(Boolean)],Addr(TRegistry.SaveKey));

RegRegisterMethod(TRegistry,'UnLoadKey',TypeInfo(_T42),[
TypeInfo(string),TypeInfo(Boolean)],Addr(TRegistry.UnLoadKey));

RegRegisterMethod(TRegistry,'ValueExists',TypeInfo(_T43),[
TypeInfo(string),TypeInfo(Boolean)],Addr(TRegistry.ValueExists));

RegRegisterMethod(TRegistry,'WriteCurrency',TypeInfo(_T44),[
TypeInfo(string),
TypeInfo(Currency)],Addr(TRegistry.WriteCurrency));

RegRegisterMethod(TRegistry,'WriteBinaryData',TypeInfo(_T45),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(Integer)],Addr(TRegistry.WriteBinaryData));

RegRegisterMethod(TRegistry,'WriteBool',TypeInfo(_T46),[
TypeInfo(string),
TypeInfo(Boolean)],Addr(TRegistry.WriteBool));

RegRegisterMethod(TRegistry,'WriteDate',TypeInfo(_T47),[
TypeInfo(string),
TypeInfo(TDateTime)],Addr(TRegistry.WriteDate));

RegRegisterMethod(TRegistry,'WriteDateTime',TypeInfo(_T48),[
TypeInfo(string),
TypeInfo(TDateTime)],Addr(TRegistry.WriteDateTime));

RegRegisterMethod(TRegistry,'WriteFloat',TypeInfo(_T49),[
TypeInfo(string),
TypeInfo(Double)],Addr(TRegistry.WriteFloat));

RegRegisterMethod(TRegistry,'WriteInteger',TypeInfo(_T50),[
TypeInfo(string),
TypeInfo(Integer)],Addr(TRegistry.WriteInteger));

RegRegisterMethod(TRegistry,'WriteString',TypeInfo(_T51),[
TypeInfo(string),
TypeInfo(string)],Addr(TRegistry.WriteString));

RegRegisterMethod(TRegistry,'WriteExpandString',TypeInfo(_T52),[
TypeInfo(string),
TypeInfo(string)],Addr(TRegistry.WriteExpandString));

RegRegisterMethod(TRegistry,'WriteTime',TypeInfo(_T53),[
TypeInfo(string),
