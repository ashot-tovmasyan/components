...
RegRegisterMethod(TCustomQuickRep,'Execute',TypeInfo(_T5),NoParams, pointer(196));

RegRegisterMethod(TCustomQuickRep,'CreateReport',TypeInfo(_T6),[
TypeInfo(Boolean)], pointer(200));

RegRegisterMethod(TCustomQuickRep,'PaintColumns',TypeInfo(_T7),NoParams, pointer(204));

RegRegisterMethod(TCustomQuickRep,'PaintMargins',TypeInfo(_T8),NoParams, pointer(208));

RegRegisterMethod(TCustomQuickRep,'PaintFrame',TypeInfo(_T9),NoParams, pointer(212));

RegRegisterMethod(TCustomQuickRep,'SetControllerBands',TypeInfo(_T10),NoParams, pointer(216));
...
TypeInfo(TComponent),
TypeInfo(Integer)], pointer(224),cRegister);
...
TypeInfo(TQRPrintable)], pointer(228));
...
RegRegisterMethod(TQRControllerBand,'CreateController',TypeInfo(_T41),NoParams, pointer(208));

RegRegisterMethod(TQRControllerBand,'RegisterBands',TypeInfo(_T42),NoParams, pointer(212));

RegRegisterMethod(TQRControllerBand,'SetMaster',TypeInfo(_T43),[
TypeInfo(TComponent)], pointer(216));

RegRegisterMethod(TQRControllerBand,'CreateLocalVar',TypeInfo(_T44),NoParams, pointer(220));

RegRegisterMethod(TQRControllerBand,'RemoveLocalVar',TypeInfo(_T45),NoParams, pointer(224));

RegRegisterMethod(TQRControllerBand,'LocalVarExpression',TypeInfo(_T46),[TypeInfo(string)], pointer(228));
...
RegRegisterMethod(TQRCustomBand,'BandTypeName',TypeInfo(_T48),[TypeInfo(string)], pointer(192));

RegRegisterMethod(TQRCustomBand,'BandComponentName',TypeInfo(_T49),[TypeInfo(string)], pointer(196));

RegRegisterMethod(TQRCustomBand,'SetParentReport',TypeInfo(_T50),[
TypeInfo(TCustomQuickRep)], pointer(200));

RegRegisterMethod(TQRCustomBand,'WriteDummy',TypeInfo(_T51),[
TypeInfo(TWriter)], pointer(204));
...
RegRegisterMethod(TQRPrintable,'IsEnabled',TypeInfo(_T72),[TypeInfo(Boolean)], pointer(184));

RegRegisterMethod(TQRPrintable,'AlignIt',TypeInfo(_T74),NoParams, pointer(192));

RegRegisterMethod(TQRPrintable,'Prepare',TypeInfo(_T75),NoParams, pointer(196));
...
TypeInfo(TObject),
TypeInfo(TQRNotifyOperation)], pointer(204));

RegRegisterMethod(TQRPrintable,'SetAlignment',TypeInfo(_T78),[
TypeInfo(TAlignment)], pointer(208));

RegRegisterMethod(TQRPrintable,'Unprepare',TypeInfo(_T79),NoParams, pointer(212));
...
{RegRegisterMethod(TQRPrintable,'GetEditorClass',TypeInfo(_T73),[TypeInfo(TQRPrintableEditorClass)], pointer(188))}
