...
RegRegisterMethod(TCustomDCMemo,'CreateDefaultMemoSource',TypeInfo(_T19),[TypeInfo(TCustomMemoSource)], pointer(152));

RegRegisterMethod(TCustomDCMemo,'SetUseGlobalOptions',TypeInfo(_T20),[
TypeInfo(Boolean)], pointer(156));

RegRegisterMethod(TCustomDCMemo,'DoPaintGutter',TypeInfo(_T21),[
TypeInfo(IDispatch),
TypeInfo(TDrawState),TypeInfo(Boolean)], pointer(160));

RegRegisterMethod(TCustomDCMemo,'DoGetFontFromStyle',TypeInfo(_T22),[
TypeInfo(Integer),
TypeInfo(TFont),
TypeInfo(TColor)], pointer(164));

RegRegisterMethod(TCustomDCMemo,'CreatePrintDialog',TypeInfo(_T23),[TypeInfo(TCustomForm)], pointer(168));

RegRegisterMethod(TCustomDCMemo,'CreatePrintProgressDialog',TypeInfo(_T24),[TypeInfo(TCustomForm)], pointer(172));

RegRegisterMethod(TCustomDCMemo,'TemplateInsert',TypeInfo(_T25),[
TypeInfo(TStrings)], pointer(176));

RegRegisterMethod(TCustomDCMemo,'HintInsert',TypeInfo(_T26),[
TypeInfo(string)], pointer(180));

RegRegisterMethod(TCustomDCMemo,'ActivatePopupBox',TypeInfo(_T27),[
TypeInfo(TPopupType),TypeInfo(Boolean)], pointer(184));

RegRegisterMethod(TCustomDCMemo,'MarkWordOnTemplate',TypeInfo(_T28),NoParams, pointer(188));
...
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(TShiftState)], pointer(196));
...
TypeInfo(TMemoStates)], pointer(212));

RegRegisterMethod(TCustomDCMemo,'SelectionChanged',TypeInfo(_T35),NoParams, pointer(216));
...
TypeInfo(Integer),
TypeInfo(TCollapseState),TypeInfo(Boolean)], pointer(224));

RegRegisterMethod(TCustomDCMemo,'CollapseStateChanged',TypeInfo(_T38),[
TypeInfo(Integer),
TypeInfo(TCollapseState)], pointer(228));

RegRegisterMethod(TCustomDCMemo,'DoFindInPopupBox',TypeInfo(_T39),[
TypeInfo(TStrings),
TypeInfo(string),
TypeInfo(Integer),TypeInfo(Boolean)], pointer(232));
...
TypeInfo(Word),
TypeInfo(TShiftState),TypeInfo(Boolean)], pointer(244));
...
RegRegisterMethod(TCustomDCMemo,'PopupHintBox',TypeInfo(_T60),[TypeInfo(Boolean)], pointer(248));
...
RegRegisterMethod(TCustomDCMemo,'LoadGlobalOptions',TypeInfo(_T80),NoParams, pointer(252));
...
RegRegisterMethod(TCustomDCMemo,'CopyToClipboard',TypeInfo(_T147),NoParams, pointer(256));

RegRegisterMethod(TCustomDCMemo,'CutToClipboard',TypeInfo(_T148),NoParams, pointer(260));

RegRegisterMethod(TCustomDCMemo,'PasteFromClipboard',TypeInfo(_T149),NoParams, pointer(264));
