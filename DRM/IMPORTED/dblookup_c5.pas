...
procedure _mreg_0;
begin
RegRegisterMethod(TDBLookupCombo,'DropDown',TypeInfo(_T0),NoParams, pointer(MinVMTOffset - 74));

RegRegisterMethod(TDBLookupCombo,'CloseUp',TypeInfo(_T1),NoParams, pointer(MinVMTOffset - 75));

RegRegisterMethod(TDBLookupList,'CanEdit',TypeInfo(_T2),[TypeInfo(Boolean)], pointer(236));

RegRegisterMethod(TDBLookupList,'ListClick',TypeInfo(_T3),NoParams, pointer(MinVMTOffset - 102));
