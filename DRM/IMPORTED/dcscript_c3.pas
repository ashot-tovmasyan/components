...
_T67 = function : TStringList of object;

{_T68 = function (p0 : TClass): Integer of object;}

_T69 = procedure (p0 : TDCScripter;
p1 : TStrings) of object;

_T70 = function (const p0 : string;
p1 : TStrings;
p2 : TComponent;
const p3 : string;
const p4 : Array of OleVariant): OleVariant of object;

_T71 = procedure (const p0 : string) of object;
...
_T84 = function (p0 : Integer): TRegisteredClassInfo of object;

_T85 = procedure (var p0 : TDCScripter) of object;

_T86 = function (p0 : Integer): Integer of object;

{_T87 = function (p0 : PTypeInfo): PTypeConvertInfo of object;}

{_T88 = function (p0 : PTypeInfo): Boolean of object;}

_T90 = _T77;

_T91 = function (var p0 : TLCID): HRESULT of object;

_T92 = function (var p0 : TBSTR): HRESULT of object;

_T93 = function (var p0 : OleVariant;
var p1 : TExcepInfo): HRESULT of object;

_T94 = function (p0 : Longint): HRESULT of object;

{_T95 = function (p0 : IActiveScriptError): HRESULT of object;}

_T96 = function : HRESULT of object;

_T97 = _T96;

_T98 = function (var p0 : THandle): HRESULT of object;

_T99 = function (p0 : WordBool): HRESULT of object;

_T100 = _T71;

{_T101 = procedure (const p0 : string;
const p1 : IUnknown;
p2 : Integer) of object;}

_T102 = function : IDispatch of object;

_T103 = function (p0 : TObject;
p1 : TMethodInfo;
var p2 : TDispParams;
p3 : POleVariant): HRESULT of object;

_T104 = function (p0 : Pointer;
var p1 : TDispParams): HRESULT of object;
...
_T107 = function : Pointer of object;

_T108 = procedure (p0 : TObject;
const p1 : TExcepInfo;
p2 : Integer;
p3 : Integer;
var p4 : Boolean) of object;

_T109 = function (const p0 : TFilerID;
...
_T114 = function : Integer of object;
...
{_T118 = function : TCodeDesignerClass of object;}

_T119 = _T77;

_T120 = _T77;

{_T121 = procedure (const p0 : string;
p1 : Boolean;
const p2 : IDispatch) of object;}

_T122 = procedure (p0 : TObject;
const p1 : string;
p2 : Boolean) of object;

_T123 = _T71;

_T124 = function : Variant of object;

_T125 = function (const p0 : string;
const p1 : Array of OleVariant): Variant of object;

_T126 = function (const p0 : string): Variant of object;

_T127 = function : TComponent of object;

_T128 = function : Boolean of object;

_T129 = function (var p0 : Integer;
var p1 : Integer;
...
_T132 = procedure (p0 : TStream) of object;
...
_T136 = function : string of object;
...
{_T143 = function (const p0 : PWideChar): Integer of object;}

_T144 = _T77;

_T145 = _T71;

{_T146 = function : IDispatch of object;}
...
_T153 = procedure (p0 : TDCScripter;
const p1 : string) of object;

_T154 = function (const p0 : string): TDispID of object;
...
{_T157 = procedure (const p0 : string;
p1 : Boolean;
const p2 : IDispatch) of object;}

_T158 = _T71;

_T159 = procedure (p0 : TStrings) of object;

_T160 = procedure (const p0 : string;
const p1 : OleVariant) of object;

_T161 = function (const p0 : string): OleVariant of object;
...
const ClassList : array[0..24] of TClass = (
...
TypeInfo(Integer),
TypeInfo(PArgList),TypeInfo(OleVariant)],Addr(CreateObject),cRegister);
}
RegisterProc(nil,MethodNames[16],mtProc,TypeInfo(_T43),[
TypeInfo(TObject),TypeInfo(OleVariant)],Addr(VarFromObject),cRegister);

RegisterProc(nil,MethodNames[17],mtProc,TypeInfo(_T44),[
TypeInfoUntyped,
TypeInfo(Integer),TypeInfo(Integer)],Addr(VarFromSet),cRegister);

RegisterProc(nil,MethodNames[18],mtProc,TypeInfo(_T45),[
TypeInfoUntyped,
TypeInfo(Integer),
TypeInfo(OleVariant)],Addr(VarToSet),cRegister);

RegisterProc(nil,MethodNames[19],mtProc,TypeInfo(_T46),[
TypeInfo(OleVariant),TypeInfo(TObject)],Addr(VarToObject),cRegister);

RegisterProc(nil,MethodNames[20],mtProc,TypeInfo(_T47),[
TypeInfo(OleVariant),TypeInfo(Char)],Addr(VarToChar),cRegister);

RegisterProc(nil,MethodNames[21],mtProc,TypeInfo(_T48),[
TypeInfo(OleVariant),TypeInfoPointer],Addr(VarToPointer),cRegister);

RegisterProc(nil,MethodNames[22],mtProc,TypeInfo(_T49),[
TypeInfoPointer,TypeInfo(OleVariant)],Addr(PointerToVariant),cRegister);

RegisterProc(nil,MethodNames[23],mtProc,TypeInfo(_T50),[
TypeInfo(string),TypeInfo(Boolean)],Addr(FileCanBeExecuted),cRegister);

RegisterProc(nil,MethodNames[24],mtProc,TypeInfo(_T54),[
TypeInfo(string),TypeInfo(THandle)],Addr(ExternalRunProject),cRegister);

RegisterProc(nil,MethodNames[25],mtProc,TypeInfo(_T55),[
TypeInfo(THandle),TypeInfo(Boolean)],Addr(IsModuleRunning),cRegister);

RegisterProc(nil,MethodNames[26],mtProc,TypeInfo(_T56),[
TypeInfo(THandle)],Addr(ResetRunningModule),cRegister);

RegisterProc(nil,MethodNames[27],mtProc,TypeInfo(_T57),[
TypeInfo(TIDEObjectList),TypeInfo(THandle)],Addr(RunObjectList),cRegister);

RegisterProc(nil,MethodNames[28],mtProc,TypeInfo(_T58),[
TypeInfo(TIDEObjectList),TypeInfo(THandle)],Addr(RunObjectListModal),cRegister);

RegisterProc(nil,MethodNames[29],mtProc,TypeInfo(_T59),[
TypeInfo(string),TypeInfo(THandle)],Addr(RunUnit),cRegister);

RegisterProc(nil,MethodNames[30],mtProc,TypeInfo(_T60),[
TypeInfo(string),TypeInfo(THandle)],Addr(RunUnitModal),cRegister);

RegisterProc(nil,MethodNames[31],mtProc,TypeInfo(_T61),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(TFilerID),
TypeInfo(Boolean),TypeInfo(THandle)],Addr(UniRunUnit),cRegister);

RegisterProc(nil,MethodNames[32],mtProc,TypeInfo(_T62),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(Boolean)],Addr(InSet),cRegister);
{
RegisterProc(nil,MethodNames[33],mtProc,TypeInfo(_T63),[
TypeInfo(Integer),
TypeInfo(PArgList),TypeInfo(OleVariant)],Addr(_Set),cRegister);
}
RegisterProc(nil,MethodNames[34],mtProc,TypeInfo(_T64),[
TypeInfo(Byte),TypeInfo(string)],Addr(_Chr),cRegister);

RegisterProc(nil,MethodNames[35],mtProc,TypeInfo(_T65),[
TypeInfoPointer,TypeInfoPointer],Addr(GetRefVariant),cRegister);

RegisterProc(nil,MethodNames[36],mtProc,TypeInfo(_T67),[TypeInfo(TStringList)],Addr(GetRegisteredClassesList),cRegister);

RegisterProc(nil,MethodNames[37],mtProc,TypeInfo(_T69),[
TypeInfo(TDCScripter),
TypeInfo(TStrings)],Addr(GetRoutineNames),cRegister);

RegisterProc(nil,MethodNames[38],mtProc,TypeInfo(_T70),[
TypeInfo(string),
TypeInfo(TStrings),
TypeInfo(TComponent),
TypeInfo(string),
...
RegisterProc(nil,MethodNames[39],mtProc,TypeInfo(_T71),[
TypeInfo(string)],Addr(ExecuteJavaClass),cRegister);

RegisterProc(nil,MethodNames[40],mtProc,TypeInfo(_T72),[
TypeInfo(string),TypeInfo(Boolean)],Addr(IsIdentRegistered),cRegister);

RegisterProc(nil,MethodNames[41],mtProc,TypeInfo(_T73),[
TypeInfo(string),TypeInfo(Boolean)],Addr(IsConstRegistered),cRegister);

RegisterProc(nil,MethodNames[42],mtProc,TypeInfo(_T74),[
TypeInfo(string),TypeInfo(Boolean)],Addr(IsClassRegistered),cRegister);

RegisterProc(nil,MethodNames[43],mtProc,TypeInfo(_T75),[
TypeInfo(string),TypeInfo(Boolean)],Addr(IsPropRegistered),cRegister);

RegisterProc(nil,MethodNames[44],mtProc,TypeInfo(_T76),[
TypeInfo(string),
TypeInfo(Variant)],Addr(GetRegisteredConst),cRegister);

RegisterProc(nil,MethodNames[45],mtProc,TypeInfo(_T77),NoParams,Addr(BreakRunningScript),cRegister);

RegisterProc(nil,MethodNames[46],mtProc,TypeInfo(_T78),[
TypeInfo(string),TypeInfo(Boolean)],Addr(IsMethodRegistered),cRegister);

RegisterProc(nil,MethodNames[47],mtProc,TypeInfo(_T79),[
TypeInfo(string),TypeInfo(Boolean)],Addr(IsVarRegistered),cRegister);

RegisterProc(nil,MethodNames[48],mtProc,TypeInfo(_T80),[TypeInfo(TStringList)],Addr(GetRegisteredConstList),cRegister);

RegisterProc(nil,MethodNames[49],mtProc,TypeInfo(_T81),[TypeInfo(TStringList)],Addr(GetRegisteredVarList),cRegister);

RegisterProc(nil,MethodNames[50],mtProc,TypeInfo(_T82),[TypeInfo(TStringList)],Addr(GetRegisteredPropNames),cRegister);

RegisterProc(nil,MethodNames[51],mtProc,TypeInfo(_T83),[TypeInfo(TStringList)],Addr(GetRegisteredProcList),cRegister);

RegisterProc(nil,MethodNames[52],mtProc,TypeInfo(_T84),[
TypeInfo(Integer),TypeInfo(TRegisteredClassInfo)],Addr(GetRegisteredClassInfo),cRegister);

RegisterProc(nil,MethodNames[53],mtProc,TypeInfo(_T85),[
TypeInfo(TDCScripter)],Addr(RunRunner),cRegister);

RegisterProc(nil,MethodNames[54],mtProc,TypeInfo(_T86),[
TypeInfo(Integer),TypeInfo(Integer)],Addr(GetDWordSize),cRegister);

RegisterProc(nil,MethodNames[55],mtProc,TypeInfo(_T90),NoParams,Addr(DCUnitFinalization),cRegister);

RegisterProc(TActiveScriptSite,'GetLCID',mtMethod,TypeInfo(_T91),[
TypeInfo(TLCID),TypeInfo(HRESULT)], pointer(0),cStdCall);
{
RegisterProc(TActiveScriptSite,'GetDocVersionString',mtMethod,TypeInfo(_T92),[
TypeInfo(TBSTR),TypeInfo(HRESULT)], pointer(4),cStdCall);
}
RegisterProc(TActiveScriptSite,'OnScriptTerminate',mtMethod,TypeInfo(_T93),[
TypeInfo(OleVariant),
TypeInfo(TExcepInfo),TypeInfo(HRESULT)], pointer(8),cStdCall);

RegisterProc(TActiveScriptSite,'OnStateChange',mtMethod,TypeInfo(_T94),[
TypeInfo(Longint),TypeInfo(HRESULT)], pointer(12),cStdCall);

RegisterProc(TActiveScriptSite,'OnEnterScript',mtMethod,TypeInfo(_T96),[TypeInfo(HRESULT)], pointer(20),cStdCall);

RegisterProc(TActiveScriptSite,'OnLeaveScript',mtMethod,TypeInfo(_T97),[TypeInfo(HRESULT)], pointer(24),cStdCall);

RegisterProc(TActiveScriptSite,'GetWindow',mtMethod,TypeInfo(_T98),[
TypeInfo(THandle),TypeInfo(HRESULT)], pointer(28),cStdCall);

RegisterProc(TActiveScriptSite,'EnableModeless',mtMethod,TypeInfo(_T99),[
TypeInfo(WordBool),TypeInfo(HRESULT)], pointer(32),cStdCall);

RegisterProc(TActiveScriptSite,'Create',mtConstructor,TypeInfo(_T100),[
TypeInfo(string)],Addr(TActiveScriptSite.Create),cRegister);

RegRegisterMethod(TAxScriptRunner,'GetDefaultCatID',TypeInfo(_T102),[TypeInfo(IDispatch)], pointer(76));
{
RegRegisterMethod(TDCompWrapper,'MethodCall',TypeInfo(_T103),[
TypeInfo(TObject),
TypeInfo(TMethodInfo),
TypeInfo(TDispParams),
TypeInfoPointer,TypeInfo(HRESULT)],Addr(TDCompWrapper.MethodCall));
}
{
RegRegisterMethod(TDCompWrapper,'PutProperty',TypeInfo(_T104),[
TypeInfoPointer,
TypeInfo(TDispParams),TypeInfo(HRESULT)],Addr(TDCompWrapper.PutProperty));
}
{
RegRegisterMethod(TDCompWrapper,'GetProperty',TypeInfo(_T105),[
TypeInfoPointer,
TypeInfo(TDispParams),
TypeInfoPointer,TypeInfo(HRESULT)],Addr(TDCompWrapper.GetProperty));
}
RegisterProc(TDCRecordWrapper,'Create',mtConstructor,TypeInfo(_T106),NoParams,Addr(TDCRecordWrapper.Create),cRegister);

RegRegisterMethod(TDCRecordWrapper,'GetRecordPtr',TypeInfo(_T107),[TypeInfoPointer], pointer(12));

RegRegisterMethod(TDCScripter,'ScriptError',TypeInfo(_T108),[
TypeInfo(TObject),
TypeInfo(TExcepInfo),
TypeInfo(Integer),
TypeInfo(Integer),
...
RegRegisterMethod(TDCScripter,'LoadModule',TypeInfo(_T109),[
TypeInfo(TFilerID),
TypeInfo(TFileName),TypeInfo(TComponent)], pointer(68));

RegRegisterMethod(TDCScripter,'GetUnitFileName',TypeInfo(_T110),[
TypeInfo(string),
TypeInfo(TFilerID),
TypeInfo(TFileName),TypeInfo(Boolean)], pointer(72));

RegRegisterMethod(TDCScripter,'TraceInto',TypeInfo(_T111),NoParams,Addr(TDCScripter.TraceInto));

RegRegisterMethod(TDCScripter,'StepOver',TypeInfo(_T112),NoParams,Addr(TDCScripter.StepOver));

RegRegisterMethod(TDCScripter,'CreateScriptRunner',TypeInfo(_T113),NoParams,Addr(TDCScripter.CreateScriptRunner));

RegRegisterMethod(TDCScripter,'CurrentExecutionLine',TypeInfo(_T114),[TypeInfo(Integer)],Addr(TDCScripter.CurrentExecutionLine));

RegRegisterMethod(TDCScripter,'RaiseScriptError',TypeInfo(_T115),[
TypeInfo(string)],Addr(TDCScripter.RaiseScriptError));

RegRegisterMethod(TDCScripter,'StopScripts',TypeInfo(_T116),NoParams,Addr(TDCScripter.StopScripts));

RegRegisterMethod(TDCScripter,'Stop',TypeInfo(_T119),NoParams,Addr(TDCScripter.Stop));

RegRegisterMethod(TDCScripter,'InterruptScript',TypeInfo(_T120),NoParams,Addr(TDCScripter.InterruptScript));

RegRegisterMethod(TDCScripter,'AddObjectToScript',TypeInfo(_T122),[
TypeInfo(TObject),
TypeInfo(string),
TypeInfo(Boolean)],Addr(TDCScripter.AddObjectToScript));

RegRegisterMethod(TDCScripter,'RemoveItem',TypeInfo(_T123),[
TypeInfo(string)],Addr(TDCScripter.RemoveItem));

RegRegisterMethod(TDCScripter,'Run',TypeInfo(_T124),[TypeInfo(Variant)],Addr(TDCScripter.Run));

RegRegisterMethod(TDCScripter,'DispatchMethod',TypeInfo(_T125),[
TypeInfo(string),
ArrayInfo(TypeInfo(OleVariant)),TypeInfo(Variant)],Addr(TDCScripter.DispatchMethod));

RegRegisterMethod(TDCScripter,'CallNoParamsMethod',TypeInfo(_T126),[
TypeInfo(string),TypeInfo(Variant)],Addr(TDCScripter.CallNoParamsMethod));

RegRegisterMethod(TDCScripter,'GetModule',TypeInfo(_T127),[TypeInfo(TComponent)], pointer(76));

RegRegisterMethod(TDCScripter,'CheckSyntax',TypeInfo(_T128),[TypeInfo(Boolean)],Addr(TDCScripter.CheckSyntax));

RegRegisterMethod(TDCScripter,'CheckSyntaxEx',TypeInfo(_T129),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Boolean),TypeInfo(Boolean)],Addr(TDCScripter.CheckSyntaxEx));

RegRegisterMethod(TDCScripter,'CheckSyntaxEx2',TypeInfo(_T130),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(string),
TypeInfo(Boolean),TypeInfo(Boolean)],Addr(TDCScripter.CheckSyntaxEx2));

RegRegisterMethod(TDCScripter,'Evaluate',TypeInfo(_T131),[
TypeInfo(string),TypeInfo(Variant)],Addr(TDCScripter.Evaluate));

RegRegisterMethod(TDCScripter,'LoadCompiledScriptFromStream',TypeInfo(_T132),[
TypeInfo(TStream)],Addr(TDCScripter.LoadCompiledScriptFromStream));

RegRegisterMethod(TDCScripter,'SaveCompiledScriptToStream',TypeInfo(_T133),[
TypeInfo(TStream)],Addr(TDCScripter.SaveCompiledScriptToStream));

RegRegisterMethod(TDCScripter,'LoadCompiledScriptFromFile',TypeInfo(_T134),[
TypeInfo(string)],Addr(TDCScripter.LoadCompiledScriptFromFile));

RegRegisterMethod(TDCScripter,'SaveCompiledScriptToFile',TypeInfo(_T135),[
TypeInfo(string)],Addr(TDCScripter.SaveCompiledScriptToFile));

RegRegisterMethod(TDCScripter,'GetDisplayScriptName',TypeInfo(_T136),[TypeInfo(string)],Addr(TDCScripter.GetDisplayScriptName));

RegRegisterMethod(TDCScripter,'IsRunning',TypeInfo(_T137),[TypeInfo(Boolean)],Addr(TDCScripter.IsRunning));

RegRegisterMethod(TDCScripter,'UseUnit',TypeInfo(_T138),[
TypeInfo(string)],Addr(TDCScripter.UseUnit));

RegRegisterMethod(TDCScripter,'UnloadUnit',TypeInfo(_T139),[
TypeInfo(string)],Addr(TDCScripter.UnloadUnit));

RegRegisterMethod(TDebugManager,'IsBreakPoint',TypeInfo(_T140),[
TypeInfo(TDCScripter),
TypeInfo(Integer),TypeInfo(Boolean)], pointer(0));

RegisterProc(TRegisteredClassInfo,'Create',mtConstructor,TypeInfo(_T141),NoParams,Addr(TRegisteredClassInfo.Create),cRegister);

RegRegisterMethod(TScriptRun,'InitEngine',TypeInfo(_T142),[TypeInfo(Boolean)],Addr(TScriptRun.InitEngine));

RegRegisterMethod(TScriptRun,'StopEngine',TypeInfo(_T144),NoParams,Addr(TScriptRun.StopEngine));

RegisterProc(TScriptRun,'Create',mtConstructor,TypeInfo(_T145),[
TypeInfo(string)],Addr(TScriptRun.Create),cRegister);

RegRegisterMethod(TScriptRunner,'ScriptError',TypeInfo(_T147),[
TypeInfo(TObject),
TypeInfo(TExcepInfo),
TypeInfo(Integer),
TypeInfo(Integer),
...
RegRegisterMethod(TScriptRunner,'StopScript',TypeInfo(_T148),NoParams, pointer(8));

RegRegisterMethod(TScriptRunner,'GetModuleAlias',TypeInfo(_T149),[TypeInfo(string)], pointer(12));

RegRegisterMethod(TScriptRunner,'DoRemoveItem',TypeInfo(_T150),[
TypeInfo(string)], pointer(16));

RegRegisterMethod(TScriptRunner,'FreeRunner',TypeInfo(_T151),NoParams, pointer(20));

RegRegisterMethod(TScriptRunner,'DoInterrupt',TypeInfo(_T152),NoParams, pointer(24));

RegisterProc(TScriptRunner,'Create',mtConstructor,TypeInfo(_T153),[
TypeInfo(TDCScripter),
TypeInfo(string)], pointer(28),cRegister);

RegRegisterMethod(TScriptRunner,'GetIDByName',TypeInfo(_T154),[
TypeInfo(string),TypeInfo(TDispID)],Addr(TScriptRunner.GetIDByName));

RegRegisterMethod(TScriptRunner,'ParseScript',TypeInfo(_T156),[
TypeInfo(string),TypeInfo(Boolean)], pointer(36));

RegRegisterMethod(TScriptRunner,'RemoveItem',TypeInfo(_T158),[
TypeInfo(string)],Addr(TScriptRunner.RemoveItem));

RegRegisterMethod(TScriptRunner,'GetVarList',TypeInfo(_T159),[
TypeInfo(TStrings)], pointer(44));

RegRegisterMethod(TScriptRunner,'SetVarValue',TypeInfo(_T160),[
TypeInfo(string),
TypeInfo(OleVariant)],Addr(TScriptRunner.SetVarValue));

RegRegisterMethod(TScriptRunner,'GetVarValue',TypeInfo(_T161),[
TypeInfo(string),TypeInfo(OleVariant)],Addr(TScriptRunner.GetVarValue));

RegRegisterMethod(TScriptRunner,'SaveToStream',TypeInfo(_T162),[
TypeInfo(TStream)], pointer(48));

RegRegisterMethod(TScriptRunner,'LoadFromStream',TypeInfo(_T163),[
TypeInfo(TStream)], pointer(52));

RegRegisterMethod(TScriptRunner,'EvaluateExpression',TypeInfo(_T164),[
TypeInfo(string),TypeInfo(OleVariant)], pointer(56));

RegRegisterMethod(TScriptRunner,'Run',TypeInfo(_T165),[TypeInfo(Variant)],Addr(TScriptRunner.Run));

RegRegisterMethod(TScriptRunner,'TraceInto',TypeInfo(_T166),NoParams, pointer(60));

RegRegisterMethod(TScriptRunner,'StepOver',TypeInfo(_T167),NoParams, pointer(64));

RegRegisterMethod(TScriptRunner,'CurrentExecutionLine',TypeInfo(_T168),[TypeInfo(Integer)], pointer(68));

RegRegisterMethod(TScriptRunner,'GetWatchesPreffixes',TypeInfo(_T169),[
TypeInfo(string),
...
{RegisterProc(nil,'GetClassInfoIndex',mtProc,TypeInfo(_T68),[
TypeInfo(TClass),TypeInfo(Integer)],Addr(GetClassInfoIndex),cRegister)}

{RegisterProc(nil,'GetConvertInfo',mtProc,TypeInfo(_T87),[
TypeInfoPointer,TypeInfoPointer],Addr(GetConvertInfo),cRegister)}

{RegisterProc(nil,'IsArrayInfo',mtProc,TypeInfo(_T88),[
TypeInfoPointer,TypeInfo(Boolean)],Addr(IsArrayInfo),cRegister)}

{RegisterProc(TActiveScriptSite,'OnScriptError',mtMethod,TypeInfo(_T95),[
TypeInfo(IActiveScriptError),TypeInfo(HRESULT)], pointer(16),cStdCall)}

{RegRegisterMethod(TActiveScriptSite,'AddItem',TypeInfo(_T101),[
TypeInfo(string),
TypeInfo(IUnknown),
TypeInfo(Integer)],Addr(TActiveScriptSite.AddItem))}

{RegRegisterMethod(TDCScripter,'_DispatchMethod',TypeInfo(_T117),[
TypeInfoPChar,
TypeInfo(Integer),
TypeInfo(PArgList),TypeInfo(Variant)],Addr(TDCScripter._DispatchMethod))}

{RegRegisterMethod(TDCScripter,'GetCodeDesignerClass',TypeInfo(_T118),[TypeInfo(TCodeDesignerClass)],Addr(TDCScripter.GetCodeDesignerClass))}

{RegRegisterMethod(TDCScripter,'AddItem',TypeInfo(_T121),[
TypeInfo(string),
TypeInfo(Boolean),
TypeInfo(IDispatch)],Addr(TDCScripter.AddItem))}

{RegisterProc(TScriptRun,'ParseScript',mtMethod,TypeInfo(_T143),[
TypeInfoPWideChar,TypeInfo(Integer)],Addr(TScriptRun.ParseScript),cSafeCall)}

{RegRegisterMethod(TScriptRunner,'GetScriptDispatch',TypeInfo(_T146),[TypeInfo(IDispatch)], pointer(0))}

{RegRegisterMethod(TScriptRunner,'DispatchMethod',TypeInfo(_T155),[
TypeInfoPChar,
TypeInfo(Integer),
TypeInfo(PArgList),TypeInfo(Variant)], pointer(32))}

{RegRegisterMethod(TScriptRunner,'AddItem',TypeInfo(_T157),[
TypeInfo(string),
TypeInfo(Boolean),
