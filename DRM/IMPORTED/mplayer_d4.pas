...
TypeInfo(TMPBtnType)], pointer(MinVMTOffset - 71));

RegRegisterMethod(TMediaPlayer,'Click',TypeInfo(_T1),[
TypeInfo(TMPBtnType),
TypeInfo(Boolean)], pointer(MinVMTOffset - 72));

RegRegisterMethod(TMediaPlayer,'PostClick',TypeInfo(_T2),[
TypeInfo(TMPBtnType)], pointer(MinVMTOffset - 73));

RegRegisterMethod(TMediaPlayer,'DoNotify',TypeInfo(_T3),NoParams, pointer(MinVMTOffset - 74));
