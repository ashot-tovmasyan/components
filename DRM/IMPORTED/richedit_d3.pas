...
function ConvertTTextRangeToVariant(var R : TTextRange) : OleVariant;
function ConvertVariantToTTextRange(const V : OleVariant) : TTextRange;
...
procedure sethr(const val : HRESULT);
function gethr : HRESULT;
property hr : HRESULT read gethr write sethr;
end;
...
function GetRecordPtr : pointer; override;
published
procedure sethdc(const val : hdc);
function gethdc : hdc;
property hdc : hdc read gethdc write sethdc;
procedure sethdcTarget(const val : hdc);
function gethdcTarget : hdc;
property hdcTarget : hdc read gethdcTarget write sethdcTarget;
end;
...
type __TTextRange__Wrapper = class(TDCRecordWrapper)
private
fR : TTextRange;
public
function GetRecordPtr : pointer; override;
published
procedure setlpstrText(const val : AnsiChar);
function getlpstrText : AnsiChar;
property lpstrText : AnsiChar read getlpstrText write setlpstrText;
end;
...
function GetRecordPtr : pointer; override;
published
procedure setlpstrText(const val : WideChar);
function getlpstrText : WideChar;
property lpstrText : WideChar read getlpstrText write setlpstrText;
end;
...
procedure __TENOleOpFailed__Wrapper.sethr(const val : HRESULT);
begin
TENOleOpFailed(GetRecordPtr^).hr := val;
end;
function __TENOleOpFailed__Wrapper.gethr : HRESULT;
begin
result := TENOleOpFailed(GetRecordPtr^).hr;
end;
...
procedure __TFormatRange__Wrapper.sethdc(const val : hdc);
begin
TFormatRange(GetRecordPtr^).hdc := val;
end;
function __TFormatRange__Wrapper.gethdc : hdc;
begin
result := TFormatRange(GetRecordPtr^).hdc;
end;
procedure __TFormatRange__Wrapper.sethdcTarget(const val : hdc);
begin
TFormatRange(GetRecordPtr^).hdcTarget := val;
end;
function __TFormatRange__Wrapper.gethdcTarget : hdc;
begin
result := TFormatRange(GetRecordPtr^).hdcTarget;
end;
...
function __TTextRange__Wrapper.GetRecordPtr : pointer;
begin
result := @fR;
end;
procedure __TTextRange__Wrapper.setlpstrText(const val : AnsiChar);
begin
TTextRange(GetRecordPtr^).lpstrText := val;
end;
function __TTextRange__Wrapper.getlpstrText : AnsiChar;
begin
result := TTextRange(GetRecordPtr^).lpstrText;
end;
function __TTextRangeA__Wrapper.GetRecordPtr : pointer;
begin
result := @fR;
end;
procedure __TTextRangeA__Wrapper.setlpstrText(const val : AnsiChar);
begin
TTextRangeA(GetRecordPtr^).lpstrText := val;
end;
function __TTextRangeA__Wrapper.getlpstrText : AnsiChar;
begin
result := TTextRangeA(GetRecordPtr^).lpstrText;
end;
function __TTextRangeW__Wrapper.GetRecordPtr : pointer;
begin
result := @fR;
end;
procedure __TTextRangeW__Wrapper.setlpstrText(const val : WideChar);
begin
TTextRangeW(GetRecordPtr^).lpstrText := val;
end;
function __TTextRangeW__Wrapper.getlpstrText : WideChar;
begin
result := TTextRangeW(GetRecordPtr^).lpstrText;
end;
...
function _TTextRange_ : IDispatch;
begin
  result := __TTextRange__Wrapper.Create;
end;
...
type __TTextRange__Wrapper__ = class(__TTextRange__Wrapper)
private
fRPtr : pointer;
function GetRecordPtr : pointer; override;
end;
function __TTextRange__Wrapper__.GetRecordPtr : pointer;
begin
result := fRPtr;
end;
function ConvertTTextRangeToVariant(var R : TTextRange) : OleVariant;
var
__rw : __TTextRange__Wrapper__;
begin
__rw := __TTextRange__Wrapper__.Create;
__rw.fRPtr := @R;
result := IDispatch(__rw);
end;
function ConvertVariantToTTextRange(const V : OleVariant) : TTextRange;
...
_idisp := VarToInterface(v);
if _idisp = nil then exit;
result := TTextRange((_idisp as IDCRecordWrapper).GetRecordPtr^);
end;
...
procedure _mreg_0;
begin
__RegisteredMethods.Add(RegisterRWProc(MethodNames[0],Addr(_TCharFormat_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[1],Addr(_TCharFormat2_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[2],Addr(_TCharFormat2A_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[3],Addr(_TCharFormat2W_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[4],Addr(_TCharFormatA_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[5],Addr(_TCharFormatW_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[6],Addr(_TCharRange_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[7],Addr(_TCompColor_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[8],Addr(_TEditStream_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[9],Addr(_TENCorrectText_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[10],Addr(_TEndDropFiles_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[11],Addr(_TENLink_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[12],Addr(_TENOleOpFailed_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[13],Addr(_TENProtected_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[14],Addr(_TENSaveClipboard_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[15],Addr(_TFindText_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[16],Addr(_TFindTextA_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[17],Addr(_TFindTextExA_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[18],Addr(_TFindTextExW_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[19],Addr(_TFindTextW_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[20],Addr(_TFormatRange_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[21],Addr(_TGetTextEx_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[22],Addr(_TGetTextLengthEx_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[23],Addr(_TMsgFilter_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[24],Addr(_TObjectPositions_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[25],Addr(_TParaFormat_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[26],Addr(_TParaFormat2_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[27],Addr(_TPunctuation_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[28],Addr(_TRepasteSpecial_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[29],Addr(_TReqSize_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[30],Addr(_TSelChange_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[31],Addr(_TTextRange_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[32],Addr(_TTextRangeA_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[33],Addr(_TTextRangeW_)));
end;
initialization
