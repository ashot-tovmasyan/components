...
RegRegisterMethod(TCheckEdit,'GetWinStyle',TypeInfo(_T3),[TypeInfo(Integer)], pointer(188));

RegRegisterMethod(TCustomDCEdit,'RestoreSavedText',TypeInfo(_T4),NoParams, pointer(188));

RegRegisterMethod(TCustomDCEdit,'CheckReadOnly',TypeInfo(_T5),NoParams, pointer(192));

RegRegisterMethod(TCustomDCEdit,'GetText',TypeInfo(_T6),[TypeInfo(string)], pointer(196));
...
RegRegisterMethod(TCustomDCEdit,'SetDropValue',TypeInfo(_T9),NoParams, pointer(208));

RegRegisterMethod(TCustomDCEdit,'GetDropValue',TypeInfo(_T10),NoParams, pointer(212));

RegRegisterMethod(TCustomDCEdit,'GetModified',TypeInfo(_T11),[TypeInfo(Boolean)], pointer(216));

RegRegisterMethod(TCustomDCEdit,'GetReadOnly',TypeInfo(_T12),[TypeInfo(Boolean)], pointer(220));

RegRegisterMethod(TCustomDCEdit,'DoTerm',TypeInfo(_T14),NoParams, pointer(228));

RegRegisterMethod(TCustomDCEdit,'Change',TypeInfo(_T17),NoParams, pointer(240));
...
RegRegisterMethod(TCustomDCEdit,'Drop',TypeInfo(_T20),NoParams, pointer(244));

RegRegisterMethod(TCustomDCEdit,'CloseDropped',TypeInfo(_T21),[
TypeInfo(Boolean)], pointer(248));

RegRegisterMethod(TCustomDCEdit,'Term',TypeInfo(_T22),NoParams,Addr(TCustomDCEdit.Term));

RegRegisterMethod(TCustomFileDirEdit,'Button1Click',TypeInfo(_T23),[
TypeInfo(TObject)], pointer(252));

RegRegisterMethod(TDCDtEdit,'GetText',TypeInfo(_T24),[TypeInfo(string)], pointer(212));

RegRegisterMethod(TDCDtEdit,'SetText',TypeInfo(_T25),[
...
RegRegisterMethod(TGraphEdit,'GetGraphic',TypeInfo(_T27),[TypeInfo(TGraphic)], pointer(200));

RegRegisterMethod(TGraphicEdit,'PaintToCanvas',TypeInfo(_T28),[
TypeInfo(TCanvas),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(188));

RegRegisterMethod(TGraphicEdit,'SetText',TypeInfo(_T29),[
TypeInfo(string)], pointer(192));

RegRegisterMethod(TGraphicEdit,'GetText',TypeInfo(_T30),[TypeInfo(string)], pointer(196));

RegRegisterMethod(TPopupListBox,'Close',TypeInfo(_T31),[
TypeInfo(Boolean)], pointer(192));

RegRegisterMethod(TPopupListBox,'BuildList',TypeInfo(_T32),NoParams, pointer(196));
...
TypeInfo(TControlClass)], pointer(224))}

{RegRegisterMethod(TCustomDCEdit,'GetDefaultEditorClass',TypeInfo(_T15),[TypeInfo(TControlClass)], pointer(232))}

{RegRegisterMethod(TCustomDCEdit,'GetDefaultPopupClass',TypeInfo(_T16),[TypeInfo(TWinControlClass)], pointer(236))}
