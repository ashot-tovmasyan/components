...
function GetRecordPtr : pointer; override;
published
procedure setHandle(const val : HFont);
...
function GetRecordPtr : pointer; override;
published
procedure setHandle(const val : HBrush);
...
function GetRecordPtr : pointer; override;
published
procedure setHandle(const val : HPen);
...
_T58 = function (const p0 : string): IDispatch of object;

_T59 = function (const p0 : string): Integer of object;
...
_T63 = function : Boolean of object;
...
_T67 = procedure (p0 : TObject) of object;

_T68 = procedure (p0 : TCanvas;
const p1 : IDispatch) of object;

_T69 = function (p0 : TGraphic): Boolean of object;

_T70 = _T63;

_T71 = function : Integer of object;
...
_T76 = procedure (p0 : TStream) of object;

_T77 = procedure (p0 : Integer) of object;

_T78 = procedure (p0 : HPALETTE) of object;

_T79 = procedure (p0 : Boolean) of object;

_T80 = _T77;

_T81 = _T76;

_T82 = procedure (const p0 : string) of object;
...
_T86 = procedure (p0 : Word;
p1 : THandle;
p2 : HPALETTE) of object;

_T87 = procedure (var p0 : Word;
var p1 : THandle;
var p2 : HPALETTE) of object;

_T88 = _T14;

_T89 = function : HICON of object;

_T90 = _T14;

_T91 = function : HENHMETAFILE of object;

_T92 = procedure (p0 : TMetafile;
p1 : HDC) of object;

_T93 = procedure (p0 : TMetafile;
p1 : HDC;
const p2 : string;
const p3 : string) of object;
...
_T102 = function (p0 : Word): Boolean of object;

{_T103 = procedure (const p0 : string;
const p1 : string;
...
{_T105 = procedure (p0 : Word;
p1 : TGraphicClass) of object;}

{_T106 = procedure (p0 : TGraphicClass) of object;}
...
procedure __TFontData__Wrapper.setHandle(const val : HFont);
begin
TFontData(GetRecordPtr^).Handle := val;
end;
function __TFontData__Wrapper.getHandle : HFont;
begin
result := TFontData(GetRecordPtr^).Handle;
end;
...
procedure __TBrushData__Wrapper.setHandle(const val : HBrush);
begin
TBrushData(GetRecordPtr^).Handle := val;
end;
function __TBrushData__Wrapper.getHandle : HBrush;
begin
result := TBrushData(GetRecordPtr^).Handle;
end;
...
procedure __TPenData__Wrapper.setHandle(const val : HPen);
begin
TPenData(GetRecordPtr^).Handle := val;
end;
function __TPenData__Wrapper.getHandle : HPen;
begin
result := TPenData(GetRecordPtr^).Handle;
end;
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[60] ,fsBold));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[61] ,fsItalic));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[62] ,fsUnderline));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[63] ,fsStrikeOut));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[64] ,fpDefault));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[65] ,fpVariable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[66] ,fpFixed));
...
RegRegisterMethod(TCanvas,'Rectangle',TypeInfo(_T54),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TCanvas.Rectangle));

RegRegisterMethod(TCanvas,'Refresh',TypeInfo(_T55),NoParams,Addr(TCanvas.Refresh));

RegRegisterMethod(TCanvas,'RoundRect',TypeInfo(_T56),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
...
RegRegisterMethod(TCanvas,'StretchDraw',TypeInfo(_T57),[
TypeInfo(IDispatch),
TypeInfo(TGraphic)],Addr(__TCanvas__StretchDraw__Wrapper));

RegRegisterMethod(TCanvas,'TextExtent',TypeInfo(_T58),[
TypeInfo(string),TypeInfo(IDispatch)],Addr(__TCanvas__TextExtent__Wrapper));

RegRegisterMethod(TCanvas,'TextHeight',TypeInfo(_T59),[
TypeInfo(string),TypeInfo(Integer)],Addr(TCanvas.TextHeight));

RegRegisterMethod(TCanvas,'TextOut',TypeInfo(_T60),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(string)],Addr(TCanvas.TextOut));

RegRegisterMethod(TCanvas,'TextRect',TypeInfo(_T61),[
TypeInfo(IDispatch),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(string)],Addr(__TCanvas__TextRect__Wrapper));

RegRegisterMethod(TCanvas,'TextWidth',TypeInfo(_T62),[
TypeInfo(string),TypeInfo(Integer)],Addr(TCanvas.TextWidth));

RegRegisterMethod(TCanvas,'TryLock',TypeInfo(_T63),[TypeInfo(Boolean)],Addr(TCanvas.TryLock));

RegRegisterMethod(TCanvas,'Unlock',TypeInfo(_T64),NoParams,Addr(TCanvas.Unlock));

RegisterProc(TFont,'Create',mtConstructor,TypeInfo(_T65),NoParams,Addr(TFont.Create),cRegister);

RegisterProc(TGraphic,'Create',mtConstructor,TypeInfo(_T66),NoParams, pointer(12),cRegister);

RegRegisterMethod(TGraphic,'Changed',TypeInfo(_T67),[
TypeInfo(TObject)], pointer(16));

RegRegisterMethod(TGraphic,'Draw',TypeInfo(_T68),[
TypeInfo(TCanvas),
TypeInfo(IDispatch)], pointer(20));

RegRegisterMethod(TGraphic,'Equals',TypeInfo(_T69),[
TypeInfo(TGraphic),TypeInfo(Boolean)], pointer(24));

RegRegisterMethod(TGraphic,'GetEmpty',TypeInfo(_T70),[TypeInfo(Boolean)], pointer(28));

RegRegisterMethod(TGraphic,'GetHeight',TypeInfo(_T71),[TypeInfo(Integer)], pointer(32));

RegRegisterMethod(TGraphic,'GetPalette',TypeInfo(_T72),[TypeInfo(HPALETTE)], pointer(36));

RegRegisterMethod(TGraphic,'GetTransparent',TypeInfo(_T73),[TypeInfo(Boolean)], pointer(40));

RegRegisterMethod(TGraphic,'GetWidth',TypeInfo(_T74),[TypeInfo(Integer)], pointer(44));

RegRegisterMethod(TGraphic,'Progress',TypeInfo(_T75),[
TypeInfo(TObject),
...
RegRegisterMethod(TGraphic,'ReadData',TypeInfo(_T76),[
TypeInfo(TStream)], pointer(48));

RegRegisterMethod(TGraphic,'SetHeight',TypeInfo(_T77),[
TypeInfo(Integer)], pointer(52));

RegRegisterMethod(TGraphic,'SetPalette',TypeInfo(_T78),[
TypeInfo(HPALETTE)], pointer(56));

RegRegisterMethod(TGraphic,'SetTransparent',TypeInfo(_T79),[
TypeInfo(Boolean)], pointer(60));

RegRegisterMethod(TGraphic,'SetWidth',TypeInfo(_T80),[
TypeInfo(Integer)], pointer(64));

RegRegisterMethod(TGraphic,'WriteData',TypeInfo(_T81),[
TypeInfo(TStream)], pointer(68));

RegRegisterMethod(TGraphic,'LoadFromFile',TypeInfo(_T82),[
TypeInfo(string)], pointer(72));

RegRegisterMethod(TGraphic,'SaveToFile',TypeInfo(_T83),[
TypeInfo(string)], pointer(76));

RegRegisterMethod(TGraphic,'LoadFromStream',TypeInfo(_T84),[
TypeInfo(TStream)], pointer(80));

RegRegisterMethod(TGraphic,'SaveToStream',TypeInfo(_T85),[
TypeInfo(TStream)], pointer(84));

RegRegisterMethod(TGraphic,'LoadFromClipboardFormat',TypeInfo(_T86),[
TypeInfo(Word),
TypeInfo(THandle),
TypeInfo(HPALETTE)], pointer(88));

RegRegisterMethod(TGraphic,'SaveToClipboardFormat',TypeInfo(_T87),[
TypeInfo(Word),
TypeInfo(THandle),
TypeInfo(HPALETTE)], pointer(92));

RegRegisterMethod(TGraphicsObject,'Changed',TypeInfo(_T88),NoParams, pointer(MinVMTOffset - 2));

RegRegisterMethod(TIcon,'ReleaseHandle',TypeInfo(_T89),[TypeInfo(HICON)],Addr(TIcon.ReleaseHandle));

RegRegisterMethod(TMetafile,'Clear',TypeInfo(_T90),NoParams,Addr(TMetafile.Clear));

RegRegisterMethod(TMetafile,'ReleaseHandle',TypeInfo(_T91),[TypeInfo(HENHMETAFILE)],Addr(TMetafile.ReleaseHandle));

RegisterProc(TMetafileCanvas,'Create',mtConstructor,TypeInfo(_T92),[
TypeInfo(TMetafile),
TypeInfo(HDC)],Addr(TMetafileCanvas.Create),cRegister);

RegisterProc(TMetafileCanvas,'CreateWithComment',mtConstructor,TypeInfo(_T93),[
TypeInfo(TMetafile),
TypeInfo(HDC),
TypeInfo(string),
TypeInfo(string)],Addr(TMetafileCanvas.CreateWithComment),cRegister);

RegisterProc(TPen,'Create',mtConstructor,TypeInfo(_T94),NoParams,Addr(TPen.Create),cRegister);

RegRegisterMethod(TPicture,'Changed',TypeInfo(_T95),[
TypeInfo(TObject)], pointer(MinVMTOffset - 2));

RegRegisterMethod(TPicture,'Progress',TypeInfo(_T96),[
TypeInfo(TObject),
TypeInfo(TProgressStage),
TypeInfo(Byte),
TypeInfo(Boolean),
...
RegisterProc(TPicture,'Create',mtConstructor,TypeInfo(_T97),NoParams,Addr(TPicture.Create),cRegister);

RegRegisterMethod(TPicture,'LoadFromFile',TypeInfo(_T98),[
TypeInfo(string)],Addr(TPicture.LoadFromFile));

RegRegisterMethod(TPicture,'SaveToFile',TypeInfo(_T99),[
TypeInfo(string)],Addr(TPicture.SaveToFile));

RegRegisterMethod(TPicture,'LoadFromClipboardFormat',TypeInfo(_T100),[
TypeInfo(Word),
TypeInfo(THandle),
TypeInfo(HPALETTE)],Addr(TPicture.LoadFromClipboardFormat));

RegRegisterMethod(TPicture,'SaveToClipboardFormat',TypeInfo(_T101),[
TypeInfo(Word),
TypeInfo(THandle),
TypeInfo(HPALETTE)],Addr(TPicture.SaveToClipboardFormat));

RegisterProc(TPicture,'SupportsClipboardFormat',mtClassMethod,TypeInfo(_T102),[
TypeInfo(Word),TypeInfo(Boolean)],Addr(TPicture.SupportsClipboardFormat),cRegister);

RegRegisterMethod(TSharedImage,'FreeHandle',TypeInfo(_T107),NoParams, pointer(0));
...
{RegisterProc(TPicture,'RegisterFileFormat',mtClassMethod,TypeInfo(_T103),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(TGraphicClass)],Addr(TPicture.RegisterFileFormat),cRegister)}

{RegisterProc(TPicture,'RegisterFileFormatRes',mtClassMethod,TypeInfo(_T104),[
TypeInfo(string),
TypeInfo(Integer),
TypeInfo(TGraphicClass)],Addr(TPicture.RegisterFileFormatRes),cRegister)}

{RegisterProc(TPicture,'RegisterClipboardFormat',mtClassMethod,TypeInfo(_T105),[
TypeInfo(Word),
TypeInfo(TGraphicClass)],Addr(TPicture.RegisterClipboardFormat),cRegister)}

{RegisterProc(TPicture,'UnregisterGraphicClass',mtClassMethod,TypeInfo(_T106),[
