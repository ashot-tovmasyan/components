...
_T44 = procedure (p0 : TDragDockObject;
p1 : Integer;
p2 : Integer) of object;
...
RegRegisterMethod(TControl,'UpdateLastResize',TypeInfo(_T33),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(48));

RegRegisterMethod(TControl,'ActionChange',TypeInfo(_T34),[
TypeInfo(TObject),
TypeInfo(Boolean)], pointer(MinVMTOffset - 15));

RegRegisterMethod(TControl,'AdjustSize',TypeInfo(_T35),NoParams, pointer(MinVMTOffset - 16));

RegRegisterMethod(TControl,'BeginAutoDrag',TypeInfo(_T36),NoParams, pointer(MinVMTOffset - 17));

RegRegisterMethod(TControl,'CanResize',TypeInfo(_T37),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(Boolean)], pointer(52));

RegRegisterMethod(TControl,'CanAutoSize',TypeInfo(_T38),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(Boolean)], pointer(56));

RegRegisterMethod(TControl,'ChangeScale',TypeInfo(_T39),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(MinVMTOffset - 18));

RegRegisterMethod(TControl,'Click',TypeInfo(_T40),NoParams, pointer(MinVMTOffset - 19));

RegRegisterMethod(TControl,'ConstrainedResize',TypeInfo(_T41),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(60));

RegRegisterMethod(TControl,'DblClick',TypeInfo(_T42),NoParams, pointer(MinVMTOffset - 20));

RegRegisterMethod(TControl,'DefaultDockImage',TypeInfo(_T43),[
TypeInfo(TDragDockObject),
TypeInfo(Boolean)], pointer(MinVMTOffset - 21));

RegRegisterMethod(TControl,'DockTrackNoTarget',TypeInfo(_T44),[
TypeInfo(TDragDockObject),
TypeInfo(Integer),
...
TypeInfo(IDispatch)], pointer(MinVMTOffset - 24));

RegRegisterMethod(TControl,'DoStartDock',TypeInfo(_T47),[
TypeInfo(TDragObject)], pointer(MinVMTOffset - 25));

RegRegisterMethod(TControl,'DragCanceled',TypeInfo(_T48),NoParams, pointer(MinVMTOffset - 26));
...
TypeInfo(TDragObject)], pointer(MinVMTOffset - 29));
...
RegRegisterMethod(TControl,'GetClientOrigin',TypeInfo(_T55),[TypeInfo(IDispatch)], pointer(64));

RegRegisterMethod(TControl,'GetClientRect',TypeInfo(_T56),[TypeInfo(IDispatch)], pointer(68));
...
TypeInfo(IDispatch),TypeInfo(TAlign)], pointer(MinVMTOffset - 33));

RegRegisterMethod(TControl,'GetDragImages',TypeInfo(_T59),[TypeInfo(TDragImageList)], pointer(76));

RegRegisterMethod(TControl,'GetEnabled',TypeInfo(_T60),[TypeInfo(Boolean)], pointer(80));

RegRegisterMethod(TControl,'GetFloating',TypeInfo(_T61),[TypeInfo(Boolean)], pointer(84));

RegRegisterMethod(TControl,'GetPalette',TypeInfo(_T63),[TypeInfo(HPALETTE)], pointer(MinVMTOffset - 34));

RegRegisterMethod(TControl,'GetPopupMenu',TypeInfo(_T64),[TypeInfo(TPopupMenu)], pointer(MinVMTOffset - 35));
...
TypeInfo(TDragDockObject)], pointer(MinVMTOffset - 39));

RegRegisterMethod(TControl,'PaletteChanged',TypeInfo(_T69),[
TypeInfo(Boolean),TypeInfo(Boolean)], pointer(MinVMTOffset - 40));

RegRegisterMethod(TControl,'RequestAlign',TypeInfo(_T70),NoParams, pointer(MinVMTOffset - 41));

RegRegisterMethod(TControl,'Resize',TypeInfo(_T71),NoParams, pointer(MinVMTOffset - 42));

RegRegisterMethod(TControl,'SetDragMode',TypeInfo(_T72),[
TypeInfo(TDragMode)], pointer(92));

RegRegisterMethod(TControl,'SetEnabled',TypeInfo(_T73),[
TypeInfo(Boolean)], pointer(96));

RegRegisterMethod(TControl,'SetParent',TypeInfo(_T74),[
TypeInfo(TWinControl)], pointer(100));

RegRegisterMethod(TControl,'SetParentBiDiMode',TypeInfo(_T75),[
TypeInfo(Boolean)], pointer(104));

RegRegisterMethod(TControl,'SetBiDiMode',TypeInfo(_T76),[
TypeInfo(TBiDiMode)], pointer(108));

RegRegisterMethod(TControl,'SetZOrder',TypeInfo(_T77),[
TypeInfo(Boolean)], pointer(MinVMTOffset - 43));

RegRegisterMethod(TControl,'VisibleChanging',TypeInfo(_T78),NoParams, pointer(MinVMTOffset - 44));

RegRegisterMethod(TControl,'WndProc',TypeInfo(_T79),[
TypeInfo(IDispatch)], pointer(112));
...
TypeInfo(TWinControl),
TypeInfo(IDispatch)], pointer(MinVMTOffset - 45));
...
TypeInfo(TObject),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(MinVMTOffset - 46));
...
RegRegisterMethod(TControl,'GetControlsAlignment',TypeInfo(_T89),[TypeInfo(TAlignment)], pointer(MinVMTOffset - 47));
...
RegRegisterMethod(TControl,'InitiateAction',TypeInfo(_T93),NoParams, pointer(116));

RegRegisterMethod(TControl,'Invalidate',TypeInfo(_T94),NoParams, pointer(120));
...
RegRegisterMethod(TControl,'Repaint',TypeInfo(_T100),NoParams, pointer(124));
...
RegRegisterMethod(TControl,'Update',TypeInfo(_T107),NoParams, pointer(132));

RegRegisterMethod(TControl,'UseRightToLeftAlignment',TypeInfo(_T108),[TypeInfo(Boolean)], pointer(MinVMTOffset - 48));
...
TypeInfo(string),TypeInfo(Boolean)], pointer(92));
...
RegRegisterMethod(TCustomControl,'Paint',TypeInfo(_T114),NoParams, pointer(184));
...
TypeInfo(TWinControl)],Addr(TDockTree.Create),cRegister);

RegRegisterMethod(TDockTree,'PaintSite',TypeInfo(_T125),[
TypeInfo(HDC)], pointer(36));
...
RegRegisterMethod(TGraphicControl,'Paint',TypeInfo(_T149),NoParams, pointer(136));

RegRegisterMethod(THintWindow,'ActivateHint',TypeInfo(_T150),[
TypeInfo(IDispatch),
TypeInfo(string)], pointer(188));

RegRegisterMethod(THintWindow,'ActivateHintData',TypeInfo(_T151),[
TypeInfo(IDispatch),
TypeInfo(string),
TypeInfoPointer], pointer(192));

RegRegisterMethod(THintWindow,'CalcHintRect',TypeInfo(_T152),[
TypeInfo(Integer),
TypeInfo(string),
TypeInfoPointer,TypeInfo(IDispatch)], pointer(196));
...
RegRegisterMethod(TWinControl,'CreateHandle',TypeInfo(_T162),NoParams, pointer(144));
...
RegRegisterMethod(TWinControl,'CreateWnd',TypeInfo(_T165),NoParams, pointer(156));

RegRegisterMethod(TWinControl,'DestroyWindowHandle',TypeInfo(_T166),NoParams, pointer(160));

RegRegisterMethod(TWinControl,'DestroyWnd',TypeInfo(_T167),NoParams, pointer(164));

RegRegisterMethod(TWinControl,'DoAddDockClient',TypeInfo(_T168),[
TypeInfo(TControl),
TypeInfo(IDispatch)], pointer(MinVMTOffset - 50));
...
RegRegisterMethod(TWinControl,'DoEnter',TypeInfo(_T171),NoParams, pointer(MinVMTOffset - 53));

RegRegisterMethod(TWinControl,'DoExit',TypeInfo(_T172),NoParams, pointer(MinVMTOffset - 54));

RegRegisterMethod(TWinControl,'DoFlipChildren',TypeInfo(_T173),NoParams, pointer(MinVMTOffset - 55));

RegRegisterMethod(TWinControl,'DoMouseWheel',TypeInfo(_T174),[
TypeInfo(TShiftState),
TypeInfo(Integer),
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(MinVMTOffset - 56));
...
TypeInfo(TControl)], pointer(MinVMTOffset - 59));

RegRegisterMethod(TWinControl,'DoUnDock',TypeInfo(_T178),[
TypeInfo(TWinControl),
TypeInfo(TControl),TypeInfo(Boolean)], pointer(MinVMTOffset - 60));

RegRegisterMethod(TWinControl,'GetControlExtents',TypeInfo(_T179),[TypeInfo(IDispatch)], pointer(168));

RegRegisterMethod(TWinControl,'GetSiteInfo',TypeInfo(_T180),[
TypeInfo(TControl),
TypeInfo(IDispatch),
TypeInfo(IDispatch),
TypeInfo(Boolean)], pointer(MinVMTOffset - 61));

RegRegisterMethod(TWinControl,'KeyDown',TypeInfo(_T181),[
TypeInfo(Word),
TypeInfo(TShiftState)], pointer(MinVMTOffset - 62));
...
RegRegisterMethod(TWinControl,'CanFocus',TypeInfo(_T190),[TypeInfo(Boolean)],Addr(TWinControl.CanFocus));
...
RegRegisterMethod(TWinControl,'ControlAtPos',TypeInfo(_T192),[
TypeInfo(IDispatch),
...
TypeInfo(TDragDockObject),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(MinVMTOffset - 66));
...
TypeInfo(Boolean)], pointer(MinVMTOffset - 67));

RegRegisterMethod(TWinControl,'Focused',TypeInfo(_T198),[TypeInfo(Boolean)], pointer(MinVMTOffset - 68));

RegRegisterMethod(TWinControl,'GetTabOrderList',TypeInfo(_T199),[
TypeInfo(TList)], pointer(MinVMTOffset - 69));
...
TypeInfo(IDispatch)], pointer(MinVMTOffset - 70));
...
RegRegisterMethod(TWinControl,'SetFocus',TypeInfo(_T209),NoParams, pointer(180));
...
{RegRegisterMethod(TControl,'GetActionLinkClass',TypeInfo(_T54),[TypeInfo(TControlActionLinkClass)], pointer(MinVMTOffset - 32))}

{RegRegisterMethod(TControl,'GetFloatingDockSiteClass',TypeInfo(_T62),[TypeInfo(TWinControlClass)], pointer(88))}
...
{RegRegisterMethod(TWinControl,'CreateDockManager',TypeInfo(_T161),[TypeInfo(IDockManager)], pointer(MinVMTOffset - 49))}
