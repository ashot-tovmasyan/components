...
RegRegisterMethod(TCheckEdit,'GetWinStyle',TypeInfo(_T3),[TypeInfo(Integer)], pointer(184));

RegRegisterMethod(TCustomDCEdit,'RestoreSavedText',TypeInfo(_T4),NoParams, pointer(184));

RegRegisterMethod(TCustomDCEdit,'CheckReadOnly',TypeInfo(_T5),NoParams, pointer(188));

RegRegisterMethod(TCustomDCEdit,'GetText',TypeInfo(_T6),[TypeInfo(string)], pointer(192));
...
RegRegisterMethod(TCustomDCEdit,'SetDropValue',TypeInfo(_T9),NoParams, pointer(204));

RegRegisterMethod(TCustomDCEdit,'GetDropValue',TypeInfo(_T10),NoParams, pointer(208));

RegRegisterMethod(TCustomDCEdit,'GetModified',TypeInfo(_T11),[TypeInfo(Boolean)], pointer(212));

RegRegisterMethod(TCustomDCEdit,'GetReadOnly',TypeInfo(_T12),[TypeInfo(Boolean)], pointer(216));

RegRegisterMethod(TCustomDCEdit,'DoTerm',TypeInfo(_T14),NoParams, pointer(224));

RegRegisterMethod(TCustomDCEdit,'Change',TypeInfo(_T17),NoParams, pointer(236));
...
RegRegisterMethod(TCustomDCEdit,'Drop',TypeInfo(_T20),NoParams, pointer(240));
...
TypeInfo(TObject)], pointer(248));

RegRegisterMethod(TDCDtEdit,'GetText',TypeInfo(_T24),[TypeInfo(string)], pointer(208));
...
RegRegisterMethod(TGraphEdit,'GetGraphic',TypeInfo(_T27),[TypeInfo(TGraphic)], pointer(196));
...
RegRegisterMethod(TGraphicEdit,'GetText',TypeInfo(_T30),[TypeInfo(string)], pointer(192));

RegRegisterMethod(TPopupListBox,'Close',TypeInfo(_T31),[
TypeInfo(Boolean)], pointer(188));

RegRegisterMethod(TPopupListBox,'BuildList',TypeInfo(_T32),NoParams, pointer(192));
...
TypeInfo(TControlClass)], pointer(220))}

{RegRegisterMethod(TCustomDCEdit,'GetDefaultEditorClass',TypeInfo(_T15),[TypeInfo(TControlClass)], pointer(228))}

{RegRegisterMethod(TCustomDCEdit,'GetDefaultPopupClass',TypeInfo(_T16),[TypeInfo(TWinControlClass)], pointer(232))}
