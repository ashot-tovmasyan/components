...
RegRegisterMethod(TCustomDBGrid,'DefineFieldMap',TypeInfo(_T32),NoParams, pointer(144));
...
TypeInfo(Integer),
TypeInfo(string),
TypeInfo(TGridDrawState),TypeInfo(Boolean)], pointer(148));

RegRegisterMethod(TCustomDBGrid,'LayoutChanged',TypeInfo(_T37),NoParams, pointer(152));
...
TypeInfo(Integer)], pointer(160));

RegRegisterMethod(TCustomDBGrid,'SetColumnAttributes',TypeInfo(_T40),NoParams, pointer(164));
