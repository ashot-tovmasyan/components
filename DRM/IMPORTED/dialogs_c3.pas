...
_T23 = function : IDispatch of object;
...
RegRegisterMethod(TCommonDialog,'DoClose',TypeInfo(_T9),NoParams, pointer(MinVMTOffset - 13));

RegRegisterMethod(TCommonDialog,'DoShow',TypeInfo(_T10),NoParams, pointer(MinVMTOffset - 14));
...
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(48));

RegRegisterMethod(TCommonDialog,'TaskModalDialog',TypeInfo(_T13),[
TypeInfoPointer,
TypeInfoUntyped,TypeInfo(Bool)], pointer(52));

RegRegisterMethod(TCommonDialog,'Execute',TypeInfo(_T14),[TypeInfo(Boolean)], pointer(56));

RegRegisterMethod(TFindDialog,'Find',TypeInfo(_T15),NoParams, pointer(MinVMTOffset - 15));

RegRegisterMethod(TFindDialog,'Replace',TypeInfo(_T16),NoParams, pointer(MinVMTOffset - 16));
...
TypeInfo(HWnd)], pointer(MinVMTOffset - 15));

RegRegisterMethod(TOpenDialog,'DoCanClose',TypeInfo(_T19),[TypeInfo(Boolean)], pointer(MinVMTOffset - 15));

RegRegisterMethod(TOpenDialog,'DoSelectionChange',TypeInfo(_T20),NoParams, pointer(MinVMTOffset - 16));

RegRegisterMethod(TOpenDialog,'DoFolderChange',TypeInfo(_T21),NoParams, pointer(MinVMTOffset - 17));

RegRegisterMethod(TOpenDialog,'DoTypeChange',TypeInfo(_T22),NoParams, pointer(MinVMTOffset - 18));

RegRegisterMethod(TOpenDialog,'GetStaticRect',TypeInfo(_T23),[TypeInfo(IDispatch)], pointer(60));
