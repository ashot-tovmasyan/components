...
_T99 = function : HICON of object;

_T100 = _T14;

_T101 = _T29;

_T102 = function : HENHMETAFILE of object;

_T103 = procedure (p0 : TMetafile;
p1 : HDC) of object;

_T104 = procedure (p0 : TMetafile;
p1 : HDC;
const p2 : string;
const p3 : string) of object;
...
_T106 = procedure (p0 : TPen) of object;
...
_T114 = function (p0 : Word): Boolean of object;

{_T115 = procedure (const p0 : string;
const p1 : string;
...
{_T117 = procedure (p0 : Word;
p1 : TGraphicClass) of object;}

{_T118 = procedure (p0 : TGraphicClass) of object;}
...
const __ConstNames0 : array[0..131] of string = (
'clScrollBar'
,'clBackground'
,'clActiveCaption'
,'clInactiveCaption'
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[25] ,clGradientActiveCaption));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[26] ,clGradientInactiveCaption));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[27] ,clBlack));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[28] ,clMaroon));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[29] ,clGreen));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[30] ,clOlive));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[31] ,clNavy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[32] ,clPurple));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[33] ,clTeal));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[34] ,clGray));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[35] ,clSilver));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[36] ,clRed));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[37] ,clLime));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[38] ,clYellow));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[39] ,clBlue));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[40] ,clFuchsia));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[41] ,clAqua));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[42] ,clLtGray));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[43] ,clDkGray));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[44] ,clWhite));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[45] ,StandardColorsCount));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[46] ,clMoneyGreen));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[47] ,clSkyBlue));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[48] ,clCream));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[49] ,clMedGray));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[50] ,ExtendedColorsCount));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[51] ,clNone));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[52] ,clDefault));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[53] ,cmBlackness));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[54] ,cmDstInvert));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[55] ,cmMergeCopy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[56] ,cmMergePaint));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[57] ,cmNotSrcCopy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[58] ,cmNotSrcErase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[59] ,cmPatCopy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[60] ,cmPatInvert));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[61] ,cmPatPaint));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[62] ,cmSrcAnd));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[63] ,cmSrcCopy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[64] ,cmSrcErase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[65] ,cmSrcInvert));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[66] ,cmSrcPaint));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[67] ,cmWhiteness));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[68] ,fpDefault));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[69] ,fpVariable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[70] ,fpFixed));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[71] ,fsBold));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[72] ,fsItalic));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[73] ,fsUnderline));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[74] ,fsStrikeOut));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[75] ,psSolid));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[76] ,psDash));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[77] ,psDot));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[78] ,psDashDot));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[79] ,psDashDotDot));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[80] ,psClear));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[81] ,psInsideFrame));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[82] ,pmBlack));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[83] ,pmWhite));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[84] ,pmNop));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[85] ,pmNot));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[86] ,pmCopy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[87] ,pmNotCopy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[88] ,pmMergePenNot));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[89] ,pmMaskPenNot));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[90] ,pmMergeNotPen));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[91] ,pmMaskNotPen));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[92] ,pmMerge));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[93] ,pmNotMerge));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[94] ,pmMask));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[95] ,pmNotMask));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[96] ,pmXor));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[97] ,pmNotXor));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[98] ,bsSolid));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[99] ,bsClear));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[100] ,bsHorizontal));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[101] ,bsVertical));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[102] ,bsFDiagonal));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[103] ,bsBDiagonal));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[104] ,bsCross));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[105] ,bsDiagCross));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[106] ,fsSurface));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[107] ,fsBorder));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[108] ,fmAlternate));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[109] ,fmWinding));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[110] ,csHandleValid));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[111] ,csFontValid));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[112] ,csPenValid));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[113] ,csBrushValid));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[114] ,coLeftToRight));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[115] ,coRightToLeft));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[116] ,psStarting));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[117] ,psRunning));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[118] ,psEnding));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[119] ,bmDIB));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[120] ,bmDDB));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[121] ,pfDevice));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[122] ,pf1bit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[123] ,pf4bit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[124] ,pf8bit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[125] ,pf15bit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[126] ,pf16bit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[127] ,pf24bit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[128] ,pf32bit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[129] ,pfCustom));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[130] ,tmAuto));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[131] ,tmFixed));
end;
...
RegRegisterMethod(TBitmap,'GetHandle',TypeInfo(_T24),[TypeInfo(HBITMAP)], pointer(100));

RegRegisterMethod(TBitmap,'GetMaskHandle',TypeInfo(_T25),[TypeInfo(HBITMAP)], pointer(104));

RegRegisterMethod(TBitmap,'SetHandleType',TypeInfo(_T26),[
TypeInfo(TBitmapHandleType)], pointer(108));
...
RegRegisterMethod(TGraphic,'Changed',TypeInfo(_T74),[
TypeInfo(TObject)], pointer(16));

RegRegisterMethod(TGraphic,'Draw',TypeInfo(_T75),[
TypeInfo(TCanvas),
TypeInfo(IDispatch)], pointer(20));

RegRegisterMethod(TGraphic,'Equals',TypeInfo(_T76),[
...
RegRegisterMethod(TGraphic,'ReadData',TypeInfo(_T83),[
TypeInfo(TStream)], pointer(48));

RegRegisterMethod(TGraphic,'SetHeight',TypeInfo(_T84),[
TypeInfo(Integer)], pointer(52));

RegRegisterMethod(TGraphic,'SetPalette',TypeInfo(_T85),[
TypeInfo(HPALETTE)], pointer(56));

RegRegisterMethod(TGraphic,'SetTransparent',TypeInfo(_T86),[
TypeInfo(Boolean)], pointer(60));

RegRegisterMethod(TGraphic,'SetWidth',TypeInfo(_T87),[
TypeInfo(Integer)], pointer(64));

RegRegisterMethod(TGraphic,'WriteData',TypeInfo(_T88),[
TypeInfo(TStream)], pointer(68));

RegisterProc(TGraphic,'Create',mtConstructor,TypeInfo(_T89),NoParams, pointer(72),cRegister);

RegRegisterMethod(TGraphic,'LoadFromFile',TypeInfo(_T90),[
TypeInfo(string)], pointer(76));

RegRegisterMethod(TGraphic,'SaveToFile',TypeInfo(_T91),[
TypeInfo(string)], pointer(80));

RegRegisterMethod(TGraphic,'LoadFromStream',TypeInfo(_T92),[
TypeInfo(TStream)], pointer(84));

RegRegisterMethod(TGraphic,'SaveToStream',TypeInfo(_T93),[
TypeInfo(TStream)], pointer(88));

RegRegisterMethod(TGraphic,'LoadFromClipboardFormat',TypeInfo(_T94),[
TypeInfo(Word),
TypeInfo(THandle),
TypeInfo(HPALETTE)], pointer(92));

RegRegisterMethod(TGraphic,'SaveToClipboardFormat',TypeInfo(_T95),[
TypeInfo(Word),
TypeInfo(THandle),
TypeInfo(HPALETTE)], pointer(96));

RegRegisterMethod(TGraphicsObject,'Changed',TypeInfo(_T96),NoParams, pointer(MinVMTOffset - 2));

RegRegisterMethod(TGraphicsObject,'HandleAllocated',TypeInfo(_T97),[TypeInfo(Boolean)],Addr(TGraphicsObject.HandleAllocated));

RegRegisterMethod(TIcon,'HandleAllocated',TypeInfo(_T98),[TypeInfo(Boolean)],Addr(TIcon.HandleAllocated));

RegRegisterMethod(TIcon,'ReleaseHandle',TypeInfo(_T99),[TypeInfo(HICON)],Addr(TIcon.ReleaseHandle));

RegRegisterMethod(TMetafile,'Clear',TypeInfo(_T100),NoParams,Addr(TMetafile.Clear));

RegRegisterMethod(TMetafile,'HandleAllocated',TypeInfo(_T101),[TypeInfo(Boolean)],Addr(TMetafile.HandleAllocated));

RegRegisterMethod(TMetafile,'ReleaseHandle',TypeInfo(_T102),[TypeInfo(HENHMETAFILE)],Addr(TMetafile.ReleaseHandle));

RegisterProc(TMetafileCanvas,'Create',mtConstructor,TypeInfo(_T103),[
TypeInfo(TMetafile),
TypeInfo(HDC)],Addr(TMetafileCanvas.Create),cRegister);

RegisterProc(TMetafileCanvas,'CreateWithComment',mtConstructor,TypeInfo(_T104),[
TypeInfo(TMetafile),
TypeInfo(HDC),
TypeInfo(string),
TypeInfo(string)],Addr(TMetafileCanvas.CreateWithComment),cRegister);

RegisterProc(TPen,'Create',mtConstructor,TypeInfo(_T105),NoParams,Addr(TPen.Create),cRegister);

RegisterProc(TPenRecall,'Create',mtConstructor,TypeInfo(_T106),[
TypeInfo(TPen)],Addr(TPenRecall.Create),cRegister);

RegRegisterMethod(TPicture,'Changed',TypeInfo(_T107),[
TypeInfo(TObject)], pointer(MinVMTOffset - 2));

RegRegisterMethod(TPicture,'Progress',TypeInfo(_T108),[
TypeInfo(TObject),
TypeInfo(TProgressStage),
TypeInfo(Byte),
TypeInfo(Boolean),
...
RegisterProc(TPicture,'Create',mtConstructor,TypeInfo(_T109),NoParams,Addr(TPicture.Create),cRegister);

RegRegisterMethod(TPicture,'LoadFromFile',TypeInfo(_T110),[
TypeInfo(string)],Addr(TPicture.LoadFromFile));

RegRegisterMethod(TPicture,'SaveToFile',TypeInfo(_T111),[
TypeInfo(string)],Addr(TPicture.SaveToFile));

RegRegisterMethod(TPicture,'LoadFromClipboardFormat',TypeInfo(_T112),[
TypeInfo(Word),
TypeInfo(THandle),
TypeInfo(HPALETTE)],Addr(TPicture.LoadFromClipboardFormat));

RegRegisterMethod(TPicture,'SaveToClipboardFormat',TypeInfo(_T113),[
TypeInfo(Word),
TypeInfo(THandle),
TypeInfo(HPALETTE)],Addr(TPicture.SaveToClipboardFormat));

RegisterProc(TPicture,'SupportsClipboardFormat',mtClassMethod,TypeInfo(_T114),[
TypeInfo(Word),TypeInfo(Boolean)],Addr(TPicture.SupportsClipboardFormat),cRegister);

RegRegisterMethod(TSharedImage,'FreeHandle',TypeInfo(_T119),NoParams, pointer(0));
...
{RegisterProc(TPicture,'RegisterFileFormat',mtClassMethod,TypeInfo(_T115),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(TGraphicClass)],Addr(TPicture.RegisterFileFormat),cRegister)}

{RegisterProc(TPicture,'RegisterFileFormatRes',mtClassMethod,TypeInfo(_T116),[
TypeInfo(string),
TypeInfo(Integer),
TypeInfo(TGraphicClass)],Addr(TPicture.RegisterFileFormatRes),cRegister)}

{RegisterProc(TPicture,'RegisterClipboardFormat',mtClassMethod,TypeInfo(_T117),[
TypeInfo(Word),
TypeInfo(TGraphicClass)],Addr(TPicture.RegisterClipboardFormat),cRegister)}

{RegisterProc(TPicture,'UnregisterGraphicClass',mtClassMethod,TypeInfo(_T118),[
