...
procedure __TScriptErrorInfo__Wrapper.setFileName(const val : TFileName);
begin
TScriptErrorInfo(GetRecordPtr^).FileName := val;
end;
function __TScriptErrorInfo__Wrapper.getFileName : TFileName;
begin
result := TScriptErrorInfo(GetRecordPtr^).FileName;
end;
...
TypeInfo(TStrings)], pointer(40));

RegRegisterMethod(TCodeDesigner,'GetStrings',TypeInfo(_T283),[TypeInfo(TStrings)], pointer(44));
...
RegRegisterMethod(TCodeDesigner,'DeleteEmptyMethods',TypeInfo(_T290),NoParams, pointer(72));

RegRegisterMethod(TCodeDesigner,'MethodExists',TypeInfo(_T292),[
TypeInfo(String),TypeInfo(Boolean)], pointer(80));
...
TypeInfo(TComponent)], pointer(88));
...
TypeInfo(String),TypeInfo(TMethodState)], pointer(100));
...
RegRegisterMethod(TCodeDesigner,'AutoFillUses',TypeInfo(_T300),[TypeInfo(Boolean)], pointer(112));
...
TypeInfo(Integer),TypeInfo(String)], pointer(124));

RegRegisterMethod(TCodeDesigner,'GetDelimiters',TypeInfo(_T304),[TypeInfo(String)], pointer(128));
...
RegRegisterMethod(TDCSimpleScripter,'BeginDesign',TypeInfo(_T314),NoParams, pointer(40));

RegRegisterMethod(TDCSimpleScripter,'EndDesign',TypeInfo(_T315),NoParams, pointer(44));
...
TypeInfo(String),
TypeInfo(String)], pointer(52));

RegRegisterMethod(TDCSimpleScripter,'EventDeleted',TypeInfo(_T318),NoParams, pointer(56));

RegRegisterMethod(TEditSource,'GetValue',TypeInfo(_T319),[TypeInfo(String)], pointer(40));

RegRegisterMethod(TEditSource,'SetValue',TypeInfo(_T320),[
TypeInfo(String)], pointer(44));

RegRegisterMethod(TEditSource,'StartEdit',TypeInfo(_T321),NoParams, pointer(MinVMTOffset - 14));
...
RegRegisterMethod(TFileSystem,'GetCurrentDir',TypeInfo(_T324),[TypeInfo(String)], pointer(48));
...
TypeInfo(TFileName),
TypeInfo(Integer),TypeInfo(TStream)], pointer(56));

RegRegisterMethod(TFileSystem,'FileAge',TypeInfo(_T327),[
TypeInfo(TFileName),TypeInfo(Integer)], pointer(60));

RegRegisterMethod(TFileSystem,'RenameFile',TypeInfo(_T328),[
TypeInfo(TFileName),
TypeInfo(TFileName),TypeInfo(Boolean)], pointer(64));
...
TypeInfo(TFileName),TypeInfo(TFileName)], pointer(80));

RegRegisterMethod(TFileSystem,'GetBackupFileName',TypeInfo(_T333),[
TypeInfo(TFileName),TypeInfo(TFileName)], pointer(84));

RegRegisterMethod(TFileSystem,'GetFileSystemLevel',TypeInfo(_T334),[TypeInfo(TFileSystemLevel)], pointer(88));

RegRegisterMethod(TFileSystem,'ChangeFileExt',TypeInfo(_T335),[
TypeInfo(String),
TypeInfo(String),TypeInfo(String)], pointer(92));
...
TypeInfo(Integer),TypeInfo(TFont)], pointer(44));

RegRegisterMethod(TSimpleParser,'GetBackColor',TypeInfo(_T378),[
TypeInfo(Integer),
TypeInfo(TColor),TypeInfo(Boolean)], pointer(48));
...
RegRegisterMethod(TSimpleParser,'StoreColorData',TypeInfo(_T380),[TypeInfo(Boolean)], pointer(56));
...
{RegRegisterMethod(TCodeDesigner,'GetSyntaxParserClass',TypeInfo(_T285),[TypeInfo(TSimpleParserClass)], pointer(52))}

{RegRegisterMethod(TCodeDesigner,'CreateMethod',TypeInfo(_T286),[
TypeInfo(String),
TypeInfoPointer], pointer(56))}
