...
procedure setWndParent(const val : HWND);
function getWndParent : HWND;
property WndParent : HWND read getWndParent write setWndParent;
end;
...
function GetRecordPtr : pointer; override;
published
procedure setHWND(const val : HWND);
function getHWND : HWND;
property HWND : HWND read getHWND write setHWND;
...
_T48 = procedure (p0 : TDragMode) of object;

_T49 = procedure (p0 : TWinControl) of object;

_T50 = procedure (p0 : Boolean) of object;

_T51 = _T6;

_T52 = procedure (const p0 : IDispatch) of object;

_T53 = _T50;

_T54 = _T6;

_T55 = function (const p0 : IDispatch): IDispatch of object;
...
{_T59 = function (p0 : PChar;
p1 : Integer): Integer of object;}

_T60 = function : Integer of object;
...
{_T69 = procedure (p0 : PChar) of object;}
...
_T76 = function (p0 : TBitmap;
p1 : TBitmap): Integer of object;

_T77 = function (p0 : TIcon): Integer of object;

_T78 = procedure (p0 : TCustomImageList) of object;

_T79 = function (p0 : TBitmap;
p1 : TColor): Integer of object;

_T80 = function (p0 : HWND;
p1 : Integer;
p2 : Integer): Boolean of object;

_T81 = _T6;

_T82 = procedure (p0 : Integer) of object;
...
_T89 = function (p0 : TResType;
p1 : string;
p2 : TColor): Boolean of object;

_T90 = procedure (p0 : Integer;
p1 : TBitmap) of object;

_T91 = _T38;

_T92 = procedure (p0 : Integer;
p1 : TIcon) of object;

_T93 = function : HBITMAP of object;

_T94 = _T93;

_T95 = function (p0 : TResType;
p1 : string;
p2 : Integer;
p3 : TLoadResources;
...
_T103 = function (p0 : Integer;
p1 : TOverlay): Boolean of object;

_T104 = procedure (p0 : TChangeLink) of object;
...
_T115 = function (p0 : Boolean;
p1 : Integer;
p2 : Integer): TCursor of object;

_T116 = procedure (p0 : TObject;
p1 : Integer;
p2 : Integer;
p3 : Boolean) of object;

_T117 = function : THandle of object;

_T118 = function : string of object;
...
_T122 = procedure (const p0 : IDispatch;
...
_T125 = function (const p0 : IDispatch): Boolean of object;

_T126 = _T6;

_T127 = procedure (p0 : TControl;
...
_T136 = procedure (var p0 : Word;
p1 : TShiftState) of object;

_T137 = _T136;

_T138 = procedure (var p0 : Char) of object;

_T139 = procedure (p0 : HDC) of object;

_T140 = _T5;

_T141 = procedure (p0 : HWND) of object;

_T142 = procedure (var p0) of object;

_T143 = _T56;

_T144 = function (p0 : TControl): Boolean of object;
...
_T149 = procedure (p0 : TList) of object;
...
procedure __TCreateParams__Wrapper.setWndParent(const val : HWND);
begin
TCreateParams(GetRecordPtr^).WndParent := val;
end;
function __TCreateParams__Wrapper.getWndParent : HWND;
begin
result := TCreateParams(GetRecordPtr^).WndParent;
end;
...
procedure __TMsg__Wrapper.setHWND(const val : HWND);
begin
TMsg(GetRecordPtr^).HWND := val;
end;
function __TMsg__Wrapper.getHWND : HWND;
begin
result := TMsg(GetRecordPtr^).HWND;
end;
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[114] ,dmDragEnter));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[115] ,dmDragLeave));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[116] ,dmDragMove));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[117] ,dmDragDrop));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[118] ,dmDragCancel));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[119] ,dmFindTarget));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[120] ,alNone));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[121] ,alTop));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[122] ,alBottom));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[123] ,alLeft));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[124] ,alRight));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[125] ,alClient));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[126] ,csLButtonDown));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[127] ,csClicked));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[128] ,csPalette));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[129] ,csReadingState));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[130] ,csAlignmentNeeded));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[131] ,csFocusing));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[132] ,csCreating));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[133] ,csPaintCopy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[134] ,csAcceptsControls));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[135] ,csCaptureMouse));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[136] ,csDesignInteractive));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[137] ,csClickEvents));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[138] ,csFramed));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[139] ,csSetCaption));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[140] ,csOpaque));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[141] ,csDoubleClicks));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[142] ,csFixedWidth));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[143] ,csFixedHeight));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[144] ,csNoDesignVisible));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[145] ,csReplicatable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[146] ,csNoStdEvents));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[147] ,csDisplayDragImage));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[148] ,csReflector));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[149] ,mbLeft));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[150] ,mbRight));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[151] ,mbMiddle));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[152] ,dmManual));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[153] ,dmAutomatic));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[154] ,dsDragEnter));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[155] ,dsDragLeave));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[156] ,dsDragMove));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[157] ,sfLeft));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[158] ,sfTop));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[159] ,sfWidth));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[160] ,sfHeight));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[161] ,sfFont));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[162] ,imDisable));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[163] ,imClose));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[164] ,imOpen));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[165] ,imDontCare));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[166] ,imSAlpha));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[167] ,imAlpha));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[168] ,imHira));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[169] ,imSKata));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[170] ,imKata));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[171] ,imChinese));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[172] ,imSHanguel));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[173] ,imHanguel));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[174] ,dsFocus));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[175] ,dsSelected));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[176] ,dsNormal));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[177] ,dsTransparent));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[178] ,itImage));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[179] ,itMask));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[180] ,rtBitmap));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[181] ,rtCursor));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[182] ,rtIcon));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[183] ,lrDefaultColor));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[184] ,lrDefaultSize));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[185] ,lrFromFile));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[186] ,lrMap3DColors));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[187] ,lrTransparent));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[188] ,lrMonoChrome));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[189] ,CTL3D_ALL));
end;
...
TypeInfo(Integer),
TypeInfo(Integer)], pointer(MinVMTOffset - 14));

RegRegisterMethod(TControl,'Click',TypeInfo(_T32),NoParams, pointer(MinVMTOffset - 15));

RegRegisterMethod(TControl,'DblClick',TypeInfo(_T33),NoParams, pointer(MinVMTOffset - 16));

RegRegisterMethod(TControl,'DragCanceled',TypeInfo(_T34),NoParams, pointer(MinVMTOffset - 17));
...
TypeInfo(Integer),
TypeInfo(TDragState),
TypeInfo(Boolean)], pointer(MinVMTOffset - 18));
...
TypeInfo(TDragObject)], pointer(MinVMTOffset - 20));

RegRegisterMethod(TControl,'GetClientOrigin',TypeInfo(_T38),[TypeInfo(IDispatch)], pointer(40));

RegRegisterMethod(TControl,'GetClientRect',TypeInfo(_T39),[TypeInfo(IDispatch)], pointer(44));

RegRegisterMethod(TControl,'GetDeviceContext',TypeInfo(_T40),[
TypeInfo(HWND),TypeInfo(HDC)], pointer(48));

RegRegisterMethod(TControl,'GetDragImages',TypeInfo(_T41),[TypeInfo(TCustomImageList)], pointer(52));

RegRegisterMethod(TControl,'GetPalette',TypeInfo(_T42),[TypeInfo(HPALETTE)], pointer(MinVMTOffset - 21));

RegRegisterMethod(TControl,'GetPopupMenu',TypeInfo(_T43),[TypeInfo(TPopupMenu)], pointer(MinVMTOffset - 22));
...
TypeInfo(TShiftState),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(MinVMTOffset - 25));

RegRegisterMethod(TControl,'PaletteChanged',TypeInfo(_T47),[
TypeInfo(Boolean),TypeInfo(Boolean)], pointer(MinVMTOffset - 26));

RegRegisterMethod(TControl,'SetDragMode',TypeInfo(_T48),[
TypeInfo(TDragMode)], pointer(56));

RegRegisterMethod(TControl,'SetParent',TypeInfo(_T49),[
TypeInfo(TWinControl)], pointer(60));

RegRegisterMethod(TControl,'SetZOrder',TypeInfo(_T50),[
TypeInfo(Boolean)], pointer(MinVMTOffset - 27));

RegRegisterMethod(TControl,'VisibleChanging',TypeInfo(_T51),NoParams, pointer(MinVMTOffset - 28));

RegRegisterMethod(TControl,'WndProc',TypeInfo(_T52),[
TypeInfo(IDispatch)], pointer(64));

RegRegisterMethod(TControl,'BeginDrag',TypeInfo(_T53),[
TypeInfo(Boolean)],Addr(TControl.BeginDrag));

RegRegisterMethod(TControl,'BringToFront',TypeInfo(_T54),NoParams,Addr(TControl.BringToFront));

RegRegisterMethod(TControl,'ClientToScreen',TypeInfo(_T55),[
TypeInfo(IDispatch),TypeInfo(IDispatch)],Addr(__TControl__ClientToScreen__Wrapper));

RegRegisterMethod(TControl,'Dragging',TypeInfo(_T56),[TypeInfo(Boolean)],Addr(TControl.Dragging));

RegRegisterMethod(TControl,'DragDrop',TypeInfo(_T57),[
TypeInfo(TObject),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(MinVMTOffset - 29));

RegRegisterMethod(TControl,'EndDrag',TypeInfo(_T58),[
TypeInfo(Boolean)],Addr(TControl.EndDrag));

RegRegisterMethod(TControl,'GetTextLen',TypeInfo(_T60),[TypeInfo(Integer)],Addr(TControl.GetTextLen));

RegRegisterMethod(TControl,'Hide',TypeInfo(_T61),NoParams,Addr(TControl.Hide));

RegRegisterMethod(TControl,'Invalidate',TypeInfo(_T62),NoParams, pointer(68));

RegRegisterMethod(TControl,'Perform',TypeInfo(_T63),[
TypeInfo(Cardinal),
TypeInfo(Longint),
TypeInfo(Longint),TypeInfo(Longint)],Addr(TControl.Perform));

RegRegisterMethod(TControl,'Refresh',TypeInfo(_T64),NoParams,Addr(TControl.Refresh));

RegRegisterMethod(TControl,'Repaint',TypeInfo(_T65),NoParams, pointer(72));

RegRegisterMethod(TControl,'ScreenToClient',TypeInfo(_T66),[
TypeInfo(IDispatch),TypeInfo(IDispatch)],Addr(__TControl__ScreenToClient__Wrapper));

RegRegisterMethod(TControl,'SendToBack',TypeInfo(_T67),NoParams,Addr(TControl.SendToBack));

RegRegisterMethod(TControl,'SetBounds',TypeInfo(_T68),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(76));

RegRegisterMethod(TControl,'Show',TypeInfo(_T70),NoParams,Addr(TControl.Show));

RegRegisterMethod(TControl,'Update',TypeInfo(_T71),NoParams, pointer(80));

RegRegisterMethod(TControlCanvas,'FreeHandle',TypeInfo(_T72),NoParams,Addr(TControlCanvas.FreeHandle));

RegRegisterMethod(TCustomControl,'Paint',TypeInfo(_T73),NoParams, pointer(124));

RegRegisterMethod(TCustomImageList,'Change',TypeInfo(_T74),NoParams, pointer(MinVMTOffset - 14));

RegisterProc(TCustomImageList,'CreateSize',mtConstructor,TypeInfo(_T75),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TCustomImageList.CreateSize),cRegister);

RegRegisterMethod(TCustomImageList,'Add',TypeInfo(_T76),[
TypeInfo(TBitmap),
TypeInfo(TBitmap),TypeInfo(Integer)],Addr(TCustomImageList.Add));

RegRegisterMethod(TCustomImageList,'AddIcon',TypeInfo(_T77),[
TypeInfo(TIcon),TypeInfo(Integer)],Addr(TCustomImageList.AddIcon));

RegRegisterMethod(TCustomImageList,'AddImages',TypeInfo(_T78),[
TypeInfo(TCustomImageList)],Addr(TCustomImageList.AddImages));

RegRegisterMethod(TCustomImageList,'AddMasked',TypeInfo(_T79),[
TypeInfo(TBitmap),
TypeInfo(TColor),TypeInfo(Integer)],Addr(TCustomImageList.AddMasked));

RegRegisterMethod(TCustomImageList,'BeginDrag',TypeInfo(_T80),[
TypeInfo(HWND),
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(Boolean)],Addr(TCustomImageList.BeginDrag));

RegRegisterMethod(TCustomImageList,'Clear',TypeInfo(_T81),NoParams,Addr(TCustomImageList.Clear));

RegRegisterMethod(TCustomImageList,'Delete',TypeInfo(_T82),[
TypeInfo(Integer)],Addr(TCustomImageList.Delete));

RegRegisterMethod(TCustomImageList,'DragLock',TypeInfo(_T83),[
TypeInfo(HWND),
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(Boolean)],Addr(TCustomImageList.DragLock));

RegRegisterMethod(TCustomImageList,'DragMove',TypeInfo(_T84),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(Boolean)],Addr(TCustomImageList.DragMove));

RegRegisterMethod(TCustomImageList,'DragUnlock',TypeInfo(_T85),NoParams,Addr(TCustomImageList.DragUnlock));

RegRegisterMethod(TCustomImageList,'Draw',TypeInfo(_T86),[
TypeInfo(TCanvas),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TCustomImageList.Draw));

RegRegisterMethod(TCustomImageList,'DrawOverlay',TypeInfo(_T87),[
TypeInfo(TCanvas),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
...
RegRegisterMethod(TCustomImageList,'EndDrag',TypeInfo(_T88),[TypeInfo(Boolean)],Addr(TCustomImageList.EndDrag));

RegRegisterMethod(TCustomImageList,'FileLoad',TypeInfo(_T89),[
TypeInfo(TResType),
TypeInfo(string),
TypeInfo(TColor),TypeInfo(Boolean)],Addr(TCustomImageList.FileLoad));

RegRegisterMethod(TCustomImageList,'GetBitmap',TypeInfo(_T90),[
TypeInfo(Integer),
TypeInfo(TBitmap)],Addr(TCustomImageList.GetBitmap));

RegRegisterMethod(TCustomImageList,'GetHotSpot',TypeInfo(_T91),[TypeInfo(IDispatch)],Addr(__TCustomImageList__GetHotSpot__Wrapper));

RegRegisterMethod(TCustomImageList,'GetIcon',TypeInfo(_T92),[
TypeInfo(Integer),
TypeInfo(TIcon)],Addr(TCustomImageList.GetIcon));

RegRegisterMethod(TCustomImageList,'GetImageBitmap',TypeInfo(_T93),[TypeInfo(HBITMAP)],Addr(TCustomImageList.GetImageBitmap));

RegRegisterMethod(TCustomImageList,'GetMaskBitmap',TypeInfo(_T94),[TypeInfo(HBITMAP)],Addr(TCustomImageList.GetMaskBitmap));

RegRegisterMethod(TCustomImageList,'GetResource',TypeInfo(_T95),[
TypeInfo(TResType),
TypeInfo(string),
TypeInfo(Integer),
...
RegRegisterMethod(TCustomImageList,'GetInstRes',TypeInfo(_T96),[
TypeInfo(THandle),
TypeInfo(TResType),
TypeInfo(string),
TypeInfo(Integer),
...
RegRegisterMethod(TCustomImageList,'HandleAllocated',TypeInfo(_T97),[TypeInfo(Boolean)],Addr(TCustomImageList.HandleAllocated));

RegRegisterMethod(TCustomImageList,'HideDragImage',TypeInfo(_T98),NoParams,Addr(TCustomImageList.HideDragImage));

RegRegisterMethod(TCustomImageList,'Insert',TypeInfo(_T99),[
TypeInfo(Integer),
TypeInfo(TBitmap),
TypeInfo(TBitmap)],Addr(TCustomImageList.Insert));

RegRegisterMethod(TCustomImageList,'InsertIcon',TypeInfo(_T100),[
TypeInfo(Integer),
TypeInfo(TIcon)],Addr(TCustomImageList.InsertIcon));

RegRegisterMethod(TCustomImageList,'InsertMasked',TypeInfo(_T101),[
TypeInfo(Integer),
TypeInfo(TBitmap),
TypeInfo(TColor)],Addr(TCustomImageList.InsertMasked));

RegRegisterMethod(TCustomImageList,'Move',TypeInfo(_T102),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TCustomImageList.Move));

RegRegisterMethod(TCustomImageList,'Overlay',TypeInfo(_T103),[
TypeInfo(Integer),
TypeInfo(TOverlay),TypeInfo(Boolean)],Addr(TCustomImageList.Overlay));

RegRegisterMethod(TCustomImageList,'RegisterChanges',TypeInfo(_T104),[
TypeInfo(TChangeLink)],Addr(TCustomImageList.RegisterChanges));

RegRegisterMethod(TCustomImageList,'ResourceLoad',TypeInfo(_T105),[
TypeInfo(TResType),
TypeInfo(string),
TypeInfo(TColor),TypeInfo(Boolean)],Addr(TCustomImageList.ResourceLoad));

RegRegisterMethod(TCustomImageList,'ResInstLoad',TypeInfo(_T106),[
TypeInfo(THandle),
TypeInfo(TResType),
TypeInfo(string),
TypeInfo(TColor),TypeInfo(Boolean)],Addr(TCustomImageList.ResInstLoad));

RegRegisterMethod(TCustomImageList,'Replace',TypeInfo(_T107),[
TypeInfo(Integer),
TypeInfo(TBitmap),
TypeInfo(TBitmap)],Addr(TCustomImageList.Replace));

RegRegisterMethod(TCustomImageList,'ReplaceIcon',TypeInfo(_T108),[
TypeInfo(Integer),
TypeInfo(TIcon)],Addr(TCustomImageList.ReplaceIcon));

RegRegisterMethod(TCustomImageList,'ReplaceMasked',TypeInfo(_T109),[
TypeInfo(Integer),
TypeInfo(TBitmap),
TypeInfo(TColor)],Addr(TCustomImageList.ReplaceMasked));

RegRegisterMethod(TCustomImageList,'SetDragImage',TypeInfo(_T110),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(Boolean)],Addr(TCustomImageList.SetDragImage));

RegRegisterMethod(TCustomImageList,'ShowDragImage',TypeInfo(_T111),NoParams,Addr(TCustomImageList.ShowDragImage));

RegRegisterMethod(TCustomImageList,'UnRegisterChanges',TypeInfo(_T112),[
TypeInfo(TChangeLink)],Addr(TCustomImageList.UnRegisterChanges));

RegisterProc(TDragControlObject,'Create',mtConstructor,TypeInfo(_T113),[
TypeInfo(TControl)],Addr(TDragControlObject.Create),cRegister);

RegRegisterMethod(TDragObject,'GetDragImages',TypeInfo(_T114),[TypeInfo(TCustomImageList)], pointer(0));

RegRegisterMethod(TDragObject,'GetDragCursor',TypeInfo(_T115),[
TypeInfo(Boolean),
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(TCursor)], pointer(4));

RegRegisterMethod(TDragObject,'Finished',TypeInfo(_T116),[
TypeInfo(TObject),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Boolean)], pointer(8));

RegRegisterMethod(TDragObject,'Instance',TypeInfo(_T117),[TypeInfo(THandle)], pointer(12));

RegRegisterMethod(TDragObject,'GetName',TypeInfo(_T118),[TypeInfo(string)], pointer(16));

RegRegisterMethod(TDragObject,'HideDragImage',TypeInfo(_T119),NoParams, pointer(20));

RegRegisterMethod(TDragObject,'ShowDragImage',TypeInfo(_T120),NoParams, pointer(24));

RegRegisterMethod(TGraphicControl,'Paint',TypeInfo(_T121),NoParams, pointer(84));

RegRegisterMethod(THintWindow,'ActivateHint',TypeInfo(_T122),[
TypeInfo(IDispatch),
TypeInfo(string)], pointer(128));

RegRegisterMethod(THintWindow,'ActivateHintData',TypeInfo(_T123),[
TypeInfo(IDispatch),
TypeInfo(string),
TypeInfoPointer], pointer(132));

RegRegisterMethod(THintWindow,'CalcHintRect',TypeInfo(_T124),[
TypeInfo(Integer),
TypeInfo(string),
TypeInfoPointer,TypeInfo(IDispatch)], pointer(136));

RegRegisterMethod(THintWindow,'IsHintMsg',TypeInfo(_T125),[
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(140));

RegRegisterMethod(THintWindow,'ReleaseHandle',TypeInfo(_T126),NoParams,Addr(THintWindow.ReleaseHandle));

RegRegisterMethod(TWinControl,'AlignControls',TypeInfo(_T127),[
TypeInfo(TControl),
TypeInfo(IDispatch)], pointer(84));

RegRegisterMethod(TWinControl,'CreateHandle',TypeInfo(_T128),NoParams, pointer(88));

RegRegisterMethod(TWinControl,'CreateParams',TypeInfo(_T129),[
TypeInfo(IDispatch)], pointer(92));

RegRegisterMethod(TWinControl,'CreateWindowHandle',TypeInfo(_T130),[
TypeInfo(IDispatch)], pointer(96));

RegRegisterMethod(TWinControl,'CreateWnd',TypeInfo(_T131),NoParams, pointer(100));

RegRegisterMethod(TWinControl,'DestroyWindowHandle',TypeInfo(_T132),NoParams, pointer(104));

RegRegisterMethod(TWinControl,'DestroyWnd',TypeInfo(_T133),NoParams, pointer(108));

RegRegisterMethod(TWinControl,'DoEnter',TypeInfo(_T134),NoParams, pointer(MinVMTOffset - 30));

RegRegisterMethod(TWinControl,'DoExit',TypeInfo(_T135),NoParams, pointer(MinVMTOffset - 31));

RegRegisterMethod(TWinControl,'KeyDown',TypeInfo(_T136),[
TypeInfo(Word),
TypeInfo(TShiftState)], pointer(MinVMTOffset - 32));

RegRegisterMethod(TWinControl,'KeyUp',TypeInfo(_T137),[
TypeInfo(Word),
TypeInfo(TShiftState)], pointer(MinVMTOffset - 33));

RegRegisterMethod(TWinControl,'KeyPress',TypeInfo(_T138),[
TypeInfo(Char)], pointer(MinVMTOffset - 34));

RegRegisterMethod(TWinControl,'PaintWindow',TypeInfo(_T139),[
TypeInfo(HDC)], pointer(112));

RegRegisterMethod(TWinControl,'ShowControl',TypeInfo(_T140),[
TypeInfo(TControl)], pointer(116));

RegisterProc(TWinControl,'CreateParented',mtConstructor,TypeInfo(_T141),[
TypeInfo(HWND)],Addr(TWinControl.CreateParented),cRegister);

RegRegisterMethod(TWinControl,'Broadcast',TypeInfo(_T142),[
TypeInfoUntyped],Addr(TWinControl.Broadcast));

RegRegisterMethod(TWinControl,'CanFocus',TypeInfo(_T143),[TypeInfo(Boolean)],Addr(TWinControl.CanFocus));

RegRegisterMethod(TWinControl,'ContainsControl',TypeInfo(_T144),[
TypeInfo(TControl),TypeInfo(Boolean)],Addr(TWinControl.ContainsControl));

RegRegisterMethod(TWinControl,'ControlAtPos',TypeInfo(_T145),[
TypeInfo(IDispatch),
TypeInfo(Boolean),TypeInfo(TControl)],Addr(__TWinControl__ControlAtPos__Wrapper));

RegRegisterMethod(TWinControl,'DisableAlign',TypeInfo(_T146),NoParams,Addr(TWinControl.DisableAlign));

RegRegisterMethod(TWinControl,'EnableAlign',TypeInfo(_T147),NoParams,Addr(TWinControl.EnableAlign));

RegRegisterMethod(TWinControl,'Focused',TypeInfo(_T148),[TypeInfo(Boolean)],Addr(TWinControl.Focused));

RegRegisterMethod(TWinControl,'GetTabOrderList',TypeInfo(_T149),[
TypeInfo(TList)], pointer(MinVMTOffset - 35));

RegRegisterMethod(TWinControl,'HandleAllocated',TypeInfo(_T150),[TypeInfo(Boolean)],Addr(TWinControl.HandleAllocated));

RegRegisterMethod(TWinControl,'HandleNeeded',TypeInfo(_T151),NoParams,Addr(TWinControl.HandleNeeded));

RegRegisterMethod(TWinControl,'InsertControl',TypeInfo(_T152),[
TypeInfo(TControl)],Addr(TWinControl.InsertControl));

RegRegisterMethod(TWinControl,'PaintTo',TypeInfo(_T153),[
TypeInfo(HDC),
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TWinControl.PaintTo));

RegRegisterMethod(TWinControl,'RemoveControl',TypeInfo(_T154),[
TypeInfo(TControl)],Addr(TWinControl.RemoveControl));

RegRegisterMethod(TWinControl,'Realign',TypeInfo(_T155),NoParams,Addr(TWinControl.Realign));

RegRegisterMethod(TWinControl,'ScaleBy',TypeInfo(_T156),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TWinControl.ScaleBy));

RegRegisterMethod(TWinControl,'ScrollBy',TypeInfo(_T157),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TWinControl.ScrollBy));

RegRegisterMethod(TWinControl,'SetFocus',TypeInfo(_T158),NoParams, pointer(120));

RegRegisterMethod(TWinControl,'UpdateControlState',TypeInfo(_T159),NoParams,Addr(TWinControl.UpdateControlState));
...
{RegRegisterMethod(TControl,'GetTextBuf',TypeInfo(_T59),[
TypeInfoPChar,
TypeInfo(Integer),TypeInfo(Integer)],Addr(TControl.GetTextBuf))}

{RegRegisterMethod(TControl,'SetTextBuf',TypeInfo(_T69),[
