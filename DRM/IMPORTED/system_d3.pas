...
function GetRecordPtr : pointer; override;
published
procedure setInstance(const val : Longint);
function getInstance : Longint;
property Instance : Longint read getInstance write setInstance;
procedure setResInstance(const val : Longint);
function getResInstance : Longint;
property ResInstance : Longint read getResInstance write setResInstance;
...
_T24 = function (const p0 : Variant): Integer of object;

_T25 = function (const p0 : Variant;
p1 : Integer): Variant of object;

_T26 = function (const p0 : Variant): Boolean of object;

_T27 = _T26;

_T28 = function (const p0 : Variant): string of object;

_T29 = function (p0 : TDateTime): Variant of object;

_T30 = function (const p0 : Variant): TDateTime of object;

_T31 = function (const p0 : Array of Integer;
p1 : Integer): Variant of object;

_T32 = function (const p0 : Array of Variant): Variant of object;

_T33 = _T24;

_T34 = function (const p0 : Variant;
p1 : Integer): Integer of object;

_T35 = _T34;

_T36 = function (const p0 : Variant): Pointer of object;

_T37 = procedure (const p0 : Variant) of object;

_T38 = _T26;

{_T39 = procedure (p0 : PLibModule) of object;}

{_T40 = procedure (p0 : PLibModule) of object;}

_T41 = function (p0 : Pointer): Longint of object;

{_T42 = function (p0 : TClass): Longint of object;}

_T43 = function (p0 : Longint): Longint of object;

{_T44 = function (p0 : PChar): Longint of object;}

{_T45 = procedure (p0 : TEnumModuleFunc;
p1 : Pointer) of object;}

{_T46 = procedure (p0 : TEnumModuleFunc;
p1 : Pointer) of object;}

{_T47 = procedure (p0 : TModuleUnloadProc) of object;}

{_T48 = procedure (p0 : TModuleUnloadProc) of object;}

{_T49 = function (p0 : PResStringRec): string of object;}

_T50 = procedure (var p0 : string) of object;
...
_T55 = function (p0 : Pointer): TObject of object;

_T56 = _T13;

{_T57 = function : TClass of object;}

_T58 = function : ShortString of object;

_T59 = function (const p0 : string): Boolean of object;

{_T60 = function : TClass of object;}

_T61 = function : Pointer of object;

_T62 = function : Longint of object;

{_T63 = function (p0 : TClass): Boolean of object;}

_T64 = procedure (var p0) of object;

_T65 = function (const p0 : ShortString): Pointer of object;

_T66 = function (p0 : Pointer): ShortString of object;

_T67 = _T65;

_T68 = function (const p0 : IDispatch;
out p1): Boolean of object;

{_T70 = function : PInterfaceTable of object;}

_T71 = function (p0 : TObject;
p1 : Pointer): Integer of object;

_T72 = _T64;

_T73 = function : TObject of object;
...
procedure __TLibModule__Wrapper.setInstance(const val : Longint);
begin
TLibModule(GetRecordPtr^).Instance := val;
end;
function __TLibModule__Wrapper.getInstance : Longint;
begin
result := TLibModule(GetRecordPtr^).Instance;
end;
procedure __TLibModule__Wrapper.setResInstance(const val : Longint);
begin
TLibModule(GetRecordPtr^).ResInstance := val;
end;
function __TLibModule__Wrapper.getResInstance : Longint;
begin
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[47] ,vmtDefaultHandler));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[48] ,vmtNewInstance));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[49] ,vmtFreeInstance));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[50] ,vmtDestroy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[51] ,vmtQueryInterface));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[52] ,vmtAddRef));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[53] ,vmtRelease));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[54] ,vmtCreateObject));
end;
...
RegisterProc(nil,MethodNames[43],mtProc,TypeInfo(_T41),[
...
RegisterProc(nil,MethodNames[45],mtProc,TypeInfo(_T50),[
TypeInfo(string)],Addr(UniqueString),cRegister);

RegisterProc(nil,MethodNames[46],mtProc,TypeInfo(_T51),NoParams,Addr(FPower10),cRegister);

RegisterProc(nil,MethodNames[47],mtProc,TypeInfo(_T52),NoParams,Addr(TextStart),cRegister);

RegisterProc(TObject,'Create',mtConstructor,TypeInfo(_T53),NoParams,Addr(TObject.Create),cRegister);

RegRegisterMethod(TObject,'Free',TypeInfo(_T54),NoParams,Addr(TObject.Free));

RegisterProc(TObject,'InitInstance',mtClassMethod,TypeInfo(_T55),[
TypeInfoPointer,TypeInfo(TObject)],Addr(TObject.InitInstance),cRegister);

RegRegisterMethod(TObject,'CleanupInstance',TypeInfo(_T56),NoParams,Addr(TObject.CleanupInstance));

RegisterProc(TObject,'ClassName',mtClassMethod,TypeInfo(_T58),[TypeInfo(ShortString)],Addr(TObject.ClassName),cRegister);

RegisterProc(TObject,'ClassNameIs',mtClassMethod,TypeInfo(_T59),[
TypeInfo(string),TypeInfo(Boolean)],Addr(TObject.ClassNameIs),cRegister);

RegisterProc(TObject,'ClassInfo',mtClassMethod,TypeInfo(_T61),[TypeInfoPointer],Addr(TObject.ClassInfo),cRegister);

RegisterProc(TObject,'InstanceSize',mtClassMethod,TypeInfo(_T62),[TypeInfo(Longint)],Addr(TObject.InstanceSize),cRegister);

RegRegisterMethod(TObject,'Dispatch',TypeInfo(_T64),[
TypeInfoUntyped],Addr(TObject.Dispatch));

RegisterProc(TObject,'MethodAddress',mtClassMethod,TypeInfo(_T65),[
TypeInfo(ShortString),TypeInfoPointer],Addr(TObject.MethodAddress),cRegister);

RegisterProc(TObject,'MethodName',mtClassMethod,TypeInfo(_T66),[
TypeInfoPointer,TypeInfo(ShortString)],Addr(TObject.MethodName),cRegister);

RegRegisterMethod(TObject,'FieldAddress',TypeInfo(_T67),[
TypeInfo(ShortString),TypeInfoPointer],Addr(TObject.FieldAddress));

RegRegisterMethod(TObject,'GetInterface',TypeInfo(_T68),[
TypeInfo(IDispatch),
TypeInfoUntyped,TypeInfo(Boolean)],Addr(__TObject__GetInterface__Wrapper));

RegRegisterMethod(TObject,'SafeCallException',TypeInfo(_T71),[
TypeInfo(TObject),
TypeInfoPointer,TypeInfo(Integer)], pointer(-16));

RegRegisterMethod(TObject,'DefaultHandler',TypeInfo(_T72),[
TypeInfoUntyped], pointer(-12));

RegisterProc(TObject,'NewInstance',mtClassMethod,TypeInfo(_T73),[TypeInfo(TObject)], pointer(-8),cRegister);

RegRegisterMethod(TObject,'FreeInstance',TypeInfo(_T74),NoParams, pointer(-4));

RegisterProc(TObject,'Destroy',mtDestructor,TypeInfo(_T75),NoParams, pointer(0),cRegister);
...
{RegisterProc(nil,'RegisterModule',mtProc,TypeInfo(_T39),[
TypeInfoPointer],Addr(RegisterModule),cRegister)}

{RegisterProc(nil,'UnregisterModule',mtProc,TypeInfo(_T40),[
TypeInfoPointer],Addr(UnregisterModule),cRegister)}

{RegisterProc(nil,'FindClassHInstance',mtProc,TypeInfo(_T42),[
TypeInfo(TClass),TypeInfo(Longint)],Addr(FindClassHInstance),cRegister)}

{RegisterProc(nil,'LoadResourceModule',mtProc,TypeInfo(_T44),[
TypeInfoPChar,TypeInfo(Longint)],Addr(LoadResourceModule),cRegister)}

{RegisterProc(nil,'EnumModules',mtProc,TypeInfo(_T45),[
TypeInfo(TEnumModuleFunc),
TypeInfoPointer],Addr(EnumModules),cRegister)}

{RegisterProc(nil,'EnumResourceModules',mtProc,TypeInfo(_T46),[
TypeInfo(TEnumModuleFunc),
TypeInfoPointer],Addr(EnumResourceModules),cRegister)}

{RegisterProc(nil,'AddModuleUnloadProc',mtProc,TypeInfo(_T47),[
TypeInfo(TModuleUnloadProc)],Addr(AddModuleUnloadProc),cRegister)}

{RegisterProc(nil,'RemoveModuleUnloadProc',mtProc,TypeInfo(_T48),[
TypeInfo(TModuleUnloadProc)],Addr(RemoveModuleUnloadProc),cRegister)}

{RegisterProc(nil,'LoadResString',mtProc,TypeInfo(_T49),[
TypeInfoPointer,TypeInfo(string)],Addr(LoadResString),cRegister)}

{RegRegisterMethod(TObject,'ClassType',TypeInfo(_T57),[TypeInfo(TClass)],Addr(TObject.ClassType))}

{RegisterProc(TObject,'ClassParent',mtClassMethod,TypeInfo(_T60),[TypeInfo(TClass)],Addr(TObject.ClassParent),cRegister)}

{RegisterProc(TObject,'InheritsFrom',mtClassMethod,TypeInfo(_T63),[
TypeInfo(TClass),TypeInfo(Boolean)],Addr(TObject.InheritsFrom),cRegister)}

{RegisterProc(TObject,'GetInterfaceTable',mtClassMethod,TypeInfo(_T70),[TypeInfoPointer],Addr(TObject.GetInterfaceTable),cRegister)}
