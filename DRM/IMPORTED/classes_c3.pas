...
_T44 = procedure (p0 : TCollectionItem) of object;

_T45 = _T44;

{_T46 = procedure (p0 : TCollectionItemClass) of object;}

_T47 = function : TCollectionItem of object;
...
_T51 = function (p0 : Integer): TCollectionItem of object;

_T52 = _T51;

_T53 = function : string of object;

_T54 = procedure (p0 : Integer) of object;

_T55 = procedure (const p0 : string) of object;

_T56 = procedure (p0 : TCollection) of object;

{_T57 = procedure (p0 : TGetChildProc;
p1 : TComponent) of object;}

_T58 = function : TComponent of object;

_T59 = _T58;

_T60 = _T24;

_T61 = procedure (p0 : TComponent;
p1 : TOperation) of object;

_T62 = procedure (p0 : TReader) of object;

_T63 = procedure (const p0 : TComponentName) of object;

_T64 = procedure (p0 : TComponent;
p1 : Integer) of object;

_T65 = procedure (p0 : TComponent) of object;

_T66 = _T24;

_T67 = _T24;

_T68 = procedure (p0 : Boolean;
const p1 : string;
const p2 : string) of object;
...
_T72 = procedure (p0 : TWriter) of object;
...
_T76 = function (const p0 : string): TComponent of object;
...
_T80 = function : Boolean of object;
...
_T89 = procedure (const p0 : string;
p1 : Word) of object;
...
_T94 = function : TInterfaceList of object;

{_T95 = function : IUnknown of object;}

{_T96 = function (p0 : IUnknown): Integer of object;}

{_T97 = function (p0 : IUnknown): Integer of object;}

{_T98 = procedure (p0 : Integer;
p1 : IUnknown) of object;}

{_T99 = function : IUnknown of object;}

{_T100 = function (p0 : IUnknown): Integer of object;}

_T101 = _T24;

_T102 = function (p0 : Pointer): Integer of object;
...
_T107 = function : TList of object;

_T108 = function : Pointer of object;

_T109 = _T102;

_T110 = procedure (p0 : Integer;
...
{_T115 = procedure (p0 : TListSortCompare) of object;}

_T116 = function (var p0 : Longint): Pointer of object;
...
{_T120 = procedure (p0 : TPersistent;
p1 : TCollectionItemClass) of object;}

_T121 = _T83;

_T122 = procedure (p0 : Char) of object;

_T123 = _T55;

_T124 = _T55;

_T125 = procedure (const p0 : string;
...
_T128 = function : Char of object;

_T129 = function : Longint of object;

_T130 = _T53;

_T131 = function : Extended of object;

_T132 = _T129;

_T133 = _T53;

_T134 = function (const p0 : string): Boolean of object;

_T135 = _T29;

_T136 = procedure (p0 : TFiler) of object;

_T137 = function : TPersistent of object;
...
_T149 = function : TValueType of object;

_T150 = procedure (var p0;
...
_T154 = function (p0 : TComponent): TComponent of object;

{_T155 = procedure (p0 : TComponent;
p1 : TComponent;
...
_T161 = procedure (var p0 : TFilerFlags;
...
{_T168 = procedure (p0 : THandle;
const p1 : string;
p2 : PChar) of object;}

{_T169 = procedure (p0 : THandle;
p1 : Integer;
p2 : PChar) of object;}

_T170 = procedure (p0 : Longint) of object;

_T171 = function (var p0;
p1 : Longint): Longint of object;

_T172 = function (const p0;
p1 : Longint): Longint of object;

_T173 = function (p0 : Longint;
p1 : Word): Longint of object;

_T174 = _T150;

_T175 = procedure (const p0;
p1 : Longint) of object;

_T176 = function (p0 : TStream;
p1 : Longint): Longint of object;
...
_T185 = function (p0 : Pointer;
p1 : Longint;
p2 : PLongint): HResult of object;

_T186 = _T185;

_T187 = function (p0 : Largeint;
p1 : Longint;
out p2 : Largeint): HResult of object;

_T188 = function (p0 : Largeint): HResult of object;

{_T189 = function (p0 : IStream;
p1 : Largeint;
out p2 : Largeint;
out p3 : Largeint): HResult of object;}

_T190 = function (p0 : Longint): HResult of object;

_T191 = function : HResult of object;

_T192 = function (p0 : Largeint;
p1 : Largeint;
p2 : Longint): HResult of object;

_T193 = _T192;

{_T194 = function (out p0 : TStatStg;
p1 : Longint): HResult of object;}

{_T195 = function (out p0 : IStream): HResult of object;}
...
_T203 = function (p0 : Integer): TObject of object;

_T204 = _T53;

_T205 = procedure (p0 : Integer;
const p1 : string) of object;

_T206 = procedure (p0 : Integer;
...
_T209 = procedure (p0 : Boolean) of object;

_T210 = function (const p0 : string): Integer of object;

_T211 = function (const p0 : string;
p1 : TObject): Integer of object;

_T212 = _T55;

_T213 = procedure (p0 : TStrings) of object;
...
_T218 = function (p0 : TStrings): Boolean of object;

_T219 = _T106;

_T220 = function : PChar of object;

_T221 = _T210;

_T222 = _T210;

_T223 = function (p0 : TObject): Integer of object;

_T224 = _T205;

_T225 = procedure (p0 : Integer;
const p1 : string;
...
{_T231 = procedure (p0 : PChar) of object;}

_T232 = _T55;

_T233 = function (p0 : Longint): string of object;
...
_T243 = procedure (p0 : Pointer) of object;
...
_T255 = procedure (p0 : Extended) of object;
...
RegRegisterMethod(TBits,'OpenBit',TypeInfo(_T40),[TypeInfo(Integer)],Addr(TBits.OpenBit));

RegRegisterMethod(TCollection,'GetAttrCount',TypeInfo(_T41),[TypeInfo(Integer)], pointer(MinVMTOffset - 2));

RegRegisterMethod(TCollection,'GetAttr',TypeInfo(_T42),[
TypeInfo(Integer),TypeInfo(string)], pointer(MinVMTOffset - 3));

RegRegisterMethod(TCollection,'GetItemAttr',TypeInfo(_T43),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(string)], pointer(MinVMTOffset - 4));

RegRegisterMethod(TCollection,'SetItemName',TypeInfo(_T44),[
TypeInfo(TCollectionItem)], pointer(12));

RegRegisterMethod(TCollection,'Update',TypeInfo(_T45),[
TypeInfo(TCollectionItem)], pointer(16));

RegRegisterMethod(TCollection,'Add',TypeInfo(_T47),[TypeInfo(TCollectionItem)],Addr(TCollection.Add));

RegRegisterMethod(TCollection,'BeginUpdate',TypeInfo(_T48),NoParams,Addr(TCollection.BeginUpdate));

RegRegisterMethod(TCollection,'Clear',TypeInfo(_T49),NoParams,Addr(TCollection.Clear));

RegRegisterMethod(TCollection,'EndUpdate',TypeInfo(_T50),NoParams,Addr(TCollection.EndUpdate));

RegRegisterMethod(TCollection,'FindItemID',TypeInfo(_T51),[
TypeInfo(Integer),TypeInfo(TCollectionItem)],Addr(TCollection.FindItemID));

RegRegisterMethod(TCollection,'Insert',TypeInfo(_T52),[
TypeInfo(Integer),TypeInfo(TCollectionItem)],Addr(TCollection.Insert));

RegRegisterMethod(TCollectionItem,'GetDisplayName',TypeInfo(_T53),[TypeInfo(string)], pointer(12));

RegRegisterMethod(TCollectionItem,'SetIndex',TypeInfo(_T54),[
TypeInfo(Integer)], pointer(16));

RegRegisterMethod(TCollectionItem,'SetDisplayName',TypeInfo(_T55),[
TypeInfo(string)], pointer(20));

RegisterProc(TCollectionItem,'Create',mtConstructor,TypeInfo(_T56),[
TypeInfo(TCollection)], pointer(24),cRegister);

RegRegisterMethod(TComponent,'GetChildOwner',TypeInfo(_T58),[TypeInfo(TComponent)], pointer(MinVMTOffset - 3));

RegRegisterMethod(TComponent,'GetChildParent',TypeInfo(_T59),[TypeInfo(TComponent)], pointer(MinVMTOffset - 4));

RegRegisterMethod(TComponent,'Loaded',TypeInfo(_T60),NoParams, pointer(12));

RegRegisterMethod(TComponent,'Notification',TypeInfo(_T61),[
TypeInfo(TComponent),
TypeInfo(TOperation)], pointer(16));

RegRegisterMethod(TComponent,'ReadState',TypeInfo(_T62),[
TypeInfo(TReader)], pointer(20));

RegRegisterMethod(TComponent,'SetName',TypeInfo(_T63),[
TypeInfo(TComponentName)], pointer(24));

RegRegisterMethod(TComponent,'SetChildOrder',TypeInfo(_T64),[
TypeInfo(TComponent),
TypeInfo(Integer)], pointer(MinVMTOffset - 5));

RegRegisterMethod(TComponent,'SetParentComponent',TypeInfo(_T65),[
TypeInfo(TComponent)], pointer(MinVMTOffset - 6));

RegRegisterMethod(TComponent,'Updating',TypeInfo(_T66),NoParams, pointer(MinVMTOffset - 7));

RegRegisterMethod(TComponent,'Updated',TypeInfo(_T67),NoParams, pointer(MinVMTOffset - 8));

RegisterProc(TComponent,'UpdateRegistry',mtClassMethod,TypeInfo(_T68),[
TypeInfo(Boolean),
TypeInfo(string),
TypeInfo(string)], pointer(28),cRegister);

RegRegisterMethod(TComponent,'ValidateRename',TypeInfo(_T69),[
TypeInfo(TComponent),
TypeInfo(string),
TypeInfo(string)], pointer(32));

RegRegisterMethod(TComponent,'ValidateContainer',TypeInfo(_T70),[
TypeInfo(TComponent)], pointer(MinVMTOffset - 9));

RegRegisterMethod(TComponent,'ValidateInsert',TypeInfo(_T71),[
TypeInfo(TComponent)], pointer(MinVMTOffset - 10));

RegRegisterMethod(TComponent,'WriteState',TypeInfo(_T72),[
TypeInfo(TWriter)], pointer(36));

RegisterProc(TComponent,'Create',mtConstructor,TypeInfo(_T73),[
TypeInfo(TComponent)], pointer(40),cRegister);

RegRegisterMethod(TComponent,'DestroyComponents',TypeInfo(_T74),NoParams,Addr(TComponent.DestroyComponents));

RegRegisterMethod(TComponent,'Destroying',TypeInfo(_T75),NoParams,Addr(TComponent.Destroying));

RegRegisterMethod(TComponent,'FindComponent',TypeInfo(_T76),[
TypeInfo(string),TypeInfo(TComponent)],Addr(TComponent.FindComponent));

RegRegisterMethod(TComponent,'FreeNotification',TypeInfo(_T77),[
TypeInfo(TComponent)],Addr(TComponent.FreeNotification));

RegRegisterMethod(TComponent,'FreeOnRelease',TypeInfo(_T78),NoParams,Addr(TComponent.FreeOnRelease));

RegRegisterMethod(TComponent,'GetParentComponent',TypeInfo(_T79),[TypeInfo(TComponent)], pointer(MinVMTOffset - 11));

RegRegisterMethod(TComponent,'HasParent',TypeInfo(_T80),[TypeInfo(Boolean)], pointer(MinVMTOffset - 12));

RegRegisterMethod(TComponent,'InsertComponent',TypeInfo(_T81),[
TypeInfo(TComponent)],Addr(TComponent.InsertComponent));

RegRegisterMethod(TComponent,'RemoveComponent',TypeInfo(_T82),[
TypeInfo(TComponent)],Addr(TComponent.RemoveComponent));

RegRegisterMethod(TCustomMemoryStream,'SaveToStream',TypeInfo(_T83),[
TypeInfo(TStream)],Addr(TCustomMemoryStream.SaveToStream));

RegRegisterMethod(TCustomMemoryStream,'SaveToFile',TypeInfo(_T84),[
TypeInfo(string)],Addr(TCustomMemoryStream.SaveToFile));

RegisterProc(TFiler,'Create',mtConstructor,TypeInfo(_T85),[
TypeInfo(TStream),
TypeInfo(Integer)],Addr(TFiler.Create),cRegister);

RegRegisterMethod(TFiler,'FlushBuffer',TypeInfo(_T88),NoParams, pointer(8));

RegisterProc(TFileStream,'Create',mtConstructor,TypeInfo(_T89),[
TypeInfo(string),
TypeInfo(Word)],Addr(TFileStream.Create),cRegister);

RegisterProc(THandleStream,'Create',mtConstructor,TypeInfo(_T90),[
TypeInfo(Integer)],Addr(THandleStream.Create),cRegister);

RegisterProc(TInterfaceList,'Create',mtConstructor,TypeInfo(_T91),NoParams,Addr(TInterfaceList.Create),cRegister);

RegRegisterMethod(TInterfaceList,'Clear',TypeInfo(_T92),NoParams,Addr(TInterfaceList.Clear));

RegRegisterMethod(TInterfaceList,'Delete',TypeInfo(_T93),[
TypeInfo(Integer)],Addr(TInterfaceList.Delete));

RegRegisterMethod(TInterfaceList,'Expand',TypeInfo(_T94),[TypeInfo(TInterfaceList)],Addr(TInterfaceList.Expand));

RegRegisterMethod(TList,'Grow',TypeInfo(_T101),NoParams, pointer(0));

RegRegisterMethod(TList,'Add',TypeInfo(_T102),[
TypeInfoPointer,TypeInfo(Integer)],Addr(TList.Add));

RegRegisterMethod(TList,'Clear',TypeInfo(_T103),NoParams, pointer(MinVMTOffset - 0));

RegRegisterMethod(TList,'Delete',TypeInfo(_T104),[
TypeInfo(Integer)],Addr(TList.Delete));

RegisterProc(TList,'Error',mtClassMethod,TypeInfo(_T105),[
TypeInfo(string),
TypeInfo(Integer)], pointer(4),cRegister);

RegRegisterMethod(TList,'Exchange',TypeInfo(_T106),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TList.Exchange));

RegRegisterMethod(TList,'Expand',TypeInfo(_T107),[TypeInfo(TList)],Addr(TList.Expand));

RegRegisterMethod(TList,'First',TypeInfo(_T108),[TypeInfoPointer],Addr(TList.First));

RegRegisterMethod(TList,'IndexOf',TypeInfo(_T109),[
TypeInfoPointer,TypeInfo(Integer)],Addr(TList.IndexOf));

RegRegisterMethod(TList,'Insert',TypeInfo(_T110),[
TypeInfo(Integer),
TypeInfoPointer],Addr(TList.Insert));

RegRegisterMethod(TList,'Last',TypeInfo(_T111),[TypeInfoPointer],Addr(TList.Last));

RegRegisterMethod(TList,'Move',TypeInfo(_T112),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TList.Move));

RegRegisterMethod(TList,'Remove',TypeInfo(_T113),[
TypeInfoPointer,TypeInfo(Integer)],Addr(TList.Remove));

RegRegisterMethod(TList,'Pack',TypeInfo(_T114),NoParams,Addr(TList.Pack));

RegRegisterMethod(TMemoryStream,'Realloc',TypeInfo(_T116),[
TypeInfo(Longint),TypeInfoPointer], pointer(16));

RegRegisterMethod(TMemoryStream,'Clear',TypeInfo(_T117),NoParams,Addr(TMemoryStream.Clear));

RegRegisterMethod(TMemoryStream,'LoadFromStream',TypeInfo(_T118),[
TypeInfo(TStream)],Addr(TMemoryStream.LoadFromStream));

RegRegisterMethod(TMemoryStream,'LoadFromFile',TypeInfo(_T119),[
TypeInfo(string)],Addr(TMemoryStream.LoadFromFile));

RegisterProc(TParser,'Create',mtConstructor,TypeInfo(_T121),[
TypeInfo(TStream)],Addr(TParser.Create),cRegister);

RegRegisterMethod(TParser,'CheckToken',TypeInfo(_T122),[
TypeInfo(Char)],Addr(TParser.CheckToken));

RegRegisterMethod(TParser,'CheckTokenSymbol',TypeInfo(_T123),[
TypeInfo(string)],Addr(TParser.CheckTokenSymbol));

RegRegisterMethod(TParser,'Error',TypeInfo(_T124),[
TypeInfo(string)],Addr(TParser.Error));

RegRegisterMethod(TParser,'ErrorFmt',TypeInfo(_T125),[
TypeInfo(string),
TypeInfoArrayOfConst],Addr(TParser.ErrorFmt));

RegRegisterMethod(TParser,'ErrorStr',TypeInfo(_T126),[
TypeInfo(string)],Addr(TParser.ErrorStr));

RegRegisterMethod(TParser,'HexToBinary',TypeInfo(_T127),[
TypeInfo(TStream)],Addr(TParser.HexToBinary));

RegRegisterMethod(TParser,'NextToken',TypeInfo(_T128),[TypeInfo(Char)],Addr(TParser.NextToken));

RegRegisterMethod(TParser,'SourcePos',TypeInfo(_T129),[TypeInfo(Longint)],Addr(TParser.SourcePos));

RegRegisterMethod(TParser,'TokenComponentIdent',TypeInfo(_T130),[TypeInfo(string)],Addr(TParser.TokenComponentIdent));

RegRegisterMethod(TParser,'TokenFloat',TypeInfo(_T131),[TypeInfo(Extended)],Addr(TParser.TokenFloat));

RegRegisterMethod(TParser,'TokenInt',TypeInfo(_T132),[TypeInfo(Longint)],Addr(TParser.TokenInt));

RegRegisterMethod(TParser,'TokenString',TypeInfo(_T133),[TypeInfo(string)],Addr(TParser.TokenString));

RegRegisterMethod(TParser,'TokenSymbolIs',TypeInfo(_T134),[
TypeInfo(string),TypeInfo(Boolean)],Addr(TParser.TokenSymbolIs));

RegRegisterMethod(TPersistent,'AssignTo',TypeInfo(_T135),[
TypeInfo(TPersistent)], pointer(0));

RegRegisterMethod(TPersistent,'DefineProperties',TypeInfo(_T136),[
TypeInfo(TFiler)], pointer(4));

RegRegisterMethod(TPersistent,'GetOwner',TypeInfo(_T137),[TypeInfo(TPersistent)], pointer(MinVMTOffset - 0));

RegRegisterMethod(TPersistent,'Assign',TypeInfo(_T138),[
TypeInfo(TPersistent)], pointer(8));

RegRegisterMethod(TPersistent,'GetNamePath',TypeInfo(_T139),[TypeInfo(string)], pointer(MinVMTOffset - 1));

RegRegisterMethod(TReader,'Error',TypeInfo(_T140),[
TypeInfo(string),TypeInfo(Boolean)], pointer(12));

RegRegisterMethod(TReader,'FindMethod',TypeInfo(_T141),[
TypeInfo(TComponent),
TypeInfo(string),TypeInfoPointer], pointer(16));

RegRegisterMethod(TReader,'SetName',TypeInfo(_T142),[
TypeInfo(TComponent),
TypeInfo(string)], pointer(20));

RegRegisterMethod(TReader,'ReferenceName',TypeInfo(_T143),[
TypeInfo(string)], pointer(24));

RegRegisterMethod(TReader,'BeginReferences',TypeInfo(_T145),NoParams,Addr(TReader.BeginReferences));

RegRegisterMethod(TReader,'EndOfList',TypeInfo(_T146),[TypeInfo(Boolean)],Addr(TReader.EndOfList));

RegRegisterMethod(TReader,'EndReferences',TypeInfo(_T147),NoParams,Addr(TReader.EndReferences));

RegRegisterMethod(TReader,'FixupReferences',TypeInfo(_T148),NoParams,Addr(TReader.FixupReferences));

RegRegisterMethod(TReader,'NextValue',TypeInfo(_T149),[TypeInfo(TValueType)],Addr(TReader.NextValue));

RegRegisterMethod(TReader,'Read',TypeInfo(_T150),[
TypeInfoUntyped,
TypeInfo(Longint)],Addr(TReader.Read));

RegRegisterMethod(TReader,'ReadBoolean',TypeInfo(_T151),[TypeInfo(Boolean)],Addr(TReader.ReadBoolean));

RegRegisterMethod(TReader,'ReadChar',TypeInfo(_T152),[TypeInfo(Char)],Addr(TReader.ReadChar));

RegRegisterMethod(TReader,'ReadCollection',TypeInfo(_T153),[
TypeInfo(TCollection)],Addr(TReader.ReadCollection));

RegRegisterMethod(TReader,'ReadComponent',TypeInfo(_T154),[
TypeInfo(TComponent),TypeInfo(TComponent)],Addr(TReader.ReadComponent));

RegRegisterMethod(TReader,'ReadFloat',TypeInfo(_T156),[TypeInfo(Extended)],Addr(TReader.ReadFloat));

RegRegisterMethod(TReader,'ReadIdent',TypeInfo(_T157),[TypeInfo(string)],Addr(TReader.ReadIdent));

RegRegisterMethod(TReader,'ReadInteger',TypeInfo(_T158),[TypeInfo(Longint)],Addr(TReader.ReadInteger));

RegRegisterMethod(TReader,'ReadListBegin',TypeInfo(_T159),NoParams,Addr(TReader.ReadListBegin));

RegRegisterMethod(TReader,'ReadListEnd',TypeInfo(_T160),NoParams,Addr(TReader.ReadListEnd));

RegRegisterMethod(TReader,'ReadPrefix',TypeInfo(_T161),[
TypeInfo(TFilerFlags),
TypeInfo(Integer)],Addr(TReader.ReadPrefix));

RegRegisterMethod(TReader,'ReadRootComponent',TypeInfo(_T162),[
TypeInfo(TComponent),TypeInfo(TComponent)],Addr(TReader.ReadRootComponent));

RegRegisterMethod(TReader,'ReadSignature',TypeInfo(_T163),NoParams,Addr(TReader.ReadSignature));

RegRegisterMethod(TReader,'ReadStr',TypeInfo(_T164),[TypeInfo(string)],Addr(TReader.ReadStr));

RegRegisterMethod(TReader,'ReadString',TypeInfo(_T165),[TypeInfo(string)],Addr(TReader.ReadString));

RegRegisterMethod(TReader,'ReadValue',TypeInfo(_T166),[TypeInfo(TValueType)],Addr(TReader.ReadValue));

RegRegisterMethod(TReader,'CopyValue',TypeInfo(_T167),[
TypeInfo(TWriter)],Addr(TReader.CopyValue));

RegRegisterMethod(TStream,'SetSize',TypeInfo(_T170),[
TypeInfo(Longint)], pointer(0));

RegRegisterMethod(TStream,'Read',TypeInfo(_T171),[
TypeInfoUntyped,
TypeInfo(Longint),TypeInfo(Longint)], pointer(4));

RegRegisterMethod(TStream,'Write',TypeInfo(_T172),[
TypeInfoUntyped,
TypeInfo(Longint),TypeInfo(Longint)], pointer(8));

RegRegisterMethod(TStream,'Seek',TypeInfo(_T173),[
TypeInfo(Longint),
TypeInfo(Word),TypeInfo(Longint)], pointer(12));

RegRegisterMethod(TStream,'ReadBuffer',TypeInfo(_T174),[
TypeInfoUntyped,
TypeInfo(Longint)],Addr(TStream.ReadBuffer));

RegRegisterMethod(TStream,'WriteBuffer',TypeInfo(_T175),[
TypeInfoUntyped,
TypeInfo(Longint)],Addr(TStream.WriteBuffer));

RegRegisterMethod(TStream,'CopyFrom',TypeInfo(_T176),[
TypeInfo(TStream),
TypeInfo(Longint),TypeInfo(Longint)],Addr(TStream.CopyFrom));

RegRegisterMethod(TStream,'ReadComponent',TypeInfo(_T177),[
TypeInfo(TComponent),TypeInfo(TComponent)],Addr(TStream.ReadComponent));

RegRegisterMethod(TStream,'ReadComponentRes',TypeInfo(_T178),[
TypeInfo(TComponent),TypeInfo(TComponent)],Addr(TStream.ReadComponentRes));

RegRegisterMethod(TStream,'WriteComponent',TypeInfo(_T179),[
TypeInfo(TComponent)],Addr(TStream.WriteComponent));

RegRegisterMethod(TStream,'WriteComponentRes',TypeInfo(_T180),[
TypeInfo(string),
TypeInfo(TComponent)],Addr(TStream.WriteComponentRes));

RegRegisterMethod(TStream,'WriteDescendent',TypeInfo(_T181),[
TypeInfo(TComponent),
TypeInfo(TComponent)],Addr(TStream.WriteDescendent));

RegRegisterMethod(TStream,'WriteDescendentRes',TypeInfo(_T182),[
TypeInfo(string),
TypeInfo(TComponent),
TypeInfo(TComponent)],Addr(TStream.WriteDescendentRes));

RegRegisterMethod(TStream,'ReadResHeader',TypeInfo(_T183),NoParams,Addr(TStream.ReadResHeader));

RegisterProc(TStreamAdapter,'Create',mtConstructor,TypeInfo(_T184),[
TypeInfo(TStream)],Addr(TStreamAdapter.Create),cRegister);

RegisterProc(TStreamAdapter,'Read',mtMethod,TypeInfo(_T185),[
TypeInfoPointer,
TypeInfo(Longint),
TypeInfoPointer,TypeInfo(HResult)],Addr(TStreamAdapter.Read),cStdCall);

RegisterProc(TStreamAdapter,'Write',mtMethod,TypeInfo(_T186),[
TypeInfoPointer,
TypeInfo(Longint),
TypeInfoPointer,TypeInfo(HResult)],Addr(TStreamAdapter.Write),cStdCall);

RegisterProc(TStreamAdapter,'Seek',mtMethod,TypeInfo(_T187),[
TypeInfo(Largeint),
TypeInfo(Longint),
TypeInfo(Largeint),TypeInfo(HResult)],Addr(TStreamAdapter.Seek),cStdCall);

RegisterProc(TStreamAdapter,'SetSize',mtMethod,TypeInfo(_T188),[
TypeInfo(Largeint),TypeInfo(HResult)],Addr(TStreamAdapter.SetSize),cStdCall);

RegisterProc(TStreamAdapter,'Commit',mtMethod,TypeInfo(_T190),[
TypeInfo(Longint),TypeInfo(HResult)],Addr(TStreamAdapter.Commit),cStdCall);

RegisterProc(TStreamAdapter,'Revert',mtMethod,TypeInfo(_T191),[TypeInfo(HResult)],Addr(TStreamAdapter.Revert),cStdCall);

RegisterProc(TStreamAdapter,'LockRegion',mtMethod,TypeInfo(_T192),[
TypeInfo(Largeint),
TypeInfo(Largeint),
TypeInfo(Longint),TypeInfo(HResult)],Addr(TStreamAdapter.LockRegion),cStdCall);

RegisterProc(TStreamAdapter,'UnlockRegion',mtMethod,TypeInfo(_T193),[
TypeInfo(Largeint),
TypeInfo(Largeint),
TypeInfo(Longint),TypeInfo(HResult)],Addr(TStreamAdapter.UnlockRegion),cStdCall);

RegRegisterMethod(TStringList,'Changed',TypeInfo(_T196),NoParams, pointer(112));

RegRegisterMethod(TStringList,'Changing',TypeInfo(_T197),NoParams, pointer(116));

RegRegisterMethod(TStringList,'Find',TypeInfo(_T198),[
TypeInfo(string),
TypeInfo(Integer),TypeInfo(Boolean)], pointer(120));

RegRegisterMethod(TStringList,'Sort',TypeInfo(_T199),NoParams, pointer(124));

RegRegisterMethod(TStrings,'Get',TypeInfo(_T200),[
TypeInfo(Integer),TypeInfo(string)], pointer(12));

RegRegisterMethod(TStrings,'GetCapacity',TypeInfo(_T201),[TypeInfo(Integer)], pointer(16));

RegRegisterMethod(TStrings,'GetCount',TypeInfo(_T202),[TypeInfo(Integer)], pointer(20));

RegRegisterMethod(TStrings,'GetObject',TypeInfo(_T203),[
TypeInfo(Integer),TypeInfo(TObject)], pointer(24));

RegRegisterMethod(TStrings,'GetTextStr',TypeInfo(_T204),[TypeInfo(string)], pointer(28));

RegRegisterMethod(TStrings,'Put',TypeInfo(_T205),[
TypeInfo(Integer),
TypeInfo(string)], pointer(32));

RegRegisterMethod(TStrings,'PutObject',TypeInfo(_T206),[
TypeInfo(Integer),
TypeInfo(TObject)], pointer(36));

RegRegisterMethod(TStrings,'SetCapacity',TypeInfo(_T207),[
TypeInfo(Integer)], pointer(40));

RegRegisterMethod(TStrings,'SetTextStr',TypeInfo(_T208),[
TypeInfo(string)], pointer(44));

RegRegisterMethod(TStrings,'SetUpdateState',TypeInfo(_T209),[
TypeInfo(Boolean)], pointer(48));

RegRegisterMethod(TStrings,'Add',TypeInfo(_T210),[
TypeInfo(string),TypeInfo(Integer)], pointer(52));

RegRegisterMethod(TStrings,'AddObject',TypeInfo(_T211),[
TypeInfo(string),
TypeInfo(TObject),TypeInfo(Integer)], pointer(56));

RegRegisterMethod(TStrings,'Append',TypeInfo(_T212),[
TypeInfo(string)],Addr(TStrings.Append));

RegRegisterMethod(TStrings,'AddStrings',TypeInfo(_T213),[
TypeInfo(TStrings)], pointer(60));

RegRegisterMethod(TStrings,'BeginUpdate',TypeInfo(_T214),NoParams,Addr(TStrings.BeginUpdate));

RegRegisterMethod(TStrings,'Clear',TypeInfo(_T215),NoParams, pointer(64));

RegRegisterMethod(TStrings,'Delete',TypeInfo(_T216),[
TypeInfo(Integer)], pointer(68));

RegRegisterMethod(TStrings,'EndUpdate',TypeInfo(_T217),NoParams,Addr(TStrings.EndUpdate));

RegRegisterMethod(TStrings,'Equals',TypeInfo(_T218),[
TypeInfo(TStrings),TypeInfo(Boolean)],Addr(TStrings.Equals));

RegRegisterMethod(TStrings,'Exchange',TypeInfo(_T219),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(72));

RegRegisterMethod(TStrings,'GetText',TypeInfo(_T220),[TypeInfoPChar], pointer(76));

RegRegisterMethod(TStrings,'IndexOf',TypeInfo(_T221),[
TypeInfo(string),TypeInfo(Integer)], pointer(80));

RegRegisterMethod(TStrings,'IndexOfName',TypeInfo(_T222),[
TypeInfo(string),TypeInfo(Integer)],Addr(TStrings.IndexOfName));

RegRegisterMethod(TStrings,'IndexOfObject',TypeInfo(_T223),[
TypeInfo(TObject),TypeInfo(Integer)],Addr(TStrings.IndexOfObject));

RegRegisterMethod(TStrings,'Insert',TypeInfo(_T224),[
TypeInfo(Integer),
TypeInfo(string)], pointer(84));

RegRegisterMethod(TStrings,'InsertObject',TypeInfo(_T225),[
TypeInfo(Integer),
TypeInfo(string),
TypeInfo(TObject)],Addr(TStrings.InsertObject));

RegRegisterMethod(TStrings,'LoadFromFile',TypeInfo(_T226),[
TypeInfo(string)], pointer(88));

RegRegisterMethod(TStrings,'LoadFromStream',TypeInfo(_T227),[
TypeInfo(TStream)], pointer(92));

RegRegisterMethod(TStrings,'Move',TypeInfo(_T228),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(96));

RegRegisterMethod(TStrings,'SaveToFile',TypeInfo(_T229),[
TypeInfo(string)], pointer(100));

RegRegisterMethod(TStrings,'SaveToStream',TypeInfo(_T230),[
TypeInfo(TStream)], pointer(104));

RegisterProc(TStringStream,'Create',mtConstructor,TypeInfo(_T232),[
TypeInfo(string)],Addr(TStringStream.Create),cRegister);

RegRegisterMethod(TStringStream,'ReadString',TypeInfo(_T233),[
TypeInfo(Longint),TypeInfo(string)],Addr(TStringStream.ReadString));

RegRegisterMethod(TStringStream,'WriteString',TypeInfo(_T234),[
TypeInfo(string)],Addr(TStringStream.WriteString));

RegRegisterMethod(TThread,'DoTerminate',TypeInfo(_T235),NoParams, pointer(0));

RegRegisterMethod(TThread,'Execute',TypeInfo(_T236),NoParams, pointer(4));

RegisterProc(TThread,'Create',mtConstructor,TypeInfo(_T237),[
TypeInfo(Boolean)],Addr(TThread.Create),cRegister);

RegRegisterMethod(TThread,'Resume',TypeInfo(_T238),NoParams,Addr(TThread.Resume));

RegRegisterMethod(TThread,'Suspend',TypeInfo(_T239),NoParams,Addr(TThread.Suspend));

RegRegisterMethod(TThread,'Terminate',TypeInfo(_T240),NoParams,Addr(TThread.Terminate));

RegRegisterMethod(TThread,'WaitFor',TypeInfo(_T241),[TypeInfo(Integer)],Addr(TThread.WaitFor));

RegisterProc(TThreadList,'Create',mtConstructor,TypeInfo(_T242),NoParams,Addr(TThreadList.Create),cRegister);

RegRegisterMethod(TThreadList,'Add',TypeInfo(_T243),[
TypeInfoPointer],Addr(TThreadList.Add));

RegRegisterMethod(TThreadList,'Clear',TypeInfo(_T244),NoParams,Addr(TThreadList.Clear));

RegRegisterMethod(TThreadList,'LockList',TypeInfo(_T245),[TypeInfo(TList)],Addr(TThreadList.LockList));

RegRegisterMethod(TThreadList,'Remove',TypeInfo(_T246),[
TypeInfoPointer],Addr(TThreadList.Remove));

RegRegisterMethod(TThreadList,'UnlockList',TypeInfo(_T247),NoParams,Addr(TThreadList.UnlockList));

RegRegisterMethod(TWriter,'WriteData',TypeInfo(_T248),[
TypeInfo(TComponent)], pointer(12));

RegRegisterMethod(TWriter,'Write',TypeInfo(_T249),[
TypeInfoUntyped,
TypeInfo(Longint)],Addr(TWriter.Write));

RegRegisterMethod(TWriter,'WriteBoolean',TypeInfo(_T250),[
TypeInfo(Boolean)],Addr(TWriter.WriteBoolean));

RegRegisterMethod(TWriter,'WriteCollection',TypeInfo(_T251),[
TypeInfo(TCollection)],Addr(TWriter.WriteCollection));

RegRegisterMethod(TWriter,'WriteComponent',TypeInfo(_T252),[
TypeInfo(TComponent)],Addr(TWriter.WriteComponent));

RegRegisterMethod(TWriter,'WriteChar',TypeInfo(_T253),[
TypeInfo(Char)],Addr(TWriter.WriteChar));

RegRegisterMethod(TWriter,'WriteDescendent',TypeInfo(_T254),[
TypeInfo(TComponent),
TypeInfo(TComponent)],Addr(TWriter.WriteDescendent));

RegRegisterMethod(TWriter,'WriteFloat',TypeInfo(_T255),[
TypeInfo(Extended)],Addr(TWriter.WriteFloat));

RegRegisterMethod(TWriter,'WriteIdent',TypeInfo(_T256),[
TypeInfo(string)],Addr(TWriter.WriteIdent));

RegRegisterMethod(TWriter,'WriteInteger',TypeInfo(_T257),[
TypeInfo(Longint)],Addr(TWriter.WriteInteger));

RegRegisterMethod(TWriter,'WriteListBegin',TypeInfo(_T258),NoParams,Addr(TWriter.WriteListBegin));

RegRegisterMethod(TWriter,'WriteListEnd',TypeInfo(_T259),NoParams,Addr(TWriter.WriteListEnd));

RegRegisterMethod(TWriter,'WriteRootComponent',TypeInfo(_T260),[
TypeInfo(TComponent)],Addr(TWriter.WriteRootComponent));

RegRegisterMethod(TWriter,'WriteSignature',TypeInfo(_T261),NoParams,Addr(TWriter.WriteSignature));

RegRegisterMethod(TWriter,'WriteStr',TypeInfo(_T262),[
TypeInfo(string)],Addr(TWriter.WriteStr));

RegRegisterMethod(TWriter,'WriteString',TypeInfo(_T263),[
...
{RegisterProc(TCollection,'Create',mtConstructor,TypeInfo(_T46),[
TypeInfo(TCollectionItemClass)],Addr(TCollection.Create),cRegister)}

{RegRegisterMethod(TComponent,'GetChildren',TypeInfo(_T57),[
TypeInfo(TGetChildProc),
TypeInfo(TComponent)], pointer(MinVMTOffset - 2))}

{RegRegisterMethod(TFiler,'DefineProperty',TypeInfo(_T86),[
TypeInfo(string),
TypeInfo(TReaderProc),
TypeInfo(TWriterProc),
TypeInfo(Boolean)], pointer(0))}

{RegRegisterMethod(TFiler,'DefineBinaryProperty',TypeInfo(_T87),[
TypeInfo(string),
TypeInfo(TStreamProc),
TypeInfo(TStreamProc),
TypeInfo(Boolean)], pointer(4))}

{RegRegisterMethod(TInterfaceList,'First',TypeInfo(_T95),[TypeInfo(IUnknown)],Addr(TInterfaceList.First))}

{RegRegisterMethod(TInterfaceList,'IndexOf',TypeInfo(_T96),[
TypeInfo(IUnknown),TypeInfo(Integer)],Addr(TInterfaceList.IndexOf))}

{RegRegisterMethod(TInterfaceList,'Add',TypeInfo(_T97),[
TypeInfo(IUnknown),TypeInfo(Integer)],Addr(TInterfaceList.Add))}

{RegRegisterMethod(TInterfaceList,'Insert',TypeInfo(_T98),[
TypeInfo(Integer),
TypeInfo(IUnknown)],Addr(TInterfaceList.Insert))}

{RegRegisterMethod(TInterfaceList,'Last',TypeInfo(_T99),[TypeInfo(IUnknown)],Addr(TInterfaceList.Last))}

{RegRegisterMethod(TInterfaceList,'Remove',TypeInfo(_T100),[
TypeInfo(IUnknown),TypeInfo(Integer)],Addr(TInterfaceList.Remove))}

{RegRegisterMethod(TList,'Sort',TypeInfo(_T115),[
TypeInfo(TListSortCompare)],Addr(TList.Sort))}

{RegisterProc(TOwnedCollection,'Create',mtConstructor,TypeInfo(_T120),[
TypeInfo(TPersistent),
TypeInfo(TCollectionItemClass)],Addr(TOwnedCollection.Create),cRegister)}

{RegRegisterMethod(TReader,'FindAncestorComponent',TypeInfo(_T144),[
TypeInfo(string),
TypeInfo(TPersistentClass),TypeInfo(TComponent)], pointer(28))}

{RegRegisterMethod(TReader,'ReadComponents',TypeInfo(_T155),[
TypeInfo(TComponent),
TypeInfo(TComponent),
TypeInfo(TReadComponentsProc)],Addr(TReader.ReadComponents))}

{RegisterProc(TResourceStream,'Create',mtConstructor,TypeInfo(_T168),[
TypeInfo(THandle),
TypeInfo(string),
TypeInfoPChar],Addr(TResourceStream.Create),cRegister)}

{RegisterProc(TResourceStream,'CreateFromID',mtConstructor,TypeInfo(_T169),[
TypeInfo(THandle),
TypeInfo(Integer),
TypeInfoPChar],Addr(TResourceStream.CreateFromID),cRegister)}

{RegisterProc(TStreamAdapter,'CopyTo',mtMethod,TypeInfo(_T189),[
TypeInfo(IStream),
TypeInfo(Largeint),
TypeInfo(Largeint),
TypeInfo(Largeint),TypeInfo(HResult)],Addr(TStreamAdapter.CopyTo),cStdCall)}

{RegisterProc(TStreamAdapter,'Stat',mtMethod,TypeInfo(_T194),[
TypeInfo(TStatStg),
TypeInfo(Longint),TypeInfo(HResult)],Addr(TStreamAdapter.Stat),cStdCall)}

{RegisterProc(TStreamAdapter,'Clone',mtMethod,TypeInfo(_T195),[
TypeInfo(IStream),TypeInfo(HResult)],Addr(TStreamAdapter.Clone),cStdCall)}

{RegRegisterMethod(TStrings,'SetText',TypeInfo(_T231),[
