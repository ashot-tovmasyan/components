...
RegRegisterMethod(TCustomDCOleControl,'GetOleName',TypeInfo(_T93),[TypeInfo(string)], pointer(184));
...
TypeInfo(Integer),TypeInfo(string)], pointer(196));

RegRegisterMethod(TDCCustomControl,'UpdateKeyMapping',TypeInfo(_T97),NoParams, pointer(184));

RegRegisterMethod(TDCCustomControl,'InitDefaultKeyMapping',TypeInfo(_T98),NoParams, pointer(188));

RegRegisterMethod(TDCCustomControl,'InsertChar',TypeInfo(_T99),[
TypeInfo(Char),TypeInfo(Boolean)], pointer(192));
...
{RegRegisterMethod(TCustomDCOleControl,'GetOleObject',TypeInfo(_T94),[TypeInfo(IOleObject)], pointer(188))}
