...
_T8 = procedure (p0 : DBIResult) of object;

_T9 = _T8;

{_T10 = procedure (const p0 : TBDEInitProc) of object;}
...
{_T14 = function : hDBICur of object;}
...
_T30 = function : TUpdateStatus of object;
...
_T42 = function : TBDEDataSet of object;

_T43 = procedure (p0 : TBDEDataSet) of object;

_T44 = procedure (p0 : TUpdateKind) of object;

_T45 = _T12;

{_T46 = function : IProvider of object;}
...
_T53 = procedure (p0 : TParams;
p1 : TParamType) of object;

_T54 = procedure (p0 : TField) of object;

_T55 = procedure (p0 : TField;
const p1 : Variant) of object;

_T56 = _T12;

_T57 = procedure (p0 : Pointer) of object;

_T58 = function : Integer of object;

_T59 = procedure (const p0 : string;
p1 : TBlobType) of object;
...
_T63 = procedure (p0 : TStrings) of object;

_T64 = _T12;

_T65 = procedure (p0 : TParams) of object;

_T66 = procedure (p0 : TParam) of object;

_T67 = _T66;

_T68 = function (p0 : TFieldType;
const p1 : string;
p2 : TParamType): TParam of object;
...
_T72 = function (p0 : TParams): Boolean of object;

_T73 = function (const p0 : string): TParam of object;
...
_T80 = procedure (const p0 : string;
const p1 : string;
...
_T87 = function (const p0 : string): TDatabase of object;
...
_T98 = function (const p0 : string): Boolean of object;

_T99 = procedure (p0 : string;
p1 : TStrings) of object;
...
_T107 = function (const p0 : string): TSession of object;
...
_T129 = function (const p0 : Array of Const): Boolean of object;

_T130 = procedure (const p0 : Array of Const) of object;
...
_T135 = procedure (p0 : TLockType) of object;
...
_T139 = procedure (const p0 : Array of Const;
...
function __DC__GetTDatabase__DataSetCount(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := TDatabase(Instance).DataSetCount;
end;
...
begin
TParam(Instance).AsBlob:=OleVariant(Params^[0]);
end;
...
function __DC__GetTParam__DataType(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := TParam(Instance).DataType;
end;

procedure __DC__SetTParam__DataType(Instance : TObject; Params : PVariantArgList);
begin
TParam(Instance).DataType:=OleVariant(Params^[0]);
end;
...
function __DC__GetTParam__Name(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := TParam(Instance).Name;
end;

procedure __DC__SetTParam__Name(Instance : TObject; Params : PVariantArgList);
begin
TParam(Instance).Name:=OleVariant(Params^[0]);
end;

function __DC__GetTParam__ParamType(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := TParam(Instance).ParamType;
end;

procedure __DC__SetTParam__ParamType(Instance : TObject; Params : PVariantArgList);
begin
TParam(Instance).ParamType:=OleVariant(Params^[0]);
end;
...
function __DC__GetTParam__Value(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := TParam(Instance).Value;
end;

procedure __DC__SetTParam__Value(Instance : TObject; Params : PVariantArgList);
begin
TParam(Instance).Value:=OleVariant(Params^[0]);
end;
...
RegisterProperty(TDatabase,'DataSetCount',__DC__GetTDatabase__DataSetCount,nil);
...
RegisterProperty(TParam,'DataType',__DC__GetTParam__DataType,__DC__SetTParam__DataType);
RegisterProperty(TParam,'IsNull',__DC__GetTParam__IsNull,nil);
RegisterProperty(TParam,'Name',__DC__GetTParam__Name,__DC__SetTParam__Name);
RegisterProperty(TParam,'ParamType',__DC__GetTParam__ParamType,__DC__SetTParam__ParamType);
RegisterProperty(TParam,'Text',__DC__GetTParam__Text,__DC__SetTParam__Text);
RegisterProperty(TParam,'Value',__DC__GetTParam__Value,__DC__SetTParam__Value);
...
RegisterIndexedProperty(TParams,'Items',1,True,__DC__GetTParams__Items,nil);
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[11] ,cfmVirtual));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[12] ,cfmPersistent));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[13] ,cfmSession));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[14] ,dbOpen));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[15] ,dbClose));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[16] ,dbAdd));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[17] ,dbRemove));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[18] ,dbAddAlias));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[19] ,dbDeleteAlias));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[20] ,dbAddDriver));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[21] ,dbDeleteDriver));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[22] ,tfQPrepare));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[23] ,tfQExecute));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[24] ,tfError));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[25] ,tfStmt));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[26] ,tfConnect));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[27] ,tfTransact));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[28] ,tfBlob));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[29] ,tfMisc));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[30] ,tfVendor));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[31] ,tfDataIn));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[32] ,tfDataOut));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[33] ,tiDirtyRead));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[34] ,tiReadCommitted));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[35] ,tiRepeatableRead));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[36] ,rnDbase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[37] ,rnParadox));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[38] ,rnNotSupported));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[39] ,uaFail));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[40] ,uaAbort));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[41] ,uaSkip));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[42] ,uaRetry));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[43] ,uaApplied));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[44] ,rtModified));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[45] ,rtInserted));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[46] ,rtDeleted));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[47] ,rtUnmodified));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[48] ,kiLookup));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[49] ,kiRangeStart));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[50] ,kiRangeEnd));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[51] ,kiCurRangeStart));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[52] ,kiCurRangeEnd));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[53] ,kiSave));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[54] ,upWhereAll));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[55] ,upWhereChanged));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[56] ,upWhereKeyOnly));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[57] ,batAppend));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[58] ,batUpdate));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[59] ,batAppendUpdate));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[60] ,batDelete));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[61] ,batCopy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[62] ,ttDefault));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[63] ,ttParadox));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[64] ,ttDBase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[65] ,ttFoxPro));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[66] ,ttASCII));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[67] ,ltReadLock));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[68] ,ltWriteLock));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[69] ,ptUnknown));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[70] ,ptInput));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[71] ,ptOutput));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[72] ,ptInputOutput));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[73] ,ptResult));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[74] ,pbByName));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[75] ,pbByNumber));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[76] ,VarFromSet(cmVirtual, sizeof(cmVirtual))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[77] ,VarFromSet(cmPersistent, sizeof(cmPersistent))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[78] ,VarFromSet(cmSession, sizeof(cmSession))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[79] ,VarFromSet(cmAll, sizeof(cmAll))));
end;
...
RegisterProc(EDBEngineError,'Create',mtConstructor,TypeInfo(_T11),[
TypeInfo(DBIResult)],Addr(EDBEngineError.Create),cRegister);

RegRegisterMethod(TBatchMove,'Execute',TypeInfo(_T12),NoParams,Addr(TBatchMove.Execute));

RegRegisterMethod(TBDEDataSet,'DestroyHandle',TypeInfo(_T15),NoParams, pointer(440));

RegRegisterMethod(TBDEDataSet,'DestroyLookupCursor',TypeInfo(_T16),NoParams, pointer(444));

RegRegisterMethod(TBDEDataSet,'PrepareCursor',TypeInfo(_T18),NoParams, pointer(452));

RegRegisterMethod(TBDEDataSet,'ApplyUpdates',TypeInfo(_T19),NoParams,Addr(TBDEDataSet.ApplyUpdates));

RegRegisterMethod(TBDEDataSet,'CancelUpdates',TypeInfo(_T20),NoParams,Addr(TBDEDataSet.CancelUpdates));

RegRegisterMethod(TBDEDataSet,'CommitUpdates',TypeInfo(_T21),NoParams,Addr(TBDEDataSet.CommitUpdates));

RegRegisterMethod(TBDEDataSet,'ConstraintsDisabled',TypeInfo(_T23),[TypeInfo(Boolean)],Addr(TBDEDataSet.ConstraintsDisabled));

RegRegisterMethod(TBDEDataSet,'DisableConstraints',TypeInfo(_T24),NoParams,Addr(TBDEDataSet.DisableConstraints));

RegRegisterMethod(TBDEDataSet,'EnableConstraints',TypeInfo(_T25),NoParams,Addr(TBDEDataSet.EnableConstraints));

RegRegisterMethod(TBDEDataSet,'FetchAll',TypeInfo(_T26),NoParams,Addr(TBDEDataSet.FetchAll));

RegRegisterMethod(TBDEDataSet,'FlushBuffers',TypeInfo(_T27),NoParams,Addr(TBDEDataSet.FlushBuffers));

RegRegisterMethod(TBDEDataSet,'GetIndexInfo',TypeInfo(_T28),NoParams,Addr(TBDEDataSet.GetIndexInfo));

RegRegisterMethod(TBDEDataSet,'RevertRecord',TypeInfo(_T29),NoParams,Addr(TBDEDataSet.RevertRecord));

RegRegisterMethod(TBDEDataSet,'UpdateStatus',TypeInfo(_T30),[TypeInfo(TUpdateStatus)],Addr(TBDEDataSet.UpdateStatus));
...
RegRegisterMethod(TDatabase,'Close',TypeInfo(_T34),NoParams,Addr(TDatabase.Close));

RegRegisterMethod(TDatabase,'CloseDataSets',TypeInfo(_T35),NoParams,Addr(TDatabase.CloseDataSets));

RegRegisterMethod(TDatabase,'Commit',TypeInfo(_T36),NoParams,Addr(TDatabase.Commit));

RegRegisterMethod(TDatabase,'FlushSchemaCache',TypeInfo(_T37),[
TypeInfo(string)],Addr(TDatabase.FlushSchemaCache));

RegRegisterMethod(TDatabase,'Open',TypeInfo(_T38),NoParams,Addr(TDatabase.Open));

RegRegisterMethod(TDatabase,'Rollback',TypeInfo(_T39),NoParams,Addr(TDatabase.Rollback));

RegRegisterMethod(TDatabase,'StartTransaction',TypeInfo(_T40),NoParams,Addr(TDatabase.StartTransaction));

RegRegisterMethod(TDatabase,'ValidateName',TypeInfo(_T41),[
TypeInfo(string)],Addr(TDatabase.ValidateName));

RegRegisterMethod(TDataSetUpdateObject,'GetDataSet',TypeInfo(_T42),[TypeInfo(TBDEDataSet)], pointer(44));

RegRegisterMethod(TDataSetUpdateObject,'SetDataSet',TypeInfo(_T43),[
TypeInfo(TBDEDataSet)], pointer(48));

RegRegisterMethod(TDataSetUpdateObject,'Apply',TypeInfo(_T44),[
TypeInfo(TUpdateKind)], pointer(52));

RegRegisterMethod(TDBDataSet,'Disconnect',TypeInfo(_T45),NoParams, pointer(456));

RegRegisterMethod(TDBDataSet,'SetDBFlag',TypeInfo(_T47),[
TypeInfo(Integer),
TypeInfo(Boolean),TypeInfo(Boolean)], pointer(464));
...
RegisterProc(TParam,'Create',mtConstructor,TypeInfo(_T53),[
TypeInfo(TParams),
TypeInfo(TParamType)],Addr(TParam.Create),cRegister);

RegRegisterMethod(TParam,'AssignField',TypeInfo(_T54),[
TypeInfo(TField)],Addr(TParam.AssignField));

RegRegisterMethod(TParam,'AssignFieldValue',TypeInfo(_T55),[
TypeInfo(TField),
TypeInfo(Variant)],Addr(TParam.AssignFieldValue));

RegRegisterMethod(TParam,'Clear',TypeInfo(_T56),NoParams,Addr(TParam.Clear));

RegRegisterMethod(TParam,'GetData',TypeInfo(_T57),[
TypeInfoPointer],Addr(TParam.GetData));

RegRegisterMethod(TParam,'GetDataSize',TypeInfo(_T58),[TypeInfo(Integer)],Addr(TParam.GetDataSize));

RegRegisterMethod(TParam,'LoadFromFile',TypeInfo(_T59),[
TypeInfo(string),
TypeInfo(TBlobType)],Addr(TParam.LoadFromFile));

RegRegisterMethod(TParam,'LoadFromStream',TypeInfo(_T60),[
TypeInfo(TStream),
TypeInfo(TBlobType)],Addr(TParam.LoadFromStream));

RegRegisterMethod(TParam,'SetBlobData',TypeInfo(_T61),[
TypeInfoPointer,
TypeInfo(Integer)],Addr(TParam.SetBlobData));

RegRegisterMethod(TParam,'SetData',TypeInfo(_T62),[
TypeInfoPointer],Addr(TParam.SetData));

RegisterProc(TParamList,'Create',mtConstructor,TypeInfo(_T63),[
TypeInfo(TStrings)],Addr(TParamList.Create),cRegister);

RegisterProc(TParams,'Create',mtConstructor,TypeInfo(_T64),NoParams, pointer(12),cRegister);

RegRegisterMethod(TParams,'AssignValues',TypeInfo(_T65),[
TypeInfo(TParams)],Addr(TParams.AssignValues));

RegRegisterMethod(TParams,'AddParam',TypeInfo(_T66),[
TypeInfo(TParam)],Addr(TParams.AddParam));

RegRegisterMethod(TParams,'RemoveParam',TypeInfo(_T67),[
TypeInfo(TParam)],Addr(TParams.RemoveParam));

RegRegisterMethod(TParams,'CreateParam',TypeInfo(_T68),[
TypeInfo(TFieldType),
TypeInfo(string),
TypeInfo(TParamType),TypeInfo(TParam)],Addr(TParams.CreateParam));

RegRegisterMethod(TParams,'Count',TypeInfo(_T69),[TypeInfo(Integer)],Addr(TParams.Count));

RegRegisterMethod(TParams,'Clear',TypeInfo(_T70),NoParams,Addr(TParams.Clear));

RegRegisterMethod(TParams,'GetParamList',TypeInfo(_T71),[
TypeInfo(TList),
TypeInfo(string)],Addr(TParams.GetParamList));

RegRegisterMethod(TParams,'IsEqual',TypeInfo(_T72),[
TypeInfo(TParams),TypeInfo(Boolean)],Addr(TParams.IsEqual));

RegRegisterMethod(TParams,'ParamByName',TypeInfo(_T73),[
TypeInfo(string),TypeInfo(TParam)],Addr(TParams.ParamByName));

RegRegisterMethod(TQuery,'ExecSQL',TypeInfo(_T74),NoParams,Addr(TQuery.ExecSQL));

RegRegisterMethod(TQuery,'ParamByName',TypeInfo(_T75),[
TypeInfo(string),TypeInfo(TParam)],Addr(TQuery.ParamByName));

RegRegisterMethod(TQuery,'Prepare',TypeInfo(_T76),NoParams,Addr(TQuery.Prepare));

RegRegisterMethod(TQuery,'UnPrepare',TypeInfo(_T77),NoParams,Addr(TQuery.UnPrepare));

RegRegisterMethod(TSession,'AddAlias',TypeInfo(_T78),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.AddAlias));

RegRegisterMethod(TSession,'AddDriver',TypeInfo(_T79),[
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.AddDriver));

RegRegisterMethod(TSession,'AddStandardAlias',TypeInfo(_T80),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(string)],Addr(TSession.AddStandardAlias));

RegRegisterMethod(TSession,'AddPassword',TypeInfo(_T81),[
TypeInfo(string)],Addr(TSession.AddPassword));

RegRegisterMethod(TSession,'Close',TypeInfo(_T82),NoParams,Addr(TSession.Close));

RegRegisterMethod(TSession,'CloseDatabase',TypeInfo(_T83),[
TypeInfo(TDatabase)],Addr(TSession.CloseDatabase));

RegRegisterMethod(TSession,'DeleteAlias',TypeInfo(_T84),[
TypeInfo(string)],Addr(TSession.DeleteAlias));

RegRegisterMethod(TSession,'DeleteDriver',TypeInfo(_T85),[
TypeInfo(string)],Addr(TSession.DeleteDriver));

RegRegisterMethod(TSession,'DropConnections',TypeInfo(_T86),NoParams,Addr(TSession.DropConnections));

RegRegisterMethod(TSession,'FindDatabase',TypeInfo(_T87),[
TypeInfo(string),TypeInfo(TDatabase)],Addr(TSession.FindDatabase));

RegRegisterMethod(TSession,'GetAliasNames',TypeInfo(_T88),[
TypeInfo(TStrings)],Addr(TSession.GetAliasNames));

RegRegisterMethod(TSession,'GetAliasParams',TypeInfo(_T89),[
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.GetAliasParams));

RegRegisterMethod(TSession,'GetAliasDriverName',TypeInfo(_T90),[
TypeInfo(string),TypeInfo(string)],Addr(TSession.GetAliasDriverName));

RegRegisterMethod(TSession,'GetConfigParams',TypeInfo(_T91),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.GetConfigParams));

RegRegisterMethod(TSession,'GetDatabaseNames',TypeInfo(_T92),[
TypeInfo(TStrings)],Addr(TSession.GetDatabaseNames));

RegRegisterMethod(TSession,'GetDriverNames',TypeInfo(_T93),[
TypeInfo(TStrings)],Addr(TSession.GetDriverNames));

RegRegisterMethod(TSession,'GetDriverParams',TypeInfo(_T94),[
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.GetDriverParams));

RegRegisterMethod(TSession,'GetPassword',TypeInfo(_T95),[TypeInfo(Boolean)],Addr(TSession.GetPassword));

RegRegisterMethod(TSession,'GetTableNames',TypeInfo(_T96),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(Boolean),
TypeInfo(Boolean),
...
RegRegisterMethod(TSession,'GetStoredProcNames',TypeInfo(_T97),[
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.GetStoredProcNames));

RegRegisterMethod(TSession,'IsAlias',TypeInfo(_T98),[
TypeInfo(string),TypeInfo(Boolean)],Addr(TSession.IsAlias));

RegRegisterMethod(TSession,'ModifyAlias',TypeInfo(_T99),[
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.ModifyAlias));

RegRegisterMethod(TSession,'ModifyDriver',TypeInfo(_T100),[
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.ModifyDriver));

RegRegisterMethod(TSession,'Open',TypeInfo(_T101),NoParams,Addr(TSession.Open));

RegRegisterMethod(TSession,'OpenDatabase',TypeInfo(_T102),[
TypeInfo(string),TypeInfo(TDatabase)],Addr(TSession.OpenDatabase));

RegRegisterMethod(TSession,'RemoveAllPasswords',TypeInfo(_T103),NoParams,Addr(TSession.RemoveAllPasswords));

RegRegisterMethod(TSession,'RemovePassword',TypeInfo(_T104),[
TypeInfo(string)],Addr(TSession.RemovePassword));

RegRegisterMethod(TSession,'SaveConfigFile',TypeInfo(_T105),NoParams,Addr(TSession.SaveConfigFile));

RegisterProc(TSessionList,'Create',mtConstructor,TypeInfo(_T106),NoParams,Addr(TSessionList.Create),cRegister);

RegRegisterMethod(TSessionList,'FindSession',TypeInfo(_T107),[
TypeInfo(string),TypeInfo(TSession)],Addr(TSessionList.FindSession));

RegRegisterMethod(TSessionList,'GetSessionNames',TypeInfo(_T108),[
TypeInfo(TStrings)],Addr(TSessionList.GetSessionNames));

RegRegisterMethod(TSessionList,'OpenSession',TypeInfo(_T109),[
TypeInfo(string),TypeInfo(TSession)],Addr(TSessionList.OpenSession));

RegRegisterMethod(TStoredProc,'CopyParams',TypeInfo(_T110),[
TypeInfo(TParams)],Addr(TStoredProc.CopyParams));

RegRegisterMethod(TStoredProc,'DescriptionsAvailable',TypeInfo(_T111),[TypeInfo(Boolean)],Addr(TStoredProc.DescriptionsAvailable));

RegRegisterMethod(TStoredProc,'ExecProc',TypeInfo(_T112),NoParams,Addr(TStoredProc.ExecProc));

RegRegisterMethod(TStoredProc,'ParamByName',TypeInfo(_T113),[
TypeInfo(string),TypeInfo(TParam)],Addr(TStoredProc.ParamByName));

RegRegisterMethod(TStoredProc,'Prepare',TypeInfo(_T114),NoParams,Addr(TStoredProc.Prepare));

RegRegisterMethod(TStoredProc,'GetResults',TypeInfo(_T115),NoParams,Addr(TStoredProc.GetResults));

RegRegisterMethod(TStoredProc,'UnPrepare',TypeInfo(_T116),NoParams,Addr(TStoredProc.UnPrepare));

RegRegisterMethod(TTable,'BatchMove',TypeInfo(_T117),[
TypeInfo(TBDEDataSet),
TypeInfo(TBatchMode),TypeInfo(Longint)],Addr(TTable.BatchMove));

RegRegisterMethod(TTable,'AddIndex',TypeInfo(_T118),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(TIndexOptions)],Addr(TTable.AddIndex));

RegRegisterMethod(TTable,'ApplyRange',TypeInfo(_T119),NoParams,Addr(TTable.ApplyRange));

RegRegisterMethod(TTable,'CancelRange',TypeInfo(_T120),NoParams,Addr(TTable.CancelRange));

RegRegisterMethod(TTable,'CloseIndexFile',TypeInfo(_T121),[
TypeInfo(string)],Addr(TTable.CloseIndexFile));

RegRegisterMethod(TTable,'CreateTable',TypeInfo(_T122),NoParams,Addr(TTable.CreateTable));

RegRegisterMethod(TTable,'DeleteIndex',TypeInfo(_T123),[
TypeInfo(string)],Addr(TTable.DeleteIndex));

RegRegisterMethod(TTable,'DeleteTable',TypeInfo(_T124),NoParams,Addr(TTable.DeleteTable));

RegRegisterMethod(TTable,'EditKey',TypeInfo(_T125),NoParams,Addr(TTable.EditKey));

RegRegisterMethod(TTable,'EditRangeEnd',TypeInfo(_T126),NoParams,Addr(TTable.EditRangeEnd));

RegRegisterMethod(TTable,'EditRangeStart',TypeInfo(_T127),NoParams,Addr(TTable.EditRangeStart));

RegRegisterMethod(TTable,'EmptyTable',TypeInfo(_T128),NoParams,Addr(TTable.EmptyTable));

RegRegisterMethod(TTable,'FindKey',TypeInfo(_T129),[
TypeInfoArrayOfConst,TypeInfo(Boolean)],Addr(TTable.FindKey));

RegRegisterMethod(TTable,'FindNearest',TypeInfo(_T130),[
TypeInfoArrayOfConst],Addr(TTable.FindNearest));

RegRegisterMethod(TTable,'GetIndexNames',TypeInfo(_T131),[
TypeInfo(TStrings)],Addr(TTable.GetIndexNames));

RegRegisterMethod(TTable,'GotoCurrent',TypeInfo(_T132),[
TypeInfo(TTable)],Addr(TTable.GotoCurrent));

RegRegisterMethod(TTable,'GotoKey',TypeInfo(_T133),[TypeInfo(Boolean)],Addr(TTable.GotoKey));

RegRegisterMethod(TTable,'GotoNearest',TypeInfo(_T134),NoParams,Addr(TTable.GotoNearest));

RegRegisterMethod(TTable,'LockTable',TypeInfo(_T135),[
TypeInfo(TLockType)],Addr(TTable.LockTable));

RegRegisterMethod(TTable,'OpenIndexFile',TypeInfo(_T136),[
TypeInfo(string)],Addr(TTable.OpenIndexFile));

RegRegisterMethod(TTable,'RenameTable',TypeInfo(_T137),[
TypeInfo(string)],Addr(TTable.RenameTable));

RegRegisterMethod(TTable,'SetKey',TypeInfo(_T138),NoParams,Addr(TTable.SetKey));

RegRegisterMethod(TTable,'SetRange',TypeInfo(_T139),[
TypeInfoArrayOfConst,
TypeInfoArrayOfConst],Addr(TTable.SetRange));

RegRegisterMethod(TTable,'SetRangeEnd',TypeInfo(_T140),NoParams,Addr(TTable.SetRangeEnd));

RegRegisterMethod(TTable,'SetRangeStart',TypeInfo(_T141),NoParams,Addr(TTable.SetRangeStart));

RegRegisterMethod(TTable,'UnlockTable',TypeInfo(_T142),[
TypeInfo(TLockType)],Addr(TTable.UnlockTable));

RegRegisterMethod(TUpdateSQL,'ExecSQL',TypeInfo(_T143),[
TypeInfo(TUpdateKind)],Addr(TUpdateSQL.ExecSQL));

RegRegisterMethod(TUpdateSQL,'SetParams',TypeInfo(_T144),[
...
{RegisterProc(nil,'RegisterBDEInitProc',mtProc,TypeInfo(_T10),[
TypeInfo(TBDEInitProc)],Addr(RegisterBDEInitProc),cRegister)}

{RegisterProc(TBDECallback,'Create',mtConstructor,TypeInfo(_T13),[
TypeInfo(TObject),
TypeInfoPointer,
TypeInfo(CBType),
TypeInfoPointer,
...
{RegRegisterMethod(TBDEDataSet,'CreateHandle',TypeInfo(_T14),[TypeInfoPointer], pointer(436))}

{RegRegisterMethod(TBDEDataSet,'GetLookupCursor',TypeInfo(_T17),[
TypeInfo(string),
TypeInfo(Boolean),TypeInfoPointer], pointer(448))}

{RegRegisterMethod(TDBDataSet,'GetProvider',TypeInfo(_T46),[TypeInfo(IProvider)], pointer(460))}
...
RegisterEvent(TypeInfo(TOnServerYieldEvent),[
TypeInfo(TDataSet),
TypeInfo(Boolean)]);
