...
_T22 = function : TComClassManager of object;
...
{_T25 = procedure (p0 : IUnknown) of object;}
...
_T29 = function (out p0 : Integer): HResult of object;
...
{_T31 = procedure (const p0 : IUnknown) of object;}

_T34 = procedure  of object;

{_T35 = procedure (p0 : TComServerObject;
p1 : TFactoryProc) of object;}

{_T36 = function (p0 : TClass): TComObjectFactory of object;}

_T37 = function (const p0 : IDispatch): TComObjectFactory of object;

_T38 = _T34;

{_T39 = procedure (const p0 : IUnknown) of object;}

{_T40 = procedure (p0 : TComObjectFactory;
...
_T46 = function : WideString of object;

_T47 = function : Boolean of object;

_T48 = function (const p0 : WideString): Boolean of object;

{_T50 = function (const p0 : IUnknown): TComObject of object;}

_T51 = _T34;

_T52 = procedure (p0 : Boolean) of object;

_T53 = function (p0 : Boolean): Integer of object;
...
{_T60 = function : ITypeLib of object;}
...
RegisterProc(nil,MethodNames[12],mtProc,TypeInfo(_T15),[
TypeInfo(string),
TypeInfo(string),TypeInfo(string)],Addr(GetRegStringValue),cRegister);
...
RegisterProc(nil,MethodNames[15],mtProc,TypeInfo(_T19),[TypeInfo(string)],Addr(CreateClassID),cRegister);

RegisterProc(nil,MethodNames[16],mtProc,TypeInfo(_T22),[TypeInfo(TComClassManager)],Addr(ComClassManager),cRegister);

RegisterProc(EOleException,'Create',mtConstructor,TypeInfo(_T23),[
TypeInfo(string),
TypeInfo(HResult),
TypeInfo(string),
TypeInfo(string),
...
RegisterProc(EOleSysError,'Create',mtConstructor,TypeInfo(_T24),[
TypeInfo(string),
TypeInfo(HResult),
TypeInfo(Integer)],Addr(EOleSysError.Create),cRegister);

RegisterProc(TAutoObject,'GetIDsOfNames',mtMethod,TypeInfo(_T27),[
TypeInfo(IDispatch),
TypeInfoPointer,
TypeInfo(Integer),
TypeInfo(Integer),
...
RegisterProc(TAutoObject,'GetTypeInfo',mtMethod,TypeInfo(_T28),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfoUntyped,TypeInfo(HResult)], pointer(20),cStdCall);

RegisterProc(TAutoObject,'GetTypeInfoCount',mtMethod,TypeInfo(_T29),[
TypeInfo(Integer),TypeInfo(HResult)], pointer(24),cStdCall);

RegisterProc(TAutoObject,'Invoke',mtMethod,TypeInfo(_T30),[
TypeInfo(Integer),
TypeInfo(IDispatch),
TypeInfo(Integer),
TypeInfo(Word),
...
RegisterProc(TComClassManager,'Create',mtConstructor,TypeInfo(_T34),NoParams,Addr(TComClassManager.Create),cRegister);

RegRegisterMethod(TComClassManager,'GetFactoryFromClassID',TypeInfo(_T37),[
TypeInfo(IDispatch),TypeInfo(TComObjectFactory)],Addr(__TComClassManager__GetFactoryFromClassID__Wrapper));

RegisterProc(TComObject,'Create',mtConstructor,TypeInfo(_T38),NoParams,Addr(TComObject.Create),cRegister);

RegRegisterMethod(TComObject,'Initialize',TypeInfo(_T41),NoParams, pointer(0));

RegisterProc(TComObject,'ObjAddRef',mtMethod,TypeInfo(_T42),[TypeInfo(Integer)], pointer(4),cStdCall);

RegisterProc(TComObject,'ObjQueryInterface',mtMethod,TypeInfo(_T43),[
TypeInfo(IDispatch),
TypeInfoUntyped,TypeInfo(HResult)], pointer(8),cRegister);

RegisterProc(TComObject,'ObjRelease',mtMethod,TypeInfo(_T44),[TypeInfo(Integer)], pointer(12),cStdCall);

RegRegisterMethod(TComObjectFactory,'GetProgID',TypeInfo(_T45),[TypeInfo(string)], pointer(0));

RegRegisterMethod(TComObjectFactory,'GetLicenseString',TypeInfo(_T46),[TypeInfo(WideString)], pointer(4));

RegRegisterMethod(TComObjectFactory,'HasMachineLicense',TypeInfo(_T47),[TypeInfo(Boolean)], pointer(8));

RegRegisterMethod(TComObjectFactory,'ValidateUserLicense',TypeInfo(_T48),[
TypeInfo(WideString),TypeInfo(Boolean)], pointer(12));

RegRegisterMethod(TComObjectFactory,'RegisterClassObject',TypeInfo(_T51),NoParams,Addr(TComObjectFactory.RegisterClassObject));

RegRegisterMethod(TComObjectFactory,'UpdateRegistry',TypeInfo(_T52),[
TypeInfo(Boolean)], pointer(20));

RegRegisterMethod(TComServerObject,'CountObject',TypeInfo(_T53),[
TypeInfo(Boolean),TypeInfo(Integer)], pointer(0));

RegRegisterMethod(TComServerObject,'CountFactory',TypeInfo(_T54),[
TypeInfo(Boolean),TypeInfo(Integer)], pointer(4));

RegRegisterMethod(TComServerObject,'GetHelpFileName',TypeInfo(_T55),[TypeInfo(string)], pointer(8));

RegRegisterMethod(TComServerObject,'GetServerFileName',TypeInfo(_T56),[TypeInfo(string)], pointer(12));

RegRegisterMethod(TComServerObject,'GetServerKey',TypeInfo(_T57),[TypeInfo(string)], pointer(16));

RegRegisterMethod(TComServerObject,'GetServerName',TypeInfo(_T58),[TypeInfo(string)], pointer(20));

RegRegisterMethod(TComServerObject,'GetStartSuspended',TypeInfo(_T59),[TypeInfo(Boolean)], pointer(24));

RegRegisterMethod(TComServerObject,'SetHelpFileName',TypeInfo(_T61),[
TypeInfo(string)], pointer(32));

RegisterProc(TContainedObject,'QueryInterface',mtMethod,TypeInfo(_T62),[
TypeInfo(IDispatch),
...
{RegisterProc(TAggregatedObject,'Create',mtConstructor,TypeInfo(_T25),[
TypeInfo(IUnknown)],Addr(TAggregatedObject.Create),cRegister)}

{RegRegisterMethod(TAutoObject,'EventSinkChanged',TypeInfo(_T31),[
TypeInfo(IUnknown)], pointer(32))}

{RegRegisterMethod(TComClassManager,'ForEachFactory',TypeInfo(_T35),[
TypeInfo(TComServerObject),
TypeInfo(TFactoryProc)],Addr(TComClassManager.ForEachFactory))}

{RegRegisterMethod(TComClassManager,'GetFactoryFromClass',TypeInfo(_T36),[
TypeInfo(TClass),TypeInfo(TComObjectFactory)],Addr(TComClassManager.GetFactoryFromClass))}

{RegisterProc(TComObject,'CreateAggregated',mtConstructor,TypeInfo(_T39),[
TypeInfo(IUnknown)],Addr(TComObject.CreateAggregated),cRegister)}

{RegisterProc(TComObject,'CreateFromFactory',mtConstructor,TypeInfo(_T40),[
TypeInfo(TComObjectFactory),
TypeInfo(IUnknown)],Addr(TComObject.CreateFromFactory),cRegister)}

{RegRegisterMethod(TComObjectFactory,'CreateComObject',TypeInfo(_T50),[
TypeInfo(IUnknown),TypeInfo(TComObject)], pointer(16))}

{RegRegisterMethod(TComServerObject,'GetTypeLib',TypeInfo(_T60),[TypeInfo(ITypeLib)], pointer(28))}
