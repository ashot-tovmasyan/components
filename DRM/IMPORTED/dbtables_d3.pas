...
function __DC__GetTTable__IndexDefs(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := VarFromObject(TTable(Instance).IndexDefs);
end;
...
RegisterProperty(TTable,'IndexDefs',__DC__GetTTable__IndexDefs,nil);
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[10] ,cfmVirtual));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[11] ,cfmPersistent));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[12] ,cfmSession));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[13] ,dbOpen));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[14] ,dbClose));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[15] ,dbAdd));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[16] ,dbRemove));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[17] ,dbAddAlias));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[18] ,dbDeleteAlias));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[19] ,dbAddDriver));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[20] ,dbDeleteDriver));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[21] ,tfQPrepare));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[22] ,tfQExecute));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[23] ,tfError));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[24] ,tfStmt));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[25] ,tfConnect));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[26] ,tfTransact));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[27] ,tfBlob));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[28] ,tfMisc));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[29] ,tfVendor));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[30] ,tfDataIn));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[31] ,tfDataOut));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[32] ,tiDirtyRead));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[33] ,tiReadCommitted));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[34] ,tiRepeatableRead));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[35] ,rnDbase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[36] ,rnParadox));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[37] ,rnNotSupported));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[38] ,uaFail));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[39] ,uaAbort));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[40] ,uaSkip));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[41] ,uaRetry));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[42] ,uaApplied));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[43] ,rtModified));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[44] ,rtInserted));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[45] ,rtDeleted));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[46] ,rtUnmodified));
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[53] ,upWhereAll));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[54] ,upWhereChanged));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[55] ,upWhereKeyOnly));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[56] ,batAppend));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[57] ,batUpdate));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[58] ,batAppendUpdate));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[59] ,batDelete));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[60] ,batCopy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[61] ,ttDefault));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[62] ,ttParadox));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[63] ,ttDBase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[64] ,ttASCII));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[65] ,ltReadLock));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[66] ,ltWriteLock));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[67] ,ptUnknown));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[68] ,ptInput));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[69] ,ptOutput));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[70] ,ptInputOutput));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[71] ,ptResult));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[72] ,pbByName));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[73] ,pbByNumber));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[74] ,VarFromSet(cmVirtual, sizeof(cmVirtual))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[75] ,VarFromSet(cmPersistent, sizeof(cmPersistent))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[76] ,VarFromSet(cmSession, sizeof(cmSession))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[77] ,VarFromSet(cmAll, sizeof(cmAll))));
end;
...
RegRegisterMethod(TBDEDataSet,'DestroyHandle',TypeInfo(_T15),NoParams, pointer(432));

RegRegisterMethod(TBDEDataSet,'DestroyLookupCursor',TypeInfo(_T16),NoParams, pointer(436));

RegRegisterMethod(TBDEDataSet,'PrepareCursor',TypeInfo(_T18),NoParams, pointer(444));
...
RegRegisterMethod(TDataSetUpdateObject,'GetDataSet',TypeInfo(_T42),[TypeInfo(TBDEDataSet)], pointer(40));

RegRegisterMethod(TDataSetUpdateObject,'SetDataSet',TypeInfo(_T43),[
TypeInfo(TBDEDataSet)], pointer(44));

RegRegisterMethod(TDataSetUpdateObject,'Apply',TypeInfo(_T44),[
TypeInfo(TUpdateKind)], pointer(48));

RegRegisterMethod(TDBDataSet,'Disconnect',TypeInfo(_T45),NoParams, pointer(448));

RegRegisterMethod(TDBDataSet,'SetDBFlag',TypeInfo(_T47),[
TypeInfo(Integer),
TypeInfo(Boolean)], pointer(456));
...
{RegRegisterMethod(TBDEDataSet,'CreateHandle',TypeInfo(_T14),[TypeInfoPointer], pointer(428))}

{RegRegisterMethod(TBDEDataSet,'GetLookupCursor',TypeInfo(_T17),[
TypeInfo(string),
TypeInfo(Boolean),TypeInfoPointer], pointer(440))}

{RegisterProc(TBDEDataSet,'ConstraintCallBack',mtMethod,TypeInfo(_T22),[
TypeInfo(DsInfoReq),
TypeInfo(DataSources),TypeInfo(DBIResult)],Addr(TBDEDataSet.ConstraintCallBack),cStdCall)}

{RegRegisterMethod(TDBDataSet,'GetProvider',TypeInfo(_T46),[TypeInfo(IProvider)], pointer(452))}
