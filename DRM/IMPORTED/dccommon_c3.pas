...
RegRegisterMethod(TCustomDCOleControl,'GetOleName',TypeInfo(_T92),[TypeInfo(string)], pointer(132));
...
TypeInfo(Integer),TypeInfo(string)], pointer(144));

RegRegisterMethod(TDCCustomControl,'UpdateKeyMapping',TypeInfo(_T96),NoParams, pointer(132));

RegRegisterMethod(TDCCustomControl,'InitDefaultKeyMapping',TypeInfo(_T97),NoParams, pointer(136));

RegRegisterMethod(TDCCustomControl,'InsertChar',TypeInfo(_T98),[
TypeInfo(Char),TypeInfo(Boolean)], pointer(140));
...
RegRegisterMethod(TDCPropStore,'Load',TypeInfo(_T105),NoParams, pointer(44));

RegRegisterMethod(TDCPropStore,'Save',TypeInfo(_T106),NoParams, pointer(48));
...
{RegRegisterMethod(TCustomDCOleControl,'GetOleObject',TypeInfo(_T93),[TypeInfo(IOleObject)], pointer(136))}
