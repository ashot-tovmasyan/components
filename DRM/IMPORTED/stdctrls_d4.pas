...
_T42 = function (p0 : Integer): IDispatch of object;

_T43 = function : IDispatch of object;

_T44 = _T3;

_T45 = procedure (p0 : TScrollCode;
var p1 : Integer) of object;
...
RegRegisterMethod(TButtonControl,'GetChecked',TypeInfo(_T1),[TypeInfo(Boolean)], pointer(184));

RegRegisterMethod(TButtonControl,'SetChecked',TypeInfo(_T2),[
TypeInfo(Boolean)], pointer(188));

RegRegisterMethod(TCustomCheckBox,'Toggle',TypeInfo(_T3),NoParams, pointer(192));

RegRegisterMethod(TCustomComboBox,'ComboWndProc',TypeInfo(_T4),[
TypeInfo(IDispatch),
TypeInfo(HWnd),
TypeInfoPointer], pointer(184));

RegRegisterMethod(TCustomComboBox,'DrawItem',TypeInfo(_T5),[
TypeInfo(Integer),
TypeInfo(IDispatch),
TypeInfo(TOwnerDrawState)], pointer(188));

RegRegisterMethod(TCustomComboBox,'GetComboControl',TypeInfo(_T6),[TypeInfo(HWnd)], pointer(192));

RegRegisterMethod(TCustomComboBox,'MeasureItem',TypeInfo(_T7),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(196));

RegRegisterMethod(TCustomComboBox,'Change',TypeInfo(_T8),NoParams, pointer(MinVMTOffset - 71));

RegRegisterMethod(TCustomComboBox,'DropDown',TypeInfo(_T9),NoParams, pointer(MinVMTOffset - 72));

RegRegisterMethod(TCustomComboBox,'SetStyle',TypeInfo(_T10),[
TypeInfo(TComboBoxStyle)], pointer(200));
...
RegRegisterMethod(TCustomEdit,'Change',TypeInfo(_T13),NoParams, pointer(MinVMTOffset - 71));

RegRegisterMethod(TCustomEdit,'DoSetMaxLength',TypeInfo(_T14),[
TypeInfo(Integer)], pointer(184));

RegRegisterMethod(TCustomEdit,'GetSelLength',TypeInfo(_T15),[TypeInfo(Integer)], pointer(188));

RegRegisterMethod(TCustomEdit,'GetSelStart',TypeInfo(_T16),[TypeInfo(Integer)], pointer(192));

RegRegisterMethod(TCustomEdit,'GetSelText',TypeInfo(_T17),[TypeInfo(string)], pointer(196));
...
RegRegisterMethod(TCustomEdit,'Clear',TypeInfo(_T20),NoParams, pointer(208));
...
RegRegisterMethod(TCustomLabel,'AdjustBounds',TypeInfo(_T30),NoParams, pointer(MinVMTOffset - 49));

RegRegisterMethod(TCustomLabel,'DoDrawText',TypeInfo(_T31),[
TypeInfo(IDispatch),
TypeInfo(Longint)], pointer(MinVMTOffset - 50));

RegRegisterMethod(TCustomLabel,'GetLabelText',TypeInfo(_T32),[TypeInfo(string)], pointer(140));
...
RegRegisterMethod(TCustomListBox,'GetItemData',TypeInfo(_T36),[
TypeInfo(Integer),TypeInfo(Longint)], pointer(MinVMTOffset - 71));

RegRegisterMethod(TCustomListBox,'SetItemData',TypeInfo(_T37),[
TypeInfo(Integer),
TypeInfo(Longint)], pointer(MinVMTOffset - 72));

RegRegisterMethod(TCustomListBox,'ResetContent',TypeInfo(_T38),NoParams, pointer(MinVMTOffset - 73));

RegRegisterMethod(TCustomListBox,'DeleteString',TypeInfo(_T39),[
TypeInfo(Integer)], pointer(MinVMTOffset - 74));

RegRegisterMethod(TCustomListBox,'Clear',TypeInfo(_T40),NoParams,Addr(TCustomListBox.Clear));

RegRegisterMethod(TCustomListBox,'ItemAtPos',TypeInfo(_T41),[
TypeInfo(IDispatch),
TypeInfo(Boolean),TypeInfo(Integer)],Addr(__TCustomListBox__ItemAtPos__Wrapper));

RegRegisterMethod(TCustomListBox,'ItemRect',TypeInfo(_T42),[
TypeInfo(Integer),TypeInfo(IDispatch)],Addr(__TCustomListBox__ItemRect__Wrapper));

RegRegisterMethod(TCustomMemo,'GetCaretPos',TypeInfo(_T43),[TypeInfo(IDispatch)], pointer(216));

RegRegisterMethod(TScrollBar,'Change',TypeInfo(_T44),NoParams, pointer(MinVMTOffset - 71));

RegRegisterMethod(TScrollBar,'Scroll',TypeInfo(_T45),[
TypeInfo(TScrollCode),
TypeInfo(Integer)], pointer(MinVMTOffset - 72));

RegRegisterMethod(TScrollBar,'SetParams',TypeInfo(_T46),[
TypeInfo(Integer),
TypeInfo(Integer),
...
TypeInfoPChar,
TypeInfo(Integer),TypeInfo(Integer)], pointer(212))}
