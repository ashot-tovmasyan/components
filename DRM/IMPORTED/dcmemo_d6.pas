...
RegRegisterMethod(TCustomDCMemo,'CreateDefaultMemoSource',TypeInfo(_T19),[TypeInfo(TCustomMemoSource)], pointer(220));
...
TypeInfo(IDispatch),
TypeInfo(TDrawState),TypeInfo(Boolean)], pointer(228));

RegRegisterMethod(TCustomDCMemo,'DoGetFontFromStyle',TypeInfo(_T22),[
TypeInfo(Integer),
TypeInfo(TFont),
TypeInfo(TColor)], pointer(232));

RegRegisterMethod(TCustomDCMemo,'CreatePrintDialog',TypeInfo(_T23),[TypeInfo(TCustomForm)], pointer(236));

RegRegisterMethod(TCustomDCMemo,'CreatePrintProgressDialog',TypeInfo(_T24),[TypeInfo(TCustomForm)], pointer(240));

RegRegisterMethod(TCustomDCMemo,'TemplateInsert',TypeInfo(_T25),[
TypeInfo(TStrings)], pointer(244));

RegRegisterMethod(TCustomDCMemo,'HintInsert',TypeInfo(_T26),[
TypeInfo(string)], pointer(248));

RegRegisterMethod(TCustomDCMemo,'ActivatePopupBox',TypeInfo(_T27),[
TypeInfo(TPopupType),TypeInfo(Boolean)], pointer(252));

RegRegisterMethod(TCustomDCMemo,'MarkWordOnTemplate',TypeInfo(_T28),NoParams, pointer(256));
...
TypeInfo(TMemoStates)], pointer(280));

RegRegisterMethod(TCustomDCMemo,'SelectionChanged',TypeInfo(_T35),NoParams, pointer(284));

RegRegisterMethod(TCustomDCMemo,'MemoJumpToUrl',TypeInfo(_T36),[
TypeInfo(string)], pointer(288));

RegRegisterMethod(TCustomDCMemo,'CollapseStateChanging',TypeInfo(_T37),[
TypeInfo(Integer),
TypeInfo(TCollapseState),TypeInfo(Boolean)], pointer(292));

RegRegisterMethod(TCustomDCMemo,'CollapseStateChanged',TypeInfo(_T38),[
TypeInfo(Integer),
TypeInfo(TCollapseState)], pointer(296));

RegRegisterMethod(TCustomDCMemo,'DoFindInPopupBox',TypeInfo(_T39),[
TypeInfo(TStrings),
TypeInfo(string),
TypeInfo(Integer),TypeInfo(Boolean)], pointer(300));
...
TypeInfo(string)], pointer(308));

RegRegisterMethod(TCustomDCMemo,'ClosePopupListBox',TypeInfo(_T42),[
TypeInfo(Word),
TypeInfo(TShiftState),TypeInfo(Boolean)], pointer(312));
...
RegRegisterMethod(TCustomDCMemo,'PopupHintBox',TypeInfo(_T60),[TypeInfo(Boolean)], pointer(316));
...
RegRegisterMethod(TCustomDCMemo,'LoadGlobalOptions',TypeInfo(_T80),NoParams, pointer(320));
...
RegRegisterMethod(TCustomDCMemo,'CopyToClipboard',TypeInfo(_T147),NoParams, pointer(324));

RegRegisterMethod(TCustomDCMemo,'CutToClipboard',TypeInfo(_T148),NoParams, pointer(328));

RegRegisterMethod(TCustomDCMemo,'PasteFromClipboard',TypeInfo(_T149),NoParams, pointer(332));
