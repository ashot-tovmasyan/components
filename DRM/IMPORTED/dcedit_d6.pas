...
RegRegisterMethod(TCheckEdit,'GetWinStyle',TypeInfo(_T3),[TypeInfo(Integer)], pointer(200));

RegRegisterMethod(TCustomDCEdit,'RestoreSavedText',TypeInfo(_T4),NoParams, pointer(200));

RegRegisterMethod(TCustomDCEdit,'CheckReadOnly',TypeInfo(_T5),NoParams, pointer(204));

RegRegisterMethod(TCustomDCEdit,'GetText',TypeInfo(_T6),[TypeInfo(string)], pointer(208));
...
RegRegisterMethod(TCustomDCEdit,'SetDropValue',TypeInfo(_T9),NoParams, pointer(220));

RegRegisterMethod(TCustomDCEdit,'GetDropValue',TypeInfo(_T10),NoParams, pointer(224));

RegRegisterMethod(TCustomDCEdit,'GetModified',TypeInfo(_T11),[TypeInfo(Boolean)], pointer(228));

RegRegisterMethod(TCustomDCEdit,'GetReadOnly',TypeInfo(_T12),[TypeInfo(Boolean)], pointer(232));

RegRegisterMethod(TCustomDCEdit,'DoTerm',TypeInfo(_T14),NoParams, pointer(240));

RegRegisterMethod(TCustomDCEdit,'Change',TypeInfo(_T17),NoParams, pointer(252));
...
RegRegisterMethod(TCustomDCEdit,'Drop',TypeInfo(_T20),NoParams, pointer(256));

RegRegisterMethod(TCustomDCEdit,'CloseDropped',TypeInfo(_T21),[
TypeInfo(Boolean)], pointer(260));
...
TypeInfo(TObject)], pointer(264));

RegRegisterMethod(TDCDtEdit,'GetText',TypeInfo(_T24),[TypeInfo(string)], pointer(224));

RegRegisterMethod(TDCDtEdit,'SetText',TypeInfo(_T25),[
TypeInfo(string)], pointer(228));

RegRegisterMethod(TDCPopupListBox,'Popup',TypeInfo(_T26),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TDCPopupListBox.Popup));

RegRegisterMethod(TGraphEdit,'GetGraphic',TypeInfo(_T27),[TypeInfo(TGraphic)], pointer(212));
...
RegRegisterMethod(TGraphicEdit,'GetText',TypeInfo(_T30),[TypeInfo(string)], pointer(208));

RegRegisterMethod(TPopupListBox,'Close',TypeInfo(_T31),[
TypeInfo(Boolean)], pointer(252));

RegRegisterMethod(TPopupListBox,'BuildList',TypeInfo(_T32),NoParams, pointer(256));
...
TypeInfo(TControlClass)], pointer(236))}

{RegRegisterMethod(TCustomDCEdit,'GetDefaultEditorClass',TypeInfo(_T15),[TypeInfo(TControlClass)], pointer(244))}

{RegRegisterMethod(TCustomDCEdit,'GetDefaultPopupClass',TypeInfo(_T16),[TypeInfo(TWinControlClass)], pointer(248))}
