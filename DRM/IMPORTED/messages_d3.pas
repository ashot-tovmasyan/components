...
procedure setActiveWindow(const val : HWND);
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setRemove(const val : HWND);
function getRemove : HWND;
property Remove : HWND read getRemove write setRemove;
procedure setNext(const val : HWND);
function getNext : HWND;
property Next : HWND read getNext write setNext;
procedure setResult(const val : Longint);
function getResult : Longint;
property Result : Longint read getResult write setResult;
end;
...
procedure setListBox(const val : HWND);
function getListBox : HWND;
property ListBox : HWND read getListBox write setListBox;
procedure setResult(const val : Longint);
function getResult : Longint;
property Result : Longint read getResult write setResult;
end;
...
procedure setCtl(const val : HWND);
function getCtl : HWND;
property Ctl : HWND read getCtl write setCtl;
procedure setResult(const val : Longint);
function getResult : Longint;
property Result : Longint read getResult write setResult;
end;
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setFrom(const val : HWND);
function getFrom : HWND;
property From : HWND read getFrom write setFrom;
procedure setResult(const val : Longint);
function getResult : Longint;
property Result : Longint read getResult write setResult;
end;
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setChildDC(const val : HDC);
function getChildDC : HDC;
property ChildDC : HDC read getChildDC write setChildDC;
procedure setChildWnd(const val : HWND);
function getChildWnd : HWND;
property ChildWnd : HWND read getChildWnd write setChildWnd;
procedure setResult(const val : Longint);
function getResult : Longint;
property Result : Longint read getResult write setResult;
end;
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setPostingApp(const val : HWND);
function getPostingApp : HWND;
property PostingApp : HWND read getPostingApp write setPostingApp;
...
procedure setIdleWnd(const val : HWND);
function getIdleWnd : HWND;
property IdleWnd : HWND read getIdleWnd write setIdleWnd;
procedure setResult(const val : Longint);
function getResult : Longint;
property Result : Longint read getResult write setResult;
end;
...
procedure setScrollBar(const val : HWND);
function getScrollBar : HWND;
property ScrollBar : HWND read getScrollBar write setScrollBar;
procedure setResult(const val : Longint);
function getResult : Longint;
property Result : Longint read getResult write setResult;
end;
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setViewer(const val : HWND);
function getViewer : HWND;
property Viewer : HWND read getViewer write setViewer;
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setFocus(const val : HWND);
function getFocus : HWND;
property Focus : HWND read getFocus write setFocus;
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setMenu(const val : HMENU);
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setMenuPopup(const val : HMENU);
function getMenuPopup : HMENU;
property MenuPopup : HMENU read getMenuPopup write setMenuPopup;
procedure setPos(const val : SmallInt);
function getPos : SmallInt;
property Pos : SmallInt read getPos write setPos;
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setFocusedWnd(const val : HWND);
function getFocusedWnd : HWND;
property FocusedWnd : HWND read getFocusedWnd write setFocusedWnd;
procedure setUnused(const val : Longint);
function getUnused : Longint;
property Unused : Longint read getUnused write setUnused;
procedure setResult(const val : Longint);
...
function getChildWnd : HWND;
property ChildWnd : HWND read getChildWnd write setChildWnd;
procedure setDeactiveWnd(const val : HWND);
function getDeactiveWnd : HWND;
property DeactiveWnd : HWND read getDeactiveWnd write setDeactiveWnd;
procedure setActiveWnd(const val : HWND);
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setChild(const val : HWND);
function getChild : HWND;
property Child : HWND read getChild write setChild;
procedure setUnused(const val : Longint);
function getUnused : Longint;
property Unused : Longint read getUnused write setUnused;
procedure setResult(const val : Longint);
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setMaximize(const val : HWND);
function getMaximize : HWND;
property Maximize : HWND read getMaximize write setMaximize;
procedure setUnused(const val : Longint);
function getUnused : Longint;
property Unused : Longint read getUnused write setUnused;
procedure setResult(const val : Longint);
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setIDChild(const val : HWND);
function getIDChild : HWND;
property IDChild : HWND read getIDChild write setIDChild;
procedure setUnused(const val : Longint);
function getUnused : Longint;
property Unused : Longint read getUnused write setUnused;
procedure setResult(const val : Longint);
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setMenuFrame(const val : HMENU);
function getMenuFrame : HMENU;
property MenuFrame : HMENU read getMenuFrame write setMenuFrame;
procedure setMenuWindow(const val : HMENU);
function getMenuWindow : HMENU;
property MenuWindow : HMENU read getMenuWindow write setMenuWindow;
procedure setResult(const val : Longint);
function getResult : Longint;
property Result : Longint read getResult write setResult;
end;
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setIDCtl(const val : HWND);
function getIDCtl : HWND;
property IDCtl : HWND read getIDCtl write setIDCtl;
procedure setResult(const val : Longint);
function getResult : Longint;
property Result : Longint read getResult write setResult;
end;
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setTopLevel(const val : HWND);
function getTopLevel : HWND;
property TopLevel : HWND read getTopLevel write setTopLevel;
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setPalChg(const val : HWND);
function getPalChg : HWND;
property PalChg : HWND read getPalChg write setPalChg;
procedure setUnused(const val : Longint);
function getUnused : Longint;
property Unused : Longint read getUnused write setUnused;
procedure setResult(const val : Longint);
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setRealize(const val : HWND);
function getRealize : HWND;
property Realize : HWND read getRealize write setRealize;
procedure setUnused(const val : Longint);
function getUnused : Longint;
property Unused : Longint read getUnused write setUnused;
procedure setResult(const val : Longint);
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setCursorWnd(const val : HWND);
function getCursorWnd : HWND;
property CursorWnd : HWND read getCursorWnd write setCursorWnd;
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setFont(const val : HFONT);
...
function getBigIcon : LongBool;
property BigIcon : LongBool read getBigIcon write setBigIcon;
procedure setIcon(const val : HICON);
...
function getMsg : Cardinal;
property Msg : Cardinal read getMsg write setMsg;
procedure setActivateWnd(const val : HWND);
function getActivateWnd : HWND;
property ActivateWnd : HWND read getActivateWnd write setActivateWnd;
procedure setKey(const val : Word);
function getKey : Word;
property Key : Word read getKey write setKey;
procedure setXPos(const val : SmallInt);
...
procedure __TWMActivate__Wrapper.setActiveWindow(const val : HWND);
begin
TWMActivate(GetRecordPtr^).ActiveWindow := val;
end;
function __TWMActivate__Wrapper.getActiveWindow : HWND;
begin
result := TWMActivate(GetRecordPtr^).ActiveWindow;
end;
...
procedure __TWMChangeCBChain__Wrapper.setRemove(const val : HWND);
begin
TWMChangeCBChain(GetRecordPtr^).Remove := val;
end;
function __TWMChangeCBChain__Wrapper.getRemove : HWND;
begin
result := TWMChangeCBChain(GetRecordPtr^).Remove;
end;
procedure __TWMChangeCBChain__Wrapper.setNext(const val : HWND);
begin
TWMChangeCBChain(GetRecordPtr^).Next := val;
end;
function __TWMChangeCBChain__Wrapper.getNext : HWND;
begin
result := TWMChangeCBChain(GetRecordPtr^).Next;
end;
...
procedure __TWMCharToItem__Wrapper.setListBox(const val : HWND);
begin
TWMCharToItem(GetRecordPtr^).ListBox := val;
end;
function __TWMCharToItem__Wrapper.getListBox : HWND;
begin
result := TWMCharToItem(GetRecordPtr^).ListBox;
end;
...
procedure __TWMCommand__Wrapper.setCtl(const val : HWND);
begin
TWMCommand(GetRecordPtr^).Ctl := val;
end;
function __TWMCommand__Wrapper.getCtl : HWND;
begin
result := TWMCommand(GetRecordPtr^).Ctl;
end;
...
procedure __TWMCompareItem__Wrapper.setCtl(const val : HWND);
begin
TWMCompareItem(GetRecordPtr^).Ctl := val;
end;
function __TWMCompareItem__Wrapper.getCtl : HWND;
begin
result := TWMCompareItem(GetRecordPtr^).Ctl;
end;
...
procedure __TWMCopyData__Wrapper.setFrom(const val : HWND);
begin
TWMCopyData(GetRecordPtr^).From := val;
end;
function __TWMCopyData__Wrapper.getFrom : HWND;
begin
result := TWMCopyData(GetRecordPtr^).From;
end;
...
procedure __TWMCtlColor__Wrapper.setChildDC(const val : HDC);
begin
TWMCtlColor(GetRecordPtr^).ChildDC := val;
end;
function __TWMCtlColor__Wrapper.getChildDC : HDC;
begin
result := TWMCtlColor(GetRecordPtr^).ChildDC;
end;
procedure __TWMCtlColor__Wrapper.setChildWnd(const val : HWND);
begin
TWMCtlColor(GetRecordPtr^).ChildWnd := val;
end;
function __TWMCtlColor__Wrapper.getChildWnd : HWND;
begin
result := TWMCtlColor(GetRecordPtr^).ChildWnd;
end;
...
procedure __TWMCtlColorBtn__Wrapper.setChildDC(const val : HDC);
begin
TWMCtlColorBtn(GetRecordPtr^).ChildDC := val;
end;
function __TWMCtlColorBtn__Wrapper.getChildDC : HDC;
begin
result := TWMCtlColorBtn(GetRecordPtr^).ChildDC;
end;
procedure __TWMCtlColorBtn__Wrapper.setChildWnd(const val : HWND);
begin
TWMCtlColorBtn(GetRecordPtr^).ChildWnd := val;
end;
function __TWMCtlColorBtn__Wrapper.getChildWnd : HWND;
begin
result := TWMCtlColorBtn(GetRecordPtr^).ChildWnd;
end;
...
procedure __TWMCtlColorDlg__Wrapper.setChildDC(const val : HDC);
begin
TWMCtlColorDlg(GetRecordPtr^).ChildDC := val;
end;
function __TWMCtlColorDlg__Wrapper.getChildDC : HDC;
begin
result := TWMCtlColorDlg(GetRecordPtr^).ChildDC;
end;
procedure __TWMCtlColorDlg__Wrapper.setChildWnd(const val : HWND);
begin
TWMCtlColorDlg(GetRecordPtr^).ChildWnd := val;
end;
function __TWMCtlColorDlg__Wrapper.getChildWnd : HWND;
begin
result := TWMCtlColorDlg(GetRecordPtr^).ChildWnd;
end;
...
procedure __TWMCtlColorEdit__Wrapper.setChildDC(const val : HDC);
begin
TWMCtlColorEdit(GetRecordPtr^).ChildDC := val;
end;
function __TWMCtlColorEdit__Wrapper.getChildDC : HDC;
begin
result := TWMCtlColorEdit(GetRecordPtr^).ChildDC;
end;
procedure __TWMCtlColorEdit__Wrapper.setChildWnd(const val : HWND);
begin
TWMCtlColorEdit(GetRecordPtr^).ChildWnd := val;
end;
function __TWMCtlColorEdit__Wrapper.getChildWnd : HWND;
begin
result := TWMCtlColorEdit(GetRecordPtr^).ChildWnd;
end;
...
procedure __TWMCtlColorListbox__Wrapper.setChildDC(const val : HDC);
begin
TWMCtlColorListbox(GetRecordPtr^).ChildDC := val;
end;
function __TWMCtlColorListbox__Wrapper.getChildDC : HDC;
begin
result := TWMCtlColorListbox(GetRecordPtr^).ChildDC;
end;
procedure __TWMCtlColorListbox__Wrapper.setChildWnd(const val : HWND);
begin
TWMCtlColorListbox(GetRecordPtr^).ChildWnd := val;
end;
function __TWMCtlColorListbox__Wrapper.getChildWnd : HWND;
begin
result := TWMCtlColorListbox(GetRecordPtr^).ChildWnd;
end;
...
procedure __TWMCtlColorMsgbox__Wrapper.setChildDC(const val : HDC);
begin
TWMCtlColorMsgbox(GetRecordPtr^).ChildDC := val;
end;
function __TWMCtlColorMsgbox__Wrapper.getChildDC : HDC;
begin
result := TWMCtlColorMsgbox(GetRecordPtr^).ChildDC;
end;
procedure __TWMCtlColorMsgbox__Wrapper.setChildWnd(const val : HWND);
begin
TWMCtlColorMsgbox(GetRecordPtr^).ChildWnd := val;
end;
function __TWMCtlColorMsgbox__Wrapper.getChildWnd : HWND;
begin
result := TWMCtlColorMsgbox(GetRecordPtr^).ChildWnd;
end;
...
procedure __TWMCtlColorScrollbar__Wrapper.setChildDC(const val : HDC);
begin
TWMCtlColorScrollbar(GetRecordPtr^).ChildDC := val;
end;
function __TWMCtlColorScrollbar__Wrapper.getChildDC : HDC;
begin
result := TWMCtlColorScrollbar(GetRecordPtr^).ChildDC;
end;
procedure __TWMCtlColorScrollbar__Wrapper.setChildWnd(const val : HWND);
begin
TWMCtlColorScrollbar(GetRecordPtr^).ChildWnd := val;
end;
function __TWMCtlColorScrollbar__Wrapper.getChildWnd : HWND;
begin
result := TWMCtlColorScrollbar(GetRecordPtr^).ChildWnd;
end;
...
procedure __TWMCtlColorStatic__Wrapper.setChildDC(const val : HDC);
begin
TWMCtlColorStatic(GetRecordPtr^).ChildDC := val;
end;
function __TWMCtlColorStatic__Wrapper.getChildDC : HDC;
begin
result := TWMCtlColorStatic(GetRecordPtr^).ChildDC;
end;
procedure __TWMCtlColorStatic__Wrapper.setChildWnd(const val : HWND);
begin
TWMCtlColorStatic(GetRecordPtr^).ChildWnd := val;
end;
function __TWMCtlColorStatic__Wrapper.getChildWnd : HWND;
begin
result := TWMCtlColorStatic(GetRecordPtr^).ChildWnd;
end;
...
procedure __TWMDDE_Ack__Wrapper.setPostingApp(const val : HWND);
begin
TWMDDE_Ack(GetRecordPtr^).PostingApp := val;
end;
function __TWMDDE_Ack__Wrapper.getPostingApp : HWND;
begin
result := TWMDDE_Ack(GetRecordPtr^).PostingApp;
end;
...
procedure __TWMDDE_Advise__Wrapper.setPostingApp(const val : HWND);
begin
TWMDDE_Advise(GetRecordPtr^).PostingApp := val;
end;
function __TWMDDE_Advise__Wrapper.getPostingApp : HWND;
begin
result := TWMDDE_Advise(GetRecordPtr^).PostingApp;
end;
...
procedure __TWMDDE_Data__Wrapper.setPostingApp(const val : HWND);
begin
TWMDDE_Data(GetRecordPtr^).PostingApp := val;
end;
function __TWMDDE_Data__Wrapper.getPostingApp : HWND;
begin
result := TWMDDE_Data(GetRecordPtr^).PostingApp;
end;
...
procedure __TWMDDE_Execute__Wrapper.setPostingApp(const val : HWND);
begin
TWMDDE_Execute(GetRecordPtr^).PostingApp := val;
end;
function __TWMDDE_Execute__Wrapper.getPostingApp : HWND;
begin
result := TWMDDE_Execute(GetRecordPtr^).PostingApp;
end;
...
procedure __TWMDDE_Initiate__Wrapper.setPostingApp(const val : HWND);
begin
TWMDDE_Initiate(GetRecordPtr^).PostingApp := val;
end;
function __TWMDDE_Initiate__Wrapper.getPostingApp : HWND;
begin
result := TWMDDE_Initiate(GetRecordPtr^).PostingApp;
end;
...
procedure __TWMDDE_Poke__Wrapper.setPostingApp(const val : HWND);
begin
TWMDDE_Poke(GetRecordPtr^).PostingApp := val;
end;
function __TWMDDE_Poke__Wrapper.getPostingApp : HWND;
begin
result := TWMDDE_Poke(GetRecordPtr^).PostingApp;
end;
...
procedure __TWMDDE_Request__Wrapper.setPostingApp(const val : HWND);
begin
TWMDDE_Request(GetRecordPtr^).PostingApp := val;
end;
function __TWMDDE_Request__Wrapper.getPostingApp : HWND;
begin
result := TWMDDE_Request(GetRecordPtr^).PostingApp;
end;
...
procedure __TWMDDE_Terminate__Wrapper.setPostingApp(const val : HWND);
begin
TWMDDE_Terminate(GetRecordPtr^).PostingApp := val;
end;
function __TWMDDE_Terminate__Wrapper.getPostingApp : HWND;
begin
result := TWMDDE_Terminate(GetRecordPtr^).PostingApp;
end;
...
procedure __TWMDDE_Unadvise__Wrapper.setPostingApp(const val : HWND);
begin
TWMDDE_Unadvise(GetRecordPtr^).PostingApp := val;
end;
function __TWMDDE_Unadvise__Wrapper.getPostingApp : HWND;
begin
result := TWMDDE_Unadvise(GetRecordPtr^).PostingApp;
end;
...
procedure __TWMDeleteItem__Wrapper.setCtl(const val : HWND);
begin
TWMDeleteItem(GetRecordPtr^).Ctl := val;
end;
function __TWMDeleteItem__Wrapper.getCtl : HWND;
begin
result := TWMDeleteItem(GetRecordPtr^).Ctl;
end;
...
procedure __TWMDrawItem__Wrapper.setCtl(const val : HWND);
begin
TWMDrawItem(GetRecordPtr^).Ctl := val;
end;
function __TWMDrawItem__Wrapper.getCtl : HWND;
begin
result := TWMDrawItem(GetRecordPtr^).Ctl;
end;
...
procedure __TWMEnterIdle__Wrapper.setIdleWnd(const val : HWND);
begin
TWMEnterIdle(GetRecordPtr^).IdleWnd := val;
end;
function __TWMEnterIdle__Wrapper.getIdleWnd : HWND;
begin
result := TWMEnterIdle(GetRecordPtr^).IdleWnd;
end;
...
procedure __TWMEraseBkgnd__Wrapper.setDC(const val : HDC);
begin
TWMEraseBkgnd(GetRecordPtr^).DC := val;
end;
function __TWMEraseBkgnd__Wrapper.getDC : HDC;
begin
result := TWMEraseBkgnd(GetRecordPtr^).DC;
end;
...
procedure __TWMHScroll__Wrapper.setScrollBar(const val : HWND);
begin
TWMHScroll(GetRecordPtr^).ScrollBar := val;
end;
function __TWMHScroll__Wrapper.getScrollBar : HWND;
begin
result := TWMHScroll(GetRecordPtr^).ScrollBar;
end;
...
procedure __TWMHScrollClipboard__Wrapper.setViewer(const val : HWND);
begin
TWMHScrollClipboard(GetRecordPtr^).Viewer := val;
end;
function __TWMHScrollClipboard__Wrapper.getViewer : HWND;
begin
result := TWMHScrollClipboard(GetRecordPtr^).Viewer;
end;
...
procedure __TWMIconEraseBkgnd__Wrapper.setDC(const val : HDC);
begin
TWMIconEraseBkgnd(GetRecordPtr^).DC := val;
end;
function __TWMIconEraseBkgnd__Wrapper.getDC : HDC;
begin
result := TWMIconEraseBkgnd(GetRecordPtr^).DC;
end;
...
procedure __TWMInitDialog__Wrapper.setFocus(const val : HWND);
begin
TWMInitDialog(GetRecordPtr^).Focus := val;
end;
function __TWMInitDialog__Wrapper.getFocus : HWND;
begin
result := TWMInitDialog(GetRecordPtr^).Focus;
end;
...
procedure __TWMInitMenu__Wrapper.setMenu(const val : HMENU);
begin
TWMInitMenu(GetRecordPtr^).Menu := val;
end;
function __TWMInitMenu__Wrapper.getMenu : HMENU;
begin
result := TWMInitMenu(GetRecordPtr^).Menu;
end;
...
procedure __TWMInitMenuPopup__Wrapper.setMenuPopup(const val : HMENU);
begin
TWMInitMenuPopup(GetRecordPtr^).MenuPopup := val;
end;
function __TWMInitMenuPopup__Wrapper.getMenuPopup : HMENU;
begin
result := TWMInitMenuPopup(GetRecordPtr^).MenuPopup;
end;
...
procedure __TWMKillFocus__Wrapper.setFocusedWnd(const val : HWND);
begin
TWMKillFocus(GetRecordPtr^).FocusedWnd := val;
end;
function __TWMKillFocus__Wrapper.getFocusedWnd : HWND;
begin
result := TWMKillFocus(GetRecordPtr^).FocusedWnd;
end;
...
procedure __TWMMDIActivate__Wrapper.setChildWnd(const val : HWND);
begin
TWMMDIActivate(GetRecordPtr^).ChildWnd := val;
end;
function __TWMMDIActivate__Wrapper.getChildWnd : HWND;
begin
result := TWMMDIActivate(GetRecordPtr^).ChildWnd;
end;
procedure __TWMMDIActivate__Wrapper.setDeactiveWnd(const val : HWND);
begin
TWMMDIActivate(GetRecordPtr^).DeactiveWnd := val;
end;
function __TWMMDIActivate__Wrapper.getDeactiveWnd : HWND;
begin
result := TWMMDIActivate(GetRecordPtr^).DeactiveWnd;
end;
procedure __TWMMDIActivate__Wrapper.setActiveWnd(const val : HWND);
begin
TWMMDIActivate(GetRecordPtr^).ActiveWnd := val;
end;
function __TWMMDIActivate__Wrapper.getActiveWnd : HWND;
begin
result := TWMMDIActivate(GetRecordPtr^).ActiveWnd;
end;
...
procedure __TWMMDIDestroy__Wrapper.setChild(const val : HWND);
begin
TWMMDIDestroy(GetRecordPtr^).Child := val;
end;
function __TWMMDIDestroy__Wrapper.getChild : HWND;
begin
result := TWMMDIDestroy(GetRecordPtr^).Child;
end;
...
procedure __TWMMDIMaximize__Wrapper.setMaximize(const val : HWND);
begin
TWMMDIMaximize(GetRecordPtr^).Maximize := val;
end;
function __TWMMDIMaximize__Wrapper.getMaximize : HWND;
begin
result := TWMMDIMaximize(GetRecordPtr^).Maximize;
end;
...
procedure __TWMMDINext__Wrapper.setChild(const val : HWND);
begin
TWMMDINext(GetRecordPtr^).Child := val;
end;
function __TWMMDINext__Wrapper.getChild : HWND;
begin
result := TWMMDINext(GetRecordPtr^).Child;
end;
...
procedure __TWMMDIRestore__Wrapper.setIDChild(const val : HWND);
begin
TWMMDIRestore(GetRecordPtr^).IDChild := val;
end;
function __TWMMDIRestore__Wrapper.getIDChild : HWND;
begin
result := TWMMDIRestore(GetRecordPtr^).IDChild;
end;
...
procedure __TWMMDISetMenu__Wrapper.setMenuFrame(const val : HMENU);
begin
TWMMDISetMenu(GetRecordPtr^).MenuFrame := val;
end;
function __TWMMDISetMenu__Wrapper.getMenuFrame : HMENU;
begin
result := TWMMDISetMenu(GetRecordPtr^).MenuFrame;
end;
procedure __TWMMDISetMenu__Wrapper.setMenuWindow(const val : HMENU);
begin
TWMMDISetMenu(GetRecordPtr^).MenuWindow := val;
end;
function __TWMMDISetMenu__Wrapper.getMenuWindow : HMENU;
begin
result := TWMMDISetMenu(GetRecordPtr^).MenuWindow;
end;
...
procedure __TWMMeasureItem__Wrapper.setIDCtl(const val : HWND);
begin
TWMMeasureItem(GetRecordPtr^).IDCtl := val;
end;
function __TWMMeasureItem__Wrapper.getIDCtl : HWND;
begin
result := TWMMeasureItem(GetRecordPtr^).IDCtl;
end;
...
procedure __TWMMenuChar__Wrapper.setMenu(const val : HMENU);
begin
TWMMenuChar(GetRecordPtr^).Menu := val;
end;
function __TWMMenuChar__Wrapper.getMenu : HMENU;
begin
result := TWMMenuChar(GetRecordPtr^).Menu;
end;
...
procedure __TWMMenuSelect__Wrapper.setMenu(const val : HMENU);
begin
TWMMenuSelect(GetRecordPtr^).Menu := val;
end;
function __TWMMenuSelect__Wrapper.getMenu : HMENU;
begin
result := TWMMenuSelect(GetRecordPtr^).Menu;
end;
...
procedure __TWMMouseActivate__Wrapper.setTopLevel(const val : HWND);
begin
TWMMouseActivate(GetRecordPtr^).TopLevel := val;
end;
function __TWMMouseActivate__Wrapper.getTopLevel : HWND;
begin
result := TWMMouseActivate(GetRecordPtr^).TopLevel;
end;
...
procedure __TWMNotifyFormat__Wrapper.setFrom(const val : HWND);
begin
TWMNotifyFormat(GetRecordPtr^).From := val;
end;
function __TWMNotifyFormat__Wrapper.getFrom : HWND;
begin
result := TWMNotifyFormat(GetRecordPtr^).From;
end;
...
procedure __TWMPaintClipboard__Wrapper.setViewer(const val : HWND);
begin
TWMPaintClipboard(GetRecordPtr^).Viewer := val;
end;
function __TWMPaintClipboard__Wrapper.getViewer : HWND;
begin
result := TWMPaintClipboard(GetRecordPtr^).Viewer;
end;
...
procedure __TWMPaletteChanged__Wrapper.setPalChg(const val : HWND);
begin
TWMPaletteChanged(GetRecordPtr^).PalChg := val;
end;
function __TWMPaletteChanged__Wrapper.getPalChg : HWND;
begin
result := TWMPaletteChanged(GetRecordPtr^).PalChg;
end;
...
procedure __TWMPaletteIsChanging__Wrapper.setRealize(const val : HWND);
begin
TWMPaletteIsChanging(GetRecordPtr^).Realize := val;
end;
function __TWMPaletteIsChanging__Wrapper.getRealize : HWND;
begin
result := TWMPaletteIsChanging(GetRecordPtr^).Realize;
end;
...
procedure __TWMParentNotify__Wrapper.setChildWnd(const val : HWND);
begin
TWMParentNotify(GetRecordPtr^).ChildWnd := val;
end;
function __TWMParentNotify__Wrapper.getChildWnd : HWND;
begin
result := TWMParentNotify(GetRecordPtr^).ChildWnd;
end;
...
procedure __TWMScroll__Wrapper.setScrollBar(const val : HWND);
begin
TWMScroll(GetRecordPtr^).ScrollBar := val;
end;
function __TWMScroll__Wrapper.getScrollBar : HWND;
begin
result := TWMScroll(GetRecordPtr^).ScrollBar;
end;
...
procedure __TWMSetCursor__Wrapper.setCursorWnd(const val : HWND);
begin
TWMSetCursor(GetRecordPtr^).CursorWnd := val;
end;
function __TWMSetCursor__Wrapper.getCursorWnd : HWND;
begin
result := TWMSetCursor(GetRecordPtr^).CursorWnd;
end;
...
procedure __TWMSetFocus__Wrapper.setFocusedWnd(const val : HWND);
begin
TWMSetFocus(GetRecordPtr^).FocusedWnd := val;
end;
function __TWMSetFocus__Wrapper.getFocusedWnd : HWND;
begin
result := TWMSetFocus(GetRecordPtr^).FocusedWnd;
end;
...
procedure __TWMSetFont__Wrapper.setFont(const val : HFONT);
begin
TWMSetFont(GetRecordPtr^).Font := val;
end;
function __TWMSetFont__Wrapper.getFont : HFONT;
begin
result := TWMSetFont(GetRecordPtr^).Font;
end;
...
procedure __TWMSetIcon__Wrapper.setIcon(const val : HICON);
begin
TWMSetIcon(GetRecordPtr^).Icon := val;
end;
function __TWMSetIcon__Wrapper.getIcon : HICON;
begin
result := TWMSetIcon(GetRecordPtr^).Icon;
end;
...
procedure __TWMSizeClipboard__Wrapper.setViewer(const val : HWND);
begin
TWMSizeClipboard(GetRecordPtr^).Viewer := val;
end;
function __TWMSizeClipboard__Wrapper.getViewer : HWND;
begin
result := TWMSizeClipboard(GetRecordPtr^).Viewer;
end;
...
procedure __TWMSysCommand__Wrapper.setActivateWnd(const val : HWND);
begin
TWMSysCommand(GetRecordPtr^).ActivateWnd := val;
end;
function __TWMSysCommand__Wrapper.getActivateWnd : HWND;
begin
result := TWMSysCommand(GetRecordPtr^).ActivateWnd;
end;
...
procedure __TWMVKeyToItem__Wrapper.setListBox(const val : HWND);
begin
TWMVKeyToItem(GetRecordPtr^).ListBox := val;
end;
function __TWMVKeyToItem__Wrapper.getListBox : HWND;
begin
result := TWMVKeyToItem(GetRecordPtr^).ListBox;
end;
...
procedure __TWMVScroll__Wrapper.setScrollBar(const val : HWND);
begin
TWMVScroll(GetRecordPtr^).ScrollBar := val;
end;
function __TWMVScroll__Wrapper.getScrollBar : HWND;
begin
result := TWMVScroll(GetRecordPtr^).ScrollBar;
end;
...
procedure __TWMVScrollClipboard__Wrapper.setViewer(const val : HWND);
begin
TWMVScrollClipboard(GetRecordPtr^).Viewer := val;
end;
function __TWMVScrollClipboard__Wrapper.getViewer : HWND;
begin
result := TWMVScrollClipboard(GetRecordPtr^).Viewer;
end;
...
const __ConstNames0 : array[0..376] of string = (
'WM_NULL'
,'WM_CREATE'
,'WM_DESTROY'
,'WM_MOVE'
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[51] ,WM_COMPACTING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[52] ,WM_COMMNOTIFY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[53] ,WM_WINDOWPOSCHANGING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[54] ,WM_WINDOWPOSCHANGED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[55] ,WM_POWER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[56] ,WM_COPYDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[57] ,WM_CANCELJOURNAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[58] ,WM_NOTIFY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[59] ,WM_INPUTLANGCHANGEREQUEST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[60] ,WM_INPUTLANGCHANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[61] ,WM_TCARD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[62] ,WM_HELP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[63] ,WM_USERCHANGED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[64] ,WM_NOTIFYFORMAT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[65] ,WM_CONTEXTMENU));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[66] ,WM_STYLECHANGING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[67] ,WM_STYLECHANGED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[68] ,WM_DISPLAYCHANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[69] ,WM_GETICON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[70] ,WM_SETICON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[71] ,WM_NCCREATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[72] ,WM_NCDESTROY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[73] ,WM_NCCALCSIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[74] ,WM_NCHITTEST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[75] ,WM_NCPAINT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[76] ,WM_NCACTIVATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[77] ,WM_GETDLGCODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[78] ,WM_NCMOUSEMOVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[79] ,WM_NCLBUTTONDOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[80] ,WM_NCLBUTTONUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[81] ,WM_NCLBUTTONDBLCLK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[82] ,WM_NCRBUTTONDOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[83] ,WM_NCRBUTTONUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[84] ,WM_NCRBUTTONDBLCLK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[85] ,WM_NCMBUTTONDOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[86] ,WM_NCMBUTTONUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[87] ,WM_NCMBUTTONDBLCLK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[88] ,WM_KEYFIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[89] ,WM_KEYDOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[90] ,WM_KEYUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[91] ,WM_CHAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[92] ,WM_DEADCHAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[93] ,WM_SYSKEYDOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[94] ,WM_SYSKEYUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[95] ,WM_SYSCHAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[96] ,WM_SYSDEADCHAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[97] ,WM_KEYLAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[98] ,WM_INITDIALOG));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[99] ,WM_COMMAND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[100] ,WM_SYSCOMMAND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[101] ,WM_TIMER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[102] ,WM_HSCROLL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[103] ,WM_VSCROLL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[104] ,WM_INITMENU));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[105] ,WM_INITMENUPOPUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[106] ,WM_MENUSELECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[107] ,WM_MENUCHAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[108] ,WM_ENTERIDLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[109] ,WM_CTLCOLORMSGBOX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[110] ,WM_CTLCOLOREDIT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[111] ,WM_CTLCOLORLISTBOX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[112] ,WM_CTLCOLORBTN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[113] ,WM_CTLCOLORDLG));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[114] ,WM_CTLCOLORSCROLLBAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[115] ,WM_CTLCOLORSTATIC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[116] ,WM_MOUSEFIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[117] ,WM_MOUSEMOVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[118] ,WM_LBUTTONDOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[119] ,WM_LBUTTONUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[120] ,WM_LBUTTONDBLCLK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[121] ,WM_RBUTTONDOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[122] ,WM_RBUTTONUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[123] ,WM_RBUTTONDBLCLK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[124] ,WM_MBUTTONDOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[125] ,WM_MBUTTONUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[126] ,WM_MBUTTONDBLCLK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[127] ,WM_MOUSEWHEEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[128] ,WM_MOUSELAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[129] ,WM_PARENTNOTIFY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[130] ,WM_ENTERMENULOOP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[131] ,WM_EXITMENULOOP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[132] ,WM_NEXTMENU));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[133] ,WM_SIZING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[134] ,WM_CAPTURECHANGED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[135] ,WM_MOVING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[136] ,WM_POWERBROADCAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[137] ,WM_DEVICECHANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[138] ,WM_IME_STARTCOMPOSITION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[139] ,WM_IME_ENDCOMPOSITION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[140] ,WM_IME_COMPOSITION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[141] ,WM_IME_KEYLAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[142] ,WM_IME_SETCONTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[143] ,WM_IME_NOTIFY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[144] ,WM_IME_CONTROL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[145] ,WM_IME_COMPOSITIONFULL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[146] ,WM_IME_SELECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[147] ,WM_IME_CHAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[148] ,WM_IME_KEYDOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[149] ,WM_IME_KEYUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[150] ,WM_MDICREATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[151] ,WM_MDIDESTROY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[152] ,WM_MDIACTIVATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[153] ,WM_MDIRESTORE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[154] ,WM_MDINEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[155] ,WM_MDIMAXIMIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[156] ,WM_MDITILE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[157] ,WM_MDICASCADE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[158] ,WM_MDIICONARRANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[159] ,WM_MDIGETACTIVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[160] ,WM_MDISETMENU));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[161] ,WM_ENTERSIZEMOVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[162] ,WM_EXITSIZEMOVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[163] ,WM_DROPFILES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[164] ,WM_MDIREFRESHMENU));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[165] ,WM_MOUSEHOVER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[166] ,WM_MOUSELEAVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[167] ,WM_CUT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[168] ,WM_COPY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[169] ,WM_PASTE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[170] ,WM_CLEAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[171] ,WM_UNDO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[172] ,WM_RENDERFORMAT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[173] ,WM_RENDERALLFORMATS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[174] ,WM_DESTROYCLIPBOARD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[175] ,WM_DRAWCLIPBOARD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[176] ,WM_PAINTCLIPBOARD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[177] ,WM_VSCROLLCLIPBOARD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[178] ,WM_SIZECLIPBOARD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[179] ,WM_ASKCBFORMATNAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[180] ,WM_CHANGECBCHAIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[181] ,WM_HSCROLLCLIPBOARD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[182] ,WM_QUERYNEWPALETTE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[183] ,WM_PALETTEISCHANGING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[184] ,WM_PALETTECHANGED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[185] ,WM_HOTKEY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[186] ,WM_PRINT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[187] ,WM_PRINTCLIENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[188] ,WM_HANDHELDFIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[189] ,WM_HANDHELDLAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[190] ,WM_PENWINFIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[191] ,WM_PENWINLAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[192] ,WM_COALESCE_FIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[193] ,WM_COALESCE_LAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[194] ,WM_DDE_FIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[195] ,WM_DDE_INITIATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[196] ,WM_DDE_TERMINATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[197] ,WM_DDE_ADVISE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[198] ,WM_DDE_UNADVISE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[199] ,WM_DDE_ACK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[200] ,WM_DDE_DATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[201] ,WM_DDE_REQUEST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[202] ,WM_DDE_POKE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[203] ,WM_DDE_EXECUTE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[204] ,WM_DDE_LAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[205] ,WM_APP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[206] ,WM_USER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[207] ,BN_CLICKED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[208] ,BN_PAINT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[209] ,BN_HILITE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[210] ,BN_UNHILITE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[211] ,BN_DISABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[212] ,BN_DOUBLECLICKED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[213] ,BN_PUSHED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[214] ,BN_UNPUSHED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[215] ,BN_DBLCLK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[216] ,BN_SETFOCUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[217] ,BN_KILLFOCUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[218] ,BM_GETCHECK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[219] ,BM_SETCHECK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[220] ,BM_GETSTATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[221] ,BM_SETSTATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[222] ,BM_SETSTYLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[223] ,BM_CLICK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[224] ,BM_GETIMAGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[225] ,BM_SETIMAGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[226] ,LBN_ERRSPACE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[227] ,LBN_SELCHANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[228] ,LBN_DBLCLK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[229] ,LBN_SELCANCEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[230] ,LBN_SETFOCUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[231] ,LBN_KILLFOCUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[232] ,LB_ADDSTRING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[233] ,LB_INSERTSTRING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[234] ,LB_DELETESTRING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[235] ,LB_SELITEMRANGEEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[236] ,LB_RESETCONTENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[237] ,LB_SETSEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[238] ,LB_SETCURSEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[239] ,LB_GETSEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[240] ,LB_GETCURSEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[241] ,LB_GETTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[242] ,LB_GETTEXTLEN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[243] ,LB_GETCOUNT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[244] ,LB_SELECTSTRING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[245] ,LB_DIR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[246] ,LB_GETTOPINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[247] ,LB_FINDSTRING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[248] ,LB_GETSELCOUNT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[249] ,LB_GETSELITEMS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[250] ,LB_SETTABSTOPS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[251] ,LB_GETHORIZONTALEXTENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[252] ,LB_SETHORIZONTALEXTENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[253] ,LB_SETCOLUMNWIDTH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[254] ,LB_ADDFILE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[255] ,LB_SETTOPINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[256] ,LB_GETITEMRECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[257] ,LB_GETITEMDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[258] ,LB_SETITEMDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[259] ,LB_SELITEMRANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[260] ,LB_SETANCHORINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[261] ,LB_GETANCHORINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[262] ,LB_SETCARETINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[263] ,LB_GETCARETINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[264] ,LB_SETITEMHEIGHT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[265] ,LB_GETITEMHEIGHT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[266] ,LB_FINDSTRINGEXACT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[267] ,LB_SETLOCALE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[268] ,LB_GETLOCALE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[269] ,LB_SETCOUNT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[270] ,LB_INITSTORAGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[271] ,LB_ITEMFROMPOINT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[272] ,LB_MSGMAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[273] ,CBN_ERRSPACE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[274] ,CBN_SELCHANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[275] ,CBN_DBLCLK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[276] ,CBN_SETFOCUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[277] ,CBN_KILLFOCUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[278] ,CBN_EDITCHANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[279] ,CBN_EDITUPDATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[280] ,CBN_DROPDOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[281] ,CBN_CLOSEUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[282] ,CBN_SELENDOK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[283] ,CBN_SELENDCANCEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[284] ,CB_GETEDITSEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[285] ,CB_LIMITTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[286] ,CB_SETEDITSEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[287] ,CB_ADDSTRING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[288] ,CB_DELETESTRING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[289] ,CB_DIR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[290] ,CB_GETCOUNT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[291] ,CB_GETCURSEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[292] ,CB_GETLBTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[293] ,CB_GETLBTEXTLEN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[294] ,CB_INSERTSTRING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[295] ,CB_RESETCONTENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[296] ,CB_FINDSTRING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[297] ,CB_SELECTSTRING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[298] ,CB_SETCURSEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[299] ,CB_SHOWDROPDOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[300] ,CB_GETITEMDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[301] ,CB_SETITEMDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[302] ,CB_GETDROPPEDCONTROLRECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[303] ,CB_SETITEMHEIGHT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[304] ,CB_GETITEMHEIGHT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[305] ,CB_SETEXTENDEDUI));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[306] ,CB_GETEXTENDEDUI));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[307] ,CB_GETDROPPEDSTATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[308] ,CB_FINDSTRINGEXACT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[309] ,CB_SETLOCALE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[310] ,CB_GETLOCALE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[311] ,CB_GETTOPINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[312] ,CB_SETTOPINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[313] ,CB_GETHORIZONTALEXTENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[314] ,CB_SETHORIZONTALEXTENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[315] ,CB_GETDROPPEDWIDTH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[316] ,CB_SETDROPPEDWIDTH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[317] ,CB_INITSTORAGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[318] ,CB_MSGMAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[319] ,EN_SETFOCUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[320] ,EN_KILLFOCUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[321] ,EN_CHANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[322] ,EN_UPDATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[323] ,EN_ERRSPACE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[324] ,EN_MAXTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[325] ,EN_HSCROLL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[326] ,EN_VSCROLL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[327] ,EM_GETSEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[328] ,EM_SETSEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[329] ,EM_GETRECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[330] ,EM_SETRECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[331] ,EM_SETRECTNP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[332] ,EM_SCROLL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[333] ,EM_LINESCROLL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[334] ,EM_SCROLLCARET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[335] ,EM_GETMODIFY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[336] ,EM_SETMODIFY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[337] ,EM_GETLINECOUNT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[338] ,EM_LINEINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[339] ,EM_SETHANDLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[340] ,EM_GETHANDLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[341] ,EM_GETTHUMB));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[342] ,EM_LINELENGTH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[343] ,EM_REPLACESEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[344] ,EM_GETLINE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[345] ,EM_LIMITTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[346] ,EM_CANUNDO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[347] ,EM_UNDO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[348] ,EM_FMTLINES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[349] ,EM_LINEFROMCHAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[350] ,EM_SETTABSTOPS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[351] ,EM_SETPASSWORDCHAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[352] ,EM_EMPTYUNDOBUFFER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[353] ,EM_GETFIRSTVISIBLELINE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[354] ,EM_SETREADONLY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[355] ,EM_SETWORDBREAKPROC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[356] ,EM_GETWORDBREAKPROC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[357] ,EM_GETPASSWORDCHAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[358] ,EM_SETMARGINS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[359] ,EM_GETMARGINS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[360] ,EM_SETLIMITTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[361] ,EM_GETLIMITTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[362] ,EM_POSFROMCHAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[363] ,EM_CHARFROMPOS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[364] ,SBM_SETPOS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[365] ,SBM_GETPOS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[366] ,SBM_SETRANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[367] ,SBM_SETRANGEREDRAW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[368] ,SBM_GETRANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[369] ,SBM_ENABLE_ARROWS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[370] ,SBM_SETSCROLLINFO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[371] ,SBM_GETSCROLLINFO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[372] ,DM_GETDEFID));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[373] ,DM_SETDEFID));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[374] ,DM_REPOSITION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[375] ,PSM_PAGEINFO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[376] ,PSM_SHEETINFO));
end;
...
const MethodNames : array[0..167] of string = (
'TMessage'
,'TWMActivate'
,'TWMActivateApp'
,'TWMAskCBFormatName'
...
__RegisteredMethods.Add(RegisterRWProc(MethodNames[1],Addr(_TWMActivate_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[2],Addr(_TWMActivateApp_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[3],Addr(_TWMAskCBFormatName_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[4],Addr(_TWMCancelMode_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[5],Addr(_TWMChangeCBChain_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[6],Addr(_TWMChar_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[7],Addr(_TWMCharToItem_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[8],Addr(_TWMChildActivate_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[9],Addr(_TWMChooseFont_GetLogFont_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[10],Addr(_TWMClear_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[11],Addr(_TWMClose_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[12],Addr(_TWMCommand_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[13],Addr(_TWMCompacting_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[14],Addr(_TWMCompareItem_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[15],Addr(_TWMCopy_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[16],Addr(_TWMCopyData_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[17],Addr(_TWMCreate_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[18],Addr(_TWMCtlColor_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[19],Addr(_TWMCtlColorBtn_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[20],Addr(_TWMCtlColorDlg_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[21],Addr(_TWMCtlColorEdit_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[22],Addr(_TWMCtlColorListbox_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[23],Addr(_TWMCtlColorMsgbox_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[24],Addr(_TWMCtlColorScrollbar_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[25],Addr(_TWMCtlColorStatic_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[26],Addr(_TWMCut_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[27],Addr(_TWMDDE_Ack_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[28],Addr(_TWMDDE_Advise_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[29],Addr(_TWMDDE_Data_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[30],Addr(_TWMDDE_Execute_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[31],Addr(_TWMDDE_Initiate_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[32],Addr(_TWMDDE_Poke_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[33],Addr(_TWMDDE_Request_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[34],Addr(_TWMDDE_Terminate_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[35],Addr(_TWMDDE_Unadvise_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[36],Addr(_TWMDeadChar_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[37],Addr(_TWMDeleteItem_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[38],Addr(_TWMDestroy_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[39],Addr(_TWMDestroyClipboard_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[40],Addr(_TWMDevModeChange_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[41],Addr(_TWMDisplayChange_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[42],Addr(_TWMDrawClipboard_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[43],Addr(_TWMDrawItem_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[44],Addr(_TWMDropFiles_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[45],Addr(_TWMEnable_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[46],Addr(_TWMEndSession_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[47],Addr(_TWMEnterIdle_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[48],Addr(_TWMEnterMenuLoop_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[49],Addr(_TWMEraseBkgnd_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[50],Addr(_TWMExitMenuLoop_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[51],Addr(_TWMFontChange_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[52],Addr(_TWMGetDlgCode_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[53],Addr(_TWMGetFont_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[54],Addr(_TWMGetHotKey_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[55],Addr(_TWMGetIcon_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[56],Addr(_TWMGetMinMaxInfo_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[57],Addr(_TWMGetText_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[58],Addr(_TWMGetTextLength_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[59],Addr(_TWMHelp_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[60],Addr(_TWMHotKey_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[61],Addr(_TWMHScroll_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[62],Addr(_TWMHScrollClipboard_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[63],Addr(_TWMIconEraseBkgnd_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[64],Addr(_TWMInitDialog_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[65],Addr(_TWMInitMenu_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[66],Addr(_TWMInitMenuPopup_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[67],Addr(_TWMKey_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[68],Addr(_TWMKeyDown_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[69],Addr(_TWMKeyUp_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[70],Addr(_TWMKillFocus_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[71],Addr(_TWMLButtonDblClk_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[72],Addr(_TWMLButtonDown_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[73],Addr(_TWMLButtonUp_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[74],Addr(_TWMMButtonDblClk_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[75],Addr(_TWMMButtonDown_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[76],Addr(_TWMMButtonUp_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[77],Addr(_TWMMDIActivate_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[78],Addr(_TWMMDICascade_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[79],Addr(_TWMMDICreate_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[80],Addr(_TWMMDIDestroy_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[81],Addr(_TWMMDIGetActive_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[82],Addr(_TWMMDIIconArrange_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[83],Addr(_TWMMDIMaximize_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[84],Addr(_TWMMDINext_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[85],Addr(_TWMMDIRefreshMenu_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[86],Addr(_TWMMDIRestore_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[87],Addr(_TWMMDISetMenu_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[88],Addr(_TWMMDITile_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[89],Addr(_TWMMeasureItem_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[90],Addr(_TWMMenuChar_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[91],Addr(_TWMMenuSelect_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[92],Addr(_TWMMouse_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[93],Addr(_TWMMouseActivate_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[94],Addr(_TWMMouseMove_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[95],Addr(_TWMMove_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[96],Addr(_TWMNCActivate_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[97],Addr(_TWMNCCalcSize_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[98],Addr(_TWMNCCreate_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[99],Addr(_TWMNCDestroy_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[100],Addr(_TWMNCHitMessage_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[101],Addr(_TWMNCHitTest_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[102],Addr(_TWMNCLButtonDblClk_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[103],Addr(_TWMNCLButtonDown_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[104],Addr(_TWMNCLButtonUp_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[105],Addr(_TWMNCMButtonDblClk_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[106],Addr(_TWMNCMButtonDown_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[107],Addr(_TWMNCMButtonUp_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[108],Addr(_TWMNCMouseMove_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[109],Addr(_TWMNCPaint_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[110],Addr(_TWMNCRButtonDblClk_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[111],Addr(_TWMNCRButtonDown_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[112],Addr(_TWMNCRButtonUp_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[113],Addr(_TWMNextDlgCtl_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[114],Addr(_TWMNoParams_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[115],Addr(_TWMNotify_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[116],Addr(_TWMNotifyFormat_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[117],Addr(_TWMPaint_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[118],Addr(_TWMPaintClipboard_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[119],Addr(_TWMPaintIcon_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[120],Addr(_TWMPaletteChanged_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[121],Addr(_TWMPaletteIsChanging_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[122],Addr(_TWMParentNotify_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[123],Addr(_TWMPaste_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[124],Addr(_TWMPower_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[125],Addr(_TWMQueryDragIcon_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[126],Addr(_TWMQueryEndSession_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[127],Addr(_TWMQueryNewPalette_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[128],Addr(_TWMQueryOpen_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[129],Addr(_TWMQueueSync_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[130],Addr(_TWMQuit_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[131],Addr(_TWMRButtonDblClk_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[132],Addr(_TWMRButtonDown_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[133],Addr(_TWMRButtonUp_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[134],Addr(_TWMRenderAllFormats_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[135],Addr(_TWMRenderFormat_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[136],Addr(_TWMScroll_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[137],Addr(_TWMSetCursor_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[138],Addr(_TWMSetFocus_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[139],Addr(_TWMSetFont_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[140],Addr(_TWMSetHotKey_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[141],Addr(_TWMSetIcon_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[142],Addr(_TWMSetRedraw_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[143],Addr(_TWMSetText_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[144],Addr(_TWMShowWindow_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[145],Addr(_TWMSize_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[146],Addr(_TWMSizeClipboard_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[147],Addr(_TWMSpoolerStatus_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[148],Addr(_TWMStyleChange_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[149],Addr(_TWMStyleChanged_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[150],Addr(_TWMStyleChanging_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[151],Addr(_TWMSysChar_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[152],Addr(_TWMSysColorChange_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[153],Addr(_TWMSysCommand_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[154],Addr(_TWMSysDeadChar_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[155],Addr(_TWMSysKeyDown_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[156],Addr(_TWMSysKeyUp_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[157],Addr(_TWMSystemError_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[158],Addr(_TWMTimeChange_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[159],Addr(_TWMTimer_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[160],Addr(_TWMUndo_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[161],Addr(_TWMVKeyToItem_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[162],Addr(_TWMVScroll_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[163],Addr(_TWMVScrollClipboard_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[164],Addr(_TWMWindowPosChanged_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[165],Addr(_TWMWindowPosChanging_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[166],Addr(_TWMWindowPosMsg_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[167],Addr(_TWMWinIniChange_)));
end;
initialization
