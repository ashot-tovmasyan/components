...
{_T3 = function (const p0 : string): IDispatch of object;}

_T4 = procedure (p0 : HResult) of object;

_T5 = _T4;

_T6 = function (const p0 : string): IDispatch of object;

_T7 = function (const p0 : IDispatch): string of object;
...
_T11 = procedure (const p0 : string) of object;
...
{_T16 = procedure (p0 : IPropertyBag;
p1 : IErrorLog;
const p2 : string;
...
_T22 = function (const p0 : IDispatch;
p1 : Pointer;
p2 : Integer;
p3 : Integer;
...
_T24 = function (out p0 : Integer): HResult of object;
...
{_T28 = procedure (p0 : TComServerObject;
p1 : TFactoryProc) of object;}

{_T29 = function (p0 : TClass): TComObjectFactory of object;}

_T30 = function (const p0 : IDispatch): TComObjectFactory of object;

_T31 = procedure  of object;

{_T32 = procedure (const p0 : IUnknown) of object;}

{_T33 = procedure (p0 : TComObjectFactory;
const p1 : IUnknown) of object;}

_T34 = _T31;

_T35 = function : Integer of object;

_T36 = function (const p0 : IDispatch;
out p1): Integer of object;

_T37 = _T35;

_T38 = function : string of object;

_T39 = function : WideString of object;

_T40 = function : Boolean of object;

_T41 = function (const p0 : WideString): Boolean of object;

{_T43 = function (const p0 : IUnknown): TComObject of object;}

_T44 = _T31;

_T45 = procedure (p0 : Boolean) of object;

_T46 = function (p0 : Boolean): Integer of object;
...
{_T52 = function : ITypeLib of object;}

{_T54 = function (p0 : Integer): ITypeInfo of object;}
...
function __DC__GetComObj__ComClassManager(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := VarFromObject(ComObj.ComClassManager);
end;

procedure __DC__SetComObj__ComClassManager(Instance : TObject; Params : PVariantArgList);
begin
TObject(ComObj.ComClassManager):=(VarToObject(OleVariant(Params^[0])));
end;
...
__RegisteredVars.Add(RegisterVar('ComClassManager',__DC__GetComObj__ComClassManager,__DC__SetComObj__ComClassManager));
end;
...
RegisterProc(EOleException,'Create',mtConstructor,TypeInfo(_T19),[
TypeInfo(string),
TypeInfo(Integer),
TypeInfo(string),
TypeInfo(string),
...
RegisterProc(EOleSysError,'Create',mtConstructor,TypeInfo(_T20),[
TypeInfo(string),
TypeInfo(Integer),
TypeInfo(Integer)],Addr(EOleSysError.Create),cRegister);

RegisterProc(TAutoObject,'GetIDsOfNames',mtMethod,TypeInfo(_T22),[
TypeInfo(IDispatch),
TypeInfoPointer,
TypeInfo(Integer),
TypeInfo(Integer),
...
RegisterProc(TAutoObject,'GetTypeInfo',mtMethod,TypeInfo(_T23),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfoUntyped,TypeInfo(HResult)], pointer(20),cStdCall);

RegisterProc(TAutoObject,'GetTypeInfoCount',mtMethod,TypeInfo(_T24),[
TypeInfo(Integer),TypeInfo(HResult)], pointer(24),cStdCall);

RegisterProc(TAutoObject,'Invoke',mtMethod,TypeInfo(_T25),[
TypeInfo(Integer),
TypeInfo(IDispatch),
TypeInfo(Integer),
TypeInfo(Word),
...
RegRegisterMethod(TComClassManager,'GetFactoryFromClassID',TypeInfo(_T30),[
TypeInfo(IDispatch),TypeInfo(TComObjectFactory)],Addr(__TComClassManager__GetFactoryFromClassID__Wrapper));

RegisterProc(TComObject,'Create',mtConstructor,TypeInfo(_T31),NoParams,Addr(TComObject.Create),cRegister);

RegRegisterMethod(TComObject,'Initialize',TypeInfo(_T34),NoParams, pointer(0));

RegisterProc(TComObject,'ObjAddRef',mtMethod,TypeInfo(_T35),[TypeInfo(Integer)], pointer(4),cStdCall);

RegisterProc(TComObject,'ObjQueryInterface',mtMethod,TypeInfo(_T36),[
TypeInfo(IDispatch),
TypeInfoUntyped,TypeInfo(Integer)], pointer(8),cRegister);

RegisterProc(TComObject,'ObjRelease',mtMethod,TypeInfo(_T37),[TypeInfo(Integer)], pointer(12),cStdCall);

RegRegisterMethod(TComObjectFactory,'GetProgID',TypeInfo(_T38),[TypeInfo(string)], pointer(0));

RegRegisterMethod(TComObjectFactory,'GetLicenseString',TypeInfo(_T39),[TypeInfo(WideString)], pointer(4));

RegRegisterMethod(TComObjectFactory,'HasMachineLicense',TypeInfo(_T40),[TypeInfo(Boolean)], pointer(8));

RegRegisterMethod(TComObjectFactory,'ValidateUserLicense',TypeInfo(_T41),[
TypeInfo(WideString),TypeInfo(Boolean)], pointer(12));

RegRegisterMethod(TComObjectFactory,'RegisterClassObject',TypeInfo(_T44),NoParams,Addr(TComObjectFactory.RegisterClassObject));

RegRegisterMethod(TComObjectFactory,'UpdateRegistry',TypeInfo(_T45),[
TypeInfo(Boolean)], pointer(20));

RegRegisterMethod(TComServerObject,'CountObject',TypeInfo(_T46),[
TypeInfo(Boolean),TypeInfo(Integer)], pointer(0));

RegRegisterMethod(TComServerObject,'CountFactory',TypeInfo(_T47),[
TypeInfo(Boolean),TypeInfo(Integer)], pointer(4));

RegRegisterMethod(TComServerObject,'GetHelpFileName',TypeInfo(_T48),[TypeInfo(string)], pointer(8));

RegRegisterMethod(TComServerObject,'GetServerFileName',TypeInfo(_T49),[TypeInfo(string)], pointer(12));

RegRegisterMethod(TComServerObject,'GetServerKey',TypeInfo(_T50),[TypeInfo(string)], pointer(16));

RegRegisterMethod(TComServerObject,'GetServerName',TypeInfo(_T51),[TypeInfo(string)], pointer(20));

end;
initialization
__RegisteredMethods := TList.Create;
_mreg_0;
{RegisterProc(nil,'CreateOleObject',mtProc,TypeInfo(_T2),[
TypeInfo(string),TypeInfo(IDispatch)],Addr(CreateOleObject),cRegister)}

{RegisterProc(nil,'GetActiveOleObject',mtProc,TypeInfo(_T3),[
TypeInfo(string),TypeInfo(IDispatch)],Addr(GetActiveOleObject),cRegister)}

{RegisterProc(nil,'DispatchInvoke',mtProc,TypeInfo(_T12),[
TypeInfo(IDispatch),
TypeInfoPointer,
TypeInfoPointer,
TypeInfoPointer,
...
{RegisterProc(nil,'ReadPropFromBag',mtProc,TypeInfo(_T16),[
TypeInfo(IPropertyBag),
TypeInfo(IErrorLog),
TypeInfo(string),
TypeInfo(Variant)],Addr(ReadPropFromBag),cRegister)}

{RegisterProc(nil,'PutPropInBag',mtProc,TypeInfo(_T17),[
TypeInfo(IPropertyBag),
TypeInfo(string),
TypeInfo(Variant)],Addr(PutPropInBag),cRegister)}

{RegRegisterMethod(TComClassManager,'ForEachFactory',TypeInfo(_T28),[
TypeInfo(TComServerObject),
TypeInfo(TFactoryProc)],Addr(TComClassManager.ForEachFactory))}

{RegRegisterMethod(TComClassManager,'GetFactoryFromClass',TypeInfo(_T29),[
TypeInfo(TClass),TypeInfo(TComObjectFactory)],Addr(TComClassManager.GetFactoryFromClass))}

{RegisterProc(TComObject,'CreateAggregated',mtConstructor,TypeInfo(_T32),[
TypeInfo(IUnknown)],Addr(TComObject.CreateAggregated),cRegister)}

{RegisterProc(TComObject,'CreateFromFactory',mtConstructor,TypeInfo(_T33),[
TypeInfo(TComObjectFactory),
TypeInfo(IUnknown)],Addr(TComObject.CreateFromFactory),cRegister)}

{RegRegisterMethod(TComObjectFactory,'CreateComObject',TypeInfo(_T43),[
TypeInfo(IUnknown),TypeInfo(TComObject)], pointer(16))}

{RegRegisterMethod(TComServerObject,'GetTypeLib',TypeInfo(_T52),[TypeInfo(ITypeLib)], pointer(24))}

{RegRegisterMethod(TTypedComObjectFactory,'GetInterfaceTypeInfo',TypeInfo(_T54),[
