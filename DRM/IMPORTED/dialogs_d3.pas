...
_T10 = function (const p0 : IDispatch): Boolean of object;

_T11 = function (p0 : Pointer;
...
_T22 = function : IDispatch of object;
...
const __ConstNames0 : array[0..85] of string = (
'MaxCustomColors'
,'ofReadOnly'
,'ofOverwritePrompt'
,'ofHideReadOnly'
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[19] ,fsEdit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[20] ,fsComboBox));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[21] ,cdFullOpen));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[22] ,cdPreventFullOpen));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[23] ,cdShowHelp));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[24] ,cdSolidColor));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[25] ,cdAnyColor));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[26] ,fdAnsiOnly));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[27] ,fdTrueTypeOnly));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[28] ,fdEffects));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[29] ,fdFixedPitchOnly));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[30] ,fdForceFontExist));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[31] ,fdNoFaceSel));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[32] ,fdNoOEMFonts));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[33] ,fdNoSimulations));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[34] ,fdNoSizeSel));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[35] ,fdNoStyleSel));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[36] ,fdNoVectorFonts));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[37] ,fdShowHelp));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[38] ,fdWysiwyg));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[39] ,fdLimitSize));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[40] ,fdScalableOnly));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[41] ,fdApplyButton));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[42] ,fdScreen));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[43] ,fdPrinter));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[44] ,fdBoth));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[45] ,prAllPages));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[46] ,prSelection));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[47] ,prPageNums));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[48] ,poPrintToFile));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[49] ,poPageNums));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[50] ,poSelection));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[51] ,poWarning));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[52] ,poHelp));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[53] ,poDisablePrintToFile));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[54] ,frDown));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[55] ,frFindNext));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[56] ,frHideMatchCase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[57] ,frHideWholeWord));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[58] ,frHideUpDown));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[59] ,frMatchCase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[60] ,frDisableMatchCase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[61] ,frDisableUpDown));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[62] ,frDisableWholeWord));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[63] ,frReplace));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[64] ,frReplaceAll));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[65] ,frWholeWord));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[66] ,frShowHelp));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[67] ,mtWarning));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[68] ,mtError));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[69] ,mtInformation));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[70] ,mtConfirmation));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[71] ,mtCustom));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[72] ,mbYes));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[73] ,mbNo));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[74] ,mbOK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[75] ,mbCancel));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[76] ,mbAbort));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[77] ,mbRetry));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[78] ,mbIgnore));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[79] ,mbAll));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[80] ,mbNoToAll));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[81] ,mbYesToAll));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[82] ,mbHelp));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[83] ,VarFromSet(mbYesNoCancel, sizeof(mbYesNoCancel))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[84] ,VarFromSet(mbOKCancel, sizeof(mbOKCancel))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[85] ,VarFromSet(mbAbortRetryIgnore, sizeof(mbAbortRetryIgnore))));
end;
...
RegRegisterMethod(TCommonDialog,'WndProc',TypeInfo(_T9),[
TypeInfo(IDispatch)], pointer(40));

RegRegisterMethod(TCommonDialog,'MessageHook',TypeInfo(_T10),[
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(44));

RegRegisterMethod(TCommonDialog,'TaskModalDialog',TypeInfo(_T11),[
TypeInfoPointer,
TypeInfoUntyped,TypeInfo(Bool)], pointer(48));

RegRegisterMethod(TCommonDialog,'DoClose',TypeInfo(_T12),NoParams, pointer(MinVMTOffset - 14));

RegRegisterMethod(TCommonDialog,'DoShow',TypeInfo(_T13),NoParams, pointer(MinVMTOffset - 15));

RegRegisterMethod(TCommonDialog,'Execute',TypeInfo(_T14),[TypeInfo(Boolean)], pointer(52));

RegRegisterMethod(TFindDialog,'Find',TypeInfo(_T15),NoParams, pointer(MinVMTOffset - 16));

RegRegisterMethod(TFindDialog,'Replace',TypeInfo(_T16),NoParams, pointer(MinVMTOffset - 17));
...
TypeInfo(HWnd)], pointer(MinVMTOffset - 16));

RegRegisterMethod(TOpenDialog,'DoSelectionChange',TypeInfo(_T19),NoParams, pointer(MinVMTOffset - 16));

RegRegisterMethod(TOpenDialog,'DoFolderChange',TypeInfo(_T20),NoParams, pointer(MinVMTOffset - 17));

RegRegisterMethod(TOpenDialog,'DoTypeChange',TypeInfo(_T21),NoParams, pointer(MinVMTOffset - 18));

RegRegisterMethod(TOpenDialog,'GetStaticRect',TypeInfo(_T22),[TypeInfo(IDispatch)], pointer(56));
