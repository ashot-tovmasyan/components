...
{_T3 = function (p0 : TFormDesigner;
p1 : ITypeInfo;
p2 : TTypeDesc): string of object;}

_T4 = function (p0 : TPropertyEditor): TAxPropEditor of object;
...
function __DC__GetTCustomObjectInspector__Designer(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := VarFromObject(TCustomObjectInspector(Instance).Designer);
end;

procedure __DC__SetTCustomObjectInspector__Designer(Instance : TObject; Params : PVariantArgList);
begin
TCustomObjectInspector(Instance).Designer:=TFormDesigner(VarToObject(OleVariant(Params^[0])));
end;
...
function __DC__GetTCustomObjectInspector__InternalDesigner(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := VarFromObject(TCustomObjectInspector(Instance).InternalDesigner);
end;
...
RegisterProperty(TCustomObjectInspector,'Designer',__DC__GetTCustomObjectInspector__Designer,__DC__SetTCustomObjectInspector__Designer);
...
RegisterProperty(TCustomObjectInspector,'InternalDesigner',__DC__GetTCustomObjectInspector__InternalDesigner,nil);
...
TypeInfo(TPropertyEditor),TypeInfo(TAxPropEditor)],Addr(PSCAxPropEditor),cRegister);

RegRegisterMethod(TCustomAxInspector,'ComparePropEditorsByPropName',TypeInfo(_T5),[
TypeInfo(TDCDsgnProp),
TypeInfo(TDCDsgnProp),TypeInfo(Integer)], pointer(204));

RegRegisterMethod(TCustomAxInspector,'ComparePropEditors',TypeInfo(_T6),[
TypeInfo(TDCDsgnProp),
TypeInfo(TDCDsgnProp),TypeInfo(Integer)], pointer(208));

RegRegisterMethod(TCustomAxInspector,'IsOCX',TypeInfo(_T7),[
TypeInfo(TObject),TypeInfo(Boolean)], pointer(212));

RegRegisterMethod(TCustomObjectInspector,'ShowAxHelp',TypeInfo(_T8),NoParams, pointer(148));

RegRegisterMethod(TCustomObjectInspector,'ChangeValue',TypeInfo(_T10),[
TypeInfo(TDCDsgnProp),
TypeInfo(string)], pointer(156));

RegRegisterMethod(TCustomObjectInspector,'UpdateEditorState',TypeInfo(_T11),[
TypeInfo(TCustomDCEdit),
TypeInfo(TDCDsgnProp)], pointer(160));

RegRegisterMethod(TCustomObjectInspector,'GetRealName',TypeInfo(_T14),[
TypeInfo(TDCDsgnProp),TypeInfo(string)], pointer(172));

RegRegisterMethod(TCustomObjectInspector,'ComponentChanged',TypeInfo(_T15),NoParams, pointer(176));

RegRegisterMethod(TCustomObjectInspector,'IsEmpty',TypeInfo(_T17),[TypeInfo(Boolean)], pointer(184));

RegRegisterMethod(TCustomObjectInspector,'CanHaveSubNodes',TypeInfo(_T18),[TypeInfo(Boolean)], pointer(188));

RegRegisterMethod(TCustomObjectInspector,'IsInspectorKey',TypeInfo(_T19),[
TypeInfo(Word),
TypeInfo(TShiftState),TypeInfo(Boolean)], pointer(192));

RegRegisterMethod(TCustomObjectInspector,'GetActivePropDesc',TypeInfo(_T20),[TypeInfo(string)], pointer(196));

RegRegisterMethod(TCustomObjectInspector,'UpdateEditorValue',TypeInfo(_T21),NoParams, pointer(200));
...
{RegisterProc(nil,'TypeDescToString',mtProc,TypeInfo(_T3),[
TypeInfo(TFormDesigner),
TypeInfo(ITypeInfo),
TypeInfo(TTypeDesc),TypeInfo(string)],Addr(TypeDescToString),cRegister)}

{RegRegisterMethod(TCustomObjectInspector,'GetInplaceEditClass',TypeInfo(_T9),[TypeInfo(TInplaceEditClass)], pointer(152))}

{RegRegisterMethod(TCustomObjectInspector,'GetEditorClass',TypeInfo(_T12),[
TypeInfo(TDCDsgnProp),TypeInfo(TControlClass)], pointer(164))}

{RegRegisterMethod(TCustomObjectInspector,'GetPopupClass',TypeInfo(_T13),[
TypeInfo(TDCDsgnProp),TypeInfo(TWinControlClass)], pointer(168))}

{RegRegisterMethod(TCustomObjectInspector,'GetAllPropertyEditors',TypeInfo(_T16),[
TypeInfo(TComponentList),
TypeInfo(TTypeKinds),
TypeInfo(TFormDesigner),
TypeInfo(TGetPropEditProc)], pointer(180))}
