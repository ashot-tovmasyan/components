...
RegRegisterMethod(TCheckEdit,'GetWinStyle',TypeInfo(_T3),[TypeInfo(Integer)], pointer(128));

RegRegisterMethod(TCustomDCEdit,'RestoreSavedText',TypeInfo(_T4),NoParams, pointer(128));

RegRegisterMethod(TCustomDCEdit,'CheckReadOnly',TypeInfo(_T5),NoParams, pointer(132));

RegRegisterMethod(TCustomDCEdit,'GetText',TypeInfo(_T6),[TypeInfo(string)], pointer(136));
...
RegRegisterMethod(TCustomDCEdit,'SetDropValue',TypeInfo(_T9),NoParams, pointer(148));

RegRegisterMethod(TCustomDCEdit,'GetDropValue',TypeInfo(_T10),NoParams, pointer(152));

RegRegisterMethod(TCustomDCEdit,'GetModified',TypeInfo(_T11),[TypeInfo(Boolean)], pointer(156));

RegRegisterMethod(TCustomDCEdit,'GetReadOnly',TypeInfo(_T12),[TypeInfo(Boolean)], pointer(160));

RegRegisterMethod(TCustomDCEdit,'DoTerm',TypeInfo(_T14),NoParams, pointer(168));

RegRegisterMethod(TCustomDCEdit,'Change',TypeInfo(_T17),NoParams, pointer(180));
...
RegRegisterMethod(TCustomDCEdit,'Drop',TypeInfo(_T21),NoParams, pointer(184));
...
RegRegisterMethod(TDCDtEdit,'GetText',TypeInfo(_T25),[TypeInfo(string)], pointer(124));
...
RegRegisterMethod(TGraphEdit,'GetGraphic',TypeInfo(_T28),[TypeInfo(TGraphic)], pointer(140));
...
RegRegisterMethod(TGraphicEdit,'GetText',TypeInfo(_T31),[TypeInfo(string)], pointer(136));

RegRegisterMethod(TPopupListBox,'Close',TypeInfo(_T32),[
TypeInfo(Boolean)], pointer(132));

RegRegisterMethod(TPopupListBox,'BuildList',TypeInfo(_T33),NoParams, pointer(136));
...
TypeInfo(TControlClass)], pointer(164))}

{RegRegisterMethod(TCustomDCEdit,'GetDefaultEditorClass',TypeInfo(_T15),[TypeInfo(TControlClass)], pointer(172))}

{RegRegisterMethod(TCustomDCEdit,'GetDefaultPopupClass',TypeInfo(_T16),[TypeInfo(TWinControlClass)], pointer(176))}
