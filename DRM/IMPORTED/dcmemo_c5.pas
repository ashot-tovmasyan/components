...
RegRegisterMethod(TCustomDCMemo,'CreateDefaultMemoSource',TypeInfo(_T19),[TypeInfo(TCustomMemoSource)], pointer(204));
...
TypeInfo(IDispatch),
TypeInfo(TDrawState),TypeInfo(Boolean)], pointer(212));

RegRegisterMethod(TCustomDCMemo,'DoGetFontFromStyle',TypeInfo(_T22),[
TypeInfo(Integer),
TypeInfo(TFont),
TypeInfo(TColor)], pointer(216));

RegRegisterMethod(TCustomDCMemo,'CreatePrintDialog',TypeInfo(_T23),[TypeInfo(TCustomForm)], pointer(220));

RegRegisterMethod(TCustomDCMemo,'CreatePrintProgressDialog',TypeInfo(_T24),[TypeInfo(TCustomForm)], pointer(224));

RegRegisterMethod(TCustomDCMemo,'TemplateInsert',TypeInfo(_T25),[
TypeInfo(TStrings)], pointer(228));
...
TypeInfo(TPopupType),TypeInfo(Boolean)], pointer(236));

RegRegisterMethod(TCustomDCMemo,'MarkWordOnTemplate',TypeInfo(_T28),NoParams, pointer(240));
...
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(TShiftState)], pointer(248));
...
TypeInfo(TMemoStates)], pointer(264));

RegRegisterMethod(TCustomDCMemo,'SelectionChanged',TypeInfo(_T35),NoParams, pointer(268));

RegRegisterMethod(TCustomDCMemo,'MemoJumpToUrl',TypeInfo(_T36),[
TypeInfo(string)], pointer(272));

RegRegisterMethod(TCustomDCMemo,'CollapseStateChanging',TypeInfo(_T37),[
TypeInfo(Integer),
TypeInfo(TCollapseState),TypeInfo(Boolean)], pointer(276));

RegRegisterMethod(TCustomDCMemo,'CollapseStateChanged',TypeInfo(_T38),[
TypeInfo(Integer),
TypeInfo(TCollapseState)], pointer(280));
...
TypeInfo(string)], pointer(292));

RegRegisterMethod(TCustomDCMemo,'ClosePopupListBox',TypeInfo(_T42),[
TypeInfo(Word),
TypeInfo(TShiftState),TypeInfo(Boolean)], pointer(296));
...
RegRegisterMethod(TCustomDCMemo,'PopupHintBox',TypeInfo(_T60),[TypeInfo(Boolean)], pointer(300));
...
RegRegisterMethod(TCustomDCMemo,'LoadGlobalOptions',TypeInfo(_T80),NoParams, pointer(304));
...
RegRegisterMethod(TCustomDCMemo,'CopyToClipboard',TypeInfo(_T147),NoParams, pointer(308));

RegRegisterMethod(TCustomDCMemo,'CutToClipboard',TypeInfo(_T148),NoParams, pointer(312));

RegRegisterMethod(TCustomDCMemo,'PasteFromClipboard',TypeInfo(_T149),NoParams, pointer(316));
