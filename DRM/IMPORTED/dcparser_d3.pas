...
RegRegisterMethod(TCustomDCParser,'GetErrorDesc',TypeInfo(_T10),[TypeInfo(string)], pointer(64));
...
RegRegisterMethod(TCustomDCParser,'InitCommon',TypeInfo(_T13),NoParams, pointer(76));

RegRegisterMethod(TCustomDCParser,'UpdateLinePtr',TypeInfo(_T14),NoParams, pointer(80));

RegRegisterMethod(TCustomDCParser,'TokenDataToState',TypeInfo(_T15),[
TypeInfo(TTokenData)], pointer(84));

RegRegisterMethod(TCustomDCParser,'StateToTokenData',TypeInfo(_T16),[
TypeInfo(TTokenData)], pointer(88));

RegRegisterMethod(TCustomDCParser,'UpdateSettings',TypeInfo(_T18),NoParams, pointer(96));

RegRegisterMethod(TCustomDCParser,'ParseComment',TypeInfo(_T19),[TypeInfo(Integer)], pointer(100));

RegRegisterMethod(TCustomDCParser,'GetErrorPoint',TypeInfo(_T20),[TypeInfo(IDispatch)], pointer(104));
...
RegRegisterMethod(TCustomDCParser,'TokenString',TypeInfo(_T42),[TypeInfo(string)], pointer(108));
...
RegRegisterMethod(TCustomDCParser,'NextToken',TypeInfo(_T53),[TypeInfo(Integer)], pointer(112));
...
RegRegisterMethod(TDCIncludeParser,'GetParsedFileName',TypeInfo(_T62),[TypeInfo(string)], pointer(124));
...
TypeInfo(string),TypeInfo(Boolean)], pointer(116));
...
{RegRegisterMethod(TCustomDCParser,'GetTokenDataClass',TypeInfo(_T17),[TypeInfo(TCollectionItemClass)], pointer(92))}
