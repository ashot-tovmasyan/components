...
RegRegisterMethod(TCustomQuickRep,'Execute',TypeInfo(_T5),NoParams, pointer(140));

RegRegisterMethod(TCustomQuickRep,'CreateReport',TypeInfo(_T6),[
TypeInfo(Boolean)], pointer(144));

RegRegisterMethod(TCustomQuickRep,'PaintColumns',TypeInfo(_T7),NoParams, pointer(148));

RegRegisterMethod(TCustomQuickRep,'PaintMargins',TypeInfo(_T8),NoParams, pointer(152));

RegRegisterMethod(TCustomQuickRep,'PaintFrame',TypeInfo(_T9),NoParams, pointer(156));

RegRegisterMethod(TCustomQuickRep,'SetControllerBands',TypeInfo(_T10),NoParams, pointer(160));
...
TypeInfo(TComponent)], pointer(168),cRegister);
...
TypeInfo(TQRPrintable)], pointer(172));
...
RegRegisterMethod(TQRControllerBand,'CreateController',TypeInfo(_T41),NoParams, pointer(152));

RegRegisterMethod(TQRControllerBand,'RegisterBands',TypeInfo(_T42),NoParams, pointer(156));

RegRegisterMethod(TQRControllerBand,'SetMaster',TypeInfo(_T43),[
TypeInfo(TComponent)], pointer(160));

RegRegisterMethod(TQRControllerBand,'CreateLocalVar',TypeInfo(_T44),NoParams, pointer(164));

RegRegisterMethod(TQRControllerBand,'RemoveLocalVar',TypeInfo(_T45),NoParams, pointer(168));

RegRegisterMethod(TQRControllerBand,'LocalVarExpression',TypeInfo(_T46),[TypeInfo(string)], pointer(172));
...
RegRegisterMethod(TQRCustomBand,'BandTypeName',TypeInfo(_T48),[TypeInfo(string)], pointer(136));

RegRegisterMethod(TQRCustomBand,'BandComponentName',TypeInfo(_T49),[TypeInfo(string)], pointer(140));

RegRegisterMethod(TQRCustomBand,'SetParentReport',TypeInfo(_T50),[
TypeInfo(TCustomQuickRep)], pointer(144));

RegRegisterMethod(TQRCustomBand,'WriteDummy',TypeInfo(_T51),[
TypeInfo(TWriter)], pointer(148));
...
RegRegisterMethod(TQRCustomController,'LocalVarValue',TypeInfo(_T55),[TypeInfo(IDispatch)], pointer(40));

RegRegisterMethod(TQRCustomController,'BuildTree',TypeInfo(_T56),NoParams, pointer(44));

RegRegisterMethod(TQRCustomController,'Execute',TypeInfo(_T57),NoParams, pointer(48));

RegRegisterMethod(TQRCustomController,'Prepare',TypeInfo(_T58),NoParams, pointer(52));

RegRegisterMethod(TQRCustomController,'Unprepare',TypeInfo(_T59),NoParams, pointer(56));

RegRegisterMethod(TQRCustomController,'PrintAfterControllers',TypeInfo(_T60),NoParams, pointer(60));

RegRegisterMethod(TQRCustomController,'PrintBeforeControllers',TypeInfo(_T61),NoParams, pointer(64));

RegRegisterMethod(TQRCustomController,'PrintEmptyController',TypeInfo(_T62),NoParams, pointer(68));

RegRegisterMethod(TQRCustomController,'RegisterBands',TypeInfo(_T63),NoParams, pointer(72));

RegRegisterMethod(TQRCustomController,'RegisterDatasets',TypeInfo(_T64),NoParams, pointer(76));

RegRegisterMethod(TQRCustomController,'SetPrintBefore',TypeInfo(_T65),[
TypeInfo(Boolean)], pointer(80));

RegRegisterMethod(TQRCustomController,'UpdateLocalVar',TypeInfo(_T66),NoParams, pointer(84));
...
RegRegisterMethod(TQRPrintable,'IsEnabled',TypeInfo(_T72),[TypeInfo(Boolean)], pointer(128));

RegRegisterMethod(TQRPrintable,'AlignIt',TypeInfo(_T74),NoParams, pointer(136));

RegRegisterMethod(TQRPrintable,'Prepare',TypeInfo(_T75),NoParams, pointer(140));
...
TypeInfo(TObject),
TypeInfo(TQRNotifyOperation)], pointer(148));

RegRegisterMethod(TQRPrintable,'SetAlignment',TypeInfo(_T78),[
TypeInfo(TAlignment)], pointer(152));

RegRegisterMethod(TQRPrintable,'Unprepare',TypeInfo(_T79),NoParams, pointer(156));
...
{RegRegisterMethod(TQRPrintable,'GetEditorClass',TypeInfo(_T73),[TypeInfo(TQRPrintableEditorClass)], pointer(132))}
