...
_T30 = procedure (p0 : TBlobField;
p1 : TBlobStreamMode) of object;

_T31 = _T12;

_T32 = procedure (const p0 : Array of TDBDataSet) of object;
...
{_T45 = function : IProvider of object;}

_T46 = function (p0 : Integer;
p1 : Boolean): Boolean of object;

_T47 = function (p0 : DBIResult): Boolean of object;

_T48 = procedure (p0 : TDatabase) of object;

_T49 = function : TDatabase of object;

{_T50 = procedure (p0 : EDBEngineError;
p1 : DBIResult;
p2 : Longint;
p3 : PChar) of object;}

_T51 = procedure (p0 : TTable) of object;

_T52 = procedure (p0 : TStrings) of object;

_T53 = _T12;

{_T54 = procedure (p0 : PChar) of object;}

_T55 = _T12;

_T56 = function (const p0 : string): TParam of object;
...
_T68 = function (const p0 : string): TDatabase of object;

_T69 = _T52;

_T70 = _T60;

_T71 = function (const p0 : string): string of object;
...
_T79 = function (const p0 : string): Boolean of object;

_T80 = procedure (p0 : string;
p1 : TStrings) of object;
...
_T88 = function (const p0 : string): TSession of object;
...
function __DC__GetDBTables__Oracle8Blobs(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := DBTables.Oracle8Blobs;
end;

procedure __DC__SetDBTables__Oracle8Blobs(Instance : TObject; Params : PVariantArgList);
begin
DBTables.Oracle8Blobs:=OleVariant(Params^[0]);
end;
...
__RegisteredVars.Add(RegisterVar('Oracle8Blobs',__DC__GetDBTables__Oracle8Blobs,__DC__SetDBTables__Oracle8Blobs));
end;
...
const __ConstNames0 : array[0..71] of string = (
'smTraceBufSize'
,'dbfOpened'
,'dbfPrepared'
,'dbfExecSQL'
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[54] ,batAppend));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[55] ,batUpdate));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[56] ,batAppendUpdate));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[57] ,batDelete));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[58] ,batCopy));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[59] ,ttDefault));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[60] ,ttParadox));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[61] ,ttDBase));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[62] ,ttFoxPro));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[63] ,ttASCII));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[64] ,ltReadLock));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[65] ,ltWriteLock));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[66] ,pbByName));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[67] ,pbByNumber));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[68] ,VarFromSet(cmVirtual, sizeof(cmVirtual))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[69] ,VarFromSet(cmPersistent, sizeof(cmPersistent))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[70] ,VarFromSet(cmSession, sizeof(cmSession))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[71] ,VarFromSet(cmAll, sizeof(cmAll))));
end;
...
RegRegisterMethod(TBDEDataSet,'DestroyHandle',TypeInfo(_T15),NoParams, pointer(504));

RegRegisterMethod(TBDEDataSet,'DestroyLookupCursor',TypeInfo(_T16),NoParams, pointer(508));

RegRegisterMethod(TBDEDataSet,'PrepareCursor',TypeInfo(_T18),NoParams, pointer(516));
...
RegisterProc(TBlobStream,'Create',mtConstructor,TypeInfo(_T30),[
TypeInfo(TBlobField),
TypeInfo(TBlobStreamMode)],Addr(TBlobStream.Create),cRegister);

RegRegisterMethod(TBlobStream,'Truncate',TypeInfo(_T31),NoParams,Addr(TBlobStream.Truncate));

RegRegisterMethod(TDatabase,'ApplyUpdates',TypeInfo(_T32),[
ArrayInfo(TypeInfo(TDBDataSet))],Addr(TDatabase.ApplyUpdates));

RegRegisterMethod(TDatabase,'Close',TypeInfo(_T33),NoParams,Addr(TDatabase.Close));
...
RegRegisterMethod(TDatabase,'FlushSchemaCache',TypeInfo(_T36),[
TypeInfo(string)],Addr(TDatabase.FlushSchemaCache));

RegRegisterMethod(TDatabase,'Open',TypeInfo(_T37),NoParams,Addr(TDatabase.Open));
...
RegRegisterMethod(TDBDataSet,'Disconnect',TypeInfo(_T44),NoParams, pointer(520));

RegRegisterMethod(TDBDataSet,'SetDBFlag',TypeInfo(_T46),[
TypeInfo(Integer),
TypeInfo(Boolean),TypeInfo(Boolean)], pointer(528));

RegRegisterMethod(TDBDataSet,'CheckOpen',TypeInfo(_T47),[
TypeInfo(DBIResult),TypeInfo(Boolean)],Addr(TDBDataSet.CheckOpen));

RegRegisterMethod(TDBDataSet,'CloseDatabase',TypeInfo(_T48),[
TypeInfo(TDatabase)],Addr(TDBDataSet.CloseDatabase));

RegRegisterMethod(TDBDataSet,'OpenDatabase',TypeInfo(_T49),[TypeInfo(TDatabase)],Addr(TDBDataSet.OpenDatabase));

RegisterProc(TIndexFiles,'Create',mtConstructor,TypeInfo(_T51),[
TypeInfo(TTable)],Addr(TIndexFiles.Create),cRegister);

RegisterProc(TParamList,'Create',mtConstructor,TypeInfo(_T52),[
TypeInfo(TStrings)],Addr(TParamList.Create),cRegister);

RegRegisterMethod(TQuery,'FreeStatement',TypeInfo(_T53),NoParams, pointer(532));

RegRegisterMethod(TQuery,'ExecSQL',TypeInfo(_T55),NoParams,Addr(TQuery.ExecSQL));

RegRegisterMethod(TQuery,'ParamByName',TypeInfo(_T56),[
TypeInfo(string),TypeInfo(TParam)],Addr(TQuery.ParamByName));

RegRegisterMethod(TQuery,'Prepare',TypeInfo(_T57),NoParams,Addr(TQuery.Prepare));

RegRegisterMethod(TQuery,'UnPrepare',TypeInfo(_T58),NoParams,Addr(TQuery.UnPrepare));

RegRegisterMethod(TSession,'AddAlias',TypeInfo(_T59),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.AddAlias));

RegRegisterMethod(TSession,'AddDriver',TypeInfo(_T60),[
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.AddDriver));

RegRegisterMethod(TSession,'AddStandardAlias',TypeInfo(_T61),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(string)],Addr(TSession.AddStandardAlias));

RegRegisterMethod(TSession,'AddPassword',TypeInfo(_T62),[
TypeInfo(string)],Addr(TSession.AddPassword));

RegRegisterMethod(TSession,'Close',TypeInfo(_T63),NoParams,Addr(TSession.Close));

RegRegisterMethod(TSession,'CloseDatabase',TypeInfo(_T64),[
TypeInfo(TDatabase)],Addr(TSession.CloseDatabase));

RegRegisterMethod(TSession,'DeleteAlias',TypeInfo(_T65),[
TypeInfo(string)],Addr(TSession.DeleteAlias));

RegRegisterMethod(TSession,'DeleteDriver',TypeInfo(_T66),[
TypeInfo(string)],Addr(TSession.DeleteDriver));

RegRegisterMethod(TSession,'DropConnections',TypeInfo(_T67),NoParams,Addr(TSession.DropConnections));

RegRegisterMethod(TSession,'FindDatabase',TypeInfo(_T68),[
TypeInfo(string),TypeInfo(TDatabase)],Addr(TSession.FindDatabase));

RegRegisterMethod(TSession,'GetAliasNames',TypeInfo(_T69),[
TypeInfo(TStrings)],Addr(TSession.GetAliasNames));

RegRegisterMethod(TSession,'GetAliasParams',TypeInfo(_T70),[
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.GetAliasParams));

RegRegisterMethod(TSession,'GetAliasDriverName',TypeInfo(_T71),[
TypeInfo(string),TypeInfo(string)],Addr(TSession.GetAliasDriverName));

RegRegisterMethod(TSession,'GetConfigParams',TypeInfo(_T72),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.GetConfigParams));

RegRegisterMethod(TSession,'GetDatabaseNames',TypeInfo(_T73),[
TypeInfo(TStrings)],Addr(TSession.GetDatabaseNames));

RegRegisterMethod(TSession,'GetDriverNames',TypeInfo(_T74),[
TypeInfo(TStrings)],Addr(TSession.GetDriverNames));

RegRegisterMethod(TSession,'GetDriverParams',TypeInfo(_T75),[
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.GetDriverParams));

RegRegisterMethod(TSession,'GetPassword',TypeInfo(_T76),[TypeInfo(Boolean)],Addr(TSession.GetPassword));

RegRegisterMethod(TSession,'GetTableNames',TypeInfo(_T77),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(Boolean),
TypeInfo(Boolean),
...
RegRegisterMethod(TSession,'GetStoredProcNames',TypeInfo(_T78),[
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.GetStoredProcNames));

RegRegisterMethod(TSession,'IsAlias',TypeInfo(_T79),[
TypeInfo(string),TypeInfo(Boolean)],Addr(TSession.IsAlias));

RegRegisterMethod(TSession,'ModifyAlias',TypeInfo(_T80),[
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.ModifyAlias));

RegRegisterMethod(TSession,'ModifyDriver',TypeInfo(_T81),[
TypeInfo(string),
TypeInfo(TStrings)],Addr(TSession.ModifyDriver));

RegRegisterMethod(TSession,'Open',TypeInfo(_T82),NoParams,Addr(TSession.Open));

RegRegisterMethod(TSession,'OpenDatabase',TypeInfo(_T83),[
TypeInfo(string),TypeInfo(TDatabase)],Addr(TSession.OpenDatabase));

RegRegisterMethod(TSession,'RemoveAllPasswords',TypeInfo(_T84),NoParams,Addr(TSession.RemoveAllPasswords));

RegRegisterMethod(TSession,'RemovePassword',TypeInfo(_T85),[
TypeInfo(string)],Addr(TSession.RemovePassword));

RegRegisterMethod(TSession,'SaveConfigFile',TypeInfo(_T86),NoParams,Addr(TSession.SaveConfigFile));

RegisterProc(TSessionList,'Create',mtConstructor,TypeInfo(_T87),NoParams,Addr(TSessionList.Create),cRegister);

RegRegisterMethod(TSessionList,'FindSession',TypeInfo(_T88),[
TypeInfo(string),TypeInfo(TSession)],Addr(TSessionList.FindSession));

RegRegisterMethod(TSessionList,'GetSessionNames',TypeInfo(_T89),[
TypeInfo(TStrings)],Addr(TSessionList.GetSessionNames));

RegRegisterMethod(TSessionList,'OpenSession',TypeInfo(_T90),[
...
{RegRegisterMethod(TBDEDataSet,'CreateHandle',TypeInfo(_T14),[TypeInfoPointer], pointer(500))}

{RegRegisterMethod(TBDEDataSet,'GetLookupCursor',TypeInfo(_T17),[
TypeInfo(string),
TypeInfo(Boolean),TypeInfoPointer], pointer(512))}
...
{RegRegisterMethod(TDBDataSet,'GetProvider',TypeInfo(_T45),[TypeInfo(IProvider)], pointer(524))}

{RegisterProc(TDBError,'Create',mtConstructor,TypeInfo(_T50),[
TypeInfo(EDBEngineError),
TypeInfo(DBIResult),
TypeInfo(Longint),
TypeInfoPChar],Addr(TDBError.Create),cRegister)}

{RegRegisterMethod(TQuery,'GetStatementHandle',TypeInfo(_T54),[
TypeInfoPChar], pointer(536))}
