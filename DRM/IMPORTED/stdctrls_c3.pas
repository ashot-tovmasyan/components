...
{_T26 = procedure (p0 : PChar) of object;}

_T27 = _T1;

_T28 = procedure (const p0 : IDispatch;
p1 : Word) of object;
...
_T33 = function (p0 : Integer): Longint of object;

_T34 = procedure (p0 : Integer;
...
_T38 = function (const p0 : IDispatch;
p1 : Boolean): Integer of object;

_T39 = function (p0 : Integer): IDispatch of object;

_T40 = function : IDispatch of object;

_T41 = _T1;

_T42 = procedure (p0 : TScrollCode;
var p1 : Integer) of object;
...
RegRegisterMethod(TCustomCheckBox,'Toggle',TypeInfo(_T1),NoParams, pointer(128));

RegRegisterMethod(TCustomComboBox,'ComboWndProc',TypeInfo(_T2),[
TypeInfo(IDispatch),
TypeInfo(HWnd),
TypeInfoPointer], pointer(128));

RegRegisterMethod(TCustomComboBox,'DrawItem',TypeInfo(_T3),[
TypeInfo(Integer),
TypeInfo(IDispatch),
TypeInfo(TOwnerDrawState)], pointer(132));
...
TypeInfo(TComboBoxStyle)], pointer(140));
...
RegRegisterMethod(TCustomEdit,'GetSelLength',TypeInfo(_T12),[TypeInfo(Integer)], pointer(132));

RegRegisterMethod(TCustomEdit,'GetSelStart',TypeInfo(_T13),[TypeInfo(Integer)], pointer(136));

RegRegisterMethod(TCustomEdit,'GetSelText',TypeInfo(_T14),[TypeInfo(string)], pointer(140));
...
RegRegisterMethod(TCustomEdit,'Clear',TypeInfo(_T17),NoParams, pointer(152));
...
RegRegisterMethod(TCustomEdit,'Undo',TypeInfo(_T22),NoParams,Addr(TCustomEdit.Undo));

RegRegisterMethod(TCustomEdit,'ClearUndo',TypeInfo(_T23),NoParams,Addr(TCustomEdit.ClearUndo));

RegRegisterMethod(TCustomEdit,'SelectAll',TypeInfo(_T25),NoParams,Addr(TCustomEdit.SelectAll));

RegRegisterMethod(TCustomLabel,'AdjustBounds',TypeInfo(_T27),NoParams, pointer(MinVMTOffset - 30));

RegRegisterMethod(TCustomLabel,'DoDrawText',TypeInfo(_T28),[
TypeInfo(IDispatch),
TypeInfo(Word)], pointer(MinVMTOffset - 31));

RegRegisterMethod(TCustomLabel,'GetLabelText',TypeInfo(_T29),[TypeInfo(string)], pointer(92));

RegRegisterMethod(TCustomLabel,'SetAutoSize',TypeInfo(_T30),[
TypeInfo(Boolean)], pointer(96));

RegRegisterMethod(TCustomListBox,'DrawItem',TypeInfo(_T31),[
TypeInfo(Integer),
TypeInfo(IDispatch),
TypeInfo(TOwnerDrawState)], pointer(128));

RegRegisterMethod(TCustomListBox,'MeasureItem',TypeInfo(_T32),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(132));

RegRegisterMethod(TCustomListBox,'GetItemData',TypeInfo(_T33),[
TypeInfo(Integer),TypeInfo(Longint)], pointer(MinVMTOffset - 36));

RegRegisterMethod(TCustomListBox,'SetItemData',TypeInfo(_T34),[
TypeInfo(Integer),
TypeInfo(Longint)], pointer(MinVMTOffset - 37));

RegRegisterMethod(TCustomListBox,'ResetContent',TypeInfo(_T35),NoParams, pointer(MinVMTOffset - 38));

RegRegisterMethod(TCustomListBox,'DeleteString',TypeInfo(_T36),[
TypeInfo(Integer)], pointer(MinVMTOffset - 39));

RegRegisterMethod(TCustomListBox,'Clear',TypeInfo(_T37),NoParams,Addr(TCustomListBox.Clear));

RegRegisterMethod(TCustomListBox,'ItemAtPos',TypeInfo(_T38),[
TypeInfo(IDispatch),
TypeInfo(Boolean),TypeInfo(Integer)],Addr(__TCustomListBox__ItemAtPos__Wrapper));

RegRegisterMethod(TCustomListBox,'ItemRect',TypeInfo(_T39),[
TypeInfo(Integer),TypeInfo(IDispatch)],Addr(__TCustomListBox__ItemRect__Wrapper));

RegRegisterMethod(TCustomMemo,'GetCaretPos',TypeInfo(_T40),[TypeInfo(IDispatch)], pointer(160));

RegRegisterMethod(TScrollBar,'Change',TypeInfo(_T41),NoParams, pointer(MinVMTOffset - 36));

RegRegisterMethod(TScrollBar,'Scroll',TypeInfo(_T42),[
TypeInfo(TScrollCode),
TypeInfo(Integer)], pointer(MinVMTOffset - 37));

RegRegisterMethod(TScrollBar,'SetParams',TypeInfo(_T43),[
TypeInfo(Integer),
TypeInfo(Integer),
...
initialization
_mreg_0;
{RegRegisterMethod(TCustomEdit,'GetSelTextBuf',TypeInfo(_T24),[
TypeInfoPChar,
TypeInfo(Integer),TypeInfo(Integer)], pointer(156))}

{RegRegisterMethod(TCustomEdit,'SetSelTextBuf',TypeInfo(_T26),[
