...
RegRegisterMethod(TCustomControlBar,'StickControls',TypeInfo(_T7),NoParams, pointer(208));

RegRegisterMethod(TCustomRadioGroup,'CanModify',TypeInfo(_T8),[TypeInfo(Boolean)], pointer(188));
...
RegRegisterMethod(TSplitter,'StopSizing',TypeInfo(_T15),NoParams, pointer(MinVMTOffset - 49));
