...
TypeInfo(TDCDsgnProp),TypeInfo(Integer)], pointer(200));
...
TypeInfo(TObject),TypeInfo(Boolean)], pointer(208));

RegRegisterMethod(TCustomObjectInspector,'ShowAxHelp',TypeInfo(_T8),NoParams, pointer(144));

RegRegisterMethod(TCustomObjectInspector,'ChangeValue',TypeInfo(_T10),[
TypeInfo(TDCDsgnProp),
TypeInfo(string)], pointer(152));

RegRegisterMethod(TCustomObjectInspector,'UpdateEditorState',TypeInfo(_T11),[
TypeInfo(TCustomDCEdit),
TypeInfo(TDCDsgnProp)], pointer(156));

RegRegisterMethod(TCustomObjectInspector,'GetRealName',TypeInfo(_T14),[
TypeInfo(TDCDsgnProp),TypeInfo(string)], pointer(168));

RegRegisterMethod(TCustomObjectInspector,'ComponentChanged',TypeInfo(_T15),NoParams, pointer(172));

RegRegisterMethod(TCustomObjectInspector,'IsEmpty',TypeInfo(_T17),[TypeInfo(Boolean)], pointer(180));

RegRegisterMethod(TCustomObjectInspector,'CanHaveSubNodes',TypeInfo(_T18),[TypeInfo(Boolean)], pointer(184));

RegRegisterMethod(TCustomObjectInspector,'IsInspectorKey',TypeInfo(_T19),[
TypeInfo(Word),
TypeInfo(TShiftState),TypeInfo(Boolean)], pointer(188));

RegRegisterMethod(TCustomObjectInspector,'GetActivePropDesc',TypeInfo(_T20),[TypeInfo(string)], pointer(192));

RegRegisterMethod(TCustomObjectInspector,'UpdateEditorValue',TypeInfo(_T21),NoParams, pointer(196));
...
{RegRegisterMethod(TCustomObjectInspector,'GetInplaceEditClass',TypeInfo(_T9),[TypeInfo(TInplaceEditClass)], pointer(148))}

{RegRegisterMethod(TCustomObjectInspector,'GetEditorClass',TypeInfo(_T12),[
TypeInfo(TDCDsgnProp),TypeInfo(TControlClass)], pointer(160))}

{RegRegisterMethod(TCustomObjectInspector,'GetPopupClass',TypeInfo(_T13),[
TypeInfo(TDCDsgnProp),TypeInfo(TWinControlClass)], pointer(164))}
...
TypeInfo(TGetPropEditProc)], pointer(176))}
