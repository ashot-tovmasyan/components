...
_T31 = procedure (p0 : TColor) of object;

_T32 = _T24;

_T33 = _T24;

_T34 = function : HPALETTE of object;
...
_T45 = procedure (const p0 : IDispatch) of object;
...
_T61 = procedure (const p0 : IDispatch;
p1 : TGraphic) of object;

_T62 = function (const p0 : string): IDispatch of object;
...
_T67 = function : Boolean of object;
...
_T71 = procedure (p0 : TObject) of object;

_T72 = procedure (p0 : TCanvas;
const p1 : IDispatch) of object;

_T73 = function (p0 : TGraphic): Boolean of object;
...
_T81 = procedure (p0 : Integer) of object;

_T82 = procedure (p0 : HPALETTE) of object;

_T83 = procedure (p0 : Boolean) of object;

_T84 = _T81;

_T85 = _T80;

_T86 = procedure (const p0 : string) of object;
...
_T90 = procedure (p0 : Word;
p1 : THandle;
p2 : HPALETTE) of object;

_T91 = procedure (var p0 : Word;
var p1 : THandle;
var p2 : HPALETTE) of object;

_T92 = _T14;

_T93 = function : HICON of object;

_T94 = _T14;

_T95 = function : HENHMETAFILE of object;

_T96 = procedure (p0 : TMetafile;
p1 : HDC) of object;

_T97 = procedure (p0 : TMetafile;
p1 : HDC;
const p2 : string;
const p3 : string) of object;
...
_T106 = function (p0 : Word): Boolean of object;
...
{_T109 = procedure (p0 : Word;
p1 : TGraphicClass) of object;}

{_T110 = procedure (p0 : TGraphicClass) of object;}
...
RegRegisterMethod(TBitmap,'GetHandle',TypeInfo(_T24),[TypeInfo(HBITMAP)], pointer(96));

RegRegisterMethod(TBitmap,'GetMaskHandle',TypeInfo(_T25),[TypeInfo(HBITMAP)], pointer(100));
...
RegRegisterMethod(TBitmap,'LoadFromResourceName',TypeInfo(_T29),[
TypeInfo(THandle),
TypeInfo(string)],Addr(TBitmap.LoadFromResourceName));

RegRegisterMethod(TBitmap,'LoadFromResourceID',TypeInfo(_T30),[
TypeInfo(THandle),
TypeInfo(Integer)],Addr(TBitmap.LoadFromResourceID));

RegRegisterMethod(TBitmap,'Mask',TypeInfo(_T31),[
TypeInfo(TColor)],Addr(TBitmap.Mask));

RegRegisterMethod(TBitmap,'ReleaseHandle',TypeInfo(_T32),[TypeInfo(HBITMAP)],Addr(TBitmap.ReleaseHandle));

RegRegisterMethod(TBitmap,'ReleaseMaskHandle',TypeInfo(_T33),[TypeInfo(HBITMAP)],Addr(TBitmap.ReleaseMaskHandle));

RegRegisterMethod(TBitmap,'ReleasePalette',TypeInfo(_T34),[TypeInfo(HPALETTE)],Addr(TBitmap.ReleasePalette));

RegisterProc(TBrush,'Create',mtConstructor,TypeInfo(_T35),NoParams,Addr(TBrush.Create),cRegister);

RegRegisterMethod(TCanvas,'Changed',TypeInfo(_T36),NoParams, pointer(12));

RegRegisterMethod(TCanvas,'Changing',TypeInfo(_T37),NoParams, pointer(16));

RegRegisterMethod(TCanvas,'CreateHandle',TypeInfo(_T38),NoParams, pointer(20));

RegisterProc(TCanvas,'Create',mtConstructor,TypeInfo(_T39),NoParams,Addr(TCanvas.Create),cRegister);

RegRegisterMethod(TCanvas,'Arc',TypeInfo(_T40),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
...
RegRegisterMethod(TCanvas,'BrushCopy',TypeInfo(_T41),[
TypeInfo(IDispatch),
TypeInfo(TBitmap),
TypeInfo(IDispatch),
TypeInfo(TColor)],Addr(__TCanvas__BrushCopy__Wrapper));

RegRegisterMethod(TCanvas,'Chord',TypeInfo(_T42),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
...
RegRegisterMethod(TCanvas,'CopyRect',TypeInfo(_T43),[
TypeInfo(IDispatch),
TypeInfo(TCanvas),
TypeInfo(IDispatch)],Addr(__TCanvas__CopyRect__Wrapper));

RegRegisterMethod(TCanvas,'Draw',TypeInfo(_T44),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(TGraphic)],Addr(TCanvas.Draw));

RegRegisterMethod(TCanvas,'DrawFocusRect',TypeInfo(_T45),[
TypeInfo(IDispatch)],Addr(__TCanvas__DrawFocusRect__Wrapper));

RegRegisterMethod(TCanvas,'Ellipse',TypeInfo(_T46),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TCanvas.Ellipse));

RegRegisterMethod(TCanvas,'FillRect',TypeInfo(_T47),[
TypeInfo(IDispatch)],Addr(__TCanvas__FillRect__Wrapper));

RegRegisterMethod(TCanvas,'FloodFill',TypeInfo(_T48),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(TColor),
TypeInfo(TFillStyle)],Addr(TCanvas.FloodFill));

RegRegisterMethod(TCanvas,'FrameRect',TypeInfo(_T49),[
TypeInfo(IDispatch)],Addr(__TCanvas__FrameRect__Wrapper));

RegRegisterMethod(TCanvas,'LineTo',TypeInfo(_T50),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TCanvas.LineTo));

RegRegisterMethod(TCanvas,'Lock',TypeInfo(_T51),NoParams,Addr(TCanvas.Lock));

RegRegisterMethod(TCanvas,'MoveTo',TypeInfo(_T52),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TCanvas.MoveTo));

RegRegisterMethod(TCanvas,'Pie',TypeInfo(_T53),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
...
RegRegisterMethod(TCanvas,'Polygon',TypeInfo(_T54),[
ArrayInfo(TypeInfo(IDispatch))],Addr(__TCanvas__Polygon__Wrapper));

RegRegisterMethod(TCanvas,'Polyline',TypeInfo(_T55),[
ArrayInfo(TypeInfo(IDispatch))],Addr(__TCanvas__Polyline__Wrapper));

RegRegisterMethod(TCanvas,'PolyBezier',TypeInfo(_T56),[
ArrayInfo(TypeInfo(IDispatch))],Addr(__TCanvas__PolyBezier__Wrapper));

RegRegisterMethod(TCanvas,'PolyBezierTo',TypeInfo(_T57),[
ArrayInfo(TypeInfo(IDispatch))],Addr(__TCanvas__PolyBezierTo__Wrapper));

RegRegisterMethod(TCanvas,'Rectangle',TypeInfo(_T58),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TCanvas.Rectangle));

RegRegisterMethod(TCanvas,'Refresh',TypeInfo(_T59),NoParams,Addr(TCanvas.Refresh));

RegRegisterMethod(TCanvas,'RoundRect',TypeInfo(_T60),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer),
...
RegRegisterMethod(TCanvas,'StretchDraw',TypeInfo(_T61),[
TypeInfo(IDispatch),
TypeInfo(TGraphic)],Addr(__TCanvas__StretchDraw__Wrapper));

RegRegisterMethod(TCanvas,'TextExtent',TypeInfo(_T62),[
TypeInfo(string),TypeInfo(IDispatch)],Addr(__TCanvas__TextExtent__Wrapper));

RegRegisterMethod(TCanvas,'TextHeight',TypeInfo(_T63),[
TypeInfo(string),TypeInfo(Integer)],Addr(TCanvas.TextHeight));

RegRegisterMethod(TCanvas,'TextOut',TypeInfo(_T64),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(string)],Addr(TCanvas.TextOut));

RegRegisterMethod(TCanvas,'TextRect',TypeInfo(_T65),[
TypeInfo(IDispatch),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(string)],Addr(__TCanvas__TextRect__Wrapper));

RegRegisterMethod(TCanvas,'TextWidth',TypeInfo(_T66),[
TypeInfo(string),TypeInfo(Integer)],Addr(TCanvas.TextWidth));

RegRegisterMethod(TCanvas,'TryLock',TypeInfo(_T67),[TypeInfo(Boolean)],Addr(TCanvas.TryLock));

RegRegisterMethod(TCanvas,'Unlock',TypeInfo(_T68),NoParams,Addr(TCanvas.Unlock));

RegisterProc(TFont,'Create',mtConstructor,TypeInfo(_T69),NoParams,Addr(TFont.Create),cRegister);

RegisterProc(TGraphic,'Create',mtConstructor,TypeInfo(_T70),NoParams, pointer(12),cRegister);

RegRegisterMethod(TGraphic,'Changed',TypeInfo(_T71),[
TypeInfo(TObject)], pointer(16));

RegRegisterMethod(TGraphic,'Draw',TypeInfo(_T72),[
TypeInfo(TCanvas),
TypeInfo(IDispatch)], pointer(20));

RegRegisterMethod(TGraphic,'Equals',TypeInfo(_T73),[
TypeInfo(TGraphic),TypeInfo(Boolean)], pointer(24));

RegRegisterMethod(TGraphic,'GetEmpty',TypeInfo(_T74),[TypeInfo(Boolean)], pointer(28));

RegRegisterMethod(TGraphic,'GetHeight',TypeInfo(_T75),[TypeInfo(Integer)], pointer(32));

RegRegisterMethod(TGraphic,'GetPalette',TypeInfo(_T76),[TypeInfo(HPALETTE)], pointer(36));

RegRegisterMethod(TGraphic,'GetTransparent',TypeInfo(_T77),[TypeInfo(Boolean)], pointer(40));

RegRegisterMethod(TGraphic,'GetWidth',TypeInfo(_T78),[TypeInfo(Integer)], pointer(44));

RegRegisterMethod(TGraphic,'Progress',TypeInfo(_T79),[
TypeInfo(TObject),
...
RegRegisterMethod(TGraphic,'ReadData',TypeInfo(_T80),[
TypeInfo(TStream)], pointer(48));

RegRegisterMethod(TGraphic,'SetHeight',TypeInfo(_T81),[
TypeInfo(Integer)], pointer(52));

RegRegisterMethod(TGraphic,'SetPalette',TypeInfo(_T82),[
TypeInfo(HPALETTE)], pointer(56));

RegRegisterMethod(TGraphic,'SetTransparent',TypeInfo(_T83),[
TypeInfo(Boolean)], pointer(60));

RegRegisterMethod(TGraphic,'SetWidth',TypeInfo(_T84),[
TypeInfo(Integer)], pointer(64));

RegRegisterMethod(TGraphic,'WriteData',TypeInfo(_T85),[
TypeInfo(TStream)], pointer(68));

RegRegisterMethod(TGraphic,'LoadFromFile',TypeInfo(_T86),[
TypeInfo(string)], pointer(72));

RegRegisterMethod(TGraphic,'SaveToFile',TypeInfo(_T87),[
TypeInfo(string)], pointer(76));

RegRegisterMethod(TGraphic,'LoadFromStream',TypeInfo(_T88),[
TypeInfo(TStream)], pointer(80));

RegRegisterMethod(TGraphic,'SaveToStream',TypeInfo(_T89),[
TypeInfo(TStream)], pointer(84));

RegRegisterMethod(TGraphic,'LoadFromClipboardFormat',TypeInfo(_T90),[
TypeInfo(Word),
TypeInfo(THandle),
TypeInfo(HPALETTE)], pointer(88));

RegRegisterMethod(TGraphic,'SaveToClipboardFormat',TypeInfo(_T91),[
TypeInfo(Word),
TypeInfo(THandle),
TypeInfo(HPALETTE)], pointer(92));

RegRegisterMethod(TGraphicsObject,'Changed',TypeInfo(_T92),NoParams, pointer(MinVMTOffset - 2));

RegRegisterMethod(TIcon,'ReleaseHandle',TypeInfo(_T93),[TypeInfo(HICON)],Addr(TIcon.ReleaseHandle));

RegRegisterMethod(TMetafile,'Clear',TypeInfo(_T94),NoParams,Addr(TMetafile.Clear));

RegRegisterMethod(TMetafile,'ReleaseHandle',TypeInfo(_T95),[TypeInfo(HENHMETAFILE)],Addr(TMetafile.ReleaseHandle));

RegisterProc(TMetafileCanvas,'Create',mtConstructor,TypeInfo(_T96),[
TypeInfo(TMetafile),
TypeInfo(HDC)],Addr(TMetafileCanvas.Create),cRegister);

RegisterProc(TMetafileCanvas,'CreateWithComment',mtConstructor,TypeInfo(_T97),[
TypeInfo(TMetafile),
TypeInfo(HDC),
TypeInfo(string),
TypeInfo(string)],Addr(TMetafileCanvas.CreateWithComment),cRegister);

RegisterProc(TPen,'Create',mtConstructor,TypeInfo(_T98),NoParams,Addr(TPen.Create),cRegister);

RegRegisterMethod(TPicture,'Changed',TypeInfo(_T99),[
TypeInfo(TObject)], pointer(MinVMTOffset - 2));

RegRegisterMethod(TPicture,'Progress',TypeInfo(_T100),[
TypeInfo(TObject),
TypeInfo(TProgressStage),
TypeInfo(Byte),
TypeInfo(Boolean),
...
RegisterProc(TPicture,'Create',mtConstructor,TypeInfo(_T101),NoParams,Addr(TPicture.Create),cRegister);

RegRegisterMethod(TPicture,'LoadFromFile',TypeInfo(_T102),[
TypeInfo(string)],Addr(TPicture.LoadFromFile));

RegRegisterMethod(TPicture,'SaveToFile',TypeInfo(_T103),[
TypeInfo(string)],Addr(TPicture.SaveToFile));

RegRegisterMethod(TPicture,'LoadFromClipboardFormat',TypeInfo(_T104),[
TypeInfo(Word),
TypeInfo(THandle),
TypeInfo(HPALETTE)],Addr(TPicture.LoadFromClipboardFormat));

RegRegisterMethod(TPicture,'SaveToClipboardFormat',TypeInfo(_T105),[
TypeInfo(Word),
TypeInfo(THandle),
TypeInfo(HPALETTE)],Addr(TPicture.SaveToClipboardFormat));

RegisterProc(TPicture,'SupportsClipboardFormat',mtClassMethod,TypeInfo(_T106),[
TypeInfo(Word),TypeInfo(Boolean)],Addr(TPicture.SupportsClipboardFormat),cRegister);

RegRegisterMethod(TSharedImage,'FreeHandle',TypeInfo(_T111),NoParams, pointer(0));
...
{RegisterProc(TPicture,'RegisterFileFormat',mtClassMethod,TypeInfo(_T107),[
TypeInfo(string),
TypeInfo(string),
TypeInfo(TGraphicClass)],Addr(TPicture.RegisterFileFormat),cRegister)}

{RegisterProc(TPicture,'RegisterFileFormatRes',mtClassMethod,TypeInfo(_T108),[
TypeInfo(string),
TypeInfo(Integer),
TypeInfo(TGraphicClass)],Addr(TPicture.RegisterFileFormatRes),cRegister)}

{RegisterProc(TPicture,'RegisterClipboardFormat',mtClassMethod,TypeInfo(_T109),[
TypeInfo(Word),
TypeInfo(TGraphicClass)],Addr(TPicture.RegisterClipboardFormat),cRegister)}

{RegisterProc(TPicture,'UnregisterGraphicClass',mtClassMethod,TypeInfo(_T110),[
