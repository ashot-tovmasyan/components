...
_T58 = function (const p0 : Boolean;
const p1 : Boolean;
p2 : Char;
...
_T60 = function (p0 : TStream): string of object;

{_T61 = function (p0 : TCustomFormClass): string of object;}

{_T62 = procedure (p0 : TCustomFormClass;
const p1 : string) of object;}
...
{_T64 = procedure (p0 : TCustomFormClass) of object;}

_T65 = procedure (const p0 : Array of TSpeedButton;
p1 : Boolean) of object;

_T66 = _T18;

_T67 = function : TSortedList of object;

{_T68 = function (p0 : Integer): TCustomFormClass of object;}

_T69 = function : TStringList of object;

_T70 = _T53;

{_T71 = function (p0 : PTypeData;
...
_T74 = procedure (p0 : TCompFiler) of object;

_T75 = procedure (p0 : TReader;
const p1 : string;
...
_T77 = function (const p0 : string): Integer of object;
...
_T84 = function (p0 : Integer): string of object;

_T85 = _T37;

_T86 = function (p0 : TStream;
p1 : TComponent): string of object;

_T87 = procedure (p0 : TStream;
p1 : TComponent) of object;

_T88 = procedure (const p0 : TFileName;
p1 : TComponent) of object;

_T89 = _T88;

{_T90 = function (p0 : TStream;
p1 : TComponentClass;
p2 : Boolean): TComponent of object;}

{_T91 = function (const p0 : TFileName;
p1 : TComponentClass;
p2 : Boolean): TComponent of object;}

_T92 = function : string of object;

{_T93 = function : IOleObject of object;}
...
_T98 = function (p0 : Char): Boolean of object;
...
_T101 = procedure (p0 : TStream) of object;
...
{_T107 = procedure (p0 : TWndMethod) of object;}

_T108 = procedure (p0 : TPersistent;
const p1 : string;
p2 : Integer) of object;

_T109 = procedure (p0 : Integer) of object;
...
RegisterProc(nil,MethodNames[50],mtProc,TypeInfo(_T57),[
TypeInfo(string),
TypeInfo(string),TypeInfo(Boolean)],Addr(QueryDirectory),cRegister);

RegisterProc(nil,MethodNames[51],mtProc,TypeInfo(_T58),[
TypeInfo(Boolean),
TypeInfo(Boolean),
TypeInfo(Char),
TypeInfo(IDispatch),TypeInfo(string)],Addr(____DropFiles__Wrapper),cRegister);

RegisterProc(nil,MethodNames[52],mtProc,TypeInfo(_T59),[
TypeInfo(TStream),TypeInfo(Boolean)],Addr(IsTextStream),cRegister);

RegisterProc(nil,MethodNames[53],mtProc,TypeInfo(_T60),[
...
RegisterProc(nil,MethodNames[55],mtProc,TypeInfo(_T66),[
TypeInfo(TComponent),
TypeInfo(Boolean)],Addr(SetFlatPropToAll),cRegister);

RegisterProc(nil,MethodNames[56],mtProc,TypeInfo(_T67),[TypeInfo(TSortedList)],Addr(OptionFormClasses),cRegister);

RegisterProc(nil,MethodNames[57],mtProc,TypeInfo(_T69),[TypeInfo(TStringList)],Addr(OptionFormCaptions),cRegister);

RegisterProc(nil,MethodNames[58],mtProc,TypeInfo(_T70),[
TypeInfo(TBitmap)],Addr(CorrectBitmap),cRegister);

RegisterProc(nil,MethodNames[59],mtProc,TypeInfo(_T72),NoParams,Addr(Register),cRegister);

RegRegisterMethod(TCompFiler,'GlobalFindCompWithoutDesigned',TypeInfo(_T73),[
TypeInfo(string),TypeInfo(TComponent)],Addr(TCompFiler.GlobalFindCompWithoutDesigned));

RegRegisterMethod(TCompFiler,'Assign',TypeInfo(_T74),[
TypeInfo(TCompFiler)],Addr(TCompFiler.Assign));

RegRegisterMethod(TCompFiler,'ReaderError',TypeInfo(_T75),[
TypeInfo(TReader),
TypeInfo(string),
TypeInfo(Boolean)],Addr(TCompFiler.ReaderError));

RegRegisterMethod(TCompFiler,'ReaderOnMethod',TypeInfo(_T76),[
TypeInfo(TReader),
TypeInfo(string),
TypeInfoPointer,
TypeInfo(Boolean)],Addr(TCompFiler.ReaderOnMethod));

RegRegisterMethod(TCompFiler,'AddEvent',TypeInfo(_T77),[
TypeInfo(string),TypeInfo(Integer)],Addr(TCompFiler.AddEvent));

RegRegisterMethod(TCompFiler,'BeginMethodTrick',TypeInfo(_T78),[
TypeInfo(TComponent),
TypeInfo(Boolean)],Addr(TCompFiler.BeginMethodTrick));

RegRegisterMethod(TCompFiler,'EndMethodTrick',TypeInfo(_T79),[
TypeInfo(TComponent)],Addr(TCompFiler.EndMethodTrick));

RegRegisterMethod(TCompFiler,'BeginClassNameTrick',TypeInfo(_T80),[
TypeInfo(TComponent)],Addr(TCompFiler.BeginClassNameTrick));

RegRegisterMethod(TCompFiler,'EndClassNameTrick',TypeInfo(_T81),[
TypeInfo(TComponent)],Addr(TCompFiler.EndClassNameTrick));

RegRegisterMethod(TCompFiler,'BeginTrick',TypeInfo(_T82),[
TypeInfo(TComponent),
TypeInfo(Boolean)],Addr(TCompFiler.BeginTrick));

RegRegisterMethod(TCompFiler,'EndTrick',TypeInfo(_T83),[
TypeInfo(TComponent)],Addr(TCompFiler.EndTrick));

RegRegisterMethod(TCompFiler,'EventNameByID',TypeInfo(_T84),[
TypeInfo(Integer),TypeInfo(string)],Addr(TCompFiler.EventNameByID));

RegisterProc(TCompFiler,'Create',mtConstructor,TypeInfo(_T85),NoParams,Addr(TCompFiler.Create),cRegister);

RegRegisterMethod(TCompFiler,'LoadFromStream',TypeInfo(_T86),[
TypeInfo(TStream),
TypeInfo(TComponent),TypeInfo(string)],Addr(TCompFiler.LoadFromStream));

RegRegisterMethod(TCompFiler,'SaveToStream',TypeInfo(_T87),[
TypeInfo(TStream),
TypeInfo(TComponent)],Addr(TCompFiler.SaveToStream));

RegRegisterMethod(TCompFiler,'LoadFromFile',TypeInfo(_T88),[
TypeInfo(TFileName),
TypeInfo(TComponent)],Addr(TCompFiler.LoadFromFile));

RegRegisterMethod(TCompFiler,'SaveToFile',TypeInfo(_T89),[
TypeInfo(TFileName),
TypeInfo(TComponent)],Addr(TCompFiler.SaveToFile));

RegRegisterMethod(TCustomDCOleControl,'GetOleName',TypeInfo(_T92),[TypeInfo(string)], pointer(128));

RegRegisterMethod(TCustomDCOleControl,'SetEvent',TypeInfo(_T94),[
TypeInfo(Integer),
TypeInfo(string)], pointer(136));

RegRegisterMethod(TCustomDCOleControl,'GetEvent',TypeInfo(_T95),[
TypeInfo(Integer),TypeInfo(string)], pointer(140));

RegRegisterMethod(TDCCustomControl,'UpdateKeyMapping',TypeInfo(_T96),NoParams, pointer(128));

RegRegisterMethod(TDCCustomControl,'InitDefaultKeyMapping',TypeInfo(_T97),NoParams, pointer(132));

RegRegisterMethod(TDCCustomControl,'InsertChar',TypeInfo(_T98),[
TypeInfo(Char),TypeInfo(Boolean)], pointer(136));

RegisterProc(TDCHandleObject,'Create',mtConstructor,TypeInfo(_T99),[
TypeInfo(TObject)],Addr(TDCHandleObject.Create),cRegister);

RegRegisterMethod(TDCHandleObject,'PostMsg',TypeInfo(_T100),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TDCHandleObject.PostMsg));

RegRegisterMethod(TDCPropStore,'SaveToStream',TypeInfo(_T101),[
TypeInfo(TStream)],Addr(TDCPropStore.SaveToStream));

RegRegisterMethod(TDCPropStore,'LoadFromStream',TypeInfo(_T102),[
TypeInfo(TStream)],Addr(TDCPropStore.LoadFromStream));

RegRegisterMethod(TDCPropStore,'SaveToIniFile',TypeInfo(_T103),[
TypeInfo(string),
TypeInfo(string)],Addr(TDCPropStore.SaveToIniFile));

RegRegisterMethod(TDCPropStore,'LoadFromIniFile',TypeInfo(_T104),[
TypeInfo(string),
TypeInfo(string)],Addr(TDCPropStore.LoadFromIniFile));

RegRegisterMethod(TDCPropStore,'Load',TypeInfo(_T105),NoParams, pointer(40));

RegRegisterMethod(TDCPropStore,'Save',TypeInfo(_T106),NoParams, pointer(44));

RegisterProc(TPropStream,'Create',mtConstructor,TypeInfo(_T108),[
TypeInfo(TPersistent),
TypeInfo(string),
TypeInfo(Integer)],Addr(TPropStream.Create),cRegister);

RegRegisterMethod(TVerbDispatcher,'UpdateVerbObjects',TypeInfo(_T109),[
TypeInfo(Integer)],Addr(TVerbDispatcher.UpdateVerbObjects));

RegRegisterMethod(TVerbDispatcher,'UpdateControls',TypeInfo(_T110),NoParams,Addr(TVerbDispatcher.UpdateControls));

RegRegisterMethod(TVerbListItem,'UpdateControl',TypeInfo(_T111),NoParams,Addr(TVerbListItem.UpdateControl));

RegRegisterMethod(TVerbListItem,'VerbOnClick',TypeInfo(_T112),[
...
{RegisterProc(nil,'GetOptionsFormCaption',mtProc,TypeInfo(_T61),[
TypeInfo(TCustomFormClass),TypeInfo(string)],Addr(GetOptionsFormCaption),cRegister)}

{RegisterProc(nil,'RegisterOptionsForm',mtProc,TypeInfo(_T62),[
TypeInfo(TCustomFormClass),
TypeInfo(string)],Addr(RegisterOptionsForm),cRegister)}

{RegisterProc(nil,'RegisterOptionsFormOrder',mtProc,TypeInfo(_T63),[
TypeInfo(TCustomFormClass),
TypeInfo(Integer),
TypeInfo(string)],Addr(RegisterOptionsFormOrder),cRegister)}

{RegisterProc(nil,'UnregisterOptionsForm',mtProc,TypeInfo(_T64),[
TypeInfo(TCustomFormClass)],Addr(UnregisterOptionsForm),cRegister)}

{RegisterProc(nil,'OptionFormClass',mtProc,TypeInfo(_T68),[
TypeInfo(Integer),TypeInfo(TCustomFormClass)],Addr(OptionFormClass),cRegister)}

{RegisterProc(nil,'EqualMethodTypeData',mtProc,TypeInfo(_T71),[
TypeInfoPointer,
TypeInfoPointer,TypeInfo(Boolean)],Addr(EqualMethodTypeData),cRegister)}

{RegRegisterMethod(TCompFiler,'CreateFromStream',TypeInfo(_T90),[
TypeInfo(TStream),
TypeInfo(TComponentClass),
TypeInfo(Boolean),TypeInfo(TComponent)],Addr(TCompFiler.CreateFromStream))}

{RegRegisterMethod(TCompFiler,'CreateFromFile',TypeInfo(_T91),[
TypeInfo(TFileName),
TypeInfo(TComponentClass),
TypeInfo(Boolean),TypeInfo(TComponent)],Addr(TCompFiler.CreateFromFile))}

{RegRegisterMethod(TCustomDCOleControl,'GetOleObject',TypeInfo(_T93),[TypeInfo(IOleObject)], pointer(132))}

{RegisterProc(THandleObject,'Create',mtConstructor,TypeInfo(_T107),[
