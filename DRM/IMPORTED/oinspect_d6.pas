...
TypeInfo(TObject),TypeInfo(Boolean)], pointer(292));

RegRegisterMethod(TCustomObjectInspector,'ShowAxHelp',TypeInfo(_T8),NoParams, pointer(228));

RegRegisterMethod(TCustomObjectInspector,'ComponentChanged',TypeInfo(_T15),NoParams, pointer(256));

RegRegisterMethod(TCustomObjectInspector,'IsEmpty',TypeInfo(_T17),[TypeInfo(Boolean)], pointer(264));

RegRegisterMethod(TCustomObjectInspector,'CanHaveSubNodes',TypeInfo(_T18),[TypeInfo(Boolean)], pointer(268));

RegRegisterMethod(TCustomObjectInspector,'IsInspectorKey',TypeInfo(_T19),[
TypeInfo(Word),
TypeInfo(TShiftState),TypeInfo(Boolean)], pointer(272));

RegRegisterMethod(TCustomObjectInspector,'GetActivePropDesc',TypeInfo(_T20),[TypeInfo(string)], pointer(276));

RegRegisterMethod(TCustomObjectInspector,'UpdateEditorValue',TypeInfo(_T21),NoParams, pointer(280));
...
TypeInfo(TDCDsgnProp),TypeInfo(Integer)], pointer(284))}

{RegRegisterMethod(TCustomAxInspector,'ComparePropEditors',TypeInfo(_T6),[
TypeInfo(TDCDsgnProp),
TypeInfo(TDCDsgnProp),TypeInfo(Integer)], pointer(288))}

{RegRegisterMethod(TCustomObjectInspector,'GetInplaceEditClass',TypeInfo(_T9),[TypeInfo(TInplaceEditClass)], pointer(232))}
...
TypeInfo(TGetPropEditProc)], pointer(260))}
