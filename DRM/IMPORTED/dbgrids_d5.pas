...
TypeInfo(TColumn)], pointer(MinVMTOffset - 94));

RegRegisterMethod(TCustomDBGrid,'ColEnter',TypeInfo(_T30),NoParams, pointer(MinVMTOffset - 95));

RegRegisterMethod(TCustomDBGrid,'ColExit',TypeInfo(_T31),NoParams, pointer(MinVMTOffset - 96));

RegRegisterMethod(TCustomDBGrid,'CreateColumns',TypeInfo(_T32),[TypeInfo(TDBGridColumns)], pointer(MinVMTOffset - 97));

RegRegisterMethod(TCustomDBGrid,'DefineFieldMap',TypeInfo(_T33),NoParams, pointer(212));

RegRegisterMethod(TCustomDBGrid,'DrawDataCell',TypeInfo(_T34),[
TypeInfo(IDispatch),
TypeInfo(TField),
TypeInfo(TGridDrawState)], pointer(MinVMTOffset - 98));

RegRegisterMethod(TCustomDBGrid,'DrawColumnCell',TypeInfo(_T35),[
TypeInfo(IDispatch),
TypeInfo(Integer),
TypeInfo(TColumn),
TypeInfo(TGridDrawState)], pointer(MinVMTOffset - 99));

RegRegisterMethod(TCustomDBGrid,'EditButtonClick',TypeInfo(_T36),NoParams, pointer(MinVMTOffset - 100));

RegRegisterMethod(TCustomDBGrid,'HighlightCell',TypeInfo(_T37),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(string),
TypeInfo(TGridDrawState),TypeInfo(Boolean)], pointer(216));

RegRegisterMethod(TCustomDBGrid,'LayoutChanged',TypeInfo(_T38),NoParams, pointer(220));
...
TypeInfo(Integer)], pointer(228));

RegRegisterMethod(TCustomDBGrid,'SetColumnAttributes',TypeInfo(_T41),NoParams, pointer(232));
