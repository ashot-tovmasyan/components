...
_T65 = function (p0 : Byte): Integer of object;

_T66 = _T65;

_T67 = function (p0 : Integer): TDateTime of object;

_T68 = function (p0 : TDateTime): Integer of object;

_T69 = function : string of object;
...
{_T73 = function (p0 : PChar): Cardinal of object;}

{_T74 = function (p0 : PChar): PChar of object;}
...
{_T91 = function (p0 : PChar): PChar of object;}

{_T92 = function (p0 : PChar): string of object;}

_T93 = function (p0 : Cardinal): PChar of object;

{_T94 = function (p0 : PChar): Cardinal of object;}

{_T95 = function (p0 : PChar): PChar of object;}

{_T96 = procedure (p0 : PChar) of object;}

_T97 = function (const p0 : string;
const p1 : Array of Const): string of object;

_T98 = procedure (var p0 : string;
const p1 : string;
...
_T101 = function (var p0;
p1 : Cardinal;
const p2 : Cardinal;
p3 : Cardinal;
const p4 : Array of Const): Cardinal of object;

_T102 = function (p0 : Extended): string of object;

_T103 = function (p0 : Currency): string of object;

_T104 = function (p0 : Extended;
p1 : TFloatFormat;
p2 : Integer;
p3 : Integer): string of object;

_T105 = function (p0 : Currency;
p1 : TFloatFormat;
...
_T108 = function (const p0 : string;
...
_T110 = function (const p0 : string): Extended of object;

_T111 = function (const p0 : string): Currency of object;

{_T112 = function (p0 : PChar;
var p1 : PChar;
p2 : TFloatValue): Boolean of object;}

_T113 = procedure (const p0 : IDispatch;
const p1 : IDispatch;
p2 : TFloatValue;
p3 : Integer;
p4 : Integer) of object;

_T114 = function (p0 : TDateTime): IDispatch of object;

_T115 = function (const p0 : IDispatch): TDateTime of object;

_T116 = function (p0 : Comp): IDispatch of object;

_T117 = function (const p0 : IDispatch): Comp of object;

_T118 = function (p0 : Word;
p1 : Word;
p2 : Word): TDateTime of object;

_T119 = function (p0 : Word;
p1 : Word;
p2 : Word;
...
_T125 = function : TDateTime of object;

_T126 = _T125;

_T127 = _T125;

_T128 = function (const p0 : TDateTime;
p1 : Integer): TDateTime of object;

_T129 = function (p0 : Word): Boolean of object;

_T130 = function (p0 : TDateTime): string of object;

_T131 = _T130;

_T132 = _T130;

_T133 = function (const p0 : string): TDateTime of object;
...
_T140 = function (p0 : Integer;
p1 : Integer;
p2 : Char): Char of object;

_T141 = procedure  of object;

_T142 = function : TObject of object;

_T143 = function : Pointer of object;

{_T144 = function (p0 : TObject;
p1 : Pointer;
p2 : PChar;
p3 : Integer): Integer of object;}

_T145 = procedure (p0 : TObject;
...
_T165 = function (const p0 : string;
const p1 : string;
const p2 : string;
p3 : TReplaceFlags): string of object;

_T166 = function (const p0 : string;
const p1 : string;
p2 : TSysCharSet;
p3 : Integer): string of object;
...
_T168 = function (const p0 : string): HMODULE of object;

_T169 = procedure (p0 : HMODULE) of object;

{_T170 = procedure (p0 : HMODULE;
p1 : Pointer;
var p2 : Integer;
p3 : TPackageInfoProc) of object;}

{_T171 = function (p0 : PChar): string of object;}
...
_T175 = function (p0 : BOOL): BOOL of object;

{_T176 = procedure (p0 : TTerminateProc) of object;}

_T177 = function : Boolean of object;

_T178 = function : Longint of object;

_T179 = _T141;

_T180 = _T141;

_T181 = procedure (const p0 : string) of object;
...
_T186 = procedure (const p0 : string;
const p1 : Array of Const;
p2 : Integer) of object;

_T187 = procedure (p0 : Integer;
p1 : Integer) of object;

_T188 = procedure (p0 : Integer;
const p1 : Array of Const;
p2 : Integer) of object;
...
const __ConstNames0 : array[0..48] of string = (
'fmOpenRead'
,'fmOpenWrite'
,'fmOpenReadWrite'
,'fmShareCompat'
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[37] ,pfModuleTypeMask));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[38] ,pfExeModule));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[39] ,pfPackageModule));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[40] ,pfLibraryModule));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[41] ,ufMainUnit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[42] ,ufPackageUnit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[43] ,ufWeakUnit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[44] ,ufOrgWeakUnit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[45] ,ufImplicitUnit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[46] ,ufWeakPackageUnit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[47] ,ntContainsUnit));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[48] ,ntRequiresPackage));
end;
...
RegisterProc(nil,MethodNames[68],mtProc,TypeInfo(_T69),[TypeInfo(string)],Addr(GetCurrentDir),cRegister);
...
RegisterProc(nil,MethodNames[72],mtProc,TypeInfo(_T93),[
...
RegisterProc(nil,MethodNames[74],mtProc,TypeInfo(_T98),[
TypeInfo(string),
TypeInfo(string),
...
RegisterProc(nil,MethodNames[79],mtProc,TypeInfo(_T105),[
TypeInfo(Currency),
TypeInfo(TFloatFormat),
...
RegisterProc(nil,MethodNames[83],mtProc,TypeInfo(_T111),[
...
RegisterProc(nil,MethodNames[95],mtProc,TypeInfo(_T124),[
TypeInfo(TDateTime),TypeInfo(Integer)],Addr(DayOfWeek),cRegister);

RegisterProc(nil,MethodNames[96],mtProc,TypeInfo(_T125),[TypeInfo(TDateTime)],Addr(Date),cRegister);

RegisterProc(nil,MethodNames[97],mtProc,TypeInfo(_T126),[TypeInfo(TDateTime)],Addr(Time),cRegister);

RegisterProc(nil,MethodNames[98],mtProc,TypeInfo(_T127),[TypeInfo(TDateTime)],Addr(Now),cRegister);
...
RegisterProc(nil,MethodNames[111],mtProc,TypeInfo(_T140),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(Char),TypeInfo(Char)],Addr(GetLocaleChar),cRegister);

RegisterProc(nil,MethodNames[112],mtProc,TypeInfo(_T141),NoParams,Addr(GetFormatSettings),cRegister);

RegisterProc(nil,MethodNames[113],mtProc,TypeInfo(_T142),[TypeInfo(TObject)],Addr(ExceptObject),cRegister);

RegisterProc(nil,MethodNames[114],mtProc,TypeInfo(_T143),[TypeInfoPointer],Addr(ExceptAddr),cRegister);

RegisterProc(nil,MethodNames[115],mtProc,TypeInfo(_T145),[
TypeInfo(TObject),
TypeInfoPointer],Addr(ShowException),cRegister);

RegisterProc(nil,MethodNames[116],mtProc,TypeInfo(_T146),NoParams,Addr(Abort),cRegister);

RegisterProc(nil,MethodNames[117],mtProc,TypeInfo(_T147),NoParams,Addr(OutOfMemoryError),cRegister);

RegisterProc(nil,MethodNames[118],mtProc,TypeInfo(_T148),NoParams,Addr(Beep),cRegister);

RegisterProc(nil,MethodNames[119],mtProc,TypeInfo(_T149),[
TypeInfo(string),
...
RegisterProc(nil,MethodNames[130],mtProc,TypeInfo(_T161),[
TypeInfo(string),
...
RegisterProc(nil,MethodNames[136],mtProc,TypeInfo(_T172),[
TypeInfo(HMODULE)],Addr(InitializePackage),cRegister);

RegisterProc(nil,MethodNames[137],mtProc,TypeInfo(_T173),[
TypeInfo(HMODULE)],Addr(FinalizePackage),cRegister);

RegisterProc(nil,MethodNames[138],mtProc,TypeInfo(_T174),NoParams,Addr(RaiseLastWin32Error),cRegister);

RegisterProc(nil,MethodNames[139],mtProc,TypeInfo(_T175),[
TypeInfo(BOOL),TypeInfo(BOOL)],Addr(Win32Check),cRegister);

RegisterProc(nil,MethodNames[140],mtProc,TypeInfo(_T177),[TypeInfo(Boolean)],Addr(CallTerminateProcs),cRegister);

RegisterProc(nil,MethodNames[141],mtProc,TypeInfo(_T178),[TypeInfo(Longint)],Addr(GDAL),cRegister);

RegisterProc(nil,MethodNames[142],mtProc,TypeInfo(_T179),NoParams,Addr(RCS),cRegister);

RegisterProc(nil,MethodNames[143],mtProc,TypeInfo(_T180),NoParams,Addr(RPR),cRegister);

RegisterProc(Exception,'Create',mtConstructor,TypeInfo(_T181),[
TypeInfo(string)],Addr(Exception.Create),cRegister);

RegisterProc(Exception,'CreateFmt',mtConstructor,TypeInfo(_T182),[
TypeInfo(string),
TypeInfoArrayOfConst],Addr(Exception.CreateFmt),cRegister);

RegisterProc(Exception,'CreateRes',mtConstructor,TypeInfo(_T183),[
TypeInfo(Integer),
TypeInfo(Extended)],Addr(Exception.CreateRes),cRegister);

RegisterProc(Exception,'CreateResFmt',mtConstructor,TypeInfo(_T184),[
TypeInfo(Integer),
TypeInfoArrayOfConst],Addr(Exception.CreateResFmt),cRegister);

RegisterProc(Exception,'CreateHelp',mtConstructor,TypeInfo(_T185),[
TypeInfo(string),
TypeInfo(Integer)],Addr(Exception.CreateHelp),cRegister);

RegisterProc(Exception,'CreateFmtHelp',mtConstructor,TypeInfo(_T186),[
TypeInfo(string),
TypeInfoArrayOfConst,
TypeInfo(Integer)],Addr(Exception.CreateFmtHelp),cRegister);

RegisterProc(Exception,'CreateResHelp',mtConstructor,TypeInfo(_T187),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(Exception.CreateResHelp),cRegister);

RegisterProc(Exception,'CreateResFmtHelp',mtConstructor,TypeInfo(_T188),[
TypeInfo(Integer),
TypeInfoArrayOfConst,
