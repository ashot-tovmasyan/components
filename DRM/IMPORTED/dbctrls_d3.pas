...
RegRegisterMethod(TDBLookupControl,'KeyValueChanged',TypeInfo(_T6),NoParams, pointer(128));

RegRegisterMethod(TDBLookupControl,'ListLinkActiveChanged',TypeInfo(_T7),NoParams, pointer(132));

RegRegisterMethod(TDBLookupControl,'ListLinkDataChanged',TypeInfo(_T8),NoParams, pointer(136));
