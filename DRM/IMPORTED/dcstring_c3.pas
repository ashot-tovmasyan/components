...
RegRegisterMethod(TCustomMemoSource,'DoLoadFromFile',TypeInfo(_T30),[
TypeInfo(string)], pointer(44));

RegRegisterMethod(TCustomMemoSource,'DoSaveToFile',TypeInfo(_T31),[
TypeInfo(string)], pointer(48));

RegRegisterMethod(TCustomMemoSource,'SetObjectName',TypeInfo(_T33),[
TypeInfo(string)], pointer(56));

RegRegisterMethod(TCustomMemoSource,'MemoNotify',TypeInfo(_T34),[
TypeInfo(TObject),
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(60));

RegRegisterMethod(TCustomMemoSource,'GetReadOnly',TypeInfo(_T35),[TypeInfo(Boolean)], pointer(64));

RegRegisterMethod(TCustomMemoSource,'CheckSelectionType',TypeInfo(_T36),[
TypeInfo(TSelectionType)], pointer(68));

RegRegisterMethod(TCustomMemoSource,'GetStrings',TypeInfo(_T37),[TypeInfo(TStrings)], pointer(72));

RegRegisterMethod(TCustomMemoSource,'GetBackupName',TypeInfo(_T38),[
TypeInfo(string),TypeInfo(string)], pointer(76));

RegRegisterMethod(TCustomMemoSource,'CreateReplaceDialog',TypeInfo(_T39),[TypeInfo(TCustomForm)], pointer(80));

RegRegisterMethod(TCustomMemoSource,'CreateSearchDialog',TypeInfo(_T40),[TypeInfo(TCustomForm)], pointer(84));

RegRegisterMethod(TCustomMemoSource,'CreateNotModalSearchDialog',TypeInfo(_T41),[TypeInfo(TCustomForm)], pointer(88));

RegRegisterMethod(TCustomMemoSource,'HandleSearchException',TypeInfo(_T42),[
TypeInfo(string),TypeInfo(Boolean)], pointer(92));

RegRegisterMethod(TCustomMemoSource,'PasteFromClipboard',TypeInfo(_T43),[
TypeInfo(TStrings)], pointer(96));

RegRegisterMethod(TCustomMemoSource,'ParserOnChange',TypeInfo(_T44),[
TypeInfo(TObject),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(100));

RegRegisterMethod(TCustomMemoSource,'SetUseGlobalOptions',TypeInfo(_T45),[
TypeInfo(Boolean)], pointer(104));

RegRegisterMethod(TCustomMemoSource,'SelAttributesUpdated',TypeInfo(_T46),NoParams, pointer(108));

RegRegisterMethod(TCustomMemoSource,'AfterParse',TypeInfo(_T47),[
TypeInfo(Integer),
TypeInfo(string),
TypeInfo(string)], pointer(112));

RegRegisterMethod(TCustomMemoSource,'IsSyntaxParser',TypeInfo(_T48),[TypeInfo(Boolean)], pointer(116));

RegRegisterMethod(TCustomMemoSource,'NotifyEvents',TypeInfo(_T49),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(120));

RegRegisterMethod(TCustomMemoSource,'BeforeFindReplace',TypeInfo(_T50),[
...
RegRegisterMethod(TCustomMemoSource,'TempHighlightLine',TypeInfo(_T54),[
TypeInfo(Integer),
TypeInfo(Byte)], pointer(128));

RegRegisterMethod(TCustomMemoSource,'TempUnhighlightLine',TypeInfo(_T55),NoParams, pointer(132));
...
RegRegisterMethod(TCustomMemoSource,'Navigate',TypeInfo(_T59),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(136));

RegRegisterMethod(TCustomMemoSource,'BreakLine',TypeInfo(_T60),NoParams, pointer(140));

RegRegisterMethod(TCustomMemoSource,'JoinLines',TypeInfo(_T61),NoParams, pointer(144));

RegRegisterMethod(TCustomMemoSource,'Insert',TypeInfo(_T62),[
TypeInfo(string),TypeInfo(Boolean)], pointer(148));

RegRegisterMethod(TCustomMemoSource,'DeleteRight',TypeInfo(_T63),[
...
RegRegisterMethod(TCustomMemoSource,'ChangeObjectName',TypeInfo(_T66),[
TypeInfo(string),TypeInfo(Boolean)], pointer(156));
...
RegRegisterMethod(TCustomMemoSource,'ProcessEscape',TypeInfo(_T68),NoParams, pointer(160));
...
RegRegisterMethod(TCustomMemoSource,'Save',TypeInfo(_T86),[TypeInfo(Boolean)], pointer(164));

RegRegisterMethod(TCustomMemoSource,'BeginUpdate',TypeInfo(_T87),[
TypeInfo(Integer)],Addr(TCustomMemoSource.BeginUpdate));

RegRegisterMethod(TCustomMemoSource,'EndUpdate',TypeInfo(_T88),NoParams, pointer(168));
...
RegRegisterMethod(TCustomMemoSource,'CopyBlock',TypeInfo(_T154),NoParams, pointer(172));

RegRegisterMethod(TCustomMemoSource,'CutBlock',TypeInfo(_T155),NoParams, pointer(176));

RegRegisterMethod(TCustomMemoSource,'PasteBlock',TypeInfo(_T156),NoParams, pointer(180));
...
RegRegisterMethod(TCustomMemoSource,'PressEnter',TypeInfo(_T187),NoParams, pointer(184));
...
RegRegisterMethod(TCustomMemoSource,'ShowSearchDialog',TypeInfo(_T207),NoParams, pointer(188));

RegRegisterMethod(TCustomMemoSource,'ShowReplaceDialog',TypeInfo(_T208),NoParams, pointer(192));
...
RegRegisterMethod(TCustomMemoSource,'Find',TypeInfo(_T211),[TypeInfo(Boolean)], pointer(196));

RegRegisterMethod(TCustomMemoSource,'Replace',TypeInfo(_T212),[TypeInfo(Boolean)], pointer(200));

RegRegisterMethod(TCustomMemoSource,'FindNext',TypeInfo(_T213),[TypeInfo(Boolean)], pointer(204));
...
{RegRegisterMethod(TCustomMemoSource,'GetStrItemClass',TypeInfo(_T32),[TypeInfo(TStringItemClass)], pointer(52))}
