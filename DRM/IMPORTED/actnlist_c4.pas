...
procedure _mreg_0;
begin
RegRegisterMethod(TActionLink,'IsCaptionLinked',TypeInfo(_T4),[TypeInfo(Boolean)], pointer(28));

RegRegisterMethod(TActionLink,'IsCheckedLinked',TypeInfo(_T5),[TypeInfo(Boolean)], pointer(32));

RegRegisterMethod(TActionLink,'IsEnabledLinked',TypeInfo(_T6),[TypeInfo(Boolean)], pointer(36));

RegRegisterMethod(TActionLink,'IsHelpContextLinked',TypeInfo(_T7),[TypeInfo(Boolean)], pointer(40));

RegRegisterMethod(TActionLink,'IsHintLinked',TypeInfo(_T8),[TypeInfo(Boolean)], pointer(44));

RegRegisterMethod(TActionLink,'IsImageIndexLinked',TypeInfo(_T9),[TypeInfo(Boolean)], pointer(48));

RegRegisterMethod(TActionLink,'IsShortCutLinked',TypeInfo(_T10),[TypeInfo(Boolean)], pointer(52));

RegRegisterMethod(TActionLink,'IsVisibleLinked',TypeInfo(_T11),[TypeInfo(Boolean)], pointer(56));
...
TypeInfo(string),TypeInfo(Boolean)],Addr(TCustomAction.DoHint));
