...
_T32 = procedure (p0 : TListColumn;
const p1 : IDispatch) of object;

_T33 = function : TListItem of object;
...
_T36 = function (p0 : TListItem;
p1 : Integer;
p2 : TCustomDrawState;
p3 : TCustomDrawStage): Boolean of object;

_T37 = procedure (p0 : TListItem) of object;

_T38 = procedure (p0 : TListItem;
var p1 : string) of object;

_T39 = procedure (p0 : TListItem;
const p1 : IDispatch;
p2 : TOwnerDrawState) of object;

_T40 = procedure (const p0 : IDispatch) of object;

_T41 = function (p0 : TListItem;
p1 : TItemRequest): Boolean of object;

_T42 = function (p0 : TItemFind;
const p1 : string;
const p2 : IDispatch;
p3 : Pointer;
p4 : Integer;
...
_T47 = procedure (p0 : TListArrangement) of object;
...
_T52 = function (const p0 : IDispatch;
p1 : TSearchDirection): TListItem of object;

_T53 = function (p0 : TListItem;
p1 : TSearchDirection;
p2 : TItemStates): TListItem of object;

_T54 = function : string of object;
...
{_T57 = function (p0 : TLVCompare;
p1 : Longint): Boolean of object;}

_T58 = function (p0 : string): Integer of object;
...
_T63 = procedure (const p0 : string) of object;
...
_T72 = function (p0 : Integer): IDispatch of object;

_T73 = _T2;

_T74 = _T1;

_T75 = function (p0 : TTreeNode): Boolean of object;
...
_T79 = procedure (p0 : TTreeNode) of object;

_T80 = _T79;

_T81 = function : TTreeNode of object;

_T82 = _T34;

_T83 = function (p0 : TTreeNode;
p1 : TCustomDrawState;
p2 : TCustomDrawStage;
...
_T97 = procedure (p0 : TStream) of object;
...
_T101 = procedure (p0 : TUDBtnType) of object;

_T102 = _T4;

_T103 = procedure (p0 : THeaderSection;
const p1 : IDispatch;
p2 : Boolean) of object;

_T104 = procedure (p0 : THeaderSection) of object;

_T105 = procedure (p0 : THeaderSection;
p1 : THeaderSection;
...
_T108 = procedure (p0 : THeaderSection;
p1 : Integer;
p2 : TSectionTrackState) of object;

_T109 = procedure (p0 : TCustomImageList) of object;
...
_T113 = procedure (p0 : THeaderControl) of object;

_T114 = function : THeaderSection of object;

_T115 = procedure (p0 : TCustomListView) of object;

_T116 = _T115;

_T117 = function : TListColumn of object;

_T118 = procedure (p0 : TListItems) of object;

_T119 = _T4;

_T120 = _T4;

_T121 = function (p0 : TDisplayCode): IDispatch of object;

_T122 = _T46;

_T123 = function : IDispatch of object;

_T124 = procedure (p0 : Boolean) of object;
...
_T134 = function (p0 : TListItem): Integer of object;

_T135 = function (p0 : Integer): TListItem of object;

_T136 = procedure (p0 : TCommonCalendar) of object;

_T137 = _T4;

_T138 = function (p0 : TTabSheet;
p1 : Boolean;
p2 : Boolean): TTabSheet of object;

_T139 = _T124;

_T140 = procedure (p0 : TShiftState;
p1 : Integer;
p2 : Integer;
p3 : TPageScrollerOrientation;
var p4 : Integer) of object;

_T141 = function (p0 : TPageScrollerButton): TPageScrollerButtonState of object;

_T142 = procedure (p0 : TCustomRichEdit) of object;
...
_T146 = procedure (p0 : TStatusPanel;
const p1 : IDispatch) of object;
...
_T150 = procedure (p0 : TStatusBar) of object;

_T151 = function : TStatusPanel of object;

_T152 = _T4;

_T153 = _T4;

_T154 = procedure (p0 : TCustomRichEdit;
p1 : TAttributeType) of object;

_T155 = _T4;

_T156 = function (p0 : TToolButton): Boolean of object;

_T157 = _T3;

_T158 = _T34;

_T159 = function (p0 : TToolButton;
p1 : TCustomDrawState;
p2 : TCustomDrawStage;
...
_T162 = function (p0 : Boolean): Boolean of object;
...
_T170 = procedure (p0 : TTreeNodes) of object;

_T171 = _T46;

_T172 = _T124;

{_T173 = function (p0 : TTVCompare;
p1 : Longint): Boolean of object;}
...
_T176 = function (p0 : Boolean): IDispatch of object;
...
_T184 = function (p0 : TTreeNode): TTreeNode of object;
...
_T192 = function (p0 : TTreeNode): Integer of object;

_T193 = _T4;

_T194 = procedure (p0 : TTreeNode;
p1 : TNodeAttachMode) of object;

_T195 = procedure (p0 : TCustomTreeView) of object;

_T196 = function (p0 : TTreeNode;
const p1 : string): TTreeNode of object;

_T197 = _T196;

_T198 = function (p0 : TTreeNode;
const p1 : string;
...
{_T209 = function (p0 : HTreeItem): TTreeNode of object;}

_T210 = _T196;

_T211 = _T198;

_T212 = function : TWorkArea of object;

_T213 = _T1;

_T214 = function (p0 : Integer): TWorkArea of object;
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[94] ,updNone));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[95] ,updUp));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[96] ,updDown));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[97] ,hkShift));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[98] ,hkCtrl));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[99] ,hkAlt));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[100] ,hkExt));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[101] ,hcNone));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[102] ,hcShift));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[103] ,hcCtrl));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[104] ,hcAlt));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[105] ,hcShiftCtrl));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[106] ,hcShiftAlt));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[107] ,hcCtrlAlt));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[108] ,hcShiftCtrlAlt));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[109] ,ColumnHeaderWidth));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[110] ,ColumnTextWidth));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[111] ,drBounds));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[112] ,drIcon));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[113] ,drLabel));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[114] ,drSelectBounds));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[115] ,iaTop));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[116] ,iaLeft));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[117] ,arAlignBottom));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[118] ,arAlignLeft));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[119] ,arAlignRight));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[120] ,arAlignTop));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[121] ,arDefault));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[122] ,arSnapToGrid));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[123] ,vsIcon));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[124] ,vsSmallIcon));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[125] ,vsList));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[126] ,vsReport));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[127] ,isNone));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[128] ,isCut));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[129] ,isDropHilited));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[130] ,isFocused));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[131] ,isSelected));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[132] ,isActivating));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[133] ,ctText));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[134] ,ctImage));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[135] ,ctState));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[136] ,ifData));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[137] ,ifPartialString));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[138] ,ifExactString));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[139] ,ifNearest));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[140] ,sdLeft));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[141] ,sdRight));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[142] ,sdAbove));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[143] ,sdBelow));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[144] ,sdAll));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[145] ,htHandPoint));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[146] ,htUnderlineCold));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[147] ,htUnderlineHot));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[148] ,irText));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[149] ,irImage));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[150] ,irParam));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[151] ,irState));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[152] ,irIndent));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[153] ,aviNone));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[154] ,aviFindFolder));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[155] ,aviFindFile));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[156] ,aviFindComputer));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[157] ,aviCopyFiles));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[158] ,aviCopyFile));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[159] ,aviRecycleFile));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[160] ,aviEmptyRecycle));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[161] ,aviDeleteFile));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[162] ,CN_DROPDOWNCLOSED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[163] ,tbsButton));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[164] ,tbsCheck));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[165] ,tbsDropDown));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[166] ,tbsSeparator));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[167] ,tbsDivider));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[168] ,tbsChecked));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[169] ,tbsPressed));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[170] ,tbsEnabled));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[171] ,tbsHidden));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[172] ,tbsIndeterminate));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[173] ,tbsWrap));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[174] ,tbsEllipses));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[175] ,tbsMarked));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[176] ,tbNoEdges));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[177] ,tbHiliteHotTrack));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[178] ,tbNoOffset));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[179] ,tbNoMark));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[180] ,tbNoEtchedEffect));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[181] ,CN_BANDCHANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[182] ,bmNone));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[183] ,bmClick));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[184] ,bmDblClick));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[185] ,dowMonday));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[186] ,dowTuesday));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[187] ,dowWednesday));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[188] ,dowThursday));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[189] ,dowFriday));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[190] ,dowSaturday));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[191] ,dowSunday));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[192] ,dowLocaleDefault));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[193] ,dtkDate));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[194] ,dtkTime));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[195] ,dmComboBox));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[196] ,dmUpDown));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[197] ,dfShort));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[198] ,dfLong));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[199] ,dtaLeft));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[200] ,dtaRight));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[201] ,soHorizontal));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[202] ,soVertical));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[203] ,sbFirst));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[204] ,sbLast));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[205] ,bsNormal));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[206] ,bsInvisible));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[207] ,bsGrayed));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[208] ,bsDepressed));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[209] ,bsHot));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[210] ,ComCtlVersionIE3));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[211] ,ComCtlVersionIE4));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[212] ,ComCtlVersionIE401));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[213] ,ComCtlVersionIE5));
end;
...
const ClassList : array[0..51] of TClass = (
...
RegRegisterMethod(TAnimate,'DoOpen',TypeInfo(_T4),NoParams, pointer(180));

RegRegisterMethod(TAnimate,'DoClose',TypeInfo(_T5),NoParams, pointer(184));

RegRegisterMethod(TAnimate,'DoStart',TypeInfo(_T6),NoParams, pointer(188));

RegRegisterMethod(TAnimate,'DoStop',TypeInfo(_T7),NoParams, pointer(192));
...
RegRegisterMethod(TCommonCalendar,'CheckEmptyDate',TypeInfo(_T12),NoParams, pointer(180));

RegRegisterMethod(TCommonCalendar,'CheckValidDate',TypeInfo(_T13),[
TypeInfo(TDate)], pointer(184));

RegRegisterMethod(TCommonCalendar,'GetCalendarHandle',TypeInfo(_T14),[TypeInfo(HWND)], pointer(188));

RegRegisterMethod(TCommonCalendar,'GetCalStyles',TypeInfo(_T15),[TypeInfo(DWORD)], pointer(192));

RegRegisterMethod(TCommonCalendar,'MsgSetCalColors',TypeInfo(_T16),[
TypeInfo(Integer),
TypeInfo(TColor),TypeInfo(Boolean)], pointer(196));

RegRegisterMethod(TCommonCalendar,'MsgSetDateTime',TypeInfo(_T17),[
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(200));
...
RegRegisterMethod(TCoolBar,'Change',TypeInfo(_T27),NoParams, pointer(MinVMTOffset - 73));

RegRegisterMethod(TCustomListView,'CanChange',TypeInfo(_T28),[
TypeInfo(TListItem),
TypeInfo(Integer),TypeInfo(Boolean)], pointer(MinVMTOffset - 73));

RegRegisterMethod(TCustomListView,'CanEdit',TypeInfo(_T29),[
TypeInfo(TListItem),TypeInfo(Boolean)], pointer(MinVMTOffset - 74));

RegRegisterMethod(TCustomListView,'Change',TypeInfo(_T30),[
TypeInfo(TListItem),
TypeInfo(Integer)], pointer(MinVMTOffset - 75));

RegRegisterMethod(TCustomListView,'ColClick',TypeInfo(_T31),[
TypeInfo(TListColumn)], pointer(MinVMTOffset - 76));

RegRegisterMethod(TCustomListView,'ColRightClick',TypeInfo(_T32),[
TypeInfo(TListColumn),
TypeInfo(IDispatch)], pointer(MinVMTOffset - 77));

RegRegisterMethod(TCustomListView,'CreateListItem',TypeInfo(_T33),[TypeInfo(TListItem)], pointer(180));

RegRegisterMethod(TCustomListView,'CustomDraw',TypeInfo(_T34),[
TypeInfo(IDispatch),
TypeInfo(TCustomDrawStage),TypeInfo(Boolean)], pointer(184));

RegRegisterMethod(TCustomListView,'CustomDrawItem',TypeInfo(_T35),[
TypeInfo(TListItem),
TypeInfo(TCustomDrawState),
TypeInfo(TCustomDrawStage),TypeInfo(Boolean)], pointer(188));

RegRegisterMethod(TCustomListView,'CustomDrawSubItem',TypeInfo(_T36),[
TypeInfo(TListItem),
TypeInfo(Integer),
TypeInfo(TCustomDrawState),
TypeInfo(TCustomDrawStage),TypeInfo(Boolean)], pointer(192));

RegRegisterMethod(TCustomListView,'Delete',TypeInfo(_T37),[
TypeInfo(TListItem)], pointer(MinVMTOffset - 78));

RegRegisterMethod(TCustomListView,'DoInfoTip',TypeInfo(_T38),[
TypeInfo(TListItem),
TypeInfo(string)], pointer(196));

RegRegisterMethod(TCustomListView,'DrawItem',TypeInfo(_T39),[
TypeInfo(TListItem),
TypeInfo(IDispatch),
TypeInfo(TOwnerDrawState)], pointer(200));

RegRegisterMethod(TCustomListView,'Edit',TypeInfo(_T40),[
TypeInfo(IDispatch)], pointer(MinVMTOffset - 79));

RegRegisterMethod(TCustomListView,'OwnerDataFetch',TypeInfo(_T41),[
TypeInfo(TListItem),
TypeInfo(TItemRequest),TypeInfo(Boolean)], pointer(204));

RegRegisterMethod(TCustomListView,'OwnerDataFind',TypeInfo(_T42),[
TypeInfo(TItemFind),
TypeInfo(string),
TypeInfo(IDispatch),
TypeInfoPointer,
...
RegRegisterMethod(TCustomListView,'OwnerDataHint',TypeInfo(_T43),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(Boolean)], pointer(212));

RegRegisterMethod(TCustomListView,'OwnerDataStateChange',TypeInfo(_T44),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(TItemStates),
TypeInfo(TItemStates),TypeInfo(Boolean)], pointer(216));

RegRegisterMethod(TCustomListView,'InsertItem',TypeInfo(_T45),[
TypeInfo(TListItem)], pointer(MinVMTOffset - 80));

RegRegisterMethod(TCustomListView,'AlphaSort',TypeInfo(_T46),[TypeInfo(Boolean)],Addr(TCustomListView.AlphaSort));

RegRegisterMethod(TCustomListView,'Arrange',TypeInfo(_T47),[
TypeInfo(TListArrangement)],Addr(TCustomListView.Arrange));

RegRegisterMethod(TCustomListView,'FindCaption',TypeInfo(_T48),[
TypeInfo(Integer),
TypeInfo(string),
TypeInfo(Boolean),
TypeInfo(Boolean),
...
RegRegisterMethod(TCustomListView,'FindData',TypeInfo(_T49),[
TypeInfo(Integer),
TypeInfoPointer,
TypeInfo(Boolean),
TypeInfo(Boolean),TypeInfo(TListItem)],Addr(TCustomListView.FindData));

RegRegisterMethod(TCustomListView,'GetHitTestInfoAt',TypeInfo(_T50),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(THitTests)],Addr(TCustomListView.GetHitTestInfoAt));

RegRegisterMethod(TCustomListView,'GetItemAt',TypeInfo(_T51),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(TListItem)],Addr(TCustomListView.GetItemAt));

RegRegisterMethod(TCustomListView,'GetNearestItem',TypeInfo(_T52),[
TypeInfo(IDispatch),
TypeInfo(TSearchDirection),TypeInfo(TListItem)],Addr(__TCustomListView__GetNearestItem__Wrapper));

RegRegisterMethod(TCustomListView,'GetNextItem',TypeInfo(_T53),[
TypeInfo(TListItem),
TypeInfo(TSearchDirection),
TypeInfo(TItemStates),TypeInfo(TListItem)],Addr(TCustomListView.GetNextItem));

RegRegisterMethod(TCustomListView,'GetSearchString',TypeInfo(_T54),[TypeInfo(string)],Addr(TCustomListView.GetSearchString));

RegRegisterMethod(TCustomListView,'IsEditing',TypeInfo(_T55),[TypeInfo(Boolean)],Addr(TCustomListView.IsEditing));

RegRegisterMethod(TCustomListView,'Scroll',TypeInfo(_T56),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TCustomListView.Scroll));

RegRegisterMethod(TCustomListView,'StringWidth',TypeInfo(_T58),[
TypeInfo(string),TypeInfo(Integer)],Addr(TCustomListView.StringWidth));

RegRegisterMethod(TCustomListView,'UpdateItems',TypeInfo(_T59),[
TypeInfo(Integer),
TypeInfo(Integer)],Addr(TCustomListView.UpdateItems));

RegRegisterMethod(TCustomRichEdit,'RequestSize',TypeInfo(_T60),[
TypeInfo(IDispatch)], pointer(216));

RegRegisterMethod(TCustomRichEdit,'SelectionChange',TypeInfo(_T61),NoParams, pointer(MinVMTOffset - 74));

RegRegisterMethod(TCustomRichEdit,'FindText',TypeInfo(_T62),[
TypeInfo(string),
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(TSearchTypes),TypeInfo(Integer)],Addr(TCustomRichEdit.FindText));

RegRegisterMethod(TCustomRichEdit,'Print',TypeInfo(_T63),[
TypeInfo(string)], pointer(220));

RegRegisterMethod(TCustomTabControl,'CanChange',TypeInfo(_T65),[TypeInfo(Boolean)], pointer(MinVMTOffset - 73));

RegRegisterMethod(TCustomTabControl,'CanShowTab',TypeInfo(_T66),[
TypeInfo(Integer),TypeInfo(Boolean)], pointer(180));

RegRegisterMethod(TCustomTabControl,'Change',TypeInfo(_T67),NoParams, pointer(MinVMTOffset - 74));

RegRegisterMethod(TCustomTabControl,'DrawTab',TypeInfo(_T68),[
TypeInfo(Integer),
TypeInfo(IDispatch),
TypeInfo(Boolean)], pointer(184));

RegRegisterMethod(TCustomTabControl,'GetImageIndex',TypeInfo(_T69),[
TypeInfo(Integer),TypeInfo(Integer)], pointer(188));

RegRegisterMethod(TCustomTabControl,'IndexOfTabAt',TypeInfo(_T70),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(Integer)],Addr(TCustomTabControl.IndexOfTabAt));

RegRegisterMethod(TCustomTabControl,'GetHitTestInfoAt',TypeInfo(_T71),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(THitTests)],Addr(TCustomTabControl.GetHitTestInfoAt));

RegRegisterMethod(TCustomTabControl,'TabRect',TypeInfo(_T72),[
TypeInfo(Integer),TypeInfo(IDispatch)],Addr(__TCustomTabControl__TabRect__Wrapper));

RegRegisterMethod(TCustomTabControl,'RowCount',TypeInfo(_T73),[TypeInfo(Integer)],Addr(TCustomTabControl.RowCount));

RegRegisterMethod(TCustomTabControl,'ScrollTabs',TypeInfo(_T74),[
TypeInfo(Integer)],Addr(TCustomTabControl.ScrollTabs));

RegRegisterMethod(TCustomTreeView,'CanEdit',TypeInfo(_T75),[
TypeInfo(TTreeNode),TypeInfo(Boolean)], pointer(MinVMTOffset - 73));

RegRegisterMethod(TCustomTreeView,'CanChange',TypeInfo(_T76),[
TypeInfo(TTreeNode),TypeInfo(Boolean)], pointer(MinVMTOffset - 74));

RegRegisterMethod(TCustomTreeView,'CanCollapse',TypeInfo(_T77),[
TypeInfo(TTreeNode),TypeInfo(Boolean)], pointer(MinVMTOffset - 75));

RegRegisterMethod(TCustomTreeView,'CanExpand',TypeInfo(_T78),[
TypeInfo(TTreeNode),TypeInfo(Boolean)], pointer(MinVMTOffset - 76));

RegRegisterMethod(TCustomTreeView,'Change',TypeInfo(_T79),[
TypeInfo(TTreeNode)], pointer(MinVMTOffset - 77));

RegRegisterMethod(TCustomTreeView,'Collapse',TypeInfo(_T80),[
TypeInfo(TTreeNode)], pointer(MinVMTOffset - 78));

RegRegisterMethod(TCustomTreeView,'CreateNode',TypeInfo(_T81),[TypeInfo(TTreeNode)], pointer(180));

RegRegisterMethod(TCustomTreeView,'CustomDraw',TypeInfo(_T82),[
TypeInfo(IDispatch),
TypeInfo(TCustomDrawStage),TypeInfo(Boolean)], pointer(184));

RegRegisterMethod(TCustomTreeView,'CustomDrawItem',TypeInfo(_T83),[
TypeInfo(TTreeNode),
TypeInfo(TCustomDrawState),
TypeInfo(TCustomDrawStage),
TypeInfo(Boolean),TypeInfo(Boolean)], pointer(188));

RegRegisterMethod(TCustomTreeView,'Delete',TypeInfo(_T84),[
TypeInfo(TTreeNode)], pointer(MinVMTOffset - 79));

RegRegisterMethod(TCustomTreeView,'Edit',TypeInfo(_T85),[
TypeInfo(IDispatch)], pointer(MinVMTOffset - 80));

RegRegisterMethod(TCustomTreeView,'Expand',TypeInfo(_T86),[
TypeInfo(TTreeNode)], pointer(MinVMTOffset - 81));

RegRegisterMethod(TCustomTreeView,'GetImageIndex',TypeInfo(_T87),[
TypeInfo(TTreeNode)], pointer(192));

RegRegisterMethod(TCustomTreeView,'GetSelectedIndex',TypeInfo(_T88),[
TypeInfo(TTreeNode)], pointer(196));

RegRegisterMethod(TCustomTreeView,'AlphaSort',TypeInfo(_T89),[TypeInfo(Boolean)],Addr(TCustomTreeView.AlphaSort));

RegRegisterMethod(TCustomTreeView,'FullCollapse',TypeInfo(_T91),NoParams,Addr(TCustomTreeView.FullCollapse));

RegRegisterMethod(TCustomTreeView,'FullExpand',TypeInfo(_T92),NoParams,Addr(TCustomTreeView.FullExpand));

RegRegisterMethod(TCustomTreeView,'GetHitTestInfoAt',TypeInfo(_T93),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(THitTests)],Addr(TCustomTreeView.GetHitTestInfoAt));

RegRegisterMethod(TCustomTreeView,'GetNodeAt',TypeInfo(_T94),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(TTreeNode)],Addr(TCustomTreeView.GetNodeAt));

RegRegisterMethod(TCustomTreeView,'IsEditing',TypeInfo(_T95),[TypeInfo(Boolean)],Addr(TCustomTreeView.IsEditing));

RegRegisterMethod(TCustomTreeView,'LoadFromFile',TypeInfo(_T96),[
TypeInfo(string)],Addr(TCustomTreeView.LoadFromFile));

RegRegisterMethod(TCustomTreeView,'LoadFromStream',TypeInfo(_T97),[
TypeInfo(TStream)],Addr(TCustomTreeView.LoadFromStream));

RegRegisterMethod(TCustomTreeView,'SaveToFile',TypeInfo(_T98),[
TypeInfo(string)],Addr(TCustomTreeView.SaveToFile));

RegRegisterMethod(TCustomTreeView,'SaveToStream',TypeInfo(_T99),[
TypeInfo(TStream)],Addr(TCustomTreeView.SaveToStream));

RegRegisterMethod(TCustomUpDown,'CanChange',TypeInfo(_T100),[TypeInfo(Boolean)], pointer(MinVMTOffset - 73));

RegRegisterMethod(TCustomUpDown,'Click',TypeInfo(_T101),[
TypeInfo(TUDBtnType)], pointer(MinVMTOffset - 74));

RegRegisterMethod(TDateTimePicker,'Change',TypeInfo(_T102),NoParams, pointer(MinVMTOffset - 73));

RegRegisterMethod(THeaderControl,'DrawSection',TypeInfo(_T103),[
TypeInfo(THeaderSection),
TypeInfo(IDispatch),
TypeInfo(Boolean)], pointer(MinVMTOffset - 73));

RegRegisterMethod(THeaderControl,'SectionClick',TypeInfo(_T104),[
TypeInfo(THeaderSection)], pointer(MinVMTOffset - 74));

RegRegisterMethod(THeaderControl,'SectionDrag',TypeInfo(_T105),[
TypeInfo(THeaderSection),
TypeInfo(THeaderSection),
TypeInfo(Boolean)], pointer(MinVMTOffset - 75));

RegRegisterMethod(THeaderControl,'SectionEndDrag',TypeInfo(_T106),NoParams, pointer(MinVMTOffset - 76));

RegRegisterMethod(THeaderControl,'SectionResize',TypeInfo(_T107),[
TypeInfo(THeaderSection)], pointer(MinVMTOffset - 77));

RegRegisterMethod(THeaderControl,'SectionTrack',TypeInfo(_T108),[
TypeInfo(THeaderSection),
TypeInfo(Integer),
TypeInfo(TSectionTrackState)], pointer(MinVMTOffset - 78));

RegRegisterMethod(THeaderControl,'SetImages',TypeInfo(_T109),[
TypeInfo(TCustomImageList)], pointer(180));

RegRegisterMethod(THeaderSection,'ParentBiDiModeChanged',TypeInfo(_T110),NoParams,Addr(THeaderSection.ParentBiDiModeChanged));

RegRegisterMethod(THeaderSection,'UseRightToLeftAlignment',TypeInfo(_T111),[TypeInfo(Boolean)],Addr(THeaderSection.UseRightToLeftAlignment));

RegRegisterMethod(THeaderSection,'UseRightToLeftReading',TypeInfo(_T112),[TypeInfo(Boolean)],Addr(THeaderSection.UseRightToLeftReading));

RegisterProc(THeaderSections,'Create',mtConstructor,TypeInfo(_T113),[
TypeInfo(THeaderControl)],Addr(THeaderSections.Create),cRegister);

RegRegisterMethod(THeaderSections,'Add',TypeInfo(_T114),[TypeInfo(THeaderSection)],Addr(THeaderSections.Add));

RegisterProc(TIconOptions,'Create',mtConstructor,TypeInfo(_T115),[
TypeInfo(TCustomListView)],Addr(TIconOptions.Create),cRegister);

RegisterProc(TListColumns,'Create',mtConstructor,TypeInfo(_T116),[
TypeInfo(TCustomListView)],Addr(TListColumns.Create),cRegister);

RegRegisterMethod(TListColumns,'Add',TypeInfo(_T117),[TypeInfo(TListColumn)],Addr(TListColumns.Add));

RegisterProc(TListItem,'Create',mtConstructor,TypeInfo(_T118),[
TypeInfo(TListItems)],Addr(TListItem.Create),cRegister);

RegRegisterMethod(TListItem,'CancelEdit',TypeInfo(_T119),NoParams,Addr(TListItem.CancelEdit));

RegRegisterMethod(TListItem,'Delete',TypeInfo(_T120),NoParams,Addr(TListItem.Delete));

RegRegisterMethod(TListItem,'DisplayRect',TypeInfo(_T121),[
TypeInfo(TDisplayCode),TypeInfo(IDispatch)],Addr(__TListItem__DisplayRect__Wrapper));

RegRegisterMethod(TListItem,'EditCaption',TypeInfo(_T122),[TypeInfo(Boolean)],Addr(TListItem.EditCaption));

RegRegisterMethod(TListItem,'GetPosition',TypeInfo(_T123),[TypeInfo(IDispatch)],Addr(__TListItem__GetPosition__Wrapper));

RegRegisterMethod(TListItem,'MakeVisible',TypeInfo(_T124),[
TypeInfo(Boolean)],Addr(TListItem.MakeVisible));

RegRegisterMethod(TListItem,'Update',TypeInfo(_T125),NoParams,Addr(TListItem.Update));

RegRegisterMethod(TListItem,'SetPosition',TypeInfo(_T126),[
TypeInfo(IDispatch)],Addr(__TListItem__SetPosition__Wrapper));

RegRegisterMethod(TListItem,'WorkArea',TypeInfo(_T127),[TypeInfo(Integer)],Addr(TListItem.WorkArea));

RegisterProc(TListItems,'Create',mtConstructor,TypeInfo(_T128),[
TypeInfo(TCustomListView)],Addr(TListItems.Create),cRegister);

RegRegisterMethod(TListItems,'Add',TypeInfo(_T129),[TypeInfo(TListItem)],Addr(TListItems.Add));

RegRegisterMethod(TListItems,'BeginUpdate',TypeInfo(_T130),NoParams,Addr(TListItems.BeginUpdate));

RegRegisterMethod(TListItems,'Clear',TypeInfo(_T131),NoParams,Addr(TListItems.Clear));

RegRegisterMethod(TListItems,'Delete',TypeInfo(_T132),[
TypeInfo(Integer)],Addr(TListItems.Delete));

RegRegisterMethod(TListItems,'EndUpdate',TypeInfo(_T133),NoParams,Addr(TListItems.EndUpdate));

RegRegisterMethod(TListItems,'IndexOf',TypeInfo(_T134),[
TypeInfo(TListItem),TypeInfo(Integer)],Addr(TListItems.IndexOf));

RegRegisterMethod(TListItems,'Insert',TypeInfo(_T135),[
TypeInfo(Integer),TypeInfo(TListItem)],Addr(TListItems.Insert));

RegisterProc(TMonthCalColors,'Create',mtConstructor,TypeInfo(_T136),[
TypeInfo(TCommonCalendar)],Addr(TMonthCalColors.Create),cRegister);

RegRegisterMethod(TPageControl,'UpdateActivePage',TypeInfo(_T137),NoParams, pointer(192));

RegRegisterMethod(TPageControl,'FindNextPage',TypeInfo(_T138),[
TypeInfo(TTabSheet),
TypeInfo(Boolean),
TypeInfo(Boolean),TypeInfo(TTabSheet)],Addr(TPageControl.FindNextPage));

RegRegisterMethod(TPageControl,'SelectNextPage',TypeInfo(_T139),[
TypeInfo(Boolean)],Addr(TPageControl.SelectNextPage));

RegRegisterMethod(TPageScroller,'Scroll',TypeInfo(_T140),[
...
RegRegisterMethod(TPageScroller,'GetButtonState',TypeInfo(_T141),[
TypeInfo(TPageScrollerButton),TypeInfo(TPageScrollerButtonState)],Addr(TPageScroller.GetButtonState));

RegisterProc(TParaAttributes,'Create',mtConstructor,TypeInfo(_T142),[
TypeInfo(TCustomRichEdit)],Addr(TParaAttributes.Create),cRegister);

RegRegisterMethod(TProgressBar,'StepIt',TypeInfo(_T143),NoParams,Addr(TProgressBar.StepIt));

RegRegisterMethod(TProgressBar,'StepBy',TypeInfo(_T144),[
TypeInfo(Integer)],Addr(TProgressBar.StepBy));

RegRegisterMethod(TStatusBar,'DoHint',TypeInfo(_T145),[TypeInfo(Boolean)], pointer(180));

RegRegisterMethod(TStatusBar,'DrawPanel',TypeInfo(_T146),[
TypeInfo(TStatusPanel),
TypeInfo(IDispatch)], pointer(MinVMTOffset - 73));

RegRegisterMethod(TStatusPanel,'ParentBiDiModeChanged',TypeInfo(_T147),NoParams,Addr(TStatusPanel.ParentBiDiModeChanged));

RegRegisterMethod(TStatusPanel,'UseRightToLeftAlignment',TypeInfo(_T148),[TypeInfo(Boolean)],Addr(TStatusPanel.UseRightToLeftAlignment));

RegRegisterMethod(TStatusPanel,'UseRightToLeftReading',TypeInfo(_T149),[TypeInfo(Boolean)],Addr(TStatusPanel.UseRightToLeftReading));

RegisterProc(TStatusPanels,'Create',mtConstructor,TypeInfo(_T150),[
TypeInfo(TStatusBar)],Addr(TStatusPanels.Create),cRegister);

RegRegisterMethod(TStatusPanels,'Add',TypeInfo(_T151),[TypeInfo(TStatusPanel)],Addr(TStatusPanels.Add));

RegRegisterMethod(TTabSheet,'DoHide',TypeInfo(_T152),NoParams, pointer(MinVMTOffset - 73));

RegRegisterMethod(TTabSheet,'DoShow',TypeInfo(_T153),NoParams, pointer(MinVMTOffset - 74));

RegisterProc(TTextAttributes,'Create',mtConstructor,TypeInfo(_T154),[
TypeInfo(TCustomRichEdit),
TypeInfo(TAttributeType)],Addr(TTextAttributes.Create),cRegister);

RegRegisterMethod(TToolBar,'CancelMenu',TypeInfo(_T155),NoParams, pointer(MinVMTOffset - 73));

RegRegisterMethod(TToolBar,'CheckMenuDropdown',TypeInfo(_T156),[
TypeInfo(TToolButton),TypeInfo(Boolean)], pointer(MinVMTOffset - 74));

RegRegisterMethod(TToolBar,'ClickButton',TypeInfo(_T157),[
TypeInfo(TToolButton)], pointer(MinVMTOffset - 75));

RegRegisterMethod(TToolBar,'CustomDraw',TypeInfo(_T158),[
TypeInfo(IDispatch),
TypeInfo(TCustomDrawStage),TypeInfo(Boolean)], pointer(180));

RegRegisterMethod(TToolBar,'CustomDrawButton',TypeInfo(_T159),[
TypeInfo(TToolButton),
TypeInfo(TCustomDrawState),
TypeInfo(TCustomDrawStage),
TypeInfo(TTBCustomDrawFlags),TypeInfo(Boolean)], pointer(184));

RegRegisterMethod(TToolBar,'InitMenu',TypeInfo(_T160),[
TypeInfo(TToolButton)], pointer(MinVMTOffset - 76));

RegRegisterMethod(TToolBar,'TrackMenu',TypeInfo(_T161),[
TypeInfo(TToolButton),TypeInfo(Boolean)], pointer(MinVMTOffset - 77));

RegRegisterMethod(TToolBarDockObject,'ToolDockImage',TypeInfo(_T162),[
TypeInfo(Boolean),TypeInfo(Boolean)], pointer(56));

RegRegisterMethod(TToolButton,'BeginUpdate',TypeInfo(_T163),NoParams, pointer(136));

RegRegisterMethod(TToolButton,'EndUpdate',TypeInfo(_T164),NoParams, pointer(140));

RegRegisterMethod(TToolButton,'RefreshControl',TypeInfo(_T165),NoParams, pointer(144));

RegRegisterMethod(TToolButton,'UpdateControl',TypeInfo(_T166),NoParams, pointer(148));

RegRegisterMethod(TToolButton,'CheckMenuDropdown',TypeInfo(_T167),[TypeInfo(Boolean)], pointer(MinVMTOffset - 50));

RegRegisterMethod(TTrackBar,'Changed',TypeInfo(_T168),NoParams, pointer(MinVMTOffset - 73));

RegRegisterMethod(TTrackBar,'SetTick',TypeInfo(_T169),[
TypeInfo(Integer)],Addr(TTrackBar.SetTick));

RegisterProc(TTreeNode,'Create',mtConstructor,TypeInfo(_T170),[
TypeInfo(TTreeNodes)],Addr(TTreeNode.Create),cRegister);

RegRegisterMethod(TTreeNode,'AlphaSort',TypeInfo(_T171),[TypeInfo(Boolean)],Addr(TTreeNode.AlphaSort));

RegRegisterMethod(TTreeNode,'Collapse',TypeInfo(_T172),[
TypeInfo(Boolean)],Addr(TTreeNode.Collapse));

RegRegisterMethod(TTreeNode,'Delete',TypeInfo(_T174),NoParams,Addr(TTreeNode.Delete));

RegRegisterMethod(TTreeNode,'DeleteChildren',TypeInfo(_T175),NoParams,Addr(TTreeNode.DeleteChildren));

RegRegisterMethod(TTreeNode,'DisplayRect',TypeInfo(_T176),[
TypeInfo(Boolean),TypeInfo(IDispatch)],Addr(__TTreeNode__DisplayRect__Wrapper));

RegRegisterMethod(TTreeNode,'EditText',TypeInfo(_T177),[TypeInfo(Boolean)],Addr(TTreeNode.EditText));

RegRegisterMethod(TTreeNode,'EndEdit',TypeInfo(_T178),[
TypeInfo(Boolean)],Addr(TTreeNode.EndEdit));

RegRegisterMethod(TTreeNode,'Expand',TypeInfo(_T179),[
TypeInfo(Boolean)],Addr(TTreeNode.Expand));

RegRegisterMethod(TTreeNode,'getFirstChild',TypeInfo(_T180),[TypeInfo(TTreeNode)],Addr(TTreeNode.getFirstChild));

RegRegisterMethod(TTreeNode,'GetHandle',TypeInfo(_T181),[TypeInfo(HWND)],Addr(TTreeNode.GetHandle));

RegRegisterMethod(TTreeNode,'GetLastChild',TypeInfo(_T182),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetLastChild));

RegRegisterMethod(TTreeNode,'GetNext',TypeInfo(_T183),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetNext));

RegRegisterMethod(TTreeNode,'GetNextChild',TypeInfo(_T184),[
TypeInfo(TTreeNode),TypeInfo(TTreeNode)],Addr(TTreeNode.GetNextChild));

RegRegisterMethod(TTreeNode,'getNextSibling',TypeInfo(_T185),[TypeInfo(TTreeNode)],Addr(TTreeNode.getNextSibling));

RegRegisterMethod(TTreeNode,'GetNextVisible',TypeInfo(_T186),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetNextVisible));

RegRegisterMethod(TTreeNode,'GetPrev',TypeInfo(_T187),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetPrev));

RegRegisterMethod(TTreeNode,'GetPrevChild',TypeInfo(_T188),[
TypeInfo(TTreeNode),TypeInfo(TTreeNode)],Addr(TTreeNode.GetPrevChild));

RegRegisterMethod(TTreeNode,'getPrevSibling',TypeInfo(_T189),[TypeInfo(TTreeNode)],Addr(TTreeNode.getPrevSibling));

RegRegisterMethod(TTreeNode,'GetPrevVisible',TypeInfo(_T190),[TypeInfo(TTreeNode)],Addr(TTreeNode.GetPrevVisible));

RegRegisterMethod(TTreeNode,'HasAsParent',TypeInfo(_T191),[
TypeInfo(TTreeNode),TypeInfo(Boolean)],Addr(TTreeNode.HasAsParent));

RegRegisterMethod(TTreeNode,'IndexOf',TypeInfo(_T192),[
TypeInfo(TTreeNode),TypeInfo(Integer)],Addr(TTreeNode.IndexOf));

RegRegisterMethod(TTreeNode,'MakeVisible',TypeInfo(_T193),NoParams,Addr(TTreeNode.MakeVisible));

RegRegisterMethod(TTreeNode,'MoveTo',TypeInfo(_T194),[
TypeInfo(TTreeNode),
TypeInfo(TNodeAttachMode)], pointer(12));

RegisterProc(TTreeNodes,'Create',mtConstructor,TypeInfo(_T195),[
TypeInfo(TCustomTreeView)],Addr(TTreeNodes.Create),cRegister);

RegRegisterMethod(TTreeNodes,'AddChildFirst',TypeInfo(_T196),[
TypeInfo(TTreeNode),
TypeInfo(string),TypeInfo(TTreeNode)],Addr(TTreeNodes.AddChildFirst));

RegRegisterMethod(TTreeNodes,'AddChild',TypeInfo(_T197),[
TypeInfo(TTreeNode),
TypeInfo(string),TypeInfo(TTreeNode)],Addr(TTreeNodes.AddChild));

RegRegisterMethod(TTreeNodes,'AddChildObjectFirst',TypeInfo(_T198),[
TypeInfo(TTreeNode),
TypeInfo(string),
TypeInfoPointer,TypeInfo(TTreeNode)],Addr(TTreeNodes.AddChildObjectFirst));

RegRegisterMethod(TTreeNodes,'AddChildObject',TypeInfo(_T199),[
TypeInfo(TTreeNode),
TypeInfo(string),
TypeInfoPointer,TypeInfo(TTreeNode)],Addr(TTreeNodes.AddChildObject));

RegRegisterMethod(TTreeNodes,'AddFirst',TypeInfo(_T200),[
TypeInfo(TTreeNode),
TypeInfo(string),TypeInfo(TTreeNode)],Addr(TTreeNodes.AddFirst));

RegRegisterMethod(TTreeNodes,'Add',TypeInfo(_T201),[
TypeInfo(TTreeNode),
TypeInfo(string),TypeInfo(TTreeNode)],Addr(TTreeNodes.Add));

RegRegisterMethod(TTreeNodes,'AddObjectFirst',TypeInfo(_T202),[
TypeInfo(TTreeNode),
TypeInfo(string),
TypeInfoPointer,TypeInfo(TTreeNode)],Addr(TTreeNodes.AddObjectFirst));

RegRegisterMethod(TTreeNodes,'AddObject',TypeInfo(_T203),[
TypeInfo(TTreeNode),
TypeInfo(string),
TypeInfoPointer,TypeInfo(TTreeNode)],Addr(TTreeNodes.AddObject));

RegRegisterMethod(TTreeNodes,'BeginUpdate',TypeInfo(_T204),NoParams,Addr(TTreeNodes.BeginUpdate));

RegRegisterMethod(TTreeNodes,'Clear',TypeInfo(_T205),NoParams,Addr(TTreeNodes.Clear));

RegRegisterMethod(TTreeNodes,'Delete',TypeInfo(_T206),[
TypeInfo(TTreeNode)],Addr(TTreeNodes.Delete));

RegRegisterMethod(TTreeNodes,'EndUpdate',TypeInfo(_T207),NoParams,Addr(TTreeNodes.EndUpdate));

RegRegisterMethod(TTreeNodes,'GetFirstNode',TypeInfo(_T208),[TypeInfo(TTreeNode)],Addr(TTreeNodes.GetFirstNode));

RegRegisterMethod(TTreeNodes,'Insert',TypeInfo(_T210),[
TypeInfo(TTreeNode),
TypeInfo(string),TypeInfo(TTreeNode)],Addr(TTreeNodes.Insert));

RegRegisterMethod(TTreeNodes,'InsertObject',TypeInfo(_T211),[
TypeInfo(TTreeNode),
TypeInfo(string),
TypeInfoPointer,TypeInfo(TTreeNode)],Addr(TTreeNodes.InsertObject));

RegRegisterMethod(TWorkAreas,'Add',TypeInfo(_T212),[TypeInfo(TWorkArea)],Addr(TWorkAreas.Add));

RegRegisterMethod(TWorkAreas,'Delete',TypeInfo(_T213),[
TypeInfo(Integer)],Addr(TWorkAreas.Delete));

RegRegisterMethod(TWorkAreas,'Insert',TypeInfo(_T214),[
...
TypeInfo(Integer),
TypeInfoPointer,TypeInfo(Boolean)], pointer(204))}
...
{RegRegisterMethod(TCustomListView,'CustomSort',TypeInfo(_T57),[
TypeInfo(TLVCompare),
TypeInfo(Longint),TypeInfo(Boolean)],Addr(TCustomListView.CustomSort))}

{RegisterProc(TCustomRichEdit,'RegisterConversionFormat',mtClassMethod,TypeInfo(_T64),[
TypeInfo(string),
TypeInfo(TConversionClass)],Addr(TCustomRichEdit.RegisterConversionFormat),cRegister)}

{RegRegisterMethod(TCustomTreeView,'CustomSort',TypeInfo(_T90),[
TypeInfo(TTVCompare),
TypeInfo(Longint),TypeInfo(Boolean)],Addr(TCustomTreeView.CustomSort))}

{RegRegisterMethod(TTreeNode,'CustomSort',TypeInfo(_T173),[
TypeInfo(TTVCompare),
TypeInfo(Longint),TypeInfo(Boolean)],Addr(TTreeNode.CustomSort))}

{RegRegisterMethod(TTreeNodes,'GetNode',TypeInfo(_T209),[
