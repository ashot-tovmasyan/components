...
TypeInfo(TMPBtnType)], pointer(MinVMTOffset - 76));

RegRegisterMethod(TMediaPlayer,'Click',TypeInfo(_T1),[
TypeInfo(TMPBtnType),
TypeInfo(Boolean)], pointer(MinVMTOffset - 77));

RegRegisterMethod(TMediaPlayer,'PostClick',TypeInfo(_T2),[
TypeInfo(TMPBtnType)], pointer(MinVMTOffset - 78));

RegRegisterMethod(TMediaPlayer,'DoNotify',TypeInfo(_T3),NoParams, pointer(MinVMTOffset - 79));
