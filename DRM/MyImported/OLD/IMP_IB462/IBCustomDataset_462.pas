...
_T19 = procedure (p0 : TIBCustomDataSet) of object;
...
_T25 = function (p0 : string): TIBXSQLVAR of object;

_T26 = function : TIBCustomDataSet of object;

_T27 = _T19;

_T28 = procedure (p0 : TUpdateKind) of object;

_T29 = function (p0 : TUpdateKind): TStrings of object;

_T30 = procedure (p0 : TField;
p1 : TIBBlobStream;
...
_T34 = function (var p0 : string): Boolean of object;
...
RegRegisterMethod(TIBCustomDataSet,'InternalSetFieldData',TypeInfo(_T0),[
TypeInfo(TField),
TypeInfoPointer], pointer(592));

RegRegisterMethod(TIBCustomDataSet,'InternalBatchInput',TypeInfo(_T1),[
TypeInfo(TIBBatchInput)], pointer(596));

RegRegisterMethod(TIBCustomDataSet,'InternalBatchOutput',TypeInfo(_T2),[
TypeInfo(TIBBatchOutput)], pointer(600));

RegRegisterMethod(TIBCustomDataSet,'InternalPrepare',TypeInfo(_T3),NoParams, pointer(604));

RegRegisterMethod(TIBCustomDataSet,'InternalUnPrepare',TypeInfo(_T4),NoParams, pointer(608));

RegRegisterMethod(TIBCustomDataSet,'InternalExecQuery',TypeInfo(_T5),NoParams, pointer(612));

RegRegisterMethod(TIBCustomDataSet,'InternalRefreshRow',TypeInfo(_T6),NoParams, pointer(616));

RegRegisterMethod(TIBCustomDataSet,'InternalSetParamsFromCursor',TypeInfo(_T7),NoParams, pointer(620));

RegRegisterMethod(TIBCustomDataSet,'Disconnect',TypeInfo(_T8),NoParams, pointer(624));
...
RegisterProc(TIBDataLink,'Create',mtConstructor,TypeInfo(_T19),[
TypeInfo(TIBCustomDataSet)],Addr(TIBDataLink.Create),cRegister);

RegRegisterMethod(TIBDataSet,'Prepare',TypeInfo(_T20),NoParams,Addr(TIBDataSet.Prepare));

RegRegisterMethod(TIBDataSet,'UnPrepare',TypeInfo(_T21),NoParams,Addr(TIBDataSet.UnPrepare));

RegRegisterMethod(TIBDataSet,'BatchInput',TypeInfo(_T22),[
TypeInfo(TIBBatchInput)],Addr(TIBDataSet.BatchInput));

RegRegisterMethod(TIBDataSet,'BatchOutput',TypeInfo(_T23),[
TypeInfo(TIBBatchOutput)],Addr(TIBDataSet.BatchOutput));

RegRegisterMethod(TIBDataSet,'ExecSQL',TypeInfo(_T24),NoParams,Addr(TIBDataSet.ExecSQL));

RegRegisterMethod(TIBDataSet,'ParamByName',TypeInfo(_T25),[
TypeInfo(string),TypeInfo(TIBXSQLVAR)],Addr(TIBDataSet.ParamByName));

RegRegisterMethod(TIBDataSetUpdateObject,'GetDataSet',TypeInfo(_T26),[TypeInfo(TIBCustomDataSet)], pointer(48));

RegRegisterMethod(TIBDataSetUpdateObject,'SetDataSet',TypeInfo(_T27),[
TypeInfo(TIBCustomDataSet)], pointer(52));

RegRegisterMethod(TIBDataSetUpdateObject,'Apply',TypeInfo(_T28),[
TypeInfo(TUpdateKind)], pointer(56));

RegRegisterMethod(TIBDataSetUpdateObject,'GetSQL',TypeInfo(_T29),[
TypeInfo(TUpdateKind),TypeInfo(TStrings)], pointer(60));

RegisterProc(TIBDSBlobStream,'Create',mtConstructor,TypeInfo(_T30),[
TypeInfo(TField),
TypeInfo(TIBBlobStream),
TypeInfo(TBlobStreamMode)],Addr(TIBDSBlobStream.Create),cRegister);

RegisterProc(TIBGeneratorField,'Create',mtConstructor,TypeInfo(_T31),[
TypeInfo(TIBCustomDataSet)],Addr(TIBGeneratorField.Create),cRegister);

RegRegisterMethod(TIBGeneratorField,'ValueName',TypeInfo(_T32),[TypeInfo(string)],Addr(TIBGeneratorField.ValueName));

RegRegisterMethod(TIBGeneratorField,'Apply',TypeInfo(_T33),NoParams,Addr(TIBGeneratorField.Apply));

RegRegisterMethod(TIBStringField,'GetValue',TypeInfo(_T34),[
