...
_T51 = function (p0 : TIBDatabase): Integer of object;

_T52 = _T51;

_T53 = function : TIBDatabase of object;
...
RegRegisterMethod(TIBBase,'SetDatabase',TypeInfo(_T10),[
TypeInfo(TIBDatabase)], pointer(32));

RegRegisterMethod(TIBBase,'SetTransaction',TypeInfo(_T11),[
TypeInfo(TIBTransaction)], pointer(36));
...
RegRegisterMethod(TIBDatabase,'FlushSchema',TypeInfo(_T38),NoParams,Addr(TIBDatabase.FlushSchema));

RegRegisterMethod(TIBSchema,'FreeNodes',TypeInfo(_T39),NoParams, pointer(0));

RegRegisterMethod(TIBSchema,'Has_DEFAULT_VALUE',TypeInfo(_T40),[
TypeInfo(string),
TypeInfo(string),TypeInfo(Boolean)], pointer(4));

RegRegisterMethod(TIBSchema,'Has_COMPUTED_BLR',TypeInfo(_T41),[
TypeInfo(string),
TypeInfo(string),TypeInfo(Boolean)], pointer(8));

RegRegisterMethod(TIBTransaction,'Call',TypeInfo(_T42),[
TypeInfo(ISC_STATUS),
TypeInfo(Boolean),TypeInfo(ISC_STATUS)],Addr(TIBTransaction.Call));

RegRegisterMethod(TIBTransaction,'Commit',TypeInfo(_T43),NoParams,Addr(TIBTransaction.Commit));

RegRegisterMethod(TIBTransaction,'CommitRetaining',TypeInfo(_T44),NoParams,Addr(TIBTransaction.CommitRetaining));

RegRegisterMethod(TIBTransaction,'Rollback',TypeInfo(_T45),NoParams,Addr(TIBTransaction.Rollback));

RegRegisterMethod(TIBTransaction,'RollbackRetaining',TypeInfo(_T46),NoParams,Addr(TIBTransaction.RollbackRetaining));

RegRegisterMethod(TIBTransaction,'StartTransaction',TypeInfo(_T47),NoParams,Addr(TIBTransaction.StartTransaction));

RegRegisterMethod(TIBTransaction,'CheckInTransaction',TypeInfo(_T48),NoParams,Addr(TIBTransaction.CheckInTransaction));

RegRegisterMethod(TIBTransaction,'CheckNotInTransaction',TypeInfo(_T49),NoParams,Addr(TIBTransaction.CheckNotInTransaction));

RegRegisterMethod(TIBTransaction,'CheckAutoStop',TypeInfo(_T50),NoParams,Addr(TIBTransaction.CheckAutoStop));

RegRegisterMethod(TIBTransaction,'AddDatabase',TypeInfo(_T51),[
TypeInfo(TIBDatabase),TypeInfo(Integer)],Addr(TIBTransaction.AddDatabase));

RegRegisterMethod(TIBTransaction,'FindDatabase',TypeInfo(_T52),[
TypeInfo(TIBDatabase),TypeInfo(Integer)],Addr(TIBTransaction.FindDatabase));

RegRegisterMethod(TIBTransaction,'FindDefaultDatabase',TypeInfo(_T53),[TypeInfo(TIBDatabase)],Addr(TIBTransaction.FindDefaultDatabase));

RegRegisterMethod(TIBTransaction,'RemoveDatabase',TypeInfo(_T54),[
TypeInfo(Integer)],Addr(TIBTransaction.RemoveDatabase));

RegRegisterMethod(TIBTransaction,'RemoveDatabases',TypeInfo(_T55),NoParams,Addr(TIBTransaction.RemoveDatabases));

RegRegisterMethod(TIBTransaction,'CheckDatabasesInList',TypeInfo(_T56),NoParams,Addr(TIBTransaction.CheckDatabasesInList));
