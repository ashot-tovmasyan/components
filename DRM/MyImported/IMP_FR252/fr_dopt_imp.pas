...
procedure __TfrDocOptForm__LB1DrawItem__Wrapper(__Instance : TfrDocOptForm;
p0 : TWinControl;
p1 : Integer;
const p2 : IDispatch;
p3 : TOwnerDrawState);
...
TfrDocOptForm(__Instance).LB1DrawItem(p0,p1,__p2^,p3);
end;
...
procedure _mreg_0;
begin
RegRegisterMethod(TfrDocOptForm,'FormActivate',TypeInfo(_T0),[
TypeInfo(TObject)],Addr(TfrDocOptForm.FormActivate));

RegRegisterMethod(TfrDocOptForm,'FormCreate',TypeInfo(_T1),[
TypeInfo(TObject)],Addr(TfrDocOptForm.FormCreate));

RegRegisterMethod(TfrDocOptForm,'LB1DrawItem',TypeInfo(_T2),[
TypeInfo(TWinControl),
TypeInfo(Integer),
TypeInfo(IDispatch),
TypeInfo(TOwnerDrawState)],Addr(__TfrDocOptForm__LB1DrawItem__Wrapper));
