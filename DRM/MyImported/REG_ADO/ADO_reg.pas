...
{ Property Editors }
  ...
  TDBStringProperty = class(TStringProperty)  //я добавил
  public
...
{ TParametersProperty }
  ...
  TParametersProperty = class(TModalCollectEdit{TCollectionProperty})
  public
    procedure Edit; override;
  end;
...
*)
  TADODataSetEditor = class(TComponentEditor)
  private
    FCanCreate: Boolean;
  public
    procedure ExecuteVerb(Index: Integer); override;
...
uses TypInfo, AdoConEd, Consts{, SqlEdit}, Dialogs, DBCommon;
