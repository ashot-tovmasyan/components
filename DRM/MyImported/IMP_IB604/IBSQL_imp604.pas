...
_T13 = function : TIBXSQLDA of object;

_T14 = _T1;

_T15 = function (p0 : String): TIBXSQLVAR of object;
...
_T22 = procedure (p0 : String;
p1 : Integer) of object;

_T23 = _T15;

_T24 = procedure (p0 : TIBXSQLDA;
p1 : TIBSQL) of object;

_T25 = procedure (p0 : TIBXSQLVAR) of object;

_T26 = procedure (const p0 : String) of object;

_T27 = procedure (p0 : TStream) of object;
...
RegRegisterMethod(TIBSQL,'Call',TypeInfo(_T8),[
TypeInfo(ISC_STATUS),
TypeInfo(Boolean),TypeInfo(ISC_STATUS)],Addr(TIBSQL.Call));

RegRegisterMethod(TIBSQL,'CheckClosed',TypeInfo(_T9),NoParams,Addr(TIBSQL.CheckClosed));

RegRegisterMethod(TIBSQL,'CheckOpen',TypeInfo(_T10),NoParams,Addr(TIBSQL.CheckOpen));

RegRegisterMethod(TIBSQL,'CheckValidStatement',TypeInfo(_T11),NoParams,Addr(TIBSQL.CheckValidStatement));

RegRegisterMethod(TIBSQL,'Close',TypeInfo(_T12),NoParams,Addr(TIBSQL.Close));

RegRegisterMethod(TIBSQL,'Current',TypeInfo(_T13),[TypeInfo(TIBXSQLDA)],Addr(TIBSQL.Current));

RegRegisterMethod(TIBSQL,'ExecQuery',TypeInfo(_T14),NoParams,Addr(TIBSQL.ExecQuery));

RegRegisterMethod(TIBSQL,'FieldByName',TypeInfo(_T15),[
TypeInfo(String),TypeInfo(TIBXSQLVAR)],Addr(TIBSQL.FieldByName));

RegRegisterMethod(TIBSQL,'FreeHandle',TypeInfo(_T16),NoParams,Addr(TIBSQL.FreeHandle));

RegRegisterMethod(TIBSQL,'Next',TypeInfo(_T17),[TypeInfo(TIBXSQLDA)],Addr(TIBSQL.Next));

RegRegisterMethod(TIBSQL,'Prepare',TypeInfo(_T18),NoParams,Addr(TIBSQL.Prepare));

RegRegisterMethod(TIBSQL,'GetUniqueRelationName',TypeInfo(_T19),[TypeInfo(String)],Addr(TIBSQL.GetUniqueRelationName));

RegRegisterMethod(TIBSQL,'ParamByName',TypeInfo(_T20),[
TypeInfo(String),TypeInfo(TIBXSQLVAR)],Addr(TIBSQL.ParamByName));

RegisterProc(TIBXSQLDA,'Create',mtConstructor,TypeInfo(_T21),[
TypeInfo(TIBSQL)],Addr(TIBXSQLDA.Create),cRegister);

RegRegisterMethod(TIBXSQLDA,'AddName',TypeInfo(_T22),[
TypeInfo(String),
TypeInfo(Integer)],Addr(TIBXSQLDA.AddName));

RegRegisterMethod(TIBXSQLDA,'ByName',TypeInfo(_T23),[
TypeInfo(String),TypeInfo(TIBXSQLVAR)],Addr(TIBXSQLDA.ByName));

RegisterProc(TIBXSQLVAR,'Create',mtConstructor,TypeInfo(_T24),[
TypeInfo(TIBXSQLDA),
TypeInfo(TIBSQL)],Addr(TIBXSQLVAR.Create),cRegister);

RegRegisterMethod(TIBXSQLVAR,'Assign',TypeInfo(_T25),[
TypeInfo(TIBXSQLVAR)],Addr(TIBXSQLVAR.Assign));

RegRegisterMethod(TIBXSQLVAR,'LoadFromFile',TypeInfo(_T26),[
TypeInfo(String)],Addr(TIBXSQLVAR.LoadFromFile));

RegRegisterMethod(TIBXSQLVAR,'LoadFromStream',TypeInfo(_T27),[
TypeInfo(TStream)],Addr(TIBXSQLVAR.LoadFromStream));

RegRegisterMethod(TIBXSQLVAR,'SaveToFile',TypeInfo(_T28),[
TypeInfo(String)],Addr(TIBXSQLVAR.SaveToFile));

RegRegisterMethod(TIBXSQLVAR,'SaveToStream',TypeInfo(_T29),[
TypeInfo(TStream)],Addr(TIBXSQLVAR.SaveToStream));

RegRegisterMethod(TIBXSQLVAR,'Clear',TypeInfo(_T30),NoParams,Addr(TIBXSQLVAR.Clear));
