...
_T52 = function (p0 : TIBDatabase): Integer of object;

_T53 = _T52;

_T54 = function : TIBDatabase of object;
...
RegRegisterMethod(TIBTimer,'Timer',TypeInfo(_T42),NoParams, pointer(MinVMTOffset - 16));

RegRegisterMethod(TIBTransaction,'Call',TypeInfo(_T43),[
TypeInfo(ISC_STATUS),
TypeInfo(Boolean),TypeInfo(ISC_STATUS)],Addr(TIBTransaction.Call));

RegRegisterMethod(TIBTransaction,'Commit',TypeInfo(_T44),NoParams,Addr(TIBTransaction.Commit));

RegRegisterMethod(TIBTransaction,'CommitRetaining',TypeInfo(_T45),NoParams,Addr(TIBTransaction.CommitRetaining));

RegRegisterMethod(TIBTransaction,'Rollback',TypeInfo(_T46),NoParams,Addr(TIBTransaction.Rollback));

RegRegisterMethod(TIBTransaction,'RollbackRetaining',TypeInfo(_T47),NoParams,Addr(TIBTransaction.RollbackRetaining));

RegRegisterMethod(TIBTransaction,'StartTransaction',TypeInfo(_T48),NoParams,Addr(TIBTransaction.StartTransaction));

RegRegisterMethod(TIBTransaction,'CheckInTransaction',TypeInfo(_T49),NoParams,Addr(TIBTransaction.CheckInTransaction));

RegRegisterMethod(TIBTransaction,'CheckNotInTransaction',TypeInfo(_T50),NoParams,Addr(TIBTransaction.CheckNotInTransaction));

RegRegisterMethod(TIBTransaction,'CheckAutoStop',TypeInfo(_T51),NoParams,Addr(TIBTransaction.CheckAutoStop));

RegRegisterMethod(TIBTransaction,'AddDatabase',TypeInfo(_T52),[
TypeInfo(TIBDatabase),TypeInfo(Integer)],Addr(TIBTransaction.AddDatabase));

RegRegisterMethod(TIBTransaction,'FindDatabase',TypeInfo(_T53),[
TypeInfo(TIBDatabase),TypeInfo(Integer)],Addr(TIBTransaction.FindDatabase));

RegRegisterMethod(TIBTransaction,'FindDefaultDatabase',TypeInfo(_T54),[TypeInfo(TIBDatabase)],Addr(TIBTransaction.FindDefaultDatabase));

RegRegisterMethod(TIBTransaction,'RemoveDatabase',TypeInfo(_T55),[
TypeInfo(Integer)],Addr(TIBTransaction.RemoveDatabase));

RegRegisterMethod(TIBTransaction,'RemoveDatabases',TypeInfo(_T56),NoParams,Addr(TIBTransaction.RemoveDatabases));

RegRegisterMethod(TIBTransaction,'CheckDatabasesInList',TypeInfo(_T57),NoParams,Addr(TIBTransaction.CheckDatabasesInList));
