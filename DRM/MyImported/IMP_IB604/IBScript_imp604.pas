...
procedure _mreg_0;
begin
RegRegisterMethod(TIBScript,'DoDML',TypeInfo(_T0),[
TypeInfo(string)], pointer(48));

RegRegisterMethod(TIBScript,'DoDDL',TypeInfo(_T1),[
TypeInfo(string)], pointer(52));

RegRegisterMethod(TIBScript,'DoSET',TypeInfo(_T2),[
TypeInfo(string)], pointer(56));

RegRegisterMethod(TIBScript,'DoConnect',TypeInfo(_T3),[
TypeInfo(string)], pointer(60));

RegRegisterMethod(TIBScript,'DoCreate',TypeInfo(_T4),[
TypeInfo(string)], pointer(64));

RegRegisterMethod(TIBScript,'DoReconnect',TypeInfo(_T5),NoParams, pointer(68));

RegRegisterMethod(TIBScript,'DropDatabase',TypeInfo(_T6),[
...
RegRegisterMethod(TIBSQLParser,'DoOnParse',TypeInfo(_T14),[
TypeInfo(TIBParseKind),
TypeInfo(string)], pointer(48));

RegRegisterMethod(TIBSQLParser,'DoOnError',TypeInfo(_T15),[
TypeInfo(string),
TypeInfo(string)], pointer(52));
