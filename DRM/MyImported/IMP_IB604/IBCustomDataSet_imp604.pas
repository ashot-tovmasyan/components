...
TypeInfo(TField),
TypeInfoPointer], pointer(600));

RegRegisterMethod(TIBCustomDataSet,'InternalBatchInput',TypeInfo(_T1),[
TypeInfo(TIBBatchInput)], pointer(604));

RegRegisterMethod(TIBCustomDataSet,'InternalBatchOutput',TypeInfo(_T2),[
TypeInfo(TIBBatchOutput)], pointer(608));

RegRegisterMethod(TIBCustomDataSet,'InternalPrepare',TypeInfo(_T3),NoParams, pointer(612));

RegRegisterMethod(TIBCustomDataSet,'InternalUnPrepare',TypeInfo(_T4),NoParams, pointer(616));

RegRegisterMethod(TIBCustomDataSet,'InternalExecQuery',TypeInfo(_T5),NoParams, pointer(620));

RegRegisterMethod(TIBCustomDataSet,'InternalRefreshRow',TypeInfo(_T6),NoParams, pointer(624));

RegRegisterMethod(TIBCustomDataSet,'InternalSetParamsFromCursor',TypeInfo(_T7),NoParams, pointer(628));

RegRegisterMethod(TIBCustomDataSet,'Disconnect',TypeInfo(_T8),NoParams, pointer(632));
