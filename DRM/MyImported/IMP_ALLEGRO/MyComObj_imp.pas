...
_T5 = function (const p0 : string): IDispatch of object; //я убрал комментарий

_T6 = function (const p0 : string): IDispatch of object; //я убрал комментарий
...
TypeInfo(string),TypeInfo(IDispatch)],Addr(CreateOleObject),cRegister); //я убрал комментарий

RegisterProc(nil,'GetActiveOleObject',mtProc,TypeInfo(_T6),[
TypeInfo(string),TypeInfo(IDispatch)],Addr(GetActiveOleObject),cRegister); //я убрал комментарий
