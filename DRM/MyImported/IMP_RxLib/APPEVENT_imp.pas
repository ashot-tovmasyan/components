...
type __TAppEvents__ = class(TAppEvents);
type
...
function __TAppEvents__MessageHook__Wrapper(__Instance : TAppEvents;
...
result := __TAppEvents__(__Instance).MessageHook(__p0^);
end;
...
function __DC__GetTAppEvents__Canvas(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := VarFromObject(TAppEvents(Instance).Canvas);
end;

procedure __RegisterProps;
begin
RegisterProperty(TAppEvents,'Canvas',__DC__GetTAppEvents__Canvas,nil);
end;
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[0] ,DefHintColor));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[1] ,DefHintPause));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[2] ,DefHintShortPause));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[3] ,DefHintHidePause));
end;
...
initialization
RegRegisterMethod(TAppEvents,'PaintIcon',TypeInfo(_T0),NoParams, pointer(48));

RegRegisterMethod(TAppEvents,'SettingsChanged',TypeInfo(_T1),NoParams, pointer(MinVMTOffset - 15));

RegRegisterMethod(TAppEvents,'MessageHook',TypeInfo(_T2),[
