...
procedure __TfrBandEditorForm__LB1DrawItem__Wrapper(__Instance : TfrBandEditorForm;
p0 : TWinControl;
p1 : Integer;
const p2 : IDispatch;
p3 : TOwnerDrawState);
...
TfrBandEditorForm(__Instance).LB1DrawItem(p0,p1,__p2^,p3);
end;
...
procedure _mreg_0;
begin
RegRegisterMethod(TfrBandEditorForm,'FormCreate',TypeInfo(_T0),[
TypeInfo(TObject)],Addr(TfrBandEditorForm.FormCreate));

RegRegisterMethod(TfrBandEditorForm,'LB1Click',TypeInfo(_T1),[
TypeInfo(TObject)],Addr(TfrBandEditorForm.LB1Click));

RegRegisterMethod(TfrBandEditorForm,'LB1DrawItem',TypeInfo(_T2),[
TypeInfo(TWinControl),
TypeInfo(Integer),
TypeInfo(IDispatch),
TypeInfo(TOwnerDrawState)],Addr(__TfrBandEditorForm__LB1DrawItem__Wrapper));

RegRegisterMethod(TfrBandEditorForm,'LB1DblClick',TypeInfo(_T3),[
TypeInfo(TObject)],Addr(TfrBandEditorForm.LB1DblClick));
