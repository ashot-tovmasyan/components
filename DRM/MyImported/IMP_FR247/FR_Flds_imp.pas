...
procedure __TfrFieldsForm__DatasetsLBDrawItem__Wrapper(__Instance : TfrFieldsForm;
p0 : TWinControl;
p1 : Integer;
const p2 : IDispatch;
p3 : TOwnerDrawState);
...
TfrFieldsForm(__Instance).DatasetsLBDrawItem(p0,p1,__p2^,p3);
end;
...
procedure _mreg_0;
begin
RegRegisterMethod(TfrFieldsForm,'FormCreate',TypeInfo(_T0),[
TypeInfo(TObject)],Addr(TfrFieldsForm.FormCreate));

RegRegisterMethod(TfrFieldsForm,'FieldsLBDblClick',TypeInfo(_T1),[
TypeInfo(TObject)],Addr(TfrFieldsForm.FieldsLBDblClick));

RegRegisterMethod(TfrFieldsForm,'DatasetsLBClick',TypeInfo(_T2),[
TypeInfo(TObject)],Addr(TfrFieldsForm.DatasetsLBClick));

RegRegisterMethod(TfrFieldsForm,'DatasetsLBDrawItem',TypeInfo(_T3),[
TypeInfo(TWinControl),
TypeInfo(Integer),
TypeInfo(IDispatch),
TypeInfo(TOwnerDrawState)],Addr(__TfrFieldsForm__DatasetsLBDrawItem__Wrapper));

RegRegisterMethod(TfrFieldsForm,'FormShow',TypeInfo(_T4),[
TypeInfo(TObject)],Addr(TfrFieldsForm.FormShow));

RegRegisterMethod(TfrFieldsForm,'FormHide',TypeInfo(_T5),[
TypeInfo(TObject)],Addr(TfrFieldsForm.FormHide));
