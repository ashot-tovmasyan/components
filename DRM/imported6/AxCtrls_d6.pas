...
RegRegisterMethod(TActiveForm,'Initialize',TypeInfo(_T10),NoParams, pointer(248));

RegRegisterMethod(TActiveFormControl,'FreeOnRelease',TypeInfo(_T11),NoParams,Addr(TActiveFormControl.FreeOnRelease));

RegRegisterMethod(TActiveXControl,'GetPropertyString',TypeInfo(_T15),[
TypeInfo(Integer),
TypeInfo(string),TypeInfo(Boolean)], pointer(48));

RegRegisterMethod(TActiveXControl,'GetPropertyStrings',TypeInfo(_T16),[
TypeInfo(Integer),
TypeInfo(TStrings),TypeInfo(Boolean)], pointer(52));

RegRegisterMethod(TActiveXControl,'GetPropertyValue',TypeInfo(_T17),[
TypeInfo(Integer),
TypeInfo(Integer),
...
RegRegisterMethod(TActiveXControl,'PerformVerb',TypeInfo(_T21),[
TypeInfo(Integer)], pointer(72));

RegRegisterMethod(TActiveXControl,'WndProc',TypeInfo(_T24),[
...
RegRegisterMethod(TPropertyPage,'UpdateObject',TypeInfo(_T42),NoParams, pointer(240));

RegRegisterMethod(TPropertyPage,'UpdatePropertyPage',TypeInfo(_T43),NoParams, pointer(244));
...
TypeInfo(TDefinePropertyPage)], pointer(240))}

{RegRegisterMethod(TActiveForm,'EventSinkChanged',TypeInfo(_T9),[
TypeInfo(IUnknown)], pointer(244))}
