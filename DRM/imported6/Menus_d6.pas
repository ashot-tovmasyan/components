...
_T8 = function : TMenuItem of object;

_T9 = procedure (p0 : TMenuItem;
p1 : TCanvas;
const p2 : IDispatch;
...
_T13 = procedure (p0 : TMainMenu) of object;

_T14 = _T13;

_T15 = procedure (p0 : HMENU;
const p1 : Array of Integer;
var p2 : Array of Longint) of object;

_T16 = procedure (var p0 : HAccel;
var p1 : Integer;
const p2 : Array of Integer) of object;

_T17 = procedure (p0 : HMENU) of object;

_T18 = procedure (p0 : TMenuItem;
p1 : Boolean) of object;

_T19 = function : HMENU of object;

_T20 = procedure (p0 : TObject;
p1 : TMenuItem;
p2 : Boolean) of object;

_T21 = function (p0 : Word): Boolean of object;

_T22 = function (p0 : HMENU): Boolean of object;
...
_T26 = function (const p0 : IDispatch): Boolean of object;

_T27 = procedure  of object;

_T28 = procedure (const p0 : IDispatch) of object;
...
{_T33 = function : TMenuActionLinkClass of object;}
...
_T38 = procedure (p0 : Integer) of object;

_T39 = _T27;

_T40 = _T27;

_T41 = function (p0 : string): TMenuItem of object;

_T42 = function (p0 : TMenuItem): Integer of object;

_T43 = _T25;

_T44 = function : TCustomImageList of object;

_T45 = function : TMenu of object;
...
_T50 = procedure (p0 : TMenuItem) of object;
...
_T56 = procedure (p0 : TPopupMenu) of object;

_T57 = _T56;

_T58 = procedure (p0 : TObject) of object;
...
RegisterProc(nil,MethodNames[7],mtProc,TypeInfo(_T8),[TypeInfo(TMenuItem)],Addr(NewLine),cRegister);
...
RegRegisterMethod(TMainMenu,'Merge',TypeInfo(_T13),[
TypeInfo(TMainMenu)],Addr(TMainMenu.Merge));

RegRegisterMethod(TMainMenu,'Unmerge',TypeInfo(_T14),[
TypeInfo(TMainMenu)],Addr(TMainMenu.Unmerge));

RegRegisterMethod(TMainMenu,'PopulateOle2Menu',TypeInfo(_T15),[
TypeInfo(HMENU),
ArrayInfo(TypeInfo(Integer)),
ArrayInfo(TypeInfo(Longint))],Addr(TMainMenu.PopulateOle2Menu));

RegRegisterMethod(TMainMenu,'GetOle2AcceleratorTable',TypeInfo(_T16),[
TypeInfo(HAccel),
TypeInfo(Integer),
ArrayInfo(TypeInfo(Integer))],Addr(TMainMenu.GetOle2AcceleratorTable));

RegRegisterMethod(TMainMenu,'SetOle2MenuHandle',TypeInfo(_T17),[
TypeInfo(HMENU)],Addr(TMainMenu.SetOle2MenuHandle));

RegRegisterMethod(TMenu,'DoChange',TypeInfo(_T18),[
TypeInfo(TMenuItem),
TypeInfo(Boolean)], pointer(48));

RegRegisterMethod(TMenu,'GetHandle',TypeInfo(_T19),[TypeInfo(HMENU)], pointer(52));

RegRegisterMethod(TMenu,'MenuChanged',TypeInfo(_T20),[
TypeInfo(TObject),
TypeInfo(TMenuItem),
TypeInfo(Boolean)], pointer(56));

RegRegisterMethod(TMenu,'DispatchCommand',TypeInfo(_T21),[
TypeInfo(Word),TypeInfo(Boolean)],Addr(TMenu.DispatchCommand));

RegRegisterMethod(TMenu,'DispatchPopup',TypeInfo(_T22),[
TypeInfo(HMENU),TypeInfo(Boolean)],Addr(TMenu.DispatchPopup));

RegRegisterMethod(TMenu,'FindItem',TypeInfo(_T23),[
TypeInfo(Integer),
TypeInfo(TFindItemKind),TypeInfo(TMenuItem)],Addr(TMenu.FindItem));

RegRegisterMethod(TMenu,'GetHelpContext',TypeInfo(_T24),[
TypeInfo(Integer),
TypeInfo(Boolean),TypeInfo(THelpContext)],Addr(TMenu.GetHelpContext));

RegRegisterMethod(TMenu,'IsRightToLeft',TypeInfo(_T25),[TypeInfo(Boolean)],Addr(TMenu.IsRightToLeft));

RegRegisterMethod(TMenu,'IsShortCut',TypeInfo(_T26),[
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(MinVMTOffset - 16));

RegRegisterMethod(TMenu,'ParentBiDiModeChanged',TypeInfo(_T27),NoParams,Addr(TMenu.ParentBiDiModeChanged));

RegRegisterMethod(TMenu,'ProcessMenuChar',TypeInfo(_T28),[
TypeInfo(IDispatch)],Addr(__TMenu__ProcessMenuChar__Wrapper));

RegRegisterMethod(TMenuActionLink,'IsAutoCheckLinked',TypeInfo(_T29),[TypeInfo(Boolean)], pointer(120));

RegRegisterMethod(TMenuItem,'ActionChange',TypeInfo(_T30),[
TypeInfo(TObject),
TypeInfo(Boolean)], pointer(MinVMTOffset - 16));

RegRegisterMethod(TMenuItem,'AdvancedDrawItem',TypeInfo(_T31),[
TypeInfo(TCanvas),
TypeInfo(IDispatch),
TypeInfo(TOwnerDrawState),
TypeInfo(Boolean)], pointer(48));

RegRegisterMethod(TMenuItem,'DrawItem',TypeInfo(_T32),[
TypeInfo(TCanvas),
TypeInfo(IDispatch),
TypeInfo(Boolean)], pointer(52));

RegRegisterMethod(TMenuItem,'MeasureItem',TypeInfo(_T34),[
TypeInfo(TCanvas),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(56));

RegRegisterMethod(TMenuItem,'MenuChanged',TypeInfo(_T35),[
TypeInfo(Boolean)], pointer(60));

RegRegisterMethod(TMenuItem,'InitiateAction',TypeInfo(_T36),NoParams, pointer(64));

RegRegisterMethod(TMenuItem,'Insert',TypeInfo(_T37),[
TypeInfo(Integer),
TypeInfo(TMenuItem)],Addr(TMenuItem.Insert));

RegRegisterMethod(TMenuItem,'Delete',TypeInfo(_T38),[
TypeInfo(Integer)],Addr(TMenuItem.Delete));

RegRegisterMethod(TMenuItem,'Clear',TypeInfo(_T39),NoParams,Addr(TMenuItem.Clear));

RegRegisterMethod(TMenuItem,'Click',TypeInfo(_T40),NoParams, pointer(68));

RegRegisterMethod(TMenuItem,'Find',TypeInfo(_T41),[
TypeInfo(string),TypeInfo(TMenuItem)],Addr(TMenuItem.Find));

RegRegisterMethod(TMenuItem,'IndexOf',TypeInfo(_T42),[
TypeInfo(TMenuItem),TypeInfo(Integer)],Addr(TMenuItem.IndexOf));

RegRegisterMethod(TMenuItem,'IsLine',TypeInfo(_T43),[TypeInfo(Boolean)],Addr(TMenuItem.IsLine));

RegRegisterMethod(TMenuItem,'GetImageList',TypeInfo(_T44),[TypeInfo(TCustomImageList)],Addr(TMenuItem.GetImageList));

RegRegisterMethod(TMenuItem,'GetParentMenu',TypeInfo(_T45),[TypeInfo(TMenu)],Addr(TMenuItem.GetParentMenu));

RegRegisterMethod(TMenuItem,'NewTopLine',TypeInfo(_T46),[TypeInfo(Integer)],Addr(TMenuItem.NewTopLine));

RegRegisterMethod(TMenuItem,'NewBottomLine',TypeInfo(_T47),[TypeInfo(Integer)],Addr(TMenuItem.NewBottomLine));

RegRegisterMethod(TMenuItem,'InsertNewLineBefore',TypeInfo(_T48),[
TypeInfo(TMenuItem),TypeInfo(Integer)],Addr(TMenuItem.InsertNewLineBefore));

RegRegisterMethod(TMenuItem,'InsertNewLineAfter',TypeInfo(_T49),[
TypeInfo(TMenuItem),TypeInfo(Integer)],Addr(TMenuItem.InsertNewLineAfter));

RegRegisterMethod(TMenuItem,'Add',TypeInfo(_T50),[
TypeInfo(TMenuItem)],Addr(TMenuItem.Add));

RegRegisterMethod(TMenuItem,'Remove',TypeInfo(_T51),[
TypeInfo(TMenuItem)],Addr(TMenuItem.Remove));

RegRegisterMethod(TMenuItem,'RethinkHotkeys',TypeInfo(_T52),[TypeInfo(Boolean)],Addr(TMenuItem.RethinkHotkeys));

RegRegisterMethod(TMenuItem,'RethinkLines',TypeInfo(_T53),[TypeInfo(Boolean)],Addr(TMenuItem.RethinkLines));

RegRegisterMethod(TMenuItemStack,'ClearItem',TypeInfo(_T54),[
TypeInfo(TMenuItem)],Addr(TMenuItemStack.ClearItem));

RegRegisterMethod(TPopupList,'WndProc',TypeInfo(_T55),[
TypeInfo(IDispatch)], pointer(16));

RegRegisterMethod(TPopupList,'Add',TypeInfo(_T56),[
TypeInfo(TPopupMenu)],Addr(TPopupList.Add));

RegRegisterMethod(TPopupList,'Remove',TypeInfo(_T57),[
TypeInfo(TPopupMenu)],Addr(TPopupList.Remove));

RegRegisterMethod(TPopupMenu,'DoPopup',TypeInfo(_T58),[
TypeInfo(TObject)], pointer(60));

RegRegisterMethod(TPopupMenu,'Popup',TypeInfo(_T59),[
TypeInfo(Integer),
...
_mreg_0;
{RegisterProc(nil,'NewItem',mtProc,TypeInfo(_T7),[
TypeInfo(string),
TypeInfo(TShortCut),
TypeInfo(Boolean),
TypeInfo(Boolean),
...
{RegRegisterMethod(TMenuItem,'GetActionLinkClass',TypeInfo(_T33),[TypeInfo(TMenuActionLinkClass)], pointer(MinVMTOffset - 17))}
