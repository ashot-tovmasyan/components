...
_T17 = procedure (p0 : TService) of object;

_T18 = procedure (p0 : Boolean) of object;
...
RegRegisterMethod(TService,'DoCustomControl',TypeInfo(_T9),[
TypeInfo(DWord),TypeInfo(Boolean)], pointer(84));
...
RegRegisterMethod(TServiceApplication,'Run',TypeInfo(_T16),NoParams, pointer(56));

RegisterProc(TServiceThread,'Create',mtConstructor,TypeInfo(_T17),[
TypeInfo(TService)],Addr(TServiceThread.Create),cRegister);

RegRegisterMethod(TServiceThread,'ProcessRequests',TypeInfo(_T18),[
