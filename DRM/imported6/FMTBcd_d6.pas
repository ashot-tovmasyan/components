...
_T17 = function (const p0 : IDispatch): string of object;

_T18 = function (const p0 : IDispatch): Double of object;
...
RegisterProc(nil,MethodNames[19],mtScriptProc,TypeInfo(_T19),[
TypeInfo(IDispatch),
