...
RegRegisterMethod(TDCCustomMenuEditor,'UpdateBorders',TypeInfo(_T1),NoParams, pointer(200));

RegRegisterMethod(TDCCustomMenuEditor,'DoSelectionChanged',TypeInfo(_T2),[
TypeInfo(TDCMenuItem),
TypeInfo(TDCMenuItem)], pointer(MinVMTOffset - 76));

RegRegisterMethod(TDCMenuFolder,'DrawImageOnDragItem',TypeInfo(_T3),NoParams, pointer(200));

RegRegisterMethod(TDCMenuFolder,'ValidateChanges',TypeInfo(_T5),[
TypeInfo(Integer)], pointer(208));

RegRegisterMethod(TDCMenuFolder,'CheckFictitiousItem',TypeInfo(_T6),NoParams, pointer(212));

RegRegisterMethod(TDCMenuFolder,'UpdateSize',TypeInfo(_T7),NoParams, pointer(216));

RegRegisterMethod(TDCMenuFolder,'MoveUpward',TypeInfo(_T8),NoParams, pointer(220));

RegRegisterMethod(TDCMenuFolder,'MoveDownward',TypeInfo(_T9),NoParams, pointer(224));

RegRegisterMethod(TDCMenuFolder,'MoveRightward',TypeInfo(_T10),NoParams, pointer(228));

RegRegisterMethod(TDCMenuFolder,'MoveLeftward',TypeInfo(_T11),NoParams, pointer(232));

RegRegisterMethod(TDCMenuFolder,'MoveSelectionToParent',TypeInfo(_T12),NoParams, pointer(236));

RegRegisterMethod(TDCMenuFolder,'GetItemRect',TypeInfo(_T13),[
TypeInfo(Integer),TypeInfo(IDispatch)], pointer(240));

RegRegisterMethod(TDCMenuFolder,'GetImageShift',TypeInfo(_T14),[TypeInfo(Integer)], pointer(244));

RegRegisterMethod(TDCMenuFolder,'GetItemHeight',TypeInfo(_T15),[TypeInfo(Integer)], pointer(248));

RegRegisterMethod(TDCMenuFolder,'DoSelectionChanged',TypeInfo(_T16),[
TypeInfo(TDCMenuItem),
TypeInfo(TDCMenuItem)], pointer(MinVMTOffset - 76));

RegRegisterMethod(TDCMenuFolder,'DoGlobalMenuClick',TypeInfo(_T17),NoParams, pointer(MinVMTOffset - 77));

RegRegisterMethod(TDCMenuFolder,'DoGlobalMenuDblClick',TypeInfo(_T18),NoParams, pointer(MinVMTOffset - 78));

RegRegisterMethod(TDCMenuFolder,'InitItemRect',TypeInfo(_T19),[
TypeInfo(IDispatch)], pointer(252));

RegRegisterMethod(TDCMenuFolder,'ShiftRectOnNextItem',TypeInfo(_T20),[
TypeInfo(IDispatch),
TypeInfo(Integer)], pointer(256));

RegisterProc(TDCMenuFolder,'Create',mtConstructor,TypeInfo(_T21),[
TypeInfo(TComponent),
TypeInfo(TDCMenuItem),
TypeInfo(TMenuItem)], pointer(260),cRegister);

RegRegisterMethod(TDCMenuFolder,'Release',TypeInfo(_T22),NoParams,Addr(TDCMenuFolder.Release));

RegRegisterMethod(TDCMenuFolder,'Initialize',TypeInfo(_T23),NoParams, pointer(264));
...
RegRegisterMethod(TDCMenuFolder,'InsertItem',TypeInfo(_T26),[
TypeInfo(Integer)], pointer(268));

RegRegisterMethod(TDCMenuFolder,'DeleteItem',TypeInfo(_T27),[
TypeInfo(Integer),
...
RegRegisterMethod(TDCMenuFolder,'CheckMenuAttributes',TypeInfo(_T29),NoParams, pointer(276));

RegRegisterMethod(TDCMenuItem,'GetWidth',TypeInfo(_T30),[TypeInfo(Integer)], pointer(0));

RegRegisterMethod(TDCMenuItem,'InitSubMenu',TypeInfo(_T31),[
TypeInfo(IDispatch)], pointer(4));

RegRegisterMethod(TDCMenuItem,'DrawEmptyItem',TypeInfo(_T32),[
TypeInfo(TCanvas),
TypeInfo(IDispatch),
TypeInfo(Boolean)], pointer(8));

RegRegisterMethod(TDCMenuItem,'DrawImage',TypeInfo(_T33),[
TypeInfo(TCanvas),
TypeInfo(IDispatch),
...
RegRegisterMethod(TDCMenuItem,'DrawItem',TypeInfo(_T35),[
TypeInfo(TCanvas),
TypeInfo(IDispatch),
TypeInfo(Boolean)], pointer(20));

RegRegisterMethod(TDCMenuItem,'ShowSubMenu',TypeInfo(_T36),[
...
_mreg_0;
{RegRegisterMethod(TDCMenuFolder,'GetMenuItemClass',TypeInfo(_T4),[TypeInfo(TDCMenuItemClass)], pointer(204))}
