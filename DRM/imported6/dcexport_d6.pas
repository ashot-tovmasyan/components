...
RegisterProc(TDCExporter,'Create',mtConstructor,TypeInfo(_T11),[
TypeInfo(TStream)], pointer(0),cRegister);

RegRegisterMethod(TDCExporter,'WriteString',TypeInfo(_T12),[
TypeInfo(string)], pointer(4));

RegRegisterMethod(TDCExporter,'TranslateString',TypeInfo(_T13),[
TypeInfo(string),TypeInfo(string)], pointer(8));

RegRegisterMethod(TDCExporter,'StartParagraph',TypeInfo(_T14),[
TypeInfo(TParagraphAlign)], pointer(12));
...
RegRegisterMethod(TDCExporter,'StartFont',TypeInfo(_T19),[
TypeInfo(string)], pointer(32));

RegRegisterMethod(TDCExporter,'StartFontWithCharSet',TypeInfo(_T20),[
TypeInfo(string),
TypeInfo(TFontCharSet)], pointer(36));
...
RegRegisterMethod(TDCExporter,'StartFontSize',TypeInfo(_T26),[
...
RegRegisterMethod(TDCExporter,'StartColor',TypeInfo(_T50),[
TypeInfo(TColor)], pointer(156));

RegRegisterMethod(TDCExporter,'FinishColor',TypeInfo(_T51),NoParams, pointer(160));

RegRegisterMethod(TDCExporter,'StartBackground',TypeInfo(_T52),[
TypeInfo(TColor)], pointer(164));

RegRegisterMethod(TDCExporter,'FinishBackground',TypeInfo(_T53),NoParams, pointer(168));

RegRegisterMethod(TDCExporter,'StartBackColor',TypeInfo(_T54),[
TypeInfo(TColor)], pointer(172));

RegRegisterMethod(TDCExporter,'FinishBackColor',TypeInfo(_T55),NoParams, pointer(176));

RegRegisterMethod(TDCExporter,'StartHRef',TypeInfo(_T56),[
TypeInfo(string),
TypeInfo(TWindowStyle)], pointer(180));

RegRegisterMethod(TDCExporter,'FinishHRef',TypeInfo(_T57),NoParams, pointer(184));

RegRegisterMethod(TDCExporter,'StartTable',TypeInfo(_T58),[
...
RegRegisterMethod(TDCExporter,'WriteExternalURL',TypeInfo(_T72),[
TypeInfo(string),
TypeInfo(string)], pointer(244));

RegisterProc(TDCHtmlConverter,'Create',mtConstructor,TypeInfo(_T73),[
TypeInfo(string)],Addr(TDCHtmlConverter.Create),cRegister);

RegRegisterMethod(TDCImporter,'TextChanged',TypeInfo(_T74),[
TypeInfo(string),
TypeInfo(TFont),
TypeInfo(TColor)], pointer(0));

RegRegisterMethod(TDCImporter,'IsValidStream',TypeInfo(_T75),[
TypeInfo(TStream),TypeInfo(Boolean)], pointer(4));

RegisterProc(TDCImporter,'Create',mtConstructor,TypeInfo(_T76),NoParams,Addr(TDCImporter.Create),cRegister);

RegRegisterMethod(TDCImporter,'ParseText',TypeInfo(_T77),[
...
RegRegisterMethod(TWriterObject,'BeginTag',TypeInfo(_T110),[
TypeInfo(string)], pointer(0));

RegRegisterMethod(TWriterObject,'EndTag',TypeInfo(_T111),[
TypeInfo(string)], pointer(4));

RegRegisterMethod(TWriterObject,'IsEmbeddedTag',TypeInfo(_T112),[
TypeInfo(string),TypeInfo(Boolean)], pointer(8));

RegRegisterMethod(TWriterObject,'WriteString',TypeInfo(_T113),[
TypeInfo(TStream),
...
RegRegisterMethod(TWriterObject,'Flush',TypeInfo(_T115),[
TypeInfo(TStream)], pointer(16));

RegRegisterMethod(TWriterObject,'IsEmbeddedString',TypeInfo(_T116),[
TypeInfo(string),TypeInfo(Boolean)], pointer(20));
