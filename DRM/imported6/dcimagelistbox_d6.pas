...
procedure _mreg_0;
begin
RegRegisterMethod(TDCCustomCheckImageListBox,'DoCheckStateChanged',TypeInfo(_T0),[
TypeInfo(TDCCustomCheckListItem)], pointer(236));

RegRegisterMethod(TDCCustomImageListBox,'DoCanMoveItem',TypeInfo(_T1),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(Boolean)], pointer(200));

RegRegisterMethod(TDCCustomImageListBox,'DoItemMoved',TypeInfo(_T2),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(204));

RegRegisterMethod(TDCCustomImageListBox,'GetItemsHeight',TypeInfo(_T3),[TypeInfo(Integer)], pointer(208));

RegRegisterMethod(TDCCustomImageListBox,'GetImageWidth',TypeInfo(_T4),[TypeInfo(Integer)], pointer(212));

RegRegisterMethod(TDCCustomImageListBox,'GetItemsMaxWidth',TypeInfo(_T5),[
TypeInfo(Integer),TypeInfo(Integer)], pointer(216));

RegRegisterMethod(TDCCustomImageListBox,'DoChanged',TypeInfo(_T6),NoParams, pointer(MinVMTOffset - 76));

RegRegisterMethod(TDCCustomImageListBox,'DoSelectionChanged',TypeInfo(_T7),NoParams, pointer(MinVMTOffset - 77));

RegRegisterMethod(TDCCustomImageListBox,'GetSortingField',TypeInfo(_T9),[
TypeInfo(Integer),TypeInfo(String)], pointer(224));

RegRegisterMethod(TDCCustomImageListBox,'ResortItems',TypeInfo(_T10),NoParams, pointer(228));
...
RegRegisterMethod(TDCCustomImageListBox,'Delete',TypeInfo(_T27),[
TypeInfo(Integer)], pointer(232));

RegRegisterMethod(TDCCustomImageListItem,'DrawImage',TypeInfo(_T28),[
TypeInfo(TCanvas),
TypeInfo(IDispatch),
TypeInfo(TImageList)], pointer(32));

RegRegisterMethod(TDCCustomImageListItem,'CaptionChanged',TypeInfo(_T29),NoParams, pointer(36));

RegRegisterMethod(TDCCustomImageListItem,'DrawAt',TypeInfo(_T30),[
TypeInfo(TCanvas),
TypeInfo(IDispatch),
TypeInfo(Boolean)], pointer(40));

RegRegisterMethod(TDCCustomImageListItem,'GetItemTextWidth',TypeInfo(_T31),[
TypeInfo(TCanvas),
TypeInfo(Boolean),TypeInfo(Integer)], pointer(44));
...
initialization
_mreg_0;
{RegRegisterMethod(TDCCustomImageListBox,'GetListItemClass',TypeInfo(_T8),[TypeInfo(TDCImageListItemClass)], pointer(220))}
