...
p2 : LPSTR;
p3 : LPSTR;
var p4 : TImagehlpStatusReason): Bool of object;}
...
TypeInfoPointer,
TypeInfoPointer,
TypeInfoPointer,TypeInfo(Bool)],Addr(ImageEnumerateCertificates),cStdCall);
...
TypeInfoPChar,
TypeInfoPChar,
TypeInfo(TImagehlpStatusReason),TypeInfo(Bool)],Addr(BindImageEx),cStdCall)}
