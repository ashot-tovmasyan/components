...
begin
RegisterIndexedProperty(TCustomDCNamedItems,'Items',1,True,__DC__GetTCustomDCNamedItems__Items,__DC__SetTCustomDCNamedItems__Items);
...
RegRegisterMethod(TDCNamedItem,'OnChange',TypeInfo(_T70),[
TypeInfo(TObject)], pointer(32));
...
RegRegisterMethod(TSortedKeyDataList,'ItemByKey',TypeInfo(_T94),[
TypeInfoPointer,TypeInfoPointer], pointer(16));

RegRegisterMethod(TSortedKeyDataList,'Add',TypeInfo(_T95),[
TypeInfoPointer,TypeInfo(TSortedCustomData)], pointer(20));

RegRegisterMethod(TSortedKeyList,'KeyByItem',TypeInfo(_T97),[
