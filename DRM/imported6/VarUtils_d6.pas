...
type
_T0 = function (const p0 : IDispatch): HRESULT of object;
...
_T4 = function (const p0 : IDispatch;
const p1 : IDispatch;
p2 : Integer;
p3 : Word;
p4 : Word): HRESULT of object;
...
{_T7 = function (p0 : PVarArray): HRESULT of object;}
...
{_T16 = function (p0 : PVarArray): Integer of object;}

{_T17 = function (p0 : PVarArray;
out p1 : Pointer): HRESULT of object;}

{_T18 = function (p0 : PVarArray): HRESULT of object;}

{_T19 = function (p0 : PVarArray): HRESULT of object;}

{_T20 = function (p0 : PVarArray): HRESULT of object;}

{_T21 = function (p0 : PVarArray;
...
{_T24 = function (p0 : PVarArray): LongWord of object;}
...
function ____VariantInit__Wrapper(const p0 : IDispatch): HRESULT;
var
__p0 : ^TVarData;
__i0 : IDispatch;
begin
...
function ____VariantChangeTypeEx__Wrapper(const p0 : IDispatch;
const p1 : IDispatch;
p2 : Integer;
p3 : Word;
p4 : Word): HRESULT;
...
if p1 = nil then exit;
__p1 := (p1 as IDCRecordWrapper).GetRecordPtr;
result := VariantChangeTypeEx(__p0^,__p1^,p2,p3,p4);
end;
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[0] ,VAR_OK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[1] ,VAR_TYPEMISMATCH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[2] ,VAR_BADVARTYPE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[3] ,VAR_EXCEPTION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[4] ,VAR_OVERFLOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[5] ,VAR_BADINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[6] ,VAR_ARRAYISLOCKED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[7] ,VAR_NOTIMPL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[8] ,VAR_OUTOFMEMORY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[9] ,VAR_INVALIDARG));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[10] ,VAR_UNEXPECTED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[11] ,ARR_NONE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[12] ,ARR_FIXEDSIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[13] ,ARR_OLESTR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[14] ,ARR_UNKNOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[15] ,ARR_DISPATCH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[16] ,ARR_VARIANT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[17] ,CMinArrayVarType));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[18] ,CMaxArrayVarType));
end;
...
TypeInfo(IDispatch),TypeInfo(HRESULT)],Addr(____VariantInit__Wrapper),cRegister);
