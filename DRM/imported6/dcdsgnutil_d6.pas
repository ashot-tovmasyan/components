...
RegRegisterMethod(TDCDsgnComponentEditor,'ExecuteVerb',TypeInfo(_T13),[
...
RegRegisterMethod(TDCDsgnComponentEditor,'GetVerb',TypeInfo(_T16),[
...
RegRegisterMethod(TDCDsgnPropertyEditor,'SetValue',TypeInfo(_T41),[
