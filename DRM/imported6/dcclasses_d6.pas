...
RegRegisterMethod(TCustomSortedList,'CompareWithKey',TypeInfo(_T2),[
TypeInfoPointer,
TypeInfoPointer,TypeInfo(Integer)], pointer(0));

RegRegisterMethod(TCustomSortedList,'Compare',TypeInfo(_T3),[
TypeInfoPointer,
TypeInfoPointer,TypeInfo(Integer)], pointer(4));
...
RegRegisterMethod(TCustomSortedList,'Delete',TypeInfo(_T14),[
