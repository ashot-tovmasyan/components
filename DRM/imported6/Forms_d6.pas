...
type
_T0 = function (p0 : TControl): TCustomForm of object;
...
_T22 = procedure (p0 : TControl) of object;

_T23 = _T12;

{_T24 = procedure (p0 : TComponentClass;
var p1) of object;}

_T25 = _T12;

_T26 = function (p0 : TBasicAction): Boolean of object;
...
_T30 = function (p0 : THelpContext): Boolean of object;

_T31 = function (const p0 : string): Boolean of object;

_T32 = _T31;

_T33 = _T12;

_T34 = procedure (p0 : TControl;
const p1 : IDispatch) of object;

{_T35 = procedure (p0 : TWindowHook) of object;}
...
_T47 = procedure (p0 : Exception) of object;

_T48 = _T12;

{_T49 = procedure (p0 : TWindowHook) of object;}
...
_T60 = procedure (var p0 : TCloseAction) of object;
...
_T71 = procedure (p0 : TWinControl;
p1 : Boolean) of object;

_T72 = procedure (p0 : TWinControl) of object;

_T73 = function : TBitmap of object;

_T74 = _T12;

_T75 = function (const p0 : IDispatch): Boolean of object;

_T76 = procedure (p0 : TMonitor) of object;
...
_T80 = function (p0 : TWinControl): Boolean of object;

_T81 = _T12;

_T82 = function : Integer of object;

_T83 = function (p0 : TControl;
...
_T91 = function (const p0 : IDispatch;
p1 : TMonitorDefaultTo): TMonitor of object;

_T92 = _T91;

_T93 = function (const p0 : THandle;
p1 : TMonitorDefaultTo): TMonitor of object;
...
_T98 = procedure (p0 : TWindowState) of object;
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[53] ,afbNone));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[54] ,afbSingle));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[55] ,afbSunken));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[56] ,afbRaised));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[57] ,mdNearest));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[58] ,mdNull));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[59] ,mdPrimary));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[60] ,tmShow));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[61] ,tmHide));
end;
...
TypeInfo(TControl),TypeInfo(TCustomForm)],Addr(GetParentForm),cRegister);

RegisterProc(nil,MethodNames[5],mtProc,TypeInfo(_T1),[
TypeInfo(TControl),TypeInfo(TCustomForm)],Addr(ValidParentForm),cRegister);
...
RegisterProc(nil,MethodNames[8],mtProc,TypeInfo(_T5),[
TypeInfoPointer],Addr(FreeObjectInstance),cRegister);

RegisterProc(nil,MethodNames[9],mtProc,TypeInfo(_T6),[
TypeInfo(Word),
...
RegisterProc(nil,MethodNames[12],mtProc,TypeInfo(_T9),[
...
RegisterProc(nil,MethodNames[14],mtProc,TypeInfo(_T12),NoParams,Addr(DoneCtl3D),cRegister);

RegisterProc(nil,MethodNames[15],mtProc,TypeInfo(_T13),NoParams,Addr(InitCtl3D),cRegister);
...
RegisterProc(nil,MethodNames[18],mtProc,TypeInfo(_T17),[TypeInfo(Boolean)],Addr(ForegroundTask),cRegister);

RegisterProc(nil,MethodNames[19],mtProc,TypeInfo(_T18),[TypeInfoPointer],Addr(SaveFocusState),cRegister);
...
RegRegisterMethod(TApplication,'BringToFront',TypeInfo(_T21),NoParams,Addr(TApplication.BringToFront));

RegRegisterMethod(TApplication,'ControlDestroyed',TypeInfo(_T22),[
TypeInfo(TControl)],Addr(TApplication.ControlDestroyed));

RegRegisterMethod(TApplication,'CancelHint',TypeInfo(_T23),NoParams,Addr(TApplication.CancelHint));

RegRegisterMethod(TApplication,'CreateHandle',TypeInfo(_T25),NoParams,Addr(TApplication.CreateHandle));

RegRegisterMethod(TApplication,'ExecuteAction',TypeInfo(_T26),[
TypeInfo(TBasicAction),TypeInfo(Boolean)],Addr(TApplication.ExecuteAction));

RegRegisterMethod(TApplication,'HandleException',TypeInfo(_T27),[
TypeInfo(TObject)],Addr(TApplication.HandleException));

RegRegisterMethod(TApplication,'HandleMessage',TypeInfo(_T28),NoParams,Addr(TApplication.HandleMessage));

RegRegisterMethod(TApplication,'HelpCommand',TypeInfo(_T29),[
TypeInfo(Integer),
TypeInfo(Longint),TypeInfo(Boolean)],Addr(TApplication.HelpCommand));

RegRegisterMethod(TApplication,'HelpContext',TypeInfo(_T30),[
TypeInfo(THelpContext),TypeInfo(Boolean)],Addr(TApplication.HelpContext));

RegRegisterMethod(TApplication,'HelpJump',TypeInfo(_T31),[
TypeInfo(string),TypeInfo(Boolean)],Addr(TApplication.HelpJump));

RegRegisterMethod(TApplication,'HelpKeyword',TypeInfo(_T32),[
TypeInfo(string),TypeInfo(Boolean)],Addr(TApplication.HelpKeyword));

RegRegisterMethod(TApplication,'HideHint',TypeInfo(_T33),NoParams,Addr(TApplication.HideHint));

RegRegisterMethod(TApplication,'HintMouseMessage',TypeInfo(_T34),[
TypeInfo(TControl),
TypeInfo(IDispatch)],Addr(__TApplication__HintMouseMessage__Wrapper));

RegRegisterMethod(TApplication,'HookSynchronizeWakeup',TypeInfo(_T36),NoParams,Addr(TApplication.HookSynchronizeWakeup));

RegRegisterMethod(TApplication,'Initialize',TypeInfo(_T37),NoParams,Addr(TApplication.Initialize));

RegRegisterMethod(TApplication,'IsRightToLeft',TypeInfo(_T38),[TypeInfo(Boolean)],Addr(TApplication.IsRightToLeft));

RegRegisterMethod(TApplication,'Minimize',TypeInfo(_T40),NoParams,Addr(TApplication.Minimize));

RegRegisterMethod(TApplication,'NormalizeAllTopMosts',TypeInfo(_T41),NoParams,Addr(TApplication.NormalizeAllTopMosts));

RegRegisterMethod(TApplication,'NormalizeTopMosts',TypeInfo(_T42),NoParams,Addr(TApplication.NormalizeTopMosts));

RegRegisterMethod(TApplication,'ProcessMessages',TypeInfo(_T43),NoParams,Addr(TApplication.ProcessMessages));

RegRegisterMethod(TApplication,'Restore',TypeInfo(_T44),NoParams,Addr(TApplication.Restore));

RegRegisterMethod(TApplication,'RestoreTopMosts',TypeInfo(_T45),NoParams,Addr(TApplication.RestoreTopMosts));

RegRegisterMethod(TApplication,'Run',TypeInfo(_T46),NoParams,Addr(TApplication.Run));

RegRegisterMethod(TApplication,'ShowException',TypeInfo(_T47),[
TypeInfo(Exception)],Addr(TApplication.ShowException));

RegRegisterMethod(TApplication,'Terminate',TypeInfo(_T48),NoParams,Addr(TApplication.Terminate));

RegRegisterMethod(TApplication,'UnhookSynchronizeWakeup',TypeInfo(_T50),NoParams,Addr(TApplication.UnhookSynchronizeWakeup));

RegRegisterMethod(TApplication,'UpdateAction',TypeInfo(_T51),[
TypeInfo(TBasicAction),TypeInfo(Boolean)],Addr(TApplication.UpdateAction));

RegRegisterMethod(TApplication,'UseRightToLeftAlignment',TypeInfo(_T52),[TypeInfo(Boolean)],Addr(TApplication.UseRightToLeftAlignment));

RegRegisterMethod(TApplication,'UseRightToLeftReading',TypeInfo(_T53),[TypeInfo(Boolean)],Addr(TApplication.UseRightToLeftReading));

RegRegisterMethod(TApplication,'UseRightToLeftScrollBar',TypeInfo(_T54),[TypeInfo(Boolean)],Addr(TApplication.UseRightToLeftScrollBar));

RegRegisterMethod(TControlScrollBar,'ChangeBiDiPosition',TypeInfo(_T55),NoParams,Addr(TControlScrollBar.ChangeBiDiPosition));

RegRegisterMethod(TControlScrollBar,'IsScrollBarVisible',TypeInfo(_T56),[TypeInfo(Boolean)],Addr(TControlScrollBar.IsScrollBarVisible));

RegRegisterMethod(TCustomForm,'Activate',TypeInfo(_T57),NoParams, pointer(MinVMTOffset - 76));

RegRegisterMethod(TCustomForm,'ActiveChanged',TypeInfo(_T58),NoParams, pointer(MinVMTOffset - 77));

RegRegisterMethod(TCustomForm,'Deactivate',TypeInfo(_T59),NoParams, pointer(MinVMTOffset - 78));

RegRegisterMethod(TCustomForm,'DoClose',TypeInfo(_T60),[
TypeInfo(TCloseAction)], pointer(MinVMTOffset - 79));

RegRegisterMethod(TCustomForm,'DoCreate',TypeInfo(_T61),NoParams, pointer(208));

RegRegisterMethod(TCustomForm,'DoDestroy',TypeInfo(_T62),NoParams, pointer(212));

RegRegisterMethod(TCustomForm,'DoHide',TypeInfo(_T63),NoParams, pointer(MinVMTOffset - 80));

RegRegisterMethod(TCustomForm,'DoShow',TypeInfo(_T64),NoParams, pointer(MinVMTOffset - 81));

RegRegisterMethod(TCustomForm,'HandleCreateException',TypeInfo(_T65),[TypeInfo(Boolean)], pointer(MinVMTOffset - 82));

RegRegisterMethod(TCustomForm,'Paint',TypeInfo(_T66),NoParams, pointer(MinVMTOffset - 83));

RegRegisterMethod(TCustomForm,'UpdateActions',TypeInfo(_T67),NoParams, pointer(216));

RegisterProc(TCustomForm,'CreateNew',mtConstructor,TypeInfo(_T68),[
TypeInfo(TComponent),
TypeInfo(Integer)], pointer(220),cRegister);

RegRegisterMethod(TCustomForm,'Close',TypeInfo(_T69),NoParams,Addr(TCustomForm.Close));

RegRegisterMethod(TCustomForm,'CloseQuery',TypeInfo(_T70),[TypeInfo(Boolean)], pointer(224));

RegRegisterMethod(TCustomForm,'DefocusControl',TypeInfo(_T71),[
TypeInfo(TWinControl),
TypeInfo(Boolean)],Addr(TCustomForm.DefocusControl));

RegRegisterMethod(TCustomForm,'FocusControl',TypeInfo(_T72),[
TypeInfo(TWinControl)],Addr(TCustomForm.FocusControl));

RegRegisterMethod(TCustomForm,'GetFormImage',TypeInfo(_T73),[TypeInfo(TBitmap)],Addr(TCustomForm.GetFormImage));

RegRegisterMethod(TCustomForm,'Hide',TypeInfo(_T74),NoParams,Addr(TCustomForm.Hide));

RegRegisterMethod(TCustomForm,'IsShortCut',TypeInfo(_T75),[
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(MinVMTOffset - 84));

RegisterProc(TCustomForm,'MakeFullyVisible',mtScriptMethod,TypeInfo(_T76),[
TypeInfo(TMonitor)],Addr(__TCustomForm__MakeFullyVisible__Wrapper),cRegister);

RegRegisterMethod(TCustomForm,'Print',TypeInfo(_T77),NoParams,Addr(TCustomForm.Print));

RegRegisterMethod(TCustomForm,'Release',TypeInfo(_T78),NoParams,Addr(TCustomForm.Release));

RegRegisterMethod(TCustomForm,'SendCancelMode',TypeInfo(_T79),[
TypeInfo(TControl)],Addr(TCustomForm.SendCancelMode));

RegRegisterMethod(TCustomForm,'SetFocusedControl',TypeInfo(_T80),[
TypeInfo(TWinControl),TypeInfo(Boolean)], pointer(228));

RegRegisterMethod(TCustomForm,'Show',TypeInfo(_T81),NoParams,Addr(TCustomForm.Show));

RegRegisterMethod(TCustomForm,'ShowModal',TypeInfo(_T82),[TypeInfo(Integer)], pointer(232));

RegRegisterMethod(TCustomForm,'WantChildKey',TypeInfo(_T83),[
TypeInfo(TControl),
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(236));

RegRegisterMethod(TForm,'ArrangeIcons',TypeInfo(_T84),NoParams,Addr(TForm.ArrangeIcons));

RegRegisterMethod(TForm,'Cascade',TypeInfo(_T85),NoParams,Addr(TForm.Cascade));

RegRegisterMethod(TForm,'Next',TypeInfo(_T86),NoParams,Addr(TForm.Next));

RegRegisterMethod(TForm,'Previous',TypeInfo(_T87),NoParams,Addr(TForm.Previous));

RegRegisterMethod(TForm,'Tile',TypeInfo(_T88),NoParams,Addr(TForm.Tile));

RegRegisterMethod(TScreen,'DisableAlign',TypeInfo(_T89),NoParams,Addr(TScreen.DisableAlign));

RegRegisterMethod(TScreen,'EnableAlign',TypeInfo(_T90),NoParams,Addr(TScreen.EnableAlign));

RegisterProc(TScreen,'MonitorFromPoint',mtScriptMethod,TypeInfo(_T91),[
TypeInfo(IDispatch),
TypeInfo(TMonitorDefaultTo),TypeInfo(TMonitor)],Addr(__TScreen__MonitorFromPoint__Wrapper),cRegister);

RegisterProc(TScreen,'MonitorFromRect',mtScriptMethod,TypeInfo(_T92),[
TypeInfo(IDispatch),
TypeInfo(TMonitorDefaultTo),TypeInfo(TMonitor)],Addr(__TScreen__MonitorFromRect__Wrapper),cRegister);

RegisterProc(TScreen,'MonitorFromWindow',mtScriptMethod,TypeInfo(_T93),[
TypeInfo(THandle),
TypeInfo(TMonitorDefaultTo),TypeInfo(TMonitor)],Addr(__TScreen__MonitorFromWindow__Wrapper),cRegister);

RegRegisterMethod(TScreen,'Realign',TypeInfo(_T94),NoParams,Addr(TScreen.Realign));

RegRegisterMethod(TScreen,'ResetFonts',TypeInfo(_T95),NoParams,Addr(TScreen.ResetFonts));

RegRegisterMethod(TScrollingWinControl,'AutoScrollEnabled',TypeInfo(_T96),[TypeInfo(Boolean)], pointer(196));

RegRegisterMethod(TScrollingWinControl,'AutoScrollInView',TypeInfo(_T97),[
TypeInfo(TControl)], pointer(200));

RegRegisterMethod(TScrollingWinControl,'Resizing',TypeInfo(_T98),[
TypeInfo(TWindowState)], pointer(204));

RegRegisterMethod(TScrollingWinControl,'DisableAutoRange',TypeInfo(_T99),NoParams,Addr(TScrollingWinControl.DisableAutoRange));

RegRegisterMethod(TScrollingWinControl,'EnableAutoRange',TypeInfo(_T100),NoParams,Addr(TScrollingWinControl.EnableAutoRange));

RegRegisterMethod(TScrollingWinControl,'ScrollInView',TypeInfo(_T101),[
...
{RegRegisterMethod(TApplication,'CreateForm',TypeInfo(_T24),[
TypeInfo(TComponentClass),
TypeInfoUntyped],Addr(TApplication.CreateForm))}

{RegRegisterMethod(TApplication,'HookMainWindow',TypeInfo(_T35),[
TypeInfo(TWindowHook)],Addr(TApplication.HookMainWindow))}

{RegRegisterMethod(TApplication,'UnhookMainWindow',TypeInfo(_T49),[
