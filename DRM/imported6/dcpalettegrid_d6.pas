...
RegRegisterMethod(TDCCustomPaletteGridHeader,'DoColCountChanged',TypeInfo(_T2),NoParams, pointer(200));

RegRegisterMethod(TDCCustomPaletteGridHeader,'UpdateMeasurements',TypeInfo(_T3),NoParams, pointer(204));

RegRegisterMethod(TDCCustomPaletteGridHeader,'DoColClick',TypeInfo(_T4),[
TypeInfo(Integer)], pointer(208));

RegRegisterMethod(TDCCustomPaletteGridHeader,'DoCanColResize',TypeInfo(_T5),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(212));

RegRegisterMethod(TDCCustomPaletteGridHeader,'SetNewColCount',TypeInfo(_T6),[
TypeInfo(Integer)], pointer(216));

RegRegisterMethod(TDCCustomPaletteGridHeader,'InvalidateItem',TypeInfo(_T7),[
TypeInfo(Integer),
...
RegRegisterMethod(TDCCustomPaletteGridHeaderItem,'DrawCol',TypeInfo(_T9),[
TypeInfo(TCanvas),
TypeInfo(IDispatch),
...
RegRegisterMethod(TDCPaletteGridListBox,'SetNewColCount',TypeInfo(_T12),[
TypeInfo(Integer)], pointer(236));

end;
initialization
_mreg_0;
{RegRegisterMethod(TDCCustomPaletteGrid,'GetHeaderClass',TypeInfo(_T0),[TypeInfo(TDCPaletteGridHeaderClass)], pointer(196))}
