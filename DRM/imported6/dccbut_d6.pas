...
RegRegisterMethod(TDCCaptionButton,'DoMouseDown',TypeInfo(_T2),[
TypeInfo(IDispatch),
TypeInfo(TMouseButton),
TypeInfo(TShiftState)], pointer(56));

RegRegisterMethod(TDCCaptionButton,'DoMouseMove',TypeInfo(_T3),[
TypeInfo(IDispatch)], pointer(60));

RegRegisterMethod(TDCCaptionButton,'DoMouseUp',TypeInfo(_T4),[
TypeInfo(IDispatch),
TypeInfo(TMouseButton),
TypeInfo(TShiftState)], pointer(64));

RegRegisterMethod(TDCCaptionButton,'MouseDown',TypeInfo(_T5),[
TypeInfo(TMouseButton),
TypeInfo(TShiftState),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(68));

RegRegisterMethod(TDCCaptionButton,'MouseMove',TypeInfo(_T6),[
TypeInfo(TShiftState),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(72));

RegRegisterMethod(TDCCaptionButton,'MouseUp',TypeInfo(_T7),[
TypeInfo(TMouseButton),
TypeInfo(TShiftState),
TypeInfo(Integer),
