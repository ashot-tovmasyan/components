...
RegRegisterMethod(TValueListEditor,'AdjustColWidths',TypeInfo(_T2),NoParams, pointer(228));

RegRegisterMethod(TValueListEditor,'AdjustRowCount',TypeInfo(_T3),NoParams, pointer(232));

RegRegisterMethod(TValueListEditor,'DoOnValidate',TypeInfo(_T4),NoParams, pointer(236));

RegRegisterMethod(TValueListEditor,'GetCell',TypeInfo(_T5),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(string)], pointer(240));

RegRegisterMethod(TValueListEditor,'SetCell',TypeInfo(_T6),[
TypeInfo(Integer),
TypeInfo(Integer),
TypeInfo(string)], pointer(244));

RegRegisterMethod(TValueListEditor,'SetStrings',TypeInfo(_T7),[
TypeInfo(TStrings)], pointer(248));

RegRegisterMethod(TValueListEditor,'StringsChanging',TypeInfo(_T8),NoParams, pointer(MinVMTOffset - 98));
