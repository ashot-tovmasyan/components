...
procedure __TInspOptForm__CMApplyOptions__Wrapper(__Instance : TInspOptForm;
const p0 : IDispatch);
var
__p0 : ^TMessage;
__i0 : IDispatch;
...
TInspOptForm(__Instance).CMApplyOptions(__p0^);
end;
...
function __DC__Getdcinspopt__InspOptForm(Instance : TObject; Params : PVariantArgList) : OleVariant;
begin
result := VarFromObject(dcinspopt.InspOptForm);
end;

procedure __DC__Setdcinspopt__InspOptForm(Instance : TObject; Params : PVariantArgList);
begin
TObject(dcinspopt.InspOptForm):=(VarToObject(OleVariant(Params^[0])));
end;
...
__RegisteredVars.Add(RegisterVar('InspOptForm',__DC__Getdcinspopt__InspOptForm,__DC__Setdcinspopt__InspOptForm));
end;
...
procedure _mreg_0;
begin
RegRegisterMethod(TInspOptForm,'FormCreate',TypeInfo(_T0),[
TypeInfo(TObject)],Addr(TInspOptForm.FormCreate));

RegRegisterMethod(TInspOptForm,'FormDestroy',TypeInfo(_T1),[
TypeInfo(TObject)],Addr(TInspOptForm.FormDestroy));

RegRegisterMethod(TInspOptForm,'EditAliasClick',TypeInfo(_T2),[
TypeInfo(TObject)],Addr(TInspOptForm.EditAliasClick));

RegRegisterMethod(TInspOptForm,'CMApplyOptions',TypeInfo(_T3),[
TypeInfo(IDispatch)],Addr(__TInspOptForm__CMApplyOptions__Wrapper));
