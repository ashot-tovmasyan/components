...
RegRegisterMethod(TCustomDCDrawTreeView,'InitNode',TypeInfo(_T1),[
TypeInfo(TTreeNode)], pointer(252));

RegRegisterMethod(TCustomDCDrawTreeView,'ClickCheck',TypeInfo(_T2),[
TypeInfo(TTreeNode)], pointer(256));

RegRegisterMethod(TCustomDCDrawTreeView,'DoScroll',TypeInfo(_T3),NoParams, pointer(260));

RegRegisterMethod(TCustomDCDrawTreeView,'GetNodeState',TypeInfo(_T4),[
TypeInfo(TTreeNode),TypeInfo(TDrawNodeStates)], pointer(264));

RegRegisterMethod(TCustomDCDrawTreeView,'SetNodeState',TypeInfo(_T5),[
TypeInfo(TTreeNode),
TypeInfo(TDrawNodeState),
TypeInfo(Boolean)], pointer(268));

RegRegisterMethod(TCustomDCDrawTreeView,'SetNodeStates',TypeInfo(_T6),[
TypeInfo(TTreeNode),
TypeInfo(TDrawNodeStates)], pointer(272));

RegRegisterMethod(TCustomDCDrawTreeView,'DestroyTimers',TypeInfo(_T7),NoParams, pointer(276));

RegRegisterMethod(TCustomDCDrawTreeView,'StoreDrawData',TypeInfo(_T8),[TypeInfo(Boolean)], pointer(280));

RegRegisterMethod(TCustomDCDrawTreeView,'BeginUpdate',TypeInfo(_T9),NoParams, pointer(284));

RegRegisterMethod(TCustomDCDrawTreeView,'EndUpdate',TypeInfo(_T10),NoParams, pointer(288));
...
RegRegisterMethod(TCustomDrawListView,'SelectionChanged',TypeInfo(_T13),NoParams, pointer(296));

RegRegisterMethod(TCustomMSTreeView,'SelectionChanged',TypeInfo(_T14),NoParams, pointer(292));
...
RegRegisterMethod(TCustomMSTreeView,'DeleteSelectedItems',TypeInfo(_T18),NoParams, pointer(296));

RegRegisterMethod(TCustomMSTreeView,'SetItemSelected',TypeInfo(_T19),[
TypeInfo(TTreeNode),
TypeInfo(Boolean)],Addr(TCustomMSTreeView.SetItemSelected));

RegRegisterMethod(TDrawListItems,'InternalAdd',TypeInfo(_T20),[
TypeInfo(Integer),
TypeInfo(string),
TypeInfo(TNodeAttachMode),TypeInfo(TListItem)], pointer(12));

RegRegisterMethod(TDrawListItems,'AssignListItem',TypeInfo(_T21),[
TypeInfo(TListItem),
TypeInfo(TListItem)], pointer(16));
...
RegRegisterMethod(TDrawListItems,'Delete',TypeInfo(_T30),[
...
RegRegisterMethod(TDrawTreeNodes,'InternalAdd',TypeInfo(_T33),[
TypeInfo(TTreeNode),
TypeInfo(string),
TypeInfoPointer,
TypeInfo(TNodeAttachMode),TypeInfo(TTreeNode)], pointer(12));

RegRegisterMethod(TDrawTreeNodes,'GetNodeFromIndex',TypeInfo(_T34),[
TypeInfo(Integer),TypeInfo(TTreeNode)], pointer(16));
...
RegRegisterMethod(TDrawTreeNodes,'Delete',TypeInfo(_T49),[
TypeInfo(TTreeNode)], pointer(36));
