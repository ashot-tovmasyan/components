...
{_T30 = function (p0 : PTypeInfo): PTypeData of object;}

{_T31 = function (p0 : PTypeInfo;
p1 : Integer): string of object;}

{_T32 = function (p0 : PTypeInfo;
const p1 : string): Integer of object;}

{_T34 = procedure (p0 : PTypeInfo;
p1 : PPropList) of object;}

{_T36 = procedure (p0 : PPropList;
p1 : Integer) of object;}

{_T38 = function (p0 : PPropInfo;
const p1 : string): Integer of object;}

_T39 = function (const p0 : IDispatch): TObject of object;
...
function ____GetPropValue__Wrapper(cArgs : integer; pArgs : PArgList) : OleVariant;
begin
case cArgs of
2:
begin
result := GetPropValue(TObject(VarToObject(OleVariant(pargs^[1]))),OleVariant(pargs^[0]));
end;
3:
begin
result := GetPropValue(TObject(VarToObject(OleVariant(pargs^[2]))),OleVariant(pargs^[1]),OleVariant(pargs^[0]));
end;
end
end;
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[35] ,mkSafeProcedure));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[36] ,mkSafeFunction));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[37] ,pfVar));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[38] ,pfConst));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[39] ,pfArray));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[40] ,pfAddress));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[41] ,pfReference));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[42] ,pfOut));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[43] ,ifHasGuid));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[44] ,ifDispInterface));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[45] ,ifDispatch));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[46] ,VarFromSet(tkAny, sizeof(tkAny))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[47] ,VarFromSet(tkMethods, sizeof(tkMethods))));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[48] ,VarFromSet(tkProperties, sizeof(tkProperties))));
end;
...
RegisterProc(nil,MethodNames[25],mtScriptProc,TypeInfo(_T27),[
TypeInfo(TObject),
TypeInfo(string),
...
RegRegisterMethod(TPublishableVariantType,'GetInstance',TypeInfo(_T39),[
TypeInfo(IDispatch),TypeInfo(TObject)], pointer(76));
...
{RegisterProc(nil,'GetTypeData',mtProc,TypeInfo(_T30),[
TypeInfoPointer,TypeInfoPointer],Addr(GetTypeData),cRegister)}

{RegisterProc(nil,'GetEnumName',mtProc,TypeInfo(_T31),[
TypeInfoPointer,
TypeInfo(Integer),TypeInfo(string)],Addr(GetEnumName),cRegister)}

{RegisterProc(nil,'GetEnumValue',mtProc,TypeInfo(_T32),[
TypeInfoPointer,
TypeInfo(string),TypeInfo(Integer)],Addr(GetEnumValue),cRegister)}

{RegisterProc(nil,'GetPropInfos',mtProc,TypeInfo(_T34),[
TypeInfoPointer,
TypeInfoPointer],Addr(GetPropInfos),cRegister)}

{RegisterProc(nil,'SortPropList',mtProc,TypeInfo(_T36),[
TypeInfoPointer,
TypeInfo(Integer)],Addr(SortPropList),cRegister)}

{RegisterProc(nil,'StringToSet',mtProc,TypeInfo(_T38),[
TypeInfoPointer,
