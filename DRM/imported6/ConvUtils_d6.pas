...
RegRegisterMethod(TConvTypeInfo,'ToCommon',TypeInfo(_T32),[
TypeInfo(Double),TypeInfo(Double)], pointer(0));

RegRegisterMethod(TConvTypeInfo,'FromCommon',TypeInfo(_T33),[
TypeInfo(Double),TypeInfo(Double)], pointer(4));
