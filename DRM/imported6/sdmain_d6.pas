...
RegRegisterMethod(TRecordList,'Compare',TypeInfo(_T21),[
TypeInfoPointer,
TypeInfoPointer,TypeInfo(Integer)], pointer(0));

RegRegisterMethod(TRecordList,'GetItem',TypeInfo(_T22),[
TypeInfo(Integer),TypeInfoPointer], pointer(4));

RegRegisterMethod(TRecordList,'InternalDelete',TypeInfo(_T23),[
TypeInfo(Integer)], pointer(8));

RegRegisterMethod(TRecordList,'SetItem',TypeInfo(_T24),[
TypeInfo(Integer),
TypeInfoPointer], pointer(12));

RegRegisterMethod(TRecordList,'SetCapacity',TypeInfo(_T25),[
TypeInfo(Integer)], pointer(16));

RegRegisterMethod(TRecordList,'SetCount',TypeInfo(_T26),[
...
RegRegisterMethod(TRecordList,'Add',TypeInfo(_T28),[
TypeInfoPointer,TypeInfo(Integer)], pointer(24));

RegRegisterMethod(TRecordList,'Clear',TypeInfo(_T29),NoParams, pointer(28));

RegRegisterMethod(TRecordList,'Delete',TypeInfo(_T30),[
...
RegRegisterMethod(TRecordList,'IndexOf',TypeInfo(_T36),[
TypeInfoPointer,TypeInfo(Integer)], pointer(44));

RegRegisterMethod(TRecordList,'Insert',TypeInfo(_T37),[
TypeInfo(Integer),
TypeInfoPointer], pointer(48));
...
RegRegisterMethod(TScriptProject,'AddBreakPoint',TypeInfo(_T40),[
TypeInfo(TCustomBreakPoint)], pointer(0));

RegRegisterMethod(TScriptProject,'CauseBreak',TypeInfo(_T41),NoParams, pointer(4));

RegRegisterMethod(TScriptProject,'ConnectDebugger',TypeInfo(_T42),[
TypeInfo(TDelphiDebugger)], pointer(8));

RegRegisterMethod(TScriptProject,'DisconnectDebugger',TypeInfo(_T43),NoParams, pointer(12));

RegRegisterMethod(TScriptProject,'Evaluate',TypeInfo(_T44),[
TypeInfo(String),
TypeInfo(Integer),
TypeInfo(Boolean),
...
RegRegisterMethod(TScriptProject,'GetUnitName',TypeInfo(_T49),[
TypeInfo(Integer),TypeInfo(String)], pointer(36));

RegRegisterMethod(TScriptProject,'GetUnits',TypeInfo(_T50),[
TypeInfo(TList)], pointer(40));

RegRegisterMethod(TScriptProject,'GetUnitText',TypeInfo(_T51),[
TypeInfo(Integer),TypeInfo(String)], pointer(44));

RegRegisterMethod(TScriptProject,'GetUnitParser',TypeInfo(_T52),[
TypeInfo(Integer),TypeInfo(TSimpleParser)], pointer(48));

RegRegisterMethod(TScriptProject,'OnDebuggerClose',TypeInfo(_T53),NoParams, pointer(52));

RegRegisterMethod(TScriptProject,'RemoveBreakPoint',TypeInfo(_T54),[
TypeInfo(TCustomBreakPoint)], pointer(56));

RegRegisterMethod(TScriptProject,'ResumeFromBreakPoint',TypeInfo(_T55),[
TypeInfo(TBreakResumeType)], pointer(60));

RegRegisterMethod(TScriptProject,'CheckBreakPoint',TypeInfo(_T56),[
TypeInfo(Integer),
TypeInfo(Integer),TypeInfo(Boolean)], pointer(64));

RegRegisterMethod(TScriptProject,'RunToLine',TypeInfo(_T57),[
TypeInfo(Integer),
TypeInfo(Integer)], pointer(68));

RegRegisterMethod(TScriptProject,'SetBPData',TypeInfo(_T58),[
TypeInfo(TCustomBreakPoint),
TypeInfo(TBreakPointParts)], pointer(72));

RegRegisterMethod(TScriptProject,'GetVarList',TypeInfo(_T59),[
