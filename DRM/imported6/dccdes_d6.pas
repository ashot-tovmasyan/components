...
RegRegisterMethod(TStringsCodeDesigner,'GetMethodEnd',TypeInfo(_T6),[
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(140));

RegRegisterMethod(TStringsCodeDesigner,'FindMethod',TypeInfo(_T7),[
TypeInfo(string),
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(144));

RegRegisterMethod(TStringsCodeDesigner,'FindMethodStart',TypeInfo(_T8),[
TypeInfo(string),
TypeInfo(IDispatch),TypeInfo(Boolean)], pointer(148));
...
RegRegisterMethod(TStringsCodeDesigner,'GetMethodStart',TypeInfo(_T12),[
TypeInfo(IDispatch),TypeInfo(IDispatch)], pointer(164));
...
RegRegisterMethod(TStringsCodeDesigner,'IdentsEqual',TypeInfo(_T19),[
TypeInfo(string),
TypeInfo(string),TypeInfo(Boolean)], pointer(192));
