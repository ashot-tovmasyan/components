...
RegRegisterMethod(TDSProject,'SuspendThread',TypeInfo(_T2),[
TypeInfo(TDSUnit),
TypeInfo(Integer),
TypeInfo(Boolean),TypeInfo(Boolean)], pointer(4));

RegRegisterMethod(TDSProject,'CheckBreakPoint',TypeInfo(_T3),[
TypeInfo(TDSUnit),
TypeInfo(Integer),TypeInfo(Boolean)], pointer(8));

RegRegisterMethod(TDSProject,'AddUnit',TypeInfo(_T4),[
TypeInfo(TDSUnit)], pointer(12));

RegRegisterMethod(TDSProject,'RemoveUnit',TypeInfo(_T5),[
TypeInfo(TDSUnit)], pointer(16));

RegRegisterMethod(TDSProject,'OnException',TypeInfo(_T6),[
TypeInfo(Exception),
TypeInfo(TDSUnit),
