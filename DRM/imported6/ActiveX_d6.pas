...
p1 : Word;
out p2 : TOleDate): Integer of object;

_T109 = function (p0 : TOleDate;
out p1 : Word;
out p2 : Word): Integer of object;

_T110 = function (const p0 : IDispatch;
out p1 : TOleDate): Integer of object;
...
{_T116 = function (p0 : PSafeArray;
p1 : PSafeArray): HRESULT of object;}

{_T117 = function (p0 : PSafeArray): HRESULT of object;}

{_T118 = function (p0 : PSafeArray): HRESULT of object;}

{_T119 = function (p0 : PSafeArray): HRESULT of object;}

{_T121 = function (p0 : PSafeArray): Integer of object;}

{_T122 = function (p0 : PSafeArray): Integer of object;}

{_T123 = function (p0 : PSafeArray;
p1 : Integer;
out p2 : Longint): HRESULT of object;}

{_T124 = function (p0 : PSafeArray;
p1 : Integer;
out p2 : Longint): HRESULT of object;}

{_T125 = function (p0 : PSafeArray): HRESULT of object;}

{_T126 = function (p0 : PSafeArray): HRESULT of object;}

{_T127 = function (p0 : PSafeArray;
...
_T133 = procedure (var p0 : OleVariant) of object;

_T134 = function (var p0 : OleVariant): HRESULT of object;

_T135 = function (var p0 : OleVariant;
...
_T138 = function (var p0 : OleVariant;
const p1 : OleVariant;
p2 : TLCID;
p3 : Word;
p4 : TVarType): HRESULT of object;

{_T139 = function (p0 : TBStr;
out p1 : PSafeArray): HRESULT of object;}

{_T140 = function (p0 : PSafeArray;
out p1 : TBStr): HRESULT of object;}

{_T141 = function (p0 : TSysKind;
p1 : TLCID;
p2 : POleStr): Longint of object;}

{_T142 = function (p0 : TSysKind;
p1 : TLCID;
p2 : PChar): Longint of object;}

{_T143 = function (p0 : TLCID;
p1 : POleStr): Longint of object;}

_T144 = function (p0 : Longint): Word of object;

_T145 = function (p0 : Longint;
p1 : Longint): Boolean of object;

{_T146 = function (p0 : POleStr;
out p1 : ITypeLib): HRESULT of object;}

{_T147 = function (p0 : POleStr;
p1 : TRegKind;
out p2 : ITypeLib): HRESULT of object;}

_T149 = function (const p0 : IDispatch;
p1 : Word;
p2 : Word;
p3 : TLCID;
out p4 : WideString): HRESULT of object;

{_T150 = function (p0 : ITypeLib;
p1 : POleStr;
...
_T161 = function (p0 : Longint;
p1 : Pointer): HRESULT of object;

{_T163 = function (p0 : Longint;
p1 : IErrorInfo): HRESULT of object;}

{_T164 = function (p0 : Longint;
out p1 : IErrorInfo): HRESULT of object;}

{_T165 = function (out p0 : ICreateErrorInfo): HRESULT of object;}

_T166 = _T9;

_T167 = procedure (const p0 : IDispatch) of object;

_T168 = _T15;

{_T173 = function (p0 : IStorage;
p1 : TClipFormat;
p2 : POleStr): HRESULT of object;}

{_T174 = function (p0 : IStorage;
out p1 : TClipFormat;
...
{_T177 = function (p0 : IDataObject): HRESULT of object;}

{_T178 = function (p0 : IDataObject): HRESULT of object;}

{_T193 = function (p0 : IPersistStorage;
p1 : IStorage;
p2 : BOOL): HRESULT of object;}

{_T195 = function (p0 : IPersistStream;
p1 : IStream): HRESULT of object;}

{_T196 = function (p0 : IUnknown;
p1 : BOOL): HRESULT of object;}

{_T197 = function (p0 : IUnknown;
p1 : BOOL): HRESULT of object;}

{_T198 = function (p0 : HWND;
p1 : IDropTarget): HRESULT of object;}

_T199 = function (p0 : HWND): HRESULT of object;

{_T200 = function (p0 : IDataObject;
p1 : IDropSource;
p2 : Longint;
var p3 : Longint): HRESULT of object;}

{_T201 = function (p0 : IDataObject): HRESULT of object;}

{_T202 = function (out p0 : IDataObject): HRESULT of object;}

_T203 = _T15;

{_T204 = function (p0 : IDataObject): HRESULT of object;}

_T205 = function (p0 : HMenu;
const p1 : IDispatch): HMenu of object;

{_T206 = function (p0 : HMenu;
p1 : HWND;
p2 : HWND;
p3 : IOleInPlaceFrame;
p4 : IOleInPlaceActiveObject): HRESULT of object;}

_T207 = function (p0 : HMenu): HRESULT of object;

_T209 = function (p0 : THandle;
p1 : TClipFormat;
p2 : Integer): THandle of object;

{_T211 = function (p0 : IUnknown): HRESULT of object;}

{_T212 = function (p0 : IOleObject): BOOL of object;}

{_T213 = function (p0 : IUnknown;
p1 : BOOL;
p2 : BOOL): HRESULT of object;}

_T214 = _T167;

{_T215 = function (out p0 : IOleAdviseHolder): HRESULT of object;}

{_T218 = function (p0 : hAccel;
p1 : Integer;
p2 : PMsg;
var p3 : Word): BOOL of object;}

{_T219 = function (p0 : POleStr;
p1 : BOOL): hGlobal of object;}

{_T221 = function (p0 : hIcon;
p1 : POleStr;
p2 : POleStr;
p3 : Integer): hGlobal of object;}

{_T226 = function (p0 : IStorage;
p1 : Pointer): HRESULT of object;}

{_T227 = function (p0 : Pointer;
p1 : IStorage;
p2 : PDVTargetDevice): HRESULT of object;}

{_T230 = function (p0 : ILockBytes;
out p1 : hGlobal): HRESULT of object;}

{_T231 = function (p0 : hGlobal;
p1 : BOOL;
out p2 : ILockBytes): HRESULT of object;}

{_T232 = function (p0 : IStream;
out p1 : hGlobal): HRESULT of object;}
...
{_T237 = function (p0 : IStorage): HRESULT of object;}

{_T238 = function (p0 : IStorage;
p1 : BOOL): HRESULT of object;}
...
_T241 = function (p0 : TOleColor;
p1 : HPALETTE;
out p2 : TColorRef): HRESULT of object;

{_T246 = function (p0 : OleVariant;
var p1 : IDispatch): HRESULT of object;}

{_T247 = function (p0 : IDispatch;
p1 : TBStr): HRESULT of object;}

_T248 = function (p0 : THandle;
p1 : THandle): HCursor of object;

_T249 = function (p0 : DWORD): Word of object;

_T250 = function (p0 : DWORD): Byte of object;
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[104] ,STGM_READ));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[105] ,STGM_WRITE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[106] ,STGM_READWRITE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[107] ,STGM_SHARE_DENY_NONE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[108] ,STGM_SHARE_DENY_READ));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[109] ,STGM_SHARE_DENY_WRITE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[110] ,STGM_SHARE_EXCLUSIVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[111] ,STGM_PRIORITY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[112] ,STGM_DELETEONRELEASE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[113] ,STGM_NOSCRATCH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[114] ,STGM_CREATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[115] ,STGM_CONVERT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[116] ,STGM_FAILIFTHERE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[117] ,FADF_AUTO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[118] ,FADF_STATIC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[119] ,FADF_EMBEDDED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[120] ,FADF_FIXEDSIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[121] ,FADF_BSTR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[122] ,FADF_UNKNOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[123] ,FADF_DISPATCH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[124] ,FADF_VARIANT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[125] ,FADF_RESERVED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[126] ,VT_EMPTY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[127] ,VT_NULL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[128] ,VT_I2));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[129] ,VT_I4));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[130] ,VT_R4));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[131] ,VT_R8));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[132] ,VT_CY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[133] ,VT_DATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[134] ,VT_BSTR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[135] ,VT_DISPATCH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[136] ,VT_ERROR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[137] ,VT_BOOL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[138] ,VT_VARIANT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[139] ,VT_UNKNOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[140] ,VT_DECIMAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[141] ,VT_I1));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[142] ,VT_UI1));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[143] ,VT_UI2));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[144] ,VT_UI4));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[145] ,VT_I8));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[146] ,VT_UI8));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[147] ,VT_INT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[148] ,VT_UINT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[149] ,VT_VOID));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[150] ,VT_HRESULT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[151] ,VT_PTR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[152] ,VT_SAFEARRAY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[153] ,VT_CARRAY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[154] ,VT_USERDEFINED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[155] ,VT_LPSTR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[156] ,VT_LPWSTR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[157] ,VT_FILETIME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[158] ,VT_BLOB));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[159] ,VT_STREAM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[160] ,VT_STORAGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[161] ,VT_STREAMED_OBJECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[162] ,VT_STORED_OBJECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[163] ,VT_BLOB_OBJECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[164] ,VT_CF));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[165] ,VT_CLSID));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[166] ,VT_VECTOR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[167] ,VT_ARRAY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[168] ,VT_BYREF));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[169] ,VT_RESERVED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[170] ,VT_ILLEGAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[171] ,VT_ILLEGALMASKED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[172] ,VT_TYPEMASK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[173] ,TKIND_ENUM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[174] ,TKIND_RECORD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[175] ,TKIND_MODULE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[176] ,TKIND_INTERFACE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[177] ,TKIND_DISPATCH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[178] ,TKIND_COCLASS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[179] ,TKIND_ALIAS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[180] ,TKIND_UNION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[181] ,TKIND_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[182] ,TKIND_TYPELIB));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[183] ,TKIND_FUNC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[184] ,TKIND_VAR));
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[261] ,DESCKIND_NONE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[262] ,DESCKIND_FUNCDESC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[263] ,DESCKIND_VARDESC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[264] ,DESCKIND_TYPECOMP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[265] ,DESCKIND_IMPLICITAPPOBJ));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[266] ,DESCKIND_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[267] ,SYS_WIN16));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[268] ,SYS_WIN32));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[269] ,SYS_MAC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[270] ,LIBFLAG_FRESTRICTED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[271] ,LIBFLAG_FCONTROL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[272] ,LIBFLAG_FHIDDEN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[273] ,LIBFLAG_FHASDISKIMAGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[274] ,STDOLE_MAJORVERNUM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[275] ,STDOLE_MINORVERNUM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[276] ,STDOLE_LCID));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[277] ,VARIANT_NOVALUEPROP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[278] ,VAR_TIMEVALUEONLY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[279] ,VAR_DATEVALUEONLY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[280] ,MEMBERID_NIL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[281] ,ID_DEFAULTINST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[282] ,DISPATCH_METHOD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[283] ,DISPATCH_PROPERTYGET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[284] ,DISPATCH_PROPERTYPUT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[285] ,DISPATCH_PROPERTYPUTREF));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[286] ,DISPATCH_CONSTRUCT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[287] ,IDLFLAG_NONE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[288] ,IDLFLAG_FIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[289] ,IDLFLAG_FOUT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[290] ,IDLFLAG_FLCID));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[291] ,IDLFLAG_FRETVAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[292] ,PARAMFLAG_NONE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[293] ,PARAMFLAG_FIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[294] ,PARAMFLAG_FOUT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[295] ,PARAMFLAG_FLCID));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[296] ,PARAMFLAG_FRETVAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[297] ,PARAMFLAG_FOPT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[298] ,PARAMFLAG_FHASDEFAULT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[299] ,OLEIVERB_PRIMARY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[300] ,OLEIVERB_SHOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[301] ,OLEIVERB_OPEN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[302] ,OLEIVERB_HIDE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[303] ,OLEIVERB_UIACTIVATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[304] ,OLEIVERB_INPLACEACTIVATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[305] ,OLEIVERB_DISCARDUNDOSTATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[306] ,EMBDHLP_INPROC_HANDLER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[307] ,EMBDHLP_INPROC_SERVER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[308] ,EMBDHLP_CREATENOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[309] ,EMBDHLP_DELAYCREATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[310] ,OLECREATE_LEAVERUNNING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[311] ,UPDFCACHE_NODATACACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[312] ,UPDFCACHE_ONSAVECACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[313] ,UPDFCACHE_ONSTOPCACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[314] ,UPDFCACHE_NORMALCACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[315] ,UPDFCACHE_IFBLANK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[316] ,UPDFCACHE_ONLYIFBLANK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[317] ,UPDFCACHE_IFBLANKORONSAVECACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[318] ,UPDFCACHE_ALL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[319] ,UPDFCACHE_ALLBUTNODATACACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[320] ,DISCARDCACHE_SAVEIFDIRTY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[321] ,DISCARDCACHE_NOSAVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[322] ,OLEGETMONIKER_ONLYIFTHERE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[323] ,OLEGETMONIKER_FORCEASSIGN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[324] ,OLEGETMONIKER_UNASSIGN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[325] ,OLEGETMONIKER_TEMPFORUSER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[326] ,OLEWHICHMK_CONTAINER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[327] ,OLEWHICHMK_OBJREL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[328] ,OLEWHICHMK_OBJFULL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[329] ,USERCLASSTYPE_FULL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[330] ,USERCLASSTYPE_SHORT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[331] ,USERCLASSTYPE_APPNAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[332] ,OLEMISC_RECOMPOSEONRESIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[333] ,OLEMISC_ONLYICONIC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[334] ,OLEMISC_INSERTNOTREPLACE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[335] ,OLEMISC_STATIC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[336] ,OLEMISC_CANTLINKINSIDE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[337] ,OLEMISC_CANLINKBYOLE1));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[338] ,OLEMISC_ISLINKOBJECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[339] ,OLEMISC_INSIDEOUT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[340] ,OLEMISC_ACTIVATEWHENVISIBLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[341] ,OLEMISC_RENDERINGISDEVICEINDEPENDENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[342] ,OLEMISC_INVISIBLEATRUNTIME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[343] ,OLEMISC_ALWAYSRUN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[344] ,OLEMISC_ACTSLIKEBUTTON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[345] ,OLEMISC_ACTSLIKELABEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[346] ,OLEMISC_NOUIACTIVATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[347] ,OLEMISC_ALIGNABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[348] ,OLEMISC_SIMPLEFRAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[349] ,OLEMISC_SETCLIENTSITEFIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[350] ,OLEMISC_IMEMODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[351] ,OLEMISC_IGNOREACTIVATEWHENVISIBLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[352] ,OLEMISC_WANTSTOMENUMERGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[353] ,OLEMISC_SUPPORTSMULTILEVELUNDO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[354] ,OLECLOSE_SAVEIFDIRTY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[355] ,OLECLOSE_NOSAVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[356] ,OLECLOSE_PROMPTSAVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[357] ,OLERENDER_NONE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[358] ,OLERENDER_DRAW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[359] ,OLERENDER_FORMAT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[360] ,OLERENDER_ASIS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[361] ,OLEUPDATE_ALWAYS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[362] ,OLEUPDATE_ONCALL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[363] ,OLELINKBIND_EVENIFCLASSDIFF));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[364] ,BINDSPEED_INDEFINITE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[365] ,BINDSPEED_MODERATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[366] ,BINDSPEED_IMMEDIATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[367] ,OLECONTF_EMBEDDINGS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[368] ,OLECONTF_LINKS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[369] ,OLECONTF_OTHERS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[370] ,OLECONTF_ONLYUSER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[371] ,OLECONTF_ONLYIFRUNNING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[372] ,DROPEFFECT_NONE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[373] ,DROPEFFECT_COPY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[374] ,DROPEFFECT_MOVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[375] ,DROPEFFECT_LINK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[376] ,DROPEFFECT_SCROLL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[377] ,MK_ALT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[378] ,DD_DEFSCROLLINSET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[379] ,DD_DEFSCROLLDELAY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[380] ,DD_DEFSCROLLINTERVAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[381] ,DD_DEFDRAGDELAY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[382] ,DD_DEFDRAGMINDIST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[383] ,OLEVERBATTRIB_NEVERDIRTIES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[384] ,OLEVERBATTRIB_ONCONTAINERMENU));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[385] ,CTL_E_ILLEGALFUNCTIONCALL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[386] ,CTL_E_OVERFLOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[387] ,CTL_E_OUTOFMEMORY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[388] ,CTL_E_DIVISIONBYZERO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[389] ,CTL_E_OUTOFSTRINGSPACE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[390] ,CTL_E_OUTOFSTACKSPACE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[391] ,CTL_E_BADFILENAMEORNUMBER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[392] ,CTL_E_FILENOTFOUND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[393] ,CTL_E_BADFILEMODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[394] ,CTL_E_FILEALREADYOPEN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[395] ,CTL_E_DEVICEIOERROR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[396] ,CTL_E_FILEALREADYEXISTS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[397] ,CTL_E_BADRECORDLENGTH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[398] ,CTL_E_DISKFULL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[399] ,CTL_E_BADRECORDNUMBER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[400] ,CTL_E_BADFILENAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[401] ,CTL_E_TOOMANYFILES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[402] ,CTL_E_DEVICEUNAVAILABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[403] ,CTL_E_PERMISSIONDENIED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[404] ,CTL_E_DISKNOTREADY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[405] ,CTL_E_PATHFILEACCESSERROR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[406] ,CTL_E_PATHNOTFOUND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[407] ,CTL_E_INVALIDPATTERNSTRING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[408] ,CTL_E_INVALIDUSEOFNULL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[409] ,CTL_E_INVALIDFILEFORMAT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[410] ,CTL_E_INVALIDPROPERTYVALUE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[411] ,CTL_E_INVALIDPROPERTYARRAYINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[412] ,CTL_E_SETNOTSUPPORTEDATRUNTIME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[413] ,CTL_E_SETNOTSUPPORTED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[414] ,CTL_E_NEEDPROPERTYARRAYINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[415] ,CTL_E_SETNOTPERMITTED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[416] ,CTL_E_GETNOTSUPPORTEDATRUNTIME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[417] ,CTL_E_GETNOTSUPPORTED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[418] ,CTL_E_PROPERTYNOTFOUND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[419] ,CTL_E_INVALIDCLIPBOARDFORMAT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[420] ,CTL_E_INVALIDPICTURE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[421] ,CTL_E_PRINTERERROR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[422] ,CTL_E_CANTSAVEFILETOTEMP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[423] ,CTL_E_SEARCHTEXTNOTFOUND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[424] ,CTL_E_REPLACEMENTSTOOLONG));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[425] ,CTL_E_CUSTOM_FIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[426] ,CLASS_E_NOTLICENSED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[427] ,CONNECT_E_FIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[428] ,CONNECT_E_LAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[429] ,CONNECT_S_FIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[430] ,CONNECT_S_LAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[431] ,CONNECT_E_NOCONNECTION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[432] ,CONNECT_E_ADVISELIMIT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[433] ,CONNECT_E_CANNOTCONNECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[434] ,CONNECT_E_OVERRIDDEN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[435] ,SELFREG_E_FIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[436] ,SELFREG_E_LAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[437] ,SELFREG_S_FIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[438] ,SELFREG_S_LAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[439] ,SELFREG_E_TYPELIB));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[440] ,SELFREG_E_CLASS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[441] ,PERPROP_E_FIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[442] ,PERPROP_E_LAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[443] ,PERPROP_S_FIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[444] ,PERPROP_S_LAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[445] ,PERPROP_E_NOPAGEAVAILABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[446] ,OLEIVERB_PROPERTIES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[447] ,VT_STREAMED_PROPSET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[448] ,VT_STORED_PROPSET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[449] ,VT_BLOB_PROPSET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[450] ,VT_VERBOSE_ENUM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[451] ,VT_COLOR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[452] ,VT_XPOS_PIXELS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[453] ,VT_YPOS_PIXELS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[454] ,VT_XSIZE_PIXELS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[455] ,VT_YSIZE_PIXELS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[456] ,VT_XPOS_HIMETRIC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[457] ,VT_YPOS_HIMETRIC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[458] ,VT_XSIZE_HIMETRIC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[459] ,VT_YSIZE_HIMETRIC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[460] ,VT_TRISTATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[461] ,VT_OPTEXCLUSIVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[462] ,VT_FONT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[463] ,VT_PICTURE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[464] ,VT_HANDLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[465] ,OCM__BASE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[466] ,OCM_COMMAND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[467] ,OCM_CTLCOLORBTN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[468] ,OCM_CTLCOLOREDIT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[469] ,OCM_CTLCOLORDLG));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[470] ,OCM_CTLCOLORLISTBOX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[471] ,OCM_CTLCOLORMSGBOX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[472] ,OCM_CTLCOLORSCROLLBAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[473] ,OCM_CTLCOLORSTATIC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[474] ,OCM_DRAWITEM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[475] ,OCM_MEASUREITEM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[476] ,OCM_DELETEITEM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[477] ,OCM_VKEYTOITEM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[478] ,OCM_CHARTOITEM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[479] ,OCM_COMPAREITEM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[480] ,OCM_HSCROLL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[481] ,OCM_VSCROLL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[482] ,OCM_PARENTNOTIFY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[483] ,OCM_NOTIFY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[484] ,CTRLINFO_EATS_RETURN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[485] ,CTRLINFO_EATS_ESCAPE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[486] ,XFORMCOORDS_POSITION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[487] ,XFORMCOORDS_SIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[488] ,XFORMCOORDS_HIMETRICTOCONTAINER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[489] ,XFORMCOORDS_CONTAINERTOHIMETRIC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[490] ,PROPPAGESTATUS_DIRTY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[491] ,PROPPAGESTATUS_VALIDATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[492] ,PROPPAGESTATUS_CLEAN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[493] ,PICTURE_SCALABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[494] ,PICTURE_TRANSPARENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[495] ,PICTYPE_UNINITIALIZED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[496] ,PICTYPE_NONE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[497] ,PICTYPE_BITMAP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[498] ,PICTYPE_METAFILE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[499] ,PICTYPE_ICON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[500] ,PICTYPE_ENHMETAFILE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[501] ,DISPID_AUTOSIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[502] ,DISPID_BACKCOLOR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[503] ,DISPID_BACKSTYLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[504] ,DISPID_BORDERCOLOR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[505] ,DISPID_BORDERSTYLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[506] ,DISPID_BORDERWIDTH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[507] ,DISPID_DRAWMODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[508] ,DISPID_DRAWSTYLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[509] ,DISPID_DRAWWIDTH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[510] ,DISPID_FILLCOLOR));
end;
...
const __ConstNames1 : array[0..197] of string = (
'DISPID_FILLSTYLE'
,'DISPID_FONT'
,'DISPID_FORECOLOR'
,'DISPID_ENABLED'
...
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[0] ,DISPID_FILLSTYLE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[1] ,DISPID_FONT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[2] ,DISPID_FORECOLOR));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[3] ,DISPID_ENABLED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[4] ,DISPID_HWND));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[5] ,DISPID_TABSTOP));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[6] ,DISPID_TEXT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[7] ,DISPID_CAPTION));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[8] ,DISPID_BORDERVISIBLE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[9] ,DISPID_APPEARANCE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[10] ,DISPID_MOUSEPOINTER));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[11] ,DISPID_MOUSEICON));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[12] ,DISPID_PICTURE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[13] ,DISPID_VALID));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[14] ,DISPID_READYSTATE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[15] ,DISPID_REFRESH));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[16] ,DISPID_DOCLICK));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[17] ,DISPID_ABOUTBOX));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[18] ,DISPID_CLICK));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[19] ,DISPID_DBLCLICK));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[20] ,DISPID_KEYDOWN));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[21] ,DISPID_KEYPRESS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[22] ,DISPID_KEYUP));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[23] ,DISPID_MOUSEDOWN));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[24] ,DISPID_MOUSEMOVE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[25] ,DISPID_MOUSEUP));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[26] ,DISPID_ERROREVENT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[27] ,DISPID_READYSTATECHANGE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[28] ,DISPID_THIS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[29] ,DISPID_AMBIENT_BACKCOLOR));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[30] ,DISPID_AMBIENT_DISPLAYNAME));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[31] ,DISPID_AMBIENT_FONT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[32] ,DISPID_AMBIENT_FORECOLOR));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[33] ,DISPID_AMBIENT_LOCALEID));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[34] ,DISPID_AMBIENT_MESSAGEREFLECT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[35] ,DISPID_AMBIENT_SCALEUNITS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[36] ,DISPID_AMBIENT_TEXTALIGN));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[37] ,DISPID_AMBIENT_USERMODE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[38] ,DISPID_AMBIENT_UIDEAD));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[39] ,DISPID_AMBIENT_SHOWGRABHANDLES));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[40] ,DISPID_AMBIENT_SHOWHATCHING));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[41] ,DISPID_AMBIENT_DISPLAYASDEFAULT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[42] ,DISPID_AMBIENT_SUPPORTSMNEMONICS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[43] ,DISPID_AMBIENT_AUTOCLIP));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[44] ,DISPID_AMBIENT_APPEARANCE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[45] ,DISPID_AMBIENT_PALETTE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[46] ,DISPID_AMBIENT_TRANSFERPRIORITY));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[47] ,DISPID_Name));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[48] ,DISPID_Delete));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[49] ,DISPID_Object));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[50] ,DISPID_Parent));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[51] ,DISPID_FONT_NAME));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[52] ,DISPID_FONT_SIZE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[53] ,DISPID_FONT_BOLD));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[54] ,DISPID_FONT_ITALIC));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[55] ,DISPID_FONT_UNDER));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[56] ,DISPID_FONT_STRIKE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[57] ,DISPID_FONT_WEIGHT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[58] ,DISPID_FONT_CHARSET));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[59] ,DISPID_PICT_HANDLE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[60] ,DISPID_PICT_HPAL));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[61] ,DISPID_PICT_TYPE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[62] ,DISPID_PICT_WIDTH));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[63] ,DISPID_PICT_HEIGHT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[64] ,DISPID_PICT_RENDER));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[65] ,PID_DICTIONARY));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[66] ,PID_CODEPAGE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[67] ,PID_FIRST_USABLE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[68] ,PID_FIRST_NAME_DEFAULT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[69] ,PID_LOCALE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[70] ,PID_MODIFY_TIME));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[71] ,PID_SECURITY));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[72] ,PID_ILLEGAL));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[73] ,PIDSI_TITLE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[74] ,PIDSI_SUBJECT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[75] ,PIDSI_AUTHOR));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[76] ,PIDSI_KEYWORDS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[77] ,PIDSI_COMMENTS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[78] ,PIDSI_TEMPLATE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[79] ,PIDSI_LASTAUTHOR));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[80] ,PIDSI_REVNUMBER));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[81] ,PIDSI_EDITTIME));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[82] ,PIDSI_LASTPRINTED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[83] ,PIDSI_CREATE_DTM));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[84] ,PIDSI_LASTSAVE_DTM));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[85] ,PIDSI_PAGECOUNT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[86] ,PIDSI_WORDCOUNT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[87] ,PIDSI_CHARCOUNT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[88] ,PIDSI_THUMBNAIL));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[89] ,PIDSI_APPNAME));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[90] ,PIDSI_DOC_SECURITY));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[91] ,PRSPEC_INVALID));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[92] ,PRSPEC_LPWSTR));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[93] ,PRSPEC_PROPID));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[94] ,triUnchecked));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[95] ,triChecked));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[96] ,triGray));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[97] ,REGKIND_DEFAULT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[98] ,REGKIND_REGISTER));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[99] ,REGKIND_NONE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[100] ,PRINTFLAG_MAYBOTHERUSER));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[101] ,PRINTFLAG_PROMPTUSER));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[102] ,PRINTFLAG_USERMAYCHANGEPRINTER));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[103] ,PRINTFLAG_RECOMPOSETODEVICE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[104] ,PRINTFLAG_DONTACTUALLYPRINT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[105] ,PRINTFLAG_FORCEPROPERTIES));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[106] ,PRINTFLAG_PRINTTOFILE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[107] ,PAGESET_TOLASTPAGE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[108] ,OLECMDIDF_REFRESH_NORMAL));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[109] ,OLECMDIDF_REFRESH_IFEXPIRED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[110] ,OLECMDIDF_REFRESH_CONTINUE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[111] ,OLECMDIDF_REFRESH_COMPLETELY));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[112] ,OLECMDF_SUPPORTED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[113] ,OLECMDF_ENABLED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[114] ,OLECMDF_LATCHED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[115] ,OLECMDF_NINCHED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[116] ,OLECMDTEXTF_NONE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[117] ,OLECMDTEXTF_NAME));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[118] ,OLECMDTEXTF_STATUS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[119] ,OLECMDEXECOPT_DODEFAULT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[120] ,OLECMDEXECOPT_PROMPTUSER));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[121] ,OLECMDEXECOPT_DONTPROMPTUSER));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[122] ,OLECMDEXECOPT_SHOWHELP));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[123] ,OLECMDID_OPEN));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[124] ,OLECMDID_NEW));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[125] ,OLECMDID_SAVE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[126] ,OLECMDID_SAVEAS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[127] ,OLECMDID_SAVECOPYAS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[128] ,OLECMDID_PRINT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[129] ,OLECMDID_PRINTPREVIEW));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[130] ,OLECMDID_PAGESETUP));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[131] ,OLECMDID_SPELL));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[132] ,OLECMDID_PROPERTIES));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[133] ,OLECMDID_CUT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[134] ,OLECMDID_COPY));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[135] ,OLECMDID_PASTE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[136] ,OLECMDID_PASTESPECIAL));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[137] ,OLECMDID_UNDO));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[138] ,OLECMDID_REDO));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[139] ,OLECMDID_SELECTALL));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[140] ,OLECMDID_CLEARSELECTION));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[141] ,OLECMDID_ZOOM));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[142] ,OLECMDID_GETZOOMRANGE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[143] ,OLECMDID_UPDATECOMMANDS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[144] ,OLECMDID_REFRESH));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[145] ,OLECMDID_STOP));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[146] ,OLECMDID_HIDETOOLBARS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[147] ,OLECMDID_SETPROGRESSMAX));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[148] ,OLECMDID_SETPROGRESSPOS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[149] ,OLECMDID_SETPROGRESSTEXT));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[150] ,OLECMDID_SETTITLE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[151] ,OLECMDID_SETDOWNLOADSTATE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[152] ,OLECMDID_STOPDOWNLOAD));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[153] ,OLECMDERR_E_FIRST));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[154] ,OLECMDERR_E_NOTSUPPORTED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[155] ,OLECMDERR_E_DISABLED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[156] ,OLECMDERR_E_NOHELP));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[157] ,OLECMDERR_E_CANCELED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[158] ,OLECMDERR_E_UNKNOWNGROUP));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[159] ,MSOCMDERR_E_FIRST));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[160] ,MSOCMDERR_E_NOTSUPPORTED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[161] ,MSOCMDERR_E_DISABLED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[162] ,MSOCMDERR_E_NOHELP));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[163] ,MSOCMDERR_E_CANCELED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[164] ,MSOCMDERR_E_UNKNOWNGROUP));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[165] ,INTERFACESAFE_FOR_UNTRUSTED_CALLER));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[166] ,INTERFACESAFE_FOR_UNTRUSTED_DATA));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[167] ,fdexNameCaseSensitive));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[168] ,fdexNameEnsure));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[169] ,fdexNameImplicit));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[170] ,fdexNameCaseInsensitive));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[171] ,fdexPropCanGet));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[172] ,fdexPropCannotGet));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[173] ,fdexPropCanPut));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[174] ,fdexPropCannotPut));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[175] ,fdexPropCanPutRef));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[176] ,fdexPropCannotPutRef));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[177] ,fdexPropNoSideEffects));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[178] ,fdexPropDynamicType));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[179] ,fdexPropCanCall));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[180] ,fdexPropCannotCall));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[181] ,fdexPropCanConstruct));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[182] ,fdexPropCannotConstruct));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[183] ,fdexPropCanSourceEvents));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[184] ,fdexPropCannotSourceEvents));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[185] ,fdexPropCanAll));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[186] ,fdexPropCannotAll));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[187] ,fdexPropExtraAll));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[188] ,fdexPropAll));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[189] ,fdexEnumDefault));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[190] ,fdexEnumAll));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[191] ,COINIT_MULTITHREADED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[192] ,COINIT_APARTMENTTHREADED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[193] ,COINIT_DISABLE_OLE1DDE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[194] ,COINIT_SPEED_OVER_MEMORY));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[195] ,ACTIVEOBJECT_STRONG));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[196] ,ACTIVEOBJECT_WEAK));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[197] ,PROPSETHDR_OSVERSION_UNKNOWN));
end;
...
RegisterProc(nil,MethodNames[280],mtProc,TypeInfo(_T133),[
TypeInfo(OleVariant)],Addr(VariantInit),cStdCall);

RegisterProc(nil,MethodNames[281],mtProc,TypeInfo(_T134),[
TypeInfo(OleVariant),TypeInfo(HRESULT)],Addr(VariantClear),cStdCall);

RegisterProc(nil,MethodNames[282],mtProc,TypeInfo(_T135),[
TypeInfo(OleVariant),
TypeInfo(OleVariant),TypeInfo(HRESULT)],Addr(VariantCopy),cStdCall);

RegisterProc(nil,MethodNames[283],mtProc,TypeInfo(_T136),[
TypeInfo(OleVariant),
TypeInfo(OleVariant),TypeInfo(HRESULT)],Addr(VariantCopyInd),cStdCall);

RegisterProc(nil,MethodNames[284],mtProc,TypeInfo(_T137),[
TypeInfo(OleVariant),
TypeInfo(OleVariant),
TypeInfo(Word),
TypeInfo(TVarType),TypeInfo(HRESULT)],Addr(VariantChangeType),cStdCall);

RegisterProc(nil,MethodNames[285],mtProc,TypeInfo(_T138),[
TypeInfo(OleVariant),
TypeInfo(OleVariant),
TypeInfo(TLCID),
TypeInfo(Word),
...
RegisterProc(nil,MethodNames[286],mtProc,TypeInfo(_T144),[
TypeInfo(Longint),TypeInfo(Word)],Addr(WHashValOfLHashVal),cRegister);

RegisterProc(nil,MethodNames[287],mtProc,TypeInfo(_T145),[
TypeInfo(Longint),
TypeInfo(Longint),TypeInfo(Boolean)],Addr(IsHashValCompatible),cRegister);

RegisterProc(nil,MethodNames[288],mtProc,TypeInfo(_T149),[
TypeInfo(IDispatch),
TypeInfo(Word),
TypeInfo(Word),
TypeInfo(TLCID),
...
RegisterProc(nil,MethodNames[289],mtProc,TypeInfo(_T151),[
TypeInfo(IDispatch),
TypeInfo(Word),
TypeInfo(Word),
TypeInfo(TLCID),
...
RegisterProc(nil,MethodNames[290],mtProc,TypeInfo(_T154),[
TypeInfo(IDispatch),
TypeInfo(Integer),
TypeInfo(TVarType),
TypeInfo(OleVariant),
...
RegisterProc(nil,MethodNames[291],mtProc,TypeInfo(_T159),[
TypeInfoPointer,
TypeInfo(Longint),
TypeInfo(TCallConv),
TypeInfo(TVarType),
...
RegisterProc(nil,MethodNames[292],mtProc,TypeInfo(_T161),[
TypeInfo(Longint),
TypeInfoPointer,TypeInfo(HRESULT)],Addr(RevokeActiveObject),cStdCall);

RegisterProc(nil,MethodNames[293],mtProc,TypeInfo(_T166),[TypeInfo(Longint)],Addr(OaBuildVersion),cStdCall);

RegisterProc(nil,MethodNames[294],mtProc,TypeInfo(_T167),[
TypeInfo(IDispatch)],Addr(____ClearCustData__Wrapper),cRegister);

RegisterProc(nil,MethodNames[295],mtProc,TypeInfo(_T168),[TypeInfo(HRESULT)],Addr(OleBuildVersion),cStdCall);

RegisterProc(nil,MethodNames[296],mtProc,TypeInfo(_T175),[
TypeInfoPointer,TypeInfo(HRESULT)],Addr(OleInitialize),cStdCall);

RegisterProc(nil,MethodNames[297],mtProc,TypeInfo(_T176),NoParams,Addr(OleUninitialize),cStdCall);

RegisterProc(nil,MethodNames[298],mtProc,TypeInfo(_T199),[
TypeInfo(HWND),TypeInfo(HRESULT)],Addr(RevokeDragDrop),cStdCall);

RegisterProc(nil,MethodNames[299],mtProc,TypeInfo(_T203),[TypeInfo(HRESULT)],Addr(OleFlushClipboard),cStdCall);

RegisterProc(nil,MethodNames[300],mtProc,TypeInfo(_T205),[
TypeInfo(HMenu),
TypeInfo(IDispatch),TypeInfo(HMenu)],Addr(____OleCreateMenuDescriptor__Wrapper),cRegister);

RegisterProc(nil,MethodNames[301],mtProc,TypeInfo(_T207),[
TypeInfo(HMenu),TypeInfo(HRESULT)],Addr(OleDestroyMenuDescriptor),cStdCall);

RegisterProc(nil,MethodNames[302],mtProc,TypeInfo(_T209),[
TypeInfo(THandle),
TypeInfo(TClipFormat),
TypeInfo(Integer),TypeInfo(THandle)],Addr(OleDuplicateData),cStdCall);

RegisterProc(nil,MethodNames[303],mtProc,TypeInfo(_T214),[
TypeInfo(IDispatch)],Addr(____ReleaseStgMedium__Wrapper),cRegister);

RegisterProc(nil,MethodNames[304],mtProc,TypeInfo(_T240),[
TypeInfo(IDispatch),TypeInfo(HRESULT)],Addr(____OleCreatePropertyFrameIndirect__Wrapper),cRegister);

RegisterProc(nil,MethodNames[305],mtProc,TypeInfo(_T241),[
TypeInfo(TOleColor),
TypeInfo(HPALETTE),
TypeInfo(TColorRef),TypeInfo(HRESULT)],Addr(OleTranslateColor),cStdCall);

RegisterProc(nil,MethodNames[306],mtProc,TypeInfo(_T248),[
TypeInfo(THandle),
TypeInfo(THandle),TypeInfo(HCursor)],Addr(OleIconToCursor),cStdCall);

RegisterProc(nil,MethodNames[307],mtProc,TypeInfo(_T249),[
TypeInfo(DWORD),TypeInfo(Word)],Addr(PROPSETHDR_OSVER_KIND),cRegister);

RegisterProc(nil,MethodNames[308],mtProc,TypeInfo(_T250),[
TypeInfo(DWORD),TypeInfo(Byte)],Addr(PROPSETHDR_OSVER_MAJOR),cRegister);

RegisterProc(nil,MethodNames[309],mtProc,TypeInfo(_T251),[
...
{RegisterProc(nil,'OleLoadPictureFile',mtProc,TypeInfo(_T246),[
TypeInfo(OleVariant),
TypeInfo(IDispatch),TypeInfo(HRESULT)],Addr(OleLoadPictureFile),cStdCall)}

{RegisterProc(nil,'OleSavePictureFile',mtProc,TypeInfo(_T247),[
TypeInfo(IDispatch),
