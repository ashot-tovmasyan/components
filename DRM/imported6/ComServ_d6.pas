...
RegisterProc(TComServer,'Create',mtConstructor,TypeInfo(_T4),NoParams,Addr(TComServer.Create),cRegister);

RegRegisterMethod(TComServer,'Initialize',TypeInfo(_T5),NoParams,Addr(TComServer.Initialize));

RegRegisterMethod(TComServer,'LoadTypeLib',TypeInfo(_T6),NoParams,Addr(TComServer.LoadTypeLib));

RegRegisterMethod(TComServer,'SetServerName',TypeInfo(_T7),[
TypeInfo(string)],Addr(TComServer.SetServerName));

RegRegisterMethod(TComServer,'UpdateRegistry',TypeInfo(_T8),[
