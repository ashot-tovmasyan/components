...
procedure ____GetAcceptExSockaddrs__Wrapper(p0 : Pointer;
p1 : DWORD;
p2 : DWORD;
p3 : DWORD;
const p4 : IDispatch;
...
GetAcceptExSockaddrs(p0,p1,p2,p3,__p4^,p5,__p6^,p7);
end;
...
const MethodNames : array[0..67] of string = (
...
RegisterProc(nil,MethodNames[57],mtProc,TypeInfo(_T50),[
TypeInfoPointer,
TypeInfo(DWORD),
TypeInfo(DWORD),
TypeInfo(DWORD),
...
TypeInfo(Integer),
TypeInfo(IDispatch),
TypeInfo(Integer)],Addr(____GetAcceptExSockaddrs__Wrapper),cRegister);

RegisterProc(nil,MethodNames[58],mtProc,TypeInfo(_T51),[
TypeInfo(Word),
TypeInfo(Word),TypeInfo(Longint)],Addr(WSAMakeSyncReply),cRegister);

RegisterProc(nil,MethodNames[59],mtProc,TypeInfo(_T52),[
TypeInfo(Word),
TypeInfo(Word),TypeInfo(Longint)],Addr(WSAMakeSelectReply),cRegister);

RegisterProc(nil,MethodNames[60],mtProc,TypeInfo(_T53),[
TypeInfo(Longint),TypeInfo(Word)],Addr(WSAGetAsyncBuflen),cRegister);

RegisterProc(nil,MethodNames[61],mtProc,TypeInfo(_T54),[
TypeInfo(Longint),TypeInfo(Word)],Addr(WSAGetAsyncError),cRegister);

RegisterProc(nil,MethodNames[62],mtProc,TypeInfo(_T55),[
TypeInfo(Longint),TypeInfo(Word)],Addr(WSAGetSelectEvent),cRegister);

RegisterProc(nil,MethodNames[63],mtProc,TypeInfo(_T56),[
TypeInfo(Longint),TypeInfo(Word)],Addr(WSAGetSelectError),cRegister);

RegisterProc(nil,MethodNames[64],mtProc,TypeInfo(_T57),[
TypeInfo(TSocket),
TypeInfo(IDispatch)],Addr(____FD_CLR__Wrapper),cRegister);

RegisterProc(nil,MethodNames[65],mtProc,TypeInfo(_T58),[
TypeInfo(TSocket),
TypeInfo(IDispatch),TypeInfo(Boolean)],Addr(____FD_ISSET__Wrapper),cRegister);

RegisterProc(nil,MethodNames[66],mtProc,TypeInfo(_T59),[
TypeInfo(TSocket),
TypeInfo(IDispatch)],Addr(____FD_SET__Wrapper),cRegister);

RegisterProc(nil,MethodNames[67],mtProc,TypeInfo(_T60),[
