...
RegRegisterMethod(TComponentContainer,'SetContained',TypeInfo(_T17),[
TypeInfo(TComponent)], pointer(4));

RegRegisterMethod(TComponentContainer,'SetParent',TypeInfo(_T18),[
TypeInfo(TWInControl)], pointer(8));
...
RegRegisterMethod(TCustomLiteDesigner,'SelectionChanged',TypeInfo(_T33),[
TypeInfo(TObject)], pointer(48));

RegRegisterMethod(TCustomLiteDesigner,'SetActive',TypeInfo(_T34),[
...
RegRegisterMethod(TCustomLiteDesigner,'ActiveChanged',TypeInfo(_T37),[
...
RegRegisterMethod(TDCFormDesigner,'MouseDown',TypeInfo(_T63),[
TypeInfo(TMouseButton),
TypeInfo(TShiftState),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(48));

RegRegisterMethod(TDCFormDesigner,'MouseUp',TypeInfo(_T64),[
TypeInfo(TMouseButton),
TypeInfo(TShiftState),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(52));

RegRegisterMethod(TDCFormDesigner,'MouseMove',TypeInfo(_T65),[
TypeInfo(TShiftState),
TypeInfo(Integer),
TypeInfo(Integer)], pointer(56));

RegRegisterMethod(TDCFormDesigner,'KeyDown',TypeInfo(_T66),[
TypeInfo(Word),
TypeInfo(TShiftState)], pointer(60));
