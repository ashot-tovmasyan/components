...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[43] ,CMF_NORMAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[44] ,CMF_DEFAULTONLY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[45] ,CMF_VERBSONLY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[46] ,CMF_EXPLORE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[47] ,CMF_NOVERBS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[48] ,CMF_CANRENAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[49] ,CMF_NODEFAULT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[50] ,CMF_INCLUDESTATIC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[51] ,CMF_RESERVED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[52] ,GCS_VERBA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[53] ,GCS_HELPTEXTA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[54] ,GCS_VALIDATEA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[55] ,GCS_VERBW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[56] ,GCS_HELPTEXTW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[57] ,GCS_VALIDATEW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[58] ,GCS_UNICODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[59] ,GCS_VERB));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[60] ,GCS_HELPTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[61] ,GCS_VALIDATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[62] ,CMDSTR_NEWFOLDERA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[63] ,CMDSTR_VIEWLISTA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[64] ,CMDSTR_VIEWDETAILSA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[65] ,CMDSTR_NEWFOLDERW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[66] ,CMDSTR_VIEWLISTW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[67] ,CMDSTR_VIEWDETAILSW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[68] ,CMDSTR_NEWFOLDER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[69] ,CMDSTR_VIEWLIST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[70] ,CMDSTR_VIEWDETAILS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[71] ,CMIC_MASK_HOTKEY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[72] ,CMIC_MASK_ICON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[73] ,CMIC_MASK_FLAG_NO_UI));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[74] ,CMIC_MASK_UNICODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[75] ,CMIC_MASK_NO_CONSOLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[76] ,CMIC_MASK_ASYNCOK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[77] ,CMIC_MASK_PTINVOKE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[78] ,GIL_OPENICON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[79] ,GIL_FORSHELL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[80] ,GIL_ASYNC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[81] ,GIL_SIMULATEDOC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[82] ,GIL_PERINSTANCE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[83] ,GIL_PERCLASS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[84] ,GIL_NOTFILENAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[85] ,GIL_DONTCACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[86] ,ISIOI_ICONFILE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[87] ,ISIOI_ICONINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[88] ,ISIOI_SYSIMAGELISTINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[89] ,SLR_NO_UI));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[90] ,SLR_ANY_MATCH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[91] ,SLR_UPDATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[92] ,SLR_NOUPDATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[93] ,SLGP_SHORTPATH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[94] ,SLGP_UNCPRIORITY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[95] ,SLGP_RAWPATH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[96] ,FVSIF_RECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[97] ,FVSIF_PINNED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[98] ,FVSIF_NEWFAILED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[99] ,FVSIF_NEWFILE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[100] ,FVSIF_CANVIEWIT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[101] ,SHDVID_SETPROGRESSPOS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[102] ,SHDVID_SETPROGRESSRANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[103] ,SHDVID_SETSTATUSTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[104] ,SHDVID_REFRESH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[105] ,SHDVID_STOP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[106] ,SHDVID_UPDATECOMMANDS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[107] ,SHDVID_SETTITLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[108] ,SHDVID_FINALTITLEAVAIL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[109] ,SHDVID_STARTLOAD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[110] ,SHDVID_STOPLOAD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[111] ,SHDVID_CCALLBACK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[112] ,SHDVID_MENUEXEC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[113] ,SHDVID_MENUQS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[114] ,FCIDM_SHVIEWFIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[115] ,FCIDM_SHVIEWLAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[116] ,FCIDM_BROWSERFIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[117] ,FCIDM_BROWSERLAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[118] ,FCIDM_GLOBALFIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[119] ,FCIDM_GLOBALLAST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[120] ,FCIDM_MENU_FILE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[121] ,FCIDM_MENU_EDIT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[122] ,FCIDM_MENU_VIEW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[123] ,FCIDM_MENU_VIEW_SEP_OPTIONS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[124] ,FCIDM_MENU_TOOLS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[125] ,FCIDM_MENU_TOOLS_SEP_GOTO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[126] ,FCIDM_MENU_HELP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[127] ,FCIDM_MENU_FIND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[128] ,FCIDM_MENU_EXPLORE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[129] ,FCIDM_MENU_FAVORITES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[130] ,FCIDM_TOOLBAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[131] ,FCIDM_STATUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[132] ,IDC_OFFLINE_HAND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[133] ,FWF_AUTOARRANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[134] ,FWF_ABBREVIATEDNAMES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[135] ,FWF_SNAPTOGRID));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[136] ,FWF_OWNERDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[137] ,FWF_BESTFITWINDOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[138] ,FWF_DESKTOP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[139] ,FWF_SINGLESEL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[140] ,FWF_NOSUBFOLDERS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[141] ,FWF_TRANSPARENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[142] ,FWF_NOCLIENTEDGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[143] ,FWF_NOSCROLL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[144] ,FWF_ALIGNLEFT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[145] ,FWF_NOICONS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[146] ,FWF_SINGLECLICKACTIVATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[147] ,FVM_ICON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[148] ,FVM_SMALLICON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[149] ,FVM_LIST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[150] ,FVM_DETAILS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[151] ,SBSP_DEFBROWSER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[152] ,SBSP_SAMEBROWSER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[153] ,SBSP_NEWBROWSER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[154] ,SBSP_DEFMODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[155] ,SBSP_OPENMODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[156] ,SBSP_EXPLOREMODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[157] ,SBSP_ABSOLUTE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[158] ,SBSP_RELATIVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[159] ,SBSP_PARENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[160] ,SBSP_NAVIGATEBACK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[161] ,SBSP_NAVIGATEFORWARD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[162] ,SBSP_ALLOW_AUTONAVIGATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[163] ,SBSP_INITIATEDBYHLINKFRAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[164] ,SBSP_REDIRECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[165] ,SBSP_WRITENOHISTORY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[166] ,SBSP_NOAUTOSELECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[167] ,FCW_STATUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[168] ,FCW_TOOLBAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[169] ,FCW_TREE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[170] ,FCW_INTERNETBAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[171] ,FCW_PROGRESS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[172] ,FCT_MERGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[173] ,FCT_CONFIGABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[174] ,FCT_ADDTOEND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[175] ,CDBOSC_SETFOCUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[176] ,CDBOSC_KILLFOCUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[177] ,CDBOSC_SELCHANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[178] ,CDBOSC_RENAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[179] ,SVSI_DESELECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[180] ,SVSI_SELECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[181] ,SVSI_EDIT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[182] ,SVSI_DESELECTOTHERS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[183] ,SVSI_ENSUREVISIBLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[184] ,SVSI_FOCUSED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[185] ,SVSI_TRANSLATEPT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[186] ,SVGIO_BACKGROUND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[187] ,SVGIO_SELECTION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[188] ,SVGIO_ALLVIEW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[189] ,SBSC_HIDE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[190] ,SBSC_SHOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[191] ,SBSC_TOGGLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[192] ,SBSC_QUERY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[193] ,SBO_DEFAULT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[194] ,SBO_NOBROWSERPAGES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[195] ,SBCMDID_ENABLESHOWTREE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[196] ,SBCMDID_SHOWCONTROL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[197] ,SBCMDID_CANCELNAVIGATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[198] ,SBCMDID_MAYSAVECHANGES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[199] ,SBCMDID_SETHLINKFRAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[200] ,SBCMDID_ENABLESTOP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[201] ,SBCMDID_OPTIONS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[202] ,SVUIA_DEACTIVATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[203] ,SVUIA_ACTIVATE_NOFOCUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[204] ,SVUIA_ACTIVATE_FOCUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[205] ,SVUIA_INPLACEACTIVATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[206] ,SV2GV_CURRENTVIEW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[207] ,SV2GV_DEFAULTVIEW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[208] ,STRRET_WSTR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[209] ,STRRET_OFFSET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[210] ,STRRET_CSTR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[211] ,REGSTR_PATH_SPECIAL_FOLDERS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[212] ,CSIDL_DESKTOP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[213] ,CSIDL_INTERNET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[214] ,CSIDL_PROGRAMS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[215] ,CSIDL_CONTROLS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[216] ,CSIDL_PRINTERS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[217] ,CSIDL_PERSONAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[218] ,CSIDL_FAVORITES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[219] ,CSIDL_STARTUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[220] ,CSIDL_RECENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[221] ,CSIDL_SENDTO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[222] ,CSIDL_BITBUCKET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[223] ,CSIDL_STARTMENU));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[224] ,CSIDL_DESKTOPDIRECTORY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[225] ,CSIDL_DRIVES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[226] ,CSIDL_NETWORK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[227] ,CSIDL_NETHOOD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[228] ,CSIDL_FONTS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[229] ,CSIDL_TEMPLATES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[230] ,CSIDL_COMMON_STARTMENU));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[231] ,CSIDL_COMMON_PROGRAMS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[232] ,CSIDL_COMMON_STARTUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[233] ,CSIDL_COMMON_DESKTOPDIRECTORY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[234] ,CSIDL_APPDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[235] ,CSIDL_PRINTHOOD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[236] ,CSIDL_ALTSTARTUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[237] ,CSIDL_COMMON_ALTSTARTUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[238] ,CSIDL_COMMON_FAVORITES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[239] ,CSIDL_INTERNET_CACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[240] ,CSIDL_COOKIES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[241] ,CSIDL_HISTORY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[242] ,BIF_RETURNONLYFSDIRS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[243] ,BIF_DONTGOBELOWDOMAIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[244] ,BIF_STATUSTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[245] ,BIF_RETURNFSANCESTORS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[246] ,BIF_EDITBOX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[247] ,BIF_VALIDATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[248] ,BIF_BROWSEFORCOMPUTER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[249] ,BIF_BROWSEFORPRINTER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[250] ,BIF_BROWSEINCLUDEFILES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[251] ,BFFM_INITIALIZED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[252] ,BFFM_SELCHANGED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[253] ,BFFM_VALIDATEFAILEDA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[254] ,BFFM_VALIDATEFAILEDW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[255] ,BFFM_SETSTATUSTEXTA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[256] ,BFFM_ENABLEOK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[257] ,BFFM_SETSELECTIONA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[258] ,BFFM_SETSELECTIONW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[259] ,BFFM_SETSTATUSTEXTW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[260] ,BFFM_VALIDATEFAILED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[261] ,BFFM_SETSTATUSTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[262] ,BFFM_SETSELECTION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[263] ,SHGDN_NORMAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[264] ,SHGDN_INFOLDER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[265] ,SHGDN_FOREDITING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[266] ,SHGDN_INCLUDE_NONFILESYS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[267] ,SHGDN_FORADDRESSBAR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[268] ,SHGDN_FORPARSING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[269] ,SHCONTF_FOLDERS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[270] ,SHCONTF_NONFOLDERS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[271] ,SHCONTF_INCLUDEHIDDEN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[272] ,SFGAO_CANCOPY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[273] ,SFGAO_CANMOVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[274] ,SFGAO_CANLINK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[275] ,SFGAO_CANRENAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[276] ,SFGAO_CANDELETE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[277] ,SFGAO_HASPROPSHEET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[278] ,SFGAO_DROPTARGET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[279] ,SFGAO_CAPABILITYMASK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[280] ,SFGAO_LINK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[281] ,SFGAO_SHARE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[282] ,SFGAO_READONLY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[283] ,SFGAO_GHOSTED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[284] ,SFGAO_HIDDEN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[285] ,SFGAO_DISPLAYATTRMASK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[286] ,SFGAO_FILESYSANCESTOR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[287] ,SFGAO_FOLDER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[288] ,SFGAO_FILESYSTEM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[289] ,SFGAO_HASSUBFOLDER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[290] ,SFGAO_CONTENTSMASK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[291] ,SFGAO_VALIDATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[292] ,SFGAO_REMOVABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[293] ,SFGAO_COMPRESSED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[294] ,SFGAO_BROWSABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[295] ,SFGAO_NONENUMERATED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[296] ,SFGAO_NEWCONTENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[297] ,SHCOLSTATE_TYPE_STR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[298] ,SHCOLSTATE_TYPE_INT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[299] ,SHCOLSTATE_TYPE_DATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[300] ,SHCOLSTATE_TYPEMASK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[301] ,SHCOLSTATE_ONBYDEFAULT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[302] ,SHCOLSTATE_SLOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[303] ,SHCOLSTATE_EXTENDED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[304] ,SHCOLSTATE_SECONDARYUI));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[305] ,SHCOLSTATE_HIDDEN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[306] ,DWFRF_NORMAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[307] ,DWFRF_DELETECONFIGDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[308] ,DWFAF_HIDDEN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[309] ,DBIM_MINSIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[310] ,DBIM_MAXSIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[311] ,DBIM_INTEGRAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[312] ,DBIM_ACTUAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[313] ,DBIM_TITLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[314] ,DBIM_MODEFLAGS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[315] ,DBIM_BKCOLOR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[316] ,DBIMF_NORMAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[317] ,DBIMF_VARIABLEHEIGHT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[318] ,DBIMF_DEBOSSED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[319] ,DBIMF_BKCOLOR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[320] ,DBIF_VIEWMODE_NORMAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[321] ,DBIF_VIEWMODE_VERTICAL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[322] ,DBIF_VIEWMODE_FLOATING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[323] ,DBIF_VIEWMODE_TRANSPARENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[324] ,DBID_BANDINFOCHANGED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[325] ,DBID_SHOWONLY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[326] ,DBID_MAXIMIZEBAND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[327] ,COMPONENT_TOP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[328] ,COMP_TYPE_HTMLDOC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[329] ,COMP_TYPE_PICTURE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[330] ,COMP_TYPE_WEBSITE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[331] ,COMP_TYPE_CONTROL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[332] ,COMP_TYPE_CFHTML));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[333] ,COMP_TYPE_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[334] ,AD_APPLY_SAVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[335] ,AD_APPLY_HTMLGEN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[336] ,AD_APPLY_REFRESH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[337] ,AD_APPLY_ALL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[338] ,AD_APPLY_FORCE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[339] ,AD_APPLY_BUFFERED_REFRESH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[340] ,WPSTYLE_CENTER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[341] ,WPSTYLE_TILE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[342] ,WPSTYLE_STRETCH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[343] ,WPSTYLE_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[344] ,COMP_ELEM_TYPE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[345] ,COMP_ELEM_CHECKED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[346] ,COMP_ELEM_DIRTY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[347] ,COMP_ELEM_NOSCROLL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[348] ,COMP_ELEM_POS_LEFT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[349] ,COMP_ELEM_POS_TOP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[350] ,COMP_ELEM_SIZE_WIDTH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[351] ,COMP_ELEM_SIZE_HEIGHT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[352] ,COMP_ELEM_POS_ZINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[353] ,COMP_ELEM_SOURCE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[354] ,COMP_ELEM_FRIENDLYNAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[355] ,COMP_ELEM_SUBSCRIBEDURL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[356] ,COMP_ELEM_ALL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[357] ,ADDURL_SILENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[358] ,DTI_ADDUI_DEFAULT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[359] ,DTI_ADDUI_DISPSUBWIZARD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[360] ,CFSTR_SHELLIDLIST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[361] ,CFSTR_SHELLIDLISTOFFSET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[362] ,CFSTR_NETRESOURCES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[363] ,CFSTR_FILEDESCRIPTORA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[364] ,CFSTR_FILEDESCRIPTORW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[365] ,CFSTR_FILECONTENTS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[366] ,CFSTR_FILENAMEA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[367] ,CFSTR_FILENAMEW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[368] ,CFSTR_PRINTERGROUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[369] ,CFSTR_FILENAMEMAPA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[370] ,CFSTR_FILENAMEMAPW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[371] ,CFSTR_SHELLURL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[372] ,CFSTR_PREFERREDDROPEFFECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[373] ,CFSTR_PERFORMEDDROPEFFECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[374] ,CFSTR_PASTESUCCEEDED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[375] ,CFSTR_FILEDESCRIPTOR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[376] ,CFSTR_FILENAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[377] ,CFSTR_FILENAMEMAP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[378] ,DVASPECT_SHORTNAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[379] ,FD_CLSID));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[380] ,FD_SIZEPOINT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[381] ,FD_ATTRIBUTES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[382] ,FD_CREATETIME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[383] ,FD_ACCESSTIME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[384] ,FD_WRITESTIME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[385] ,FD_FILESIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[386] ,FD_LINKUI));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[387] ,SHCNE_RENAMEITEM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[388] ,SHCNE_CREATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[389] ,SHCNE_DELETE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[390] ,SHCNE_MKDIR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[391] ,SHCNE_RMDIR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[392] ,SHCNE_MEDIAINSERTED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[393] ,SHCNE_MEDIAREMOVED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[394] ,SHCNE_DRIVEREMOVED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[395] ,SHCNE_DRIVEADD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[396] ,SHCNE_NETSHARE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[397] ,SHCNE_NETUNSHARE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[398] ,SHCNE_ATTRIBUTES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[399] ,SHCNE_UPDATEDIR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[400] ,SHCNE_UPDATEITEM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[401] ,SHCNE_SERVERDISCONNECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[402] ,SHCNE_UPDATEIMAGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[403] ,SHCNE_DRIVEADDGUI));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[404] ,SHCNE_RENAMEFOLDER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[405] ,SHCNE_FREESPACE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[406] ,SHCNE_EXTENDED_EVENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[407] ,SHCNE_EXTENDED_EVENT_PRE_IE4));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[408] ,SHCNE_ASSOCCHANGED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[409] ,SHCNE_DISKEVENTS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[410] ,SHCNE_GLOBALEVENTS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[411] ,SHCNE_ALLEVENTS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[412] ,SHCNE_INTERRUPT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[413] ,SHCNEE_THEMECHANGED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[414] ,SHCNEE_ORDERCHANGED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[415] ,SHCNF_IDLIST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[416] ,SHCNF_PATHA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[417] ,SHCNF_PRINTERA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[418] ,SHCNF_DWORD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[419] ,SHCNF_PATHW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[420] ,SHCNF_PRINTERW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[421] ,SHCNF_TYPE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[422] ,SHCNF_FLUSH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[423] ,SHCNF_FLUSHNOWAIT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[424] ,SHCNF_PATH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[425] ,SHCNF_PRINTER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[426] ,QIF_CACHED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[427] ,QIF_DONTEXPANDFOLDER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[428] ,SHARD_PIDL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[429] ,SHARD_PATHA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[430] ,SHARD_PATHW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[431] ,SHARD_PATH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[432] ,SHGDFIL_FINDDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[433] ,SHGDFIL_NETRESOURCE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[434] ,SHGDFIL_DESCRIPTIONID));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[435] ,SHDID_ROOT_REGITEM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[436] ,SHDID_FS_FILE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[437] ,SHDID_FS_DIRECTORY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[438] ,SHDID_FS_OTHER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[439] ,SHDID_COMPUTER_DRIVE35));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[440] ,SHDID_COMPUTER_DRIVE525));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[441] ,SHDID_COMPUTER_REMOVABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[442] ,SHDID_COMPUTER_FIXED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[443] ,SHDID_COMPUTER_NETDRIVE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[444] ,SHDID_COMPUTER_CDROM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[445] ,SHDID_COMPUTER_RAMDISK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[446] ,SHDID_COMPUTER_OTHER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[447] ,SHDID_NET_DOMAIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[448] ,SHDID_NET_SERVER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[449] ,SHDID_NET_SHARE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[450] ,SHDID_NET_RESTOFNET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[451] ,SHDID_NET_OTHER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[452] ,PID_IS_URL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[453] ,PID_IS_NAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[454] ,PID_IS_WORKINGDIR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[455] ,PID_IS_HOTKEY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[456] ,PID_IS_SHOWCMD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[457] ,PID_IS_ICONINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[458] ,PID_IS_ICONFILE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[459] ,PID_IS_WHATSNEW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[460] ,PID_IS_AUTHOR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[461] ,PID_IS_DESCRIPTION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[462] ,PID_IS_COMMENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[463] ,PID_INTSITE_WHATSNEW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[464] ,PID_INTSITE_AUTHOR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[465] ,PID_INTSITE_LASTVISIT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[466] ,PID_INTSITE_LASTMOD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[467] ,PID_INTSITE_VISITCOUNT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[468] ,PID_INTSITE_DESCRIPTION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[469] ,PID_INTSITE_COMMENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[470] ,PID_INTSITE_FLAGS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[471] ,PID_INTSITE_CONTENTLEN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[472] ,PID_INTSITE_CONTENTCODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[473] ,PID_INTSITE_RECURSE));
end;
...
const __ConstNames1 : array[0..25] of string = (
'PID_INTSITE_WATCH'
...
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[0] ,PID_INTSITE_WATCH));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[1] ,PID_INTSITE_SUBSCRIPTION));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[2] ,PID_INTSITE_URL));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[3] ,PID_INTSITE_TITLE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[4] ,PID_INTSITE_CODEPAGE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[5] ,PID_INTSITE_TRACKING));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[6] ,PIDISF_RECENTLYCHANGED));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[7] ,PIDISF_CACHEDSTICKY));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[8] ,PIDISF_CACHEIMAGES));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[9] ,PIDISF_FOLLOWALLLINKS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[10] ,PIDISM_GLOBAL));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[11] ,PIDISM_WATCH));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[12] ,PIDISM_DONTWATCH));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[13] ,SSF_SHOWALLOBJECTS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[14] ,SSF_SHOWEXTENSIONS));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[15] ,SSF_SHOWCOMPCOLOR));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[16] ,SSF_SHOWSYSFILES));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[17] ,SSF_DOUBLECLICKINWEBVIEW));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[18] ,SSF_SHOWATTRIBCOL));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[19] ,SSF_DESKTOPHTML));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[20] ,SSF_WIN95CLASSIC));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[21] ,SSF_DONTPRETTYPATH));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[22] ,SSF_SHOWINFOTIP));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[23] ,SSF_MAPNETDRVBUTTON));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[24] ,SSF_NOCONFIRMRECYCLE));
__RegisteredConstsList1.Add(RegisterConst(__ConstNames1[25] ,SSF_HIDEICONS));
end;
...
const MethodNames : array[0..84] of string = (
'_browseinfo'
,'_browseinfoA'
,'_browseinfoW'
...
__RegisteredMethods.Add(RegisterRWProc(MethodNames[44],Addr(_SHELLDETAILS_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[45],Addr(_SHELLFLAGSTATE_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[46],Addr(_SHELLVIEWID_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[47],Addr(_SHITEMID_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[48],Addr(_STRRET_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[49],Addr(_SV2CVW2_PARAMS_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[50],Addr(_tagExtraSearch_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[51],Addr(_TBrowseInfo_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[52],Addr(_TBrowseInfoA_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[53],Addr(_TBrowseInfoW_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[54],Addr(_TCMInvokeCommandInfo_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[55],Addr(_TCMInvokeCommandInfoEx_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[56],Addr(_TComponentsOpt_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[57],Addr(_TCompPos_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[58],Addr(_TDeskBandInfo_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[59],Addr(_TDropFiles_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[60],Addr(_TExtraSearch_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[61],Addr(_TFileDescriptor_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[62],Addr(_TFileDescriptorA_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[63],Addr(_TFileDescriptorW_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[64],Addr(_TFileGroupDescriptor_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[65],Addr(_TFileGroupDescriptorA_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[66],Addr(_TFileGroupDescriptorW_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[67],Addr(_TFolderSettings_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[68],Addr(_TFVShowInfo_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[69],Addr(_TIDA_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[70],Addr(_TItemIDList_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[71],Addr(_TNResArray_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[72],Addr(_TShColumnID_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[73],Addr(_TShComponent_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[74],Addr(_TSHDescriptionID_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[75],Addr(_TShellDetails_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[76],Addr(_TShellFlagState_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[77],Addr(_TShellViewID_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[78],Addr(_TSHItemID_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[79],Addr(_TStrRet_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[80],Addr(_TSV2CreateParams_)));
__RegisteredMethods.Add(RegisterRWProc(MethodNames[81],Addr(_TWallPaperOpt_)));
RegisterProc(nil,MethodNames[82],mtProc,TypeInfo(_T13),[
TypeInfo(Longint),
TypeInfo(UINT),
TypeInfoPointer,
TypeInfoPointer],Addr(SHChangeNotify),cStdCall);

RegisterProc(nil,MethodNames[83],mtProc,TypeInfo(_T14),[
TypeInfo(UINT),
TypeInfoPointer],Addr(SHAddToRecentDocs),cStdCall);

RegisterProc(nil,MethodNames[84],mtProc,TypeInfo(_T19),[
TypeInfo(IDispatch),
