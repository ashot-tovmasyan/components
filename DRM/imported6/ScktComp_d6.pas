...
RegRegisterMethod(TAbstractSocket,'Event',TypeInfo(_T1),[
TypeInfo(TCustomWinSocket),
TypeInfo(TSocketEvent)], pointer(48));

RegRegisterMethod(TAbstractSocket,'Error',TypeInfo(_T2),[
TypeInfo(TCustomWinSocket),
TypeInfo(TErrorEvent),
TypeInfo(Integer)], pointer(52));

RegRegisterMethod(TAbstractSocket,'DoActivate',TypeInfo(_T3),[
...
RegRegisterMethod(TCustomWinSocket,'Accept',TypeInfo(_T14),[
TypeInfo(TSocket)], pointer(0));

RegRegisterMethod(TCustomWinSocket,'Connect',TypeInfo(_T15),[
TypeInfo(TSocket)], pointer(4));

RegRegisterMethod(TCustomWinSocket,'Disconnect',TypeInfo(_T16),[
TypeInfo(TSocket)], pointer(8));

RegRegisterMethod(TCustomWinSocket,'Read',TypeInfo(_T17),[
TypeInfo(TSocket)], pointer(12));

RegRegisterMethod(TCustomWinSocket,'Write',TypeInfo(_T18),[
TypeInfo(TSocket)], pointer(16));
...
RegRegisterMethod(TServerClientThread,'Event',TypeInfo(_T30),[
TypeInfo(TSocketEvent)], pointer(12));

RegRegisterMethod(TServerClientThread,'Error',TypeInfo(_T31),[
TypeInfo(TErrorEvent),
...
RegRegisterMethod(TServerWinSocket,'DoCreateThread',TypeInfo(_T35),[
TypeInfo(TServerClientWinSocket),TypeInfo(TServerClientThread)], pointer(20));
