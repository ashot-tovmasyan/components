...
RegRegisterMethod(TDCCustomPropEditor,'UpDownSelect',TypeInfo(_T9),[TypeInfo(Boolean)], pointer(276));

RegRegisterMethod(TDCCustomPropEditor,'ResetAfterCreateHandle',TypeInfo(_T10),NoParams, pointer(280));

RegRegisterMethod(TDCCustomPropEditor,'DoAutoUpdate',TypeInfo(_T11),NoParams, pointer(284));

RegRegisterMethod(TDCCustomPropEditor,'UpdateEditorState',TypeInfo(_T12),NoParams, pointer(288));
...
TypeInfo(string),TypeInfo(TDCDsgnProp)], pointer(264))}

{RegRegisterMethod(TDCCustomPropEditor,'GetEditType',TypeInfo(_T7),[TypeInfo(TControlClass)], pointer(268))}

{RegRegisterMethod(TDCCustomPropEditor,'GetPopupType',TypeInfo(_T8),[TypeInfo(TWinControlClass)], pointer(272))}
