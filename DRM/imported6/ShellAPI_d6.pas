...
const __ConstNames0 : array[0..88] of string = (
'ABM_NEW'
,'ABM_REMOVE'
,'ABM_QUERYPOS'
,'ABM_SETPOS'
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[67] ,NIF_MESSAGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[68] ,NIF_ICON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[69] ,NIF_TIP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[70] ,SHGFI_ICON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[71] ,SHGFI_DISPLAYNAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[72] ,SHGFI_TYPENAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[73] ,SHGFI_ATTRIBUTES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[74] ,SHGFI_ICONLOCATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[75] ,SHGFI_EXETYPE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[76] ,SHGFI_SYSICONINDEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[77] ,SHGFI_LINKOVERLAY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[78] ,SHGFI_SELECTED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[79] ,SHGFI_LARGEICON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[80] ,SHGFI_SMALLICON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[81] ,SHGFI_OPENICON));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[82] ,SHGFI_SHELLICONSIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[83] ,SHGFI_PIDL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[84] ,SHGFI_USEFILEATTRIBUTES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[85] ,SHGNLI_PIDL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[86] ,SHGNLI_PREFIXNAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[87] ,SHGNLI_NOUNIQUE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[88] ,shell32));
end;
...
const MethodNames : array[0..61] of string = (
'_AppBarData'
,'_DRAGINFO'
,'_DRAGINFOA'
,'_DRAGINFOW'
