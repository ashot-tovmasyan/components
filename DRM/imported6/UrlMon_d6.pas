...
const __ConstNames0 : array[0..318] of string = (
'MKSYS_URLMONIKER'
...
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[3] ,CF_NULL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[4] ,CFSTR_MIME_NULL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[5] ,CFSTR_MIME_TEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[6] ,CFSTR_MIME_RICHTEXT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[7] ,CFSTR_MIME_X_BITMAP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[8] ,CFSTR_MIME_POSTSCRIPT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[9] ,CFSTR_MIME_AIFF));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[10] ,CFSTR_MIME_BASICAUDIO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[11] ,CFSTR_MIME_WAV));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[12] ,CFSTR_MIME_X_WAV));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[13] ,CFSTR_MIME_GIF));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[14] ,CFSTR_MIME_PJPEG));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[15] ,CFSTR_MIME_JPEG));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[16] ,CFSTR_MIME_TIFF));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[17] ,CFSTR_MIME_X_PNG));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[18] ,CFSTR_MIME_BMP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[19] ,CFSTR_MIME_X_ART));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[20] ,CFSTR_MIME_X_EMF));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[21] ,CFSTR_MIME_X_WMF));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[22] ,CFSTR_MIME_AVI));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[23] ,CFSTR_MIME_MPEG));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[24] ,CFSTR_MIME_FRACTALS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[25] ,CFSTR_MIME_RAWDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[26] ,CFSTR_MIME_RAWDATASTRM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[27] ,CFSTR_MIME_PDF));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[28] ,CFSTR_MIME_X_AIFF));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[29] ,CFSTR_MIME_X_REALAUDIO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[30] ,CFSTR_MIME_XBM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[31] ,CFSTR_MIME_QUICKTIME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[32] ,CFSTR_MIME_X_MSVIDEO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[33] ,CFSTR_MIME_X_SGI_MOVIE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[34] ,CFSTR_MIME_HTML));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[35] ,MK_S_ASYNCHRONOUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[36] ,S_ASYNCHRONOUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[37] ,E_PENDING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[38] ,INET_E_INVALID_URL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[39] ,INET_E_NO_SESSION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[40] ,INET_E_CANNOT_CONNECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[41] ,INET_E_RESOURCE_NOT_FOUND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[42] ,INET_E_OBJECT_NOT_FOUND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[43] ,INET_E_DATA_NOT_AVAILABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[44] ,INET_E_DOWNLOAD_FAILURE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[45] ,INET_E_AUTHENTICATION_REQUIRED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[46] ,INET_E_NO_VALID_MEDIA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[47] ,INET_E_CONNECTION_TIMEOUT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[48] ,INET_E_INVALID_REQUEST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[49] ,INET_E_UNKNOWN_PROTOCOL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[50] ,INET_E_SECURITY_PROBLEM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[51] ,INET_E_CANNOT_LOAD_DATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[52] ,INET_E_CANNOT_INSTANTIATE_OBJECT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[53] ,INET_E_REDIRECT_FAILED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[54] ,INET_E_REDIRECT_TO_DIR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[55] ,INET_E_CANNOT_LOCK_REQUEST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[56] ,INET_E_ERROR_FIRST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[57] ,BINDVERB_GET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[58] ,BINDVERB_POST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[59] ,BINDVERB_PUT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[60] ,BINDVERB_CUSTOM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[61] ,BINDINFOF_URLENCODESTGMEDDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[62] ,BINDINFOF_URLENCODEDEXTRAINFO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[63] ,BINDF_ASYNCHRONOUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[64] ,BINDF_ASYNCSTORAGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[65] ,BINDF_NOPROGRESSIVERENDERING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[66] ,BINDF_OFFLINEOPERATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[67] ,BINDF_GETNEWESTVERSION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[68] ,BINDF_NOWRITECACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[69] ,BINDF_NEEDFILE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[70] ,BINDF_PULLDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[71] ,BINDF_IGNORESECURITYPROBLEM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[72] ,BINDF_RESYNCHRONIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[73] ,BINDF_HYPERLINK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[74] ,BINDF_NO_UI));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[75] ,BINDF_SILENTOPERATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[76] ,BINDF_PRAGMA_NO_CACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[77] ,BINDF_FREE_THREADED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[78] ,BINDF_DIRECT_READ));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[79] ,BINDF_FORMS_SUBMIT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[80] ,BINDF_GETFROMCACHE_IF_NET_FAIL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[81] ,BINDF_DONTUSECACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[82] ,BINDF_DONTPUTINCACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[83] ,BINDF_NOCOPYDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[84] ,BSCF_FIRSTDATANOTIFICATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[85] ,BSCF_INTERMEDIATEDATANOTIFICATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[86] ,BSCF_LASTDATANOTIFICATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[87] ,BSCF_DATAFULLYAVAILABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[88] ,BSCF_AVAILABLEDATASIZEUNKNOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[89] ,BINDSTATUS_FINDINGRESOURCE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[90] ,BINDSTATUS_CONNECTING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[91] ,BINDSTATUS_REDIRECTING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[92] ,BINDSTATUS_BEGINDOWNLOADDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[93] ,BINDSTATUS_DOWNLOADINGDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[94] ,BINDSTATUS_ENDDOWNLOADDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[95] ,BINDSTATUS_BEGINDOWNLOADCOMPONENTS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[96] ,BINDSTATUS_INSTALLINGCOMPONENTS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[97] ,BINDSTATUS_ENDDOWNLOADCOMPONENTS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[98] ,BINDSTATUS_USINGCACHEDCOPY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[99] ,BINDSTATUS_SENDINGREQUEST));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[100] ,BINDSTATUS_CLASSIDAVAILABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[101] ,BINDSTATUS_MIMETYPEAVAILABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[102] ,BINDSTATUS_CACHEFILENAMEAVAILABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[103] ,BINDSTATUS_BEGINSYNCOPERATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[104] ,BINDSTATUS_ENDSYNCOPERATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[105] ,BINDSTATUS_BEGINUPLOADDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[106] ,BINDSTATUS_UPLOADINGDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[107] ,BINDSTATUS_ENDUPLOADDATA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[108] ,BINDSTATUS_PROTOCOLCLASSID));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[109] ,BINDSTATUS_ENCODING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[110] ,BINDSTATUS_VERIFIEDMIMETYPEAVAILABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[111] ,BINDSTATUS_CLASSINSTALLLOCATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[112] ,BINDSTATUS_DECODING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[113] ,BINDSTATUS_LOADINGMIMEHANDLER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[114] ,CIP_DISK_FULL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[115] ,CIP_ACCESS_DENIED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[116] ,CIP_NEWER_VERSION_EXISTS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[117] ,CIP_OLDER_VERSION_EXISTS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[118] ,CIP_NAME_CONFLICT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[119] ,CIP_TRUST_VERIFICATION_COMPONENT_MISSING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[120] ,CIP_EXE_SELF_REGISTERATION_TIMEOUT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[121] ,CIP_UNSAFE_TO_ABORT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[122] ,CIP_NEED_REBOOT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[123] ,WININETINFO_OPTION_LOCK_HANDLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[124] ,URLOSTRM_USECACHEDCOPY_ONLY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[125] ,URLOSTRM_USECACHEDCOPY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[126] ,URLOSTRM_GETNEWESTVERSION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[127] ,BINDSTRING_HEADERS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[128] ,BINDSTRING_ACCEPT_MIMES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[129] ,BINDSTRING_EXTRA_URL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[130] ,BINDSTRING_LANGUAGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[131] ,BINDSTRING_USERNAME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[132] ,BINDSTRING_PASSWORD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[133] ,BINDSTRING_UA_PIXELS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[134] ,BINDSTRING_UA_COLOR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[135] ,BINDSTRING_OS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[136] ,BINDSTRING_USER_AGENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[137] ,BINDSTRING_ACCEPT_ENCODINGS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[138] ,BINDSTRING_POST_COOKIE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[139] ,BINDSTRING_POST_DATA_MIME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[140] ,BINDSTRING_URL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[141] ,PI_PARSE_URL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[142] ,PI_FILTER_MODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[143] ,PI_FORCE_ASYNC));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[144] ,PI_USE_WORKERTHREAD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[145] ,PI_MIMEVERIFICATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[146] ,PI_CLSIDLOOKUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[147] ,PI_DATAPROGRESS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[148] ,PI_SYNCHRONOUS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[149] ,PI_APARTMENTTHREADED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[150] ,PI_CLASSINSTALL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[151] ,PD_FORCE_SWITCH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[152] ,PI_DOCFILECLSIDLOOKUP));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[153] ,OIBDG_APARTMENTTHREADED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[154] ,PARSE_CANONICALIZE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[155] ,PARSE_FRIENDLY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[156] ,PARSE_SECURITY_URL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[157] ,PARSE_ROOTDOCUMENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[158] ,PARSE_DOCUMENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[159] ,PARSE_ANCHOR));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[160] ,PARSE_ENCODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[161] ,PARSE_DECODE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[162] ,PARSE_PATH_FROM_URL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[163] ,PARSE_URL_FROM_PATH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[164] ,PARSE_MIME));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[165] ,PARSE_SERVER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[166] ,PARSE_SCHEMA));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[167] ,PARSE_SITE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[168] ,PARSE_DOMAIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[169] ,PARSE_LOCATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[170] ,PARSE_SECURITY_DOMAIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[171] ,PSU_DEFAULT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[172] ,PSU_SECURITY_URL_ONLY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[173] ,QUERY_EXPIRATION_DATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[174] ,QUERY_TIME_OF_LAST_CHANGE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[175] ,QUERY_CONTENT_ENCODING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[176] ,QUERY_CONTENT_TYPE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[177] ,QUERY_REFRESH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[178] ,QUERY_RECOMBINE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[179] ,QUERY_CAN_NAVIGATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[180] ,QUERY_USES_NETWORK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[181] ,QUERY_IS_CACHED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[182] ,QUERY_IS_INSTALLEDENTRY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[183] ,QUERY_IS_CACHED_OR_MAPPED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[184] ,QUERY_USES_CACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[185] ,INET_E_USE_DEFAULT_PROTOCOLHANDLER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[186] ,INET_E_USE_DEFAULT_SETTING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[187] ,INET_E_DEFAULT_ACTION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[188] ,INET_E_QUERYOPTION_UNKNOWN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[189] ,INET_E_REDIRECTING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[190] ,PROTOCOLFLAG_NO_PICS_CHECK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[191] ,MAX_SIZE_SECURITY_ID));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[192] ,PUAF_DEFAULT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[193] ,PUAF_NOUI));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[194] ,PUAF_ISFILE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[195] ,PUAF_WARN_IF_DENIED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[196] ,PUAF_FORCEUI_FOREGROUND));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[197] ,PUAF_CHECK_TIFS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[198] ,SZM_CREATE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[199] ,SZM_DELETE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[200] ,URLACTION_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[201] ,URLACTION_DOWNLOAD_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[202] ,URLACTION_DOWNLOAD_SIGNED_ACTIVEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[203] ,URLACTION_DOWNLOAD_UNSIGNED_ACTIVEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[204] ,URLACTION_DOWNLOAD_CURR_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[205] ,URLACTION_DOWNLOAD_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[206] ,URLACTION_ACTIVEX_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[207] ,URLACTION_ACTIVEX_RUN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[208] ,URLACTION_ACTIVEX_OVERRIDE_OBJECT_SAFETY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[209] ,URLACTION_ACTIVEX_OVERRIDE_DATA_SAFETY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[210] ,URLACTION_ACTIVEX_OVERRIDE_SCRIPT_SAFETY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[211] ,URLACTION_SCRIPT_OVERRIDE_SAFETY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[212] ,URLACTION_ACTIVEX_CONFIRM_NOOBJECTSAFETY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[213] ,URLACTION_ACTIVEX_TREATASUNTRUSTED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[214] ,URLACTION_ACTIVEX_CURR_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[215] ,URLACTION_ACTIVEX_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[216] ,URLACTION_SCRIPT_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[217] ,URLACTION_SCRIPT_RUN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[218] ,URLACTION_SCRIPT_JAVA_USE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[219] ,URLACTION_SCRIPT_SAFE_ACTIVEX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[220] ,URLACTION_SCRIPT_CURR_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[221] ,URLACTION_SCRIPT_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[222] ,URLACTION_HTML_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[223] ,URLACTION_HTML_SUBMIT_FORMS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[224] ,URLACTION_HTML_SUBMIT_FORMS_FROM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[225] ,URLACTION_HTML_SUBMIT_FORMS_TO));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[226] ,URLACTION_HTML_FONT_DOWNLOAD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[227] ,URLACTION_HTML_JAVA_RUN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[228] ,URLACTION_HTML_CURR_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[229] ,URLACTION_HTML_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[230] ,URLACTION_SHELL_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[231] ,URLACTION_SHELL_INSTALL_DTITEMS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[232] ,URLACTION_SHELL_MOVE_OR_COPY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[233] ,URLACTION_SHELL_FILE_DOWNLOAD));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[234] ,URLACTION_SHELL_VERB));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[235] ,URLACTION_SHELL_WEBVIEW_VERB));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[236] ,URLACTION_SHELL_CURR_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[237] ,URLACTION_SHELL_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[238] ,URLACTION_NETWORK_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[239] ,URLACTION_CREDENTIALS_USE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[240] ,URLPOLICY_CREDENTIALS_SILENT_LOGON_OK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[241] ,URLPOLICY_CREDENTIALS_MUST_PROMPT_USER));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[242] ,URLPOLICY_CREDENTIALS_CONDITIONAL_PROMPT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[243] ,URLPOLICY_CREDENTIALS_ANONYMOUS_ONLY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[244] ,URLACTION_AUTHENTICATE_CLIENT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[245] ,URLPOLICY_AUTHENTICATE_CLEARTEXT_OK));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[246] ,URLPOLICY_AUTHENTICATE_CHALLENGE_RESPONSE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[247] ,URLPOLICY_AUTHENTICATE_MUTUAL_ONLY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[248] ,URLACTION_NETWORK_CURR_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[249] ,URLACTION_NETWORK_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[250] ,URLACTION_JAVA_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[251] ,URLACTION_JAVA_PERMISSIONS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[252] ,URLPOLICY_JAVA_PROHIBIT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[253] ,URLPOLICY_JAVA_HIGH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[254] ,URLPOLICY_JAVA_MEDIUM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[255] ,URLPOLICY_JAVA_LOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[256] ,URLPOLICY_JAVA_CUSTOM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[257] ,URLACTION_JAVA_CURR_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[258] ,URLACTION_JAVA_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[259] ,URLACTION_INFODELIVERY_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[260] ,URLACTION_INFODELIVERY_NO_ADDING_CHANNELS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[261] ,URLACTION_INFODELIVERY_NO_EDITING_CHANNELS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[262] ,URLACTION_INFODELIVERY_NO_REMOVING_CHANNELS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[263] ,URLACTION_INFODELIVERY_NO_ADDING_SUBSCRIPTIONS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[264] ,URLACTION_INFODELIVERY_NO_EDITING_SUBSCRIPTIONS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[265] ,URLACTION_INFODELIVERY_NO_REMOVING_SUBSCRIPTIONS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[266] ,URLACTION_INFODELIVERY_NO_CHANNEL_LOGGING));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[267] ,URLACTION_INFODELIVERY_CURR_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[268] ,URLACTION_INFODELIVERY_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[269] ,URLACTION_CHANNEL_SOFTDIST_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[270] ,URLACTION_CHANNEL_SOFTDIST_PERMISSIONS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[271] ,URLPOLICY_CHANNEL_SOFTDIST_PROHIBIT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[272] ,URLPOLICY_CHANNEL_SOFTDIST_PRECACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[273] ,URLPOLICY_CHANNEL_SOFTDIST_AUTOINSTALL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[274] ,URLACTION_CHANNEL_SOFTDIST_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[275] ,URLPOLICY_ALLOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[276] ,URLPOLICY_QUERY));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[277] ,URLPOLICY_DISALLOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[278] ,URLPOLICY_NOTIFY_ON_ALLOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[279] ,URLPOLICY_NOTIFY_ON_DISALLOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[280] ,URLPOLICY_LOG_ON_ALLOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[281] ,URLPOLICY_LOG_ON_DISALLOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[282] ,URLPOLICY_MASK_PERMISSIONS));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[283] ,URLZONE_PREDEFINED_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[284] ,URLZONE_LOCAL_MACHINE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[285] ,URLZONE_INTRANET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[286] ,URLZONE_TRUSTED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[287] ,URLZONE_INTERNET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[288] ,URLZONE_UNTRUSTED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[289] ,URLZONE_PREDEFINED_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[290] ,URLZONE_USER_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[291] ,URLZONE_USER_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[292] ,URLTEMPLATE_CUSTOM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[293] ,URLTEMPLATE_PREDEFINED_MIN));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[294] ,URLTEMPLATE_LOW));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[295] ,URLTEMPLATE_MEDIUM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[296] ,URLTEMPLATE_HIGH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[297] ,URLTEMPLATE_PREDEFINED_MAX));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[298] ,MAX_ZONE_PATH));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[299] ,MAX_ZONE_DESCRIPTION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[300] ,ZAFLAGS_CUSTOM_EDIT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[301] ,ZAFLAGS_ADD_SITES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[302] ,ZAFLAGS_REQUIRE_VERIFICATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[303] ,ZAFLAGS_INCLUDE_PROXY_OVERRIDE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[304] ,ZAFLAGS_INCLUDE_INTRANET_SITES));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[305] ,ZAFLAGS_NO_UI));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[306] ,ZAFLAGS_SUPPORTS_VERIFICATION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[307] ,ZAFLAGS_UNC_AS_INTRANET));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[308] ,URLZONEREG_DEFAULT));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[309] ,URLZONEREG_HKLM));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[310] ,URLZONEREG_HKCU));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[311] ,SOFTDIST_FLAG_USAGE_EMAIL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[312] ,SOFTDIST_FLAG_USAGE_PRECACHE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[313] ,SOFTDIST_FLAG_USAGE_AUTOINSTALL));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[314] ,SOFTDIST_FLAG_DELETE_SUBSCRIPTION));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[315] ,SOFTDIST_ADSTATE_NONE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[316] ,SOFTDIST_ADSTATE_AVAILABLE));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[317] ,SOFTDIST_ADSTATE_DOWNLOADED));
__RegisteredConstsList0.Add(RegisterConst(__ConstNames0[318] ,SOFTDIST_ADSTATE_INSTALLED));
end;
